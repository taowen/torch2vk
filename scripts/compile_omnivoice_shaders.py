#!/usr/bin/env python3
"""Compile every OmniVoice safetensor shader module discovered in its shader directory."""
...
def main() -> int:
    ...
    if compiler is None:
        print("glslangValidator is required to compile OmniVoice shaders", file=sys.stderr)
        return 127

    root = Path(__file__).resolve().parents[1]
    output_dir = root / "build" / "shaders" / "omnivoice_safetensor"
