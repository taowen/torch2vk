"""Generated shader: decode_layer_mul_broadcast_30."""
...
DECODE_LAYER_MUL_BROADCAST_30 = ShaderVariant(
    name='decode_layer_mul_broadcast_30',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='decode_layer_mul_broadcast_30',
        fields=(
            TensorFieldSpec(
                name='x',
