"""Generated shader: decode_embed_embedding_f32."""
...
DECODE_EMBED_EMBEDDING_F32 = ShaderVariant(
    name='decode_embed_embedding_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportEmbeddingProgram',
        shader_name='decode_embed_embedding_f32',
        fields=(
            TensorFieldSpec(
                name='weight',
