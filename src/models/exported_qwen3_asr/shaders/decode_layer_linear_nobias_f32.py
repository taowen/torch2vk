"""Generated shader: decode_layer_linear_nobias_f32."""
...
DECODE_LAYER_LINEAR_NOBIAS_F32 = ShaderVariant(
    name='decode_layer_linear_nobias_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasProgram',
        shader_name='decode_layer_linear_nobias_f32',
        fields=(
            TensorFieldSpec(
                name='x',
