"""Generated shader: decode_layer_linear_nobias_f32_41."""
...
DECODE_LAYER_LINEAR_NOBIAS_F32_41 = ShaderVariant(
    name='decode_layer_linear_nobias_f32_41',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasProgram',
        shader_name='decode_layer_linear_nobias_f32_41',
        fields=(
            TensorFieldSpec(
                name='x',
