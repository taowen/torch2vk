"""Generated shader: decode_layer_export_slice_f32_25."""
...
DECODE_LAYER_EXPORT_SLICE_F32_25 = ShaderVariant(
    name='decode_layer_export_slice_f32_25',
    family='export',
    contract=ShaderContract(
        class_name='ExportSliceProgram',
        shader_name='decode_layer_export_slice_f32_25',
        fields=(
            TensorFieldSpec(
                name='x',
