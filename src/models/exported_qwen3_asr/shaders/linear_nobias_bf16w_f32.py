"""Generated shader: linear_nobias_bf16w_f32."""
...
LINEAR_NOBIAS_BF16W_F32 = ShaderVariant(
    name='linear_nobias_bf16w_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasBf16WeightProgram',
        shader_name='linear_nobias_bf16w_f32',
        fields=(
            TensorFieldSpec(
                name='x',
...
shared float16_t tile_x[16 * 32]; shared bfloat16_t tile_w[32 * 64];
void main() {
