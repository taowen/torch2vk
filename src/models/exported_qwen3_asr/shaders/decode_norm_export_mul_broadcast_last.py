"""Generated shader: decode_norm_export_mul_broadcast_last."""
...
DECODE_NORM_EXPORT_MUL_BROADCAST_LAST = ShaderVariant(
    name='decode_norm_export_mul_broadcast_last',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastLastProgram',
        shader_name='decode_norm_export_mul_broadcast_last',
        fields=(
            TensorFieldSpec(
                name='x',
