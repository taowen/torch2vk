"""Generated shader: mul_left_broadcast_bf16x_f32_12."""
...
MUL_LEFT_BROADCAST_BF16X_F32_12 = ShaderVariant(
    name='mul_left_broadcast_bf16x_f32_12',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulLeftBroadcastBf16XProgram',
        shader_name='mul_left_broadcast_bf16x_f32_12',
        fields=(
            TensorFieldSpec(
                name='x',
...
void main() {
    ...
    if (idx < pc.N) { output_values[idx] = float16_t(float(y[idx]) * float(x[idx % pc.H])); }
}
""",
)
