"""Generated shader: decode_layer_mul_broadcast."""
...
DECODE_LAYER_MUL_BROADCAST = ShaderVariant(
    name='decode_layer_mul_broadcast',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='decode_layer_mul_broadcast',
        fields=(
            TensorFieldSpec(
                name='x',
