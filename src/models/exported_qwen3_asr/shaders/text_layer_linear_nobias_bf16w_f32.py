"""Generated shader: text_layer_linear_nobias_bf16w_f32."""
...
TEXT_LAYER_LINEAR_NOBIAS_BF16W_F32 = ShaderVariant(
    name='text_layer_linear_nobias_bf16w_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasBf16WeightProgram',
        shader_name='text_layer_linear_nobias_bf16w_f32',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        params_buffer=None,
        dispatch=(ceil_div(151, 16), ceil_div(2048, 64), 1),
    ),
