"""Generated shader: decode_layer_mul_broadcast_26."""
...
DECODE_LAYER_MUL_BROADCAST_26 = ShaderVariant(
    name='decode_layer_mul_broadcast_26',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='decode_layer_mul_broadcast_26',
        fields=(
            TensorFieldSpec(
                name='x',
