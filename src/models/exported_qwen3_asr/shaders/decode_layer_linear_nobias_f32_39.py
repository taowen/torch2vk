"""Generated shader: decode_layer_linear_nobias_f32_39."""
...
DECODE_LAYER_LINEAR_NOBIAS_F32_39 = ShaderVariant(
    name='decode_layer_linear_nobias_f32_39',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasProgram',
        shader_name='decode_layer_linear_nobias_f32_39',
        fields=(
            TensorFieldSpec(
                name='x',
