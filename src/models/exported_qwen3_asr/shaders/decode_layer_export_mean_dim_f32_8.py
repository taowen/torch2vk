"""Generated shader: decode_layer_export_mean_dim_f32_8."""
...
DECODE_LAYER_EXPORT_MEAN_DIM_F32_8 = ShaderVariant(
    name='decode_layer_export_mean_dim_f32_8',
    family='export',
    contract=ShaderContract(
        class_name='ExportMeanDimProgram',
        shader_name='decode_layer_export_mean_dim_f32_8',
        fields=(
            TensorFieldSpec(
                name='x',
