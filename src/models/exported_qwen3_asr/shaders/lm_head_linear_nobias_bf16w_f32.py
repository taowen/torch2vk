"""Generated shader: lm_head_linear_nobias_bf16w_f32."""
...
LM_HEAD_LINEAR_NOBIAS_BF16W_F32 = ShaderVariant(
    name='lm_head_linear_nobias_bf16w_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasBf16WeightProgram',
        shader_name='lm_head_linear_nobias_bf16w_f32',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        params_buffer=None,
        dispatch=(ceil_div(151, 16), ceil_div(151936, 64), 1),
    ),
