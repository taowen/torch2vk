"""Generated shader: decode_layer_export_cat_f32."""
...
DECODE_LAYER_EXPORT_CAT_F32 = ShaderVariant(
    name='decode_layer_export_cat_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportCatProgram',
        shader_name='decode_layer_export_cat_f32',
        fields=(
            TensorFieldSpec(
                name='a',
        ...
        push_constants=PushConstantSpec(
            size=16,
            fields=(
                PushConstantFieldSpec('N_OUT', PushConstantType.UINT32, 0, 2048, dynamic=False),
