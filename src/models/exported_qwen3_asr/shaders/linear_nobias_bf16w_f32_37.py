"""Generated shader: linear_nobias_bf16w_f32_37."""
...
LINEAR_NOBIAS_BF16W_F32_37 = ShaderVariant(
    name='linear_nobias_bf16w_f32_37',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasBf16WeightProgram',
        shader_name='linear_nobias_bf16w_f32_37',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        params_buffer=None,
        dispatch=(ceil_div(151, 16), ceil_div(1024, 64), 1),
    ),
