"""Generated shader: decode_layer_mul_broadcast_21."""
...
DECODE_LAYER_MUL_BROADCAST_21 = ShaderVariant(
    name='decode_layer_mul_broadcast_21',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='decode_layer_mul_broadcast_21',
        fields=(
            TensorFieldSpec(
                name='x',
