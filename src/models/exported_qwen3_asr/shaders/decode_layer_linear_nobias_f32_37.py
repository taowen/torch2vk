"""Generated shader: decode_layer_linear_nobias_f32_37."""
...
DECODE_LAYER_LINEAR_NOBIAS_F32_37 = ShaderVariant(
    name='decode_layer_linear_nobias_f32_37',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasProgram',
        shader_name='decode_layer_linear_nobias_f32_37',
        fields=(
            TensorFieldSpec(
                name='x',
