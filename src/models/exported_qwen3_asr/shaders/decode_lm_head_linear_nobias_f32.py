"""Generated shader: decode_lm_head_linear_nobias_f32."""
...
DECODE_LM_HEAD_LINEAR_NOBIAS_F32 = ShaderVariant(
    name='decode_lm_head_linear_nobias_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasProgram',
        shader_name='decode_lm_head_linear_nobias_f32',
        fields=(
            TensorFieldSpec(
                name='x',
