"""Generated shader: decode_layer_linear_nobias_bf16w_f32_37."""
...
DECODE_LAYER_LINEAR_NOBIAS_BF16W_F32_37 = ShaderVariant(
    name='decode_layer_linear_nobias_bf16w_f32_37',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasBf16WeightProgram',
        shader_name='decode_layer_linear_nobias_bf16w_f32_37',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('K', PushConstantType.UINT32, 4, 2048, dynamic=False),
                PushConstantFieldSpec('N', PushConstantType.UINT32, 8, 1024, dynamic=False),
            ),
        ),
        params_buffer=None,
        dispatch=(ceil_div(1, 16), ceil_div(1024, 64), 1),
    ),
