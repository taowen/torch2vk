"""Generated shader: mul_left_broadcast_bf16x_f32."""
...
MUL_LEFT_BROADCAST_BF16X_F32 = ShaderVariant(
    name='mul_left_broadcast_bf16x_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulLeftBroadcastBf16XProgram',
        shader_name='mul_left_broadcast_bf16x_f32',
        fields=(
            TensorFieldSpec(
                name='x',
