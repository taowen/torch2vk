"""Generated shader: decode_embed_embedding_bf16w_f32."""
...
DECODE_EMBED_EMBEDDING_BF16W_F32 = ShaderVariant(
    name='decode_embed_embedding_bf16w_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportEmbeddingBf16WeightProgram',
        shader_name='decode_embed_embedding_bf16w_f32',
        fields=(
            TensorFieldSpec(
                name='weight',
