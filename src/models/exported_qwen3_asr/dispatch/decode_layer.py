...
from models.exported_qwen3_asr.shaders.decode_layer_mul_broadcast_11 import DECODE_LAYER_MUL_BROADCAST_11
from models.exported_qwen3_asr.shaders.decode_layer_mul_broadcast_18 import DECODE_LAYER_MUL_BROADCAST_18
from models.exported_qwen3_asr.shaders.decode_layer_mul_broadcast_21 import DECODE_LAYER_MUL_BROADCAST_21
from models.exported_qwen3_asr.shaders.decode_layer_mul_broadcast_26 import DECODE_LAYER_MUL_BROADCAST_26
from models.exported_qwen3_asr.shaders.decode_layer_mul_broadcast_28 import DECODE_LAYER_MUL_BROADCAST_28
from models.exported_qwen3_asr.shaders.decode_layer_mul_broadcast_30 import DECODE_LAYER_MUL_BROADCAST_30
...
def _run_decode_layer_with_tensors(rt: RuntimeSession, tensors: DecodeLayerTensors, *, cache_position: int) -> None:
    ...
    DECODE_LAYER_MUL_BROADCAST_21(rt, x=tensors.transpose, y=tensors.unsqueeze, output=tensors.mul_6)
    ...
    DECODE_LAYER_MUL_BROADCAST_26(rt, x=tensors.cat, y=tensors.unsqueeze_1, output=tensors.mul_7)
    DECODE_LAYER_ADD_F32(rt, x=tensors.mul_6, y=tensors.mul_7, output=tensors.add_3)
    DECODE_LAYER_MUL_BROADCAST_28(rt, x=tensors.transpose_1, y=tensors.unsqueeze, output=tensors.mul_8)
    ...
    DECODE_LAYER_MUL_BROADCAST_30(rt, x=tensors.cat_1, y=tensors.unsqueeze_1, output=tensors.mul_9)
