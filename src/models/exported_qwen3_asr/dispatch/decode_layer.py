...
from models.exported_qwen3_asr.shaders.decode_layer_linear_nobias_bf16w_f32 import DECODE_LAYER_LINEAR_NOBIAS_BF16W_F32
from models.exported_qwen3_asr.shaders.decode_layer_linear_nobias_bf16w_f32_14 import DECODE_LAYER_LINEAR_NOBIAS_BF16W_F32_14
from models.exported_qwen3_asr.shaders.decode_layer_linear_nobias_bf16w_f32_22 import DECODE_LAYER_LINEAR_NOBIAS_BF16W_F32_22
from models.exported_qwen3_asr.shaders.decode_layer_linear_nobias_bf16w_f32_37 import DECODE_LAYER_LINEAR_NOBIAS_BF16W_F32_37
from models.exported_qwen3_asr.shaders.decode_layer_linear_nobias_bf16w_f32_39 import DECODE_LAYER_LINEAR_NOBIAS_BF16W_F32_39
from models.exported_qwen3_asr.shaders.decode_layer_linear_nobias_bf16w_f32_41 import DECODE_LAYER_LINEAR_NOBIAS_BF16W_F32_41
from models.exported_qwen3_asr.shaders.decode_layer_linear_nobias_bf16w_f32_43 import DECODE_LAYER_LINEAR_NOBIAS_BF16W_F32_43
...
from models.exported_qwen3_asr.shaders.mul_left_broadcast_bf16x_f32_20 import MUL_LEFT_BROADCAST_BF16X_F32_20
...
def _run_decode_layer_with_tensors(rt: RuntimeSession, tensors: DecodeLayerTensors) -> None:
    ...
    DECODE_LAYER_LINEAR_NOBIAS_BF16W_F32(rt, x=tensors.mul_1, weight=tensors.p_attn_q_proj_weight, output=tensors.linear)
    ...
    DECODE_LAYER_LINEAR_NOBIAS_BF16W_F32_14(rt, x=tensors.mul_1, weight=tensors.p_attn_k_proj_weight, output=tensors.linear_1)
    ...
    MUL_LEFT_BROADCAST_BF16X_F32_20(rt, x=tensors.p_attn_k_norm_weight, y=tensors.to_5, output=tensors.mul_5)
    TRANSPOSE_F32_D509518B4F(rt, x=tensors.mul_5, output=tensors.transpose_1)
    DECODE_LAYER_LINEAR_NOBIAS_BF16W_F32_22(rt, x=tensors.mul_1, weight=tensors.p_attn_v_proj_weight, output=tensors.linear_2)
    ...
    DECODE_LAYER_LINEAR_NOBIAS_BF16W_F32_37(rt, x=tensors.reshape, weight=tensors.p_attn_o_proj_weight, output=tensors.linear_3)
    ADD_F32_38(rt, x=tensors.hidden_states, y=tensors.linear_3, output=tensors.add_5)
    ...
    DECODE_LAYER_LINEAR_NOBIAS_BF16W_F32_39(rt, x=tensors.mul_11, weight=tensors.p_mlp_gate_proj_weight, output=tensors.linear_4)
    SILU_F32(rt, x=tensors.linear_4, output=tensors.silu)
    DECODE_LAYER_LINEAR_NOBIAS_BF16W_F32_41(rt, x=tensors.mul_11, weight=tensors.p_mlp_up_proj_weight, output=tensors.linear_5)
    MUL_F32(rt, x=tensors.silu, y=tensors.linear_5, output=tensors.mul_12)
    DECODE_LAYER_LINEAR_NOBIAS_BF16W_F32_43(rt, x=tensors.mul_12, weight=tensors.p_mlp_down_proj_weight, output=tensors.linear_6)
    ADD_F32_44(rt, x=tensors.add_5, y=tensors.linear_6, output=tensors.add_7)
