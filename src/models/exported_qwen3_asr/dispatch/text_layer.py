...
from models.exported_qwen3_asr.shaders.add_f32_37 import ADD_F32_37
...
from models.exported_qwen3_asr.shaders.mul_broadcast_11 import MUL_BROADCAST_11
from models.exported_qwen3_asr.shaders.mul_broadcast_18 import MUL_BROADCAST_18
from models.exported_qwen3_asr.shaders.mul_broadcast_21 import MUL_BROADCAST_21
from models.exported_qwen3_asr.shaders.mul_broadcast_26 import MUL_BROADCAST_26
from models.exported_qwen3_asr.shaders.mul_broadcast_28 import MUL_BROADCAST_28
from models.exported_qwen3_asr.shaders.mul_broadcast_30 import MUL_BROADCAST_30
...
from models.exported_qwen3_asr.shaders.slice_f32_29 import SLICE_F32_29
...
def _run_text_layer_with_tensors(rt: RuntimeSession, tensors: TextLayerTensors) -> None:
    ...
    ADD_F32_34(rt, x=tensors.hidden_states, y=tensors.linear_3, output=tensors.add_5)
    ...
    ADD_F32_37(rt, x=tensors.add_5, y=tensors.linear_6, output=tensors.add_7)
