...
from models.exported_qwen3_asr.shaders.linear_nobias_bf16w_f32_14 import LINEAR_NOBIAS_BF16W_F32_14
from models.exported_qwen3_asr.shaders.linear_nobias_bf16w_f32_22 import LINEAR_NOBIAS_BF16W_F32_22
from models.exported_qwen3_asr.shaders.linear_nobias_bf16w_f32_37 import LINEAR_NOBIAS_BF16W_F32_37
from models.exported_qwen3_asr.shaders.linear_nobias_bf16w_f32_39 import LINEAR_NOBIAS_BF16W_F32_39
from models.exported_qwen3_asr.shaders.linear_nobias_bf16w_f32_41 import LINEAR_NOBIAS_BF16W_F32_41
from models.exported_qwen3_asr.shaders.linear_nobias_bf16w_f32_43 import LINEAR_NOBIAS_BF16W_F32_43
...
from models.exported_qwen3_asr.shaders.text_layer_linear_nobias_bf16w_f32 import TEXT_LAYER_LINEAR_NOBIAS_BF16W_F32
...
def _run_text_layer_with_tensors(rt: RuntimeSession, tensors: TextLayerTensors) -> None:
    ...
    TEXT_LAYER_LINEAR_NOBIAS_BF16W_F32(rt, x=tensors.mul_1, weight=tensors.p_attn_q_proj_weight, output=tensors.linear)
    ...
    LINEAR_NOBIAS_BF16W_F32_14(rt, x=tensors.mul_1, weight=tensors.p_attn_k_proj_weight, output=tensors.linear_1)
    ...
    LINEAR_NOBIAS_BF16W_F32_22(rt, x=tensors.mul_1, weight=tensors.p_attn_v_proj_weight, output=tensors.linear_2)
    ...
    LINEAR_NOBIAS_BF16W_F32_37(rt, x=tensors.reshape, weight=tensors.p_attn_o_proj_weight, output=tensors.linear_3)
    ...
    LINEAR_NOBIAS_BF16W_F32_39(rt, x=tensors.mul_11, weight=tensors.p_mlp_gate_proj_weight, output=tensors.linear_4)
    SILU_F32(rt, x=tensors.linear_4, output=tensors.silu)
    LINEAR_NOBIAS_BF16W_F32_41(rt, x=tensors.mul_11, weight=tensors.p_mlp_up_proj_weight, output=tensors.linear_5)
    MUL_F32(rt, x=tensors.silu, y=tensors.linear_5, output=tensors.mul_12)
    LINEAR_NOBIAS_BF16W_F32_43(rt, x=tensors.mul_12, weight=tensors.p_mlp_down_proj_weight, output=tensors.linear_6)
