...
from models.exported_qwen3_asr.shaders.embedding_bf16w_f32 import EMBEDDING_BF16W_F32
...
def _run_embed_tokens_with_tensors(rt: RuntimeSession, tensors: EmbedTokensTensors) -> None:
    EMBEDDING_BF16W_F32(rt, weight=tensors.p_weight, indices=tensors.input, output=tensors.embedding)
