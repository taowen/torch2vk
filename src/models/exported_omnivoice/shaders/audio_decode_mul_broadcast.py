"""Generated shader: audio_decode_mul_broadcast."""
...
AUDIO_DECODE_MUL_BROADCAST = ShaderVariant(
    name='audio_decode_mul_broadcast',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='audio_decode_mul_broadcast',
        fields=(
            TensorFieldSpec(
                name='x',
