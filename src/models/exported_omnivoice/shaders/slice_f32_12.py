...
SLICE_F32_12 = ShaderVariant(
    name='slice_f32_12',
    family='export',
    contract=ShaderContract(
        class_name='ExportSliceProgram',
        shader_name='slice_f32_12',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('IN_STRIDE', PushConstantType.UINT32, 4, mul('I3', 1), dynamic=False),
                PushConstantFieldSpec('OUT_STRIDE', PushConstantType.UINT32, 8, mul('O3', 1), dynamic=False),
                PushConstantFieldSpec('OFFSET', PushConstantType.UINT32, 12, mul(64, 1), dynamic=False),
            ),
        ),
        params_buffer=None,
