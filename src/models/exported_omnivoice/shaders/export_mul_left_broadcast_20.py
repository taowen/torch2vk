"""Generated shader: export_mul_left_broadcast_20."""
...
EXPORT_MUL_LEFT_BROADCAST_20 = ShaderVariant(
    name='export_mul_left_broadcast_20',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulLeftBroadcastProgram',
        shader_name='export_mul_left_broadcast_20',
        fields=(
            TensorFieldSpec(
                name='x',
