"""Generated shader: linear_bias_f32w_f32b_f32."""
...
LINEAR_BIAS_F32W_F32B_F32 = ShaderVariant(
    name='linear_bias_f32w_f32b_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearBiasF32WeightF32BiasProgram',
        shader_name='linear_bias_f32w_f32b_f32',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        params_buffer=None,
        dispatch=(ceil_div(mul('X0', 'X1'), 16), ceil_div('W0', 16), 1),
    ),
...
shared float16_t tile_x[16 * 32]; shared float tile_w[32 * 16];
void main() {
