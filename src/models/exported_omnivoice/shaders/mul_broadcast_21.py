"""Generated shader: mul_broadcast_21."""
...
MUL_BROADCAST_21 = ShaderVariant(
    name='mul_broadcast_21',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='mul_broadcast_21',
        fields=(
            TensorFieldSpec(
                name='x',
            ...
            TensorFieldSpec(
                ...
                io_kind=IOKind.INPUT,
                role='input',
                contract=TensorContract(dtype='float16', shape=('B', 1, 'H', 'D',)),
            ),
            TensorFieldSpec(
                name='output',
...
void main() {
    ...
    const uint y_idx = c0 * 1u * pc.D2 * pc.D3 + c2 * pc.D3 + c3 * 1u;
