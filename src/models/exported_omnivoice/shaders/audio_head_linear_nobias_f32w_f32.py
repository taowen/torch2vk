"""Generated shader: audio_head_linear_nobias_f32w_f32."""
...
AUDIO_HEAD_LINEAR_NOBIAS_F32W_F32 = ShaderVariant(
    name='audio_head_linear_nobias_f32w_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasF32WeightProgram',
        shader_name='audio_head_linear_nobias_f32w_f32',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        params_buffer=None,
        dispatch=(ceil_div(170, 16), ceil_div(8200, 64), 1),
    ),
