"""Generated shader: export_transpose_f32_f3e8fdf2d4."""
...
EXPORT_TRANSPOSE_F32_F3E8FDF2D4 = ShaderVariant(
    name='export_transpose_f32_f3e8fdf2d4',
    family='export',
    contract=ShaderContract(
        class_name='ExportTransposeProgram',
        shader_name='export_transpose_f32_f3e8fdf2d4',
        fields=(
            TensorFieldSpec(
                name='x',
