"""Generated shader: export_linear_nobias_f32_22."""
...
EXPORT_LINEAR_NOBIAS_F32_22 = ShaderVariant(
    name='export_linear_nobias_f32_22',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasProgram',
        shader_name='export_linear_nobias_f32_22',
        fields=(
            TensorFieldSpec(
                name='x',
