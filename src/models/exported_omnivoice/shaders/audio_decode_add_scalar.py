"""Generated shader: audio_decode_add_scalar."""
...
AUDIO_DECODE_ADD_SCALAR = ShaderVariant(
    name='audio_decode_add_scalar',
    family='export',
    contract=ShaderContract(
        class_name='ExportAddScalarProgram',
        shader_name='audio_decode_add_scalar',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('scalar', PushConstantType.FLOAT32, 4, 1e-09, dynamic=False),
            ),
        ),
        params_buffer=None,
