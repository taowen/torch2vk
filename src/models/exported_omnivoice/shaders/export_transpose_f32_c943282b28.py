"""Generated shader: export_transpose_f32_c943282b28."""
...
EXPORT_TRANSPOSE_F32_C943282B28 = ShaderVariant(
    name='export_transpose_f32_c943282b28',
    family='export',
    contract=ShaderContract(
        class_name='ExportTransposeProgram',
        shader_name='export_transpose_f32_c943282b28',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            size=4,
            fields=(
                PushConstantFieldSpec('N', PushConstantType.UINT32, 0, 614400, dynamic=False),
            ),
        ),
        params_buffer=None,
        dispatch=(ceil_div(614400, 256), 1, 1),
    ),
