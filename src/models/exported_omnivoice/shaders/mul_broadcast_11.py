"""Generated shader: mul_broadcast_11."""
...
MUL_BROADCAST_11 = ShaderVariant(
    name='mul_broadcast_11',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='mul_broadcast_11',
        fields=(
            TensorFieldSpec(
                name='x',
            ...
            TensorFieldSpec(
                ...
                io_kind=IOKind.INPUT,
                role='input',
                contract=TensorContract(dtype='float32', shape=('B', 'T', 'H', 1,)),
            ),
            TensorFieldSpec(
                name='output',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('D0', PushConstantType.UINT32, 4, 'B', dynamic=False),
...
void main() {
    ...
    const uint x_idx = c0 * pc.D1 * pc.D2 * pc.D3 + c1 * pc.D2 * pc.D3 + c2 * pc.D3 + c3 * 1u;
    const uint y_idx = c0 * pc.D1 * pc.D2 * 1u + c1 * pc.D2 * 1u + c2 * 1u;
