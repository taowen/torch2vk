"""Generated shader: export_linear_nobias_f32_38."""
...
EXPORT_LINEAR_NOBIAS_F32_38 = ShaderVariant(
    name='export_linear_nobias_f32_38',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasProgram',
        shader_name='export_linear_nobias_f32_38',
        fields=(
            TensorFieldSpec(
                name='x',
