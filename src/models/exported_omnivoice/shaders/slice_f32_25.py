...
SLICE_F32_25 = ShaderVariant(
    name='slice_f32_25',
    family='export',
    contract=ShaderContract(
        class_name='ExportSliceProgram',
        shader_name='slice_f32_25',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            size=16,
            fields=(
                PushConstantFieldSpec('N_OUT', PushConstantType.UINT32, 0, 614400, dynamic=False),
