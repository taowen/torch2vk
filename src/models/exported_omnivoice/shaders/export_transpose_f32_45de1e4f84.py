"""Generated shader: export_transpose_f32_45de1e4f84."""
...
EXPORT_TRANSPOSE_F32_45DE1E4F84 = ShaderVariant(
    name='export_transpose_f32_45de1e4f84',
    family='export',
    contract=ShaderContract(
        class_name='ExportTransposeProgram',
        shader_name='export_transpose_f32_45de1e4f84',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            size=4,
            fields=(
                PushConstantFieldSpec('N', PushConstantType.UINT32, 0, 1228800, dynamic=False),
            ),
        ),
        params_buffer=None,
        dispatch=(ceil_div(1228800, 256), 1, 1),
    ),
