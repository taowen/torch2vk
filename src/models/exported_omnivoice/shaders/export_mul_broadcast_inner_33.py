"""Generated shader: export_mul_broadcast_inner_33."""
...
EXPORT_MUL_BROADCAST_INNER_33 = ShaderVariant(
    name='export_mul_broadcast_inner_33',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastInnerProgram',
        shader_name='export_mul_broadcast_inner_33',
        fields=(
            TensorFieldSpec(
                name='x',
            ...
            TensorFieldSpec(
                ...
                io_kind=IOKind.INPUT,
                role='input',
                contract=TensorContract(dtype='float32', shape=('B', 1, 'H', 'D',)),
            ),
            TensorFieldSpec(
                name='output',
