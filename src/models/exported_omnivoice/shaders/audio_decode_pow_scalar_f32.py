"""Generated shader: audio_decode_pow_scalar_f32."""
...
AUDIO_DECODE_POW_SCALAR_F32 = ShaderVariant(
    name='audio_decode_pow_scalar_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportPowScalarF32Program',
        shader_name='audio_decode_pow_scalar_f32',
        fields=(
            TensorFieldSpec(
                name='x',
