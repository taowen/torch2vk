"""Generated shader: export_mul_broadcast_last_19."""
...
EXPORT_MUL_BROADCAST_LAST_19 = ShaderVariant(
    name='export_mul_broadcast_last_19',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastLastProgram',
        shader_name='export_mul_broadcast_last_19',
        fields=(
            TensorFieldSpec(
                name='x',
