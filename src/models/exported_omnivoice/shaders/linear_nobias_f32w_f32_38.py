"""Generated shader: linear_nobias_f32w_f32_38."""
...
LINEAR_NOBIAS_F32W_F32_38 = ShaderVariant(
    name='linear_nobias_f32w_f32_38',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasF32WeightProgram',
        shader_name='linear_nobias_f32w_f32_38',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        params_buffer=None,
        dispatch=(ceil_div(170, 16), ceil_div(3072, 64), 1),
    ),
