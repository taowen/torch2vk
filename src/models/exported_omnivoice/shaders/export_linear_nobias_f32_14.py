"""Generated shader: export_linear_nobias_f32_14."""
...
EXPORT_LINEAR_NOBIAS_F32_14 = ShaderVariant(
    name='export_linear_nobias_f32_14',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasProgram',
        shader_name='export_linear_nobias_f32_14',
        fields=(
            TensorFieldSpec(
                name='x',
