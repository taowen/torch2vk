"""Generated shader: export_mul_broadcast_last_11."""
...
EXPORT_MUL_BROADCAST_LAST_11 = ShaderVariant(
    name='export_mul_broadcast_last_11',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastLastProgram',
        shader_name='export_mul_broadcast_last_11',
        fields=(
            TensorFieldSpec(
                name='x',
