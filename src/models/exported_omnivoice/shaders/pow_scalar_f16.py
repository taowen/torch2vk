"""Generated shader: pow_scalar_f16."""
...
POW_SCALAR_F16 = ShaderVariant(
    name='pow_scalar_f16',
    family='export',
    contract=ShaderContract(
        class_name='ExportPowScalarF16Program',
        shader_name='pow_scalar_f16',
        fields=(
            TensorFieldSpec(
                name='x',
...
void main() {
    ...
    if (idx < pc.N) { float v = float(x[idx]); output_values[idx] = float16_t(v * v); }
}
""",
)
