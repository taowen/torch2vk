...
from models.exported_omnivoice.shaders.audio_head_linear_nobias_f32w_f32 import AUDIO_HEAD_LINEAR_NOBIAS_F32W_F32
...
def _run_audio_head_with_tensors(rt: RuntimeSession, tensors: AudioHeadTensors) -> None:
    AUDIO_HEAD_LINEAR_NOBIAS_F32W_F32(rt, x=tensors.input, weight=tensors.p_weight, output=tensors.linear)
