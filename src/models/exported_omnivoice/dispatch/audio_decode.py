...
from models.exported_omnivoice.shaders.select_int64_4 import SELECT_INT64_4
from models.exported_omnivoice.shaders.select_int64_5 import SELECT_INT64_5
from models.exported_omnivoice.shaders.select_int64_6 import SELECT_INT64_6
from models.exported_omnivoice.shaders.select_int64_7 import SELECT_INT64_7
from models.exported_omnivoice.shaders.select_int64_8 import SELECT_INT64_8
from models.exported_omnivoice.shaders.select_int64_9 import SELECT_INT64_9
from models.exported_omnivoice.shaders.sin_f32 import SIN_F32
from models.exported_omnivoice.shaders.transpose_f32_0ae87925be import TRANSPOSE_F32_0AE87925BE
from models.exported_omnivoice.shaders.transpose_f32_7d30938139 import TRANSPOSE_F32_7D30938139
from models.exported_omnivoice.tensors.audio_decode import AudioDecodeTensors
...
def _run_audio_decode_with_tensors(rt: RuntimeSession, tensors: AudioDecodeTensors) -> None:
    ...
    EMBEDDING_F32W_F32(rt, weight=tensors.b_quantizer_quantizers_0_codebook_embed, indices=tensors.to, output=tensors.embedding)
    LINEAR_BIAS_F32W_F32B_F32(rt, x=tensors.embedding, weight=tensors.p_quantizer_quantizers_0_project_out_weight, bias=tensors.p_quantizer_quantizers_0_project_out_bias, output=tensors.linear)
    ...
    EMBEDDING_F32W_F32(rt, weight=tensors.b_quantizer_quantizers_1_codebook_embed, indices=tensors.to_1, output=tensors.embedding_1)
    LINEAR_BIAS_F32W_F32B_F32(rt, x=tensors.embedding_1, weight=tensors.p_quantizer_quantizers_1_project_out_weight, bias=tensors.p_quantizer_quantizers_1_project_out_bias, output=tensors.linear_1)
    ...
    EMBEDDING_F32W_F32(rt, weight=tensors.b_quantizer_quantizers_2_codebook_embed, indices=tensors.to_2, output=tensors.embedding_2)
    LINEAR_BIAS_F32W_F32B_F32(rt, x=tensors.embedding_2, weight=tensors.p_quantizer_quantizers_2_project_out_weight, bias=tensors.p_quantizer_quantizers_2_project_out_bias, output=tensors.linear_2)
    ...
    EMBEDDING_F32W_F32(rt, weight=tensors.b_quantizer_quantizers_3_codebook_embed, indices=tensors.to_3, output=tensors.embedding_3)
    LINEAR_BIAS_F32W_F32B_F32(rt, x=tensors.embedding_3, weight=tensors.p_quantizer_quantizers_3_project_out_weight, bias=tensors.p_quantizer_quantizers_3_project_out_bias, output=tensors.linear_3)
    ...
    EMBEDDING_F32W_F32(rt, weight=tensors.b_quantizer_quantizers_4_codebook_embed, indices=tensors.to_4, output=tensors.embedding_4)
    LINEAR_BIAS_F32W_F32B_F32(rt, x=tensors.embedding_4, weight=tensors.p_quantizer_quantizers_4_project_out_weight, bias=tensors.p_quantizer_quantizers_4_project_out_bias, output=tensors.linear_4)
    ...
    EMBEDDING_F32W_F32(rt, weight=tensors.b_quantizer_quantizers_5_codebook_embed, indices=tensors.to_5, output=tensors.embedding_5)
    LINEAR_BIAS_F32W_F32B_F32(rt, x=tensors.embedding_5, weight=tensors.p_quantizer_quantizers_5_project_out_weight, bias=tensors.p_quantizer_quantizers_5_project_out_bias, output=tensors.linear_5)
    ...
    EMBEDDING_F32W_F32(rt, weight=tensors.b_quantizer_quantizers_6_codebook_embed, indices=tensors.to_6, output=tensors.embedding_6)
    LINEAR_BIAS_F32W_F32B_F32(rt, x=tensors.embedding_6, weight=tensors.p_quantizer_quantizers_6_project_out_weight, bias=tensors.p_quantizer_quantizers_6_project_out_bias, output=tensors.linear_6)
    ...
    EMBEDDING_F32W_F32(rt, weight=tensors.b_quantizer_quantizers_7_codebook_embed, indices=tensors.to_7, output=tensors.embedding_7)
    LINEAR_BIAS_F32W_F32B_F32(rt, x=tensors.embedding_7, weight=tensors.p_quantizer_quantizers_7_project_out_weight, bias=tensors.p_quantizer_quantizers_7_project_out_bias, output=tensors.linear_7)
    ...
    LINEAR_BIAS_F32W_F32B_F32(rt, x=tensors.transpose, weight=tensors.p_fc2_weight, bias=tensors.p_fc2_bias, output=tensors.linear_8)
    TRANSPOSE_F32_0AE87925BE(rt, x=tensors.linear_8, output=tensors.transpose_1)
    CONV1D_F32W_F32B_F32(rt, x=tensors.transpose_1, weight=tensors.p_acoustic_decoder_conv1_weight, bias=tensors.p_acoustic_decoder_conv1_bias, output=tensors.conv1d)
