...
from models.exported_omnivoice.shaders.add_f32_33 import ADD_F32_33
from models.exported_omnivoice.shaders.add_f32_36 import ADD_F32_36
from models.exported_omnivoice.shaders.add_scalar import ADD_SCALAR
from models.exported_omnivoice.shaders.add_scalar_16 import ADD_SCALAR_16
...
from models.exported_omnivoice.shaders.mean_dim_f32_15 import MEAN_DIM_F32_15
...
from models.exported_omnivoice.shaders.mul_broadcast_11 import MUL_BROADCAST_11
from models.exported_omnivoice.shaders.mul_broadcast_18 import MUL_BROADCAST_18
from models.exported_omnivoice.shaders.mul_broadcast_21 import MUL_BROADCAST_21
from models.exported_omnivoice.shaders.mul_broadcast_26 import MUL_BROADCAST_26
from models.exported_omnivoice.shaders.mul_broadcast_28 import MUL_BROADCAST_28
from models.exported_omnivoice.shaders.mul_broadcast_30 import MUL_BROADCAST_30
...
from models.exported_omnivoice.shaders.mul_left_broadcast_f32x_f32_19 import MUL_LEFT_BROADCAST_F32X_F32_19
...
from models.exported_omnivoice.shaders.pow_scalar_f32_14 import POW_SCALAR_F32_14
...
from models.exported_omnivoice.shaders.rsqrt_f32_17 import RSQRT_F32_17
...
from models.exported_omnivoice.shaders.slice_f32_23 import SLICE_F32_23
from models.exported_omnivoice.shaders.slice_f32_29 import SLICE_F32_29
...
def _run_llm_forward_with_tensors(rt: RuntimeSession, tensors: LlmForwardTensors) -> None:
    for layer_t in tensors.layers:
        ...
        MUL_BROADCAST(rt, x=layer_t.to, y=layer_t.rsqrt, output=layer_t.mul)
        ...
        MUL_BROADCAST_11(rt, x=layer_t.to_2, y=layer_t.rsqrt_1, output=layer_t.mul_2)
        ...
        LINEAR_NOBIAS_F32W_F32(rt, x=layer_t.mul_1, weight=layer_t.p_layers_0_self_attn_k_proj_weight, output=layer_t.linear_1)
        ...
        MUL_BROADCAST_18(rt, x=layer_t.to_4, y=layer_t.rsqrt_2, output=layer_t.mul_4)
        ...
        LINEAR_NOBIAS_F32W_F32(rt, x=layer_t.mul_1, weight=layer_t.p_layers_0_self_attn_v_proj_weight, output=layer_t.linear_2)
        TRANSPOSE_F32_B4BB3205FC(rt, x=layer_t.view_2, output=layer_t.transpose_2)
        MUL_BROADCAST_21(rt, x=layer_t.transpose, y=layer_t.unsqueeze, output=layer_t.mul_6)
        ...
        MUL_BROADCAST_26(rt, x=layer_t.cat, y=layer_t.unsqueeze_1, output=layer_t.mul_7)
        ADD_F32(rt, x=layer_t.mul_6, y=layer_t.mul_7, output=layer_t.add_3)
        MUL_BROADCAST_28(rt, x=layer_t.transpose_1, y=layer_t.unsqueeze, output=layer_t.mul_8)
        ...
        MUL_BROADCAST_30(rt, x=layer_t.cat_1, y=layer_t.unsqueeze_1, output=layer_t.mul_9)
        ...
        MUL_BROADCAST(rt, x=layer_t.to_6, y=layer_t.rsqrt_3, output=layer_t.mul_10)
        MUL_LEFT_BROADCAST_F32X_F32(rt, x=layer_t.p_layers_0_post_attention_layernorm_weight, y=layer_t.to_7, output=layer_t.mul_11)
        LINEAR_NOBIAS_F32W_F32(rt, x=layer_t.mul_11, weight=layer_t.p_layers_0_mlp_gate_proj_weight, output=layer_t.linear_4)
        SILU_F32(rt, x=layer_t.linear_4, output=layer_t.silu)
        LINEAR_NOBIAS_F32W_F32(rt, x=layer_t.mul_11, weight=layer_t.p_layers_0_mlp_up_proj_weight, output=layer_t.linear_5)
        MUL_F32(rt, x=layer_t.silu, y=layer_t.linear_5, output=layer_t.mul_12)
        LINEAR_NOBIAS_F32W_F32(rt, x=layer_t.mul_12, weight=layer_t.p_layers_0_mlp_down_proj_weight, output=layer_t.linear_6)
    ...
    MUL_BROADCAST(rt, x=tensors.to_224, y=tensors.rsqrt_112, output=tensors.mul_364)
