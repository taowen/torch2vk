"""Generated shader: export_add_f32_run_decode_layer."""
...
EXPORT_ADD_F32_RUN_DECODE_LAYER = ShaderVariant(
    name='export_add_f32_run_decode_layer',
    family='export',
    contract=ShaderContract(
        class_name='ExportAddF32Program',
        shader_name='export_add_f32_run_decode_layer',
        fields=(
            TensorFieldSpec(
                name='x',
