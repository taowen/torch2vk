"""Generated shader: export_cat_f32_run_decode_layer."""
...
EXPORT_CAT_F32_RUN_DECODE_LAYER = ShaderVariant(
    name='export_cat_f32_run_decode_layer',
    family='export',
    contract=ShaderContract(
        class_name='ExportCatProgram',
        shader_name='export_cat_f32_run_decode_layer',
        fields=(
            TensorFieldSpec(
                name='a',
        ...
        push_constants=PushConstantSpec(
            size=16,
            fields=(
                PushConstantFieldSpec('N_OUT', PushConstantType.UINT32, 0, 2048),
