"""Generated shader: export_mul_left_broadcast_12."""
...
EXPORT_MUL_LEFT_BROADCAST_12 = ShaderVariant(
    name='export_mul_left_broadcast_12',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulLeftBroadcastProgram',
        shader_name='export_mul_left_broadcast_12',
        fields=(
            TensorFieldSpec(
                name='x',
