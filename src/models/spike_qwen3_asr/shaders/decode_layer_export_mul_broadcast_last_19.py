"""Generated shader: decode_layer_export_mul_broadcast_last_19."""
...
DECODE_LAYER_EXPORT_MUL_BROADCAST_LAST_19 = ShaderVariant(
    name='decode_layer_export_mul_broadcast_last_19',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastLastProgram',
        shader_name='decode_layer_export_mul_broadcast_last_19',
        fields=(
            TensorFieldSpec(
                name='x',
