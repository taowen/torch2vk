"""Generated shader: export_mul_broadcast_inner_x_1_1_x_1_1."""
...
EXPORT_MUL_BROADCAST_INNER_X_1_1_X_1_1 = ShaderVariant(
    name='export_mul_broadcast_inner_x_1_1_x_1_1',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastInnerProgram',
        shader_name='export_mul_broadcast_inner_x_1_1_x_1_1',
        fields=(
            TensorFieldSpec(
                name='x',
