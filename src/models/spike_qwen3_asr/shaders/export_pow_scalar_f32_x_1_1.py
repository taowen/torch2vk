"""Generated shader: export_pow_scalar_f32_x_1_1."""
...
EXPORT_POW_SCALAR_F32_X_1_1 = ShaderVariant(
    name='export_pow_scalar_f32_x_1_1',
    family='export',
    contract=ShaderContract(
        class_name='ExportPowScalarF32Program',
        shader_name='export_pow_scalar_f32_x_1_1',
        fields=(
            TensorFieldSpec(
                name='x',
