"""Generated shader: export_mean_dim_f32_run_decode_norm."""
...
EXPORT_MEAN_DIM_F32_RUN_DECODE_NORM = ShaderVariant(
    name='export_mean_dim_f32_run_decode_norm',
    family='export',
    contract=ShaderContract(
        class_name='ExportMeanDimProgram',
        shader_name='export_mean_dim_f32_run_decode_norm',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('COLS', PushConstantType.UINT32, 4, 1024),
            ),
        ),
        dispatch=(1, 1, 1),
    ),
