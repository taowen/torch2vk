"""Generated shader: decode_layer_export_sdpa_f32."""
...
DECODE_LAYER_EXPORT_SDPA_F32 = ShaderVariant(
    name='decode_layer_export_sdpa_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportSdpaProgram',
        shader_name='decode_layer_export_sdpa_f32',
        fields=(
            TensorFieldSpec(
                name='q',
