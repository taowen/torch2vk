"""Generated shader: export_conv2d_f32_run_conv2d3."""
...
EXPORT_CONV2D_F32_RUN_CONV2D3 = ShaderVariant(
    name='export_conv2d_f32_run_conv2d3',
    family='export',
    contract=ShaderContract(
        class_name='ExportConv2dProgram',
        shader_name='export_conv2d_f32_run_conv2d3',
        fields=(
            TensorFieldSpec(
                name='x',
