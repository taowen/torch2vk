"""Generated shader: export_mul_broadcast_inner_34."""
...
EXPORT_MUL_BROADCAST_INNER_34 = ShaderVariant(
    name='export_mul_broadcast_inner_34',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastInnerProgram',
        shader_name='export_mul_broadcast_inner_34',
        fields=(
            TensorFieldSpec(
                name='x',
