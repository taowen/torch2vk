"""Generated shader: text_layer_export_linear_nobias_f32."""
...
TEXT_LAYER_EXPORT_LINEAR_NOBIAS_F32 = ShaderVariant(
    name='text_layer_export_linear_nobias_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasProgram',
        shader_name='text_layer_export_linear_nobias_f32',
        fields=(
            TensorFieldSpec(
                name='x',
