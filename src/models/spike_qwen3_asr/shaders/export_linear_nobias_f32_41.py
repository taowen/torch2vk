"""Generated shader: export_linear_nobias_f32_41."""
...
EXPORT_LINEAR_NOBIAS_F32_41 = ShaderVariant(
    name='export_linear_nobias_f32_41',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasProgram',
        shader_name='export_linear_nobias_f32_41',
        fields=(
            TensorFieldSpec(
                name='x',
