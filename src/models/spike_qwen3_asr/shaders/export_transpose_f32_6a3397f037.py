"""Generated shader: export_transpose_f32_6a3397f037."""
...
EXPORT_TRANSPOSE_F32_6A3397F037 = ShaderVariant(
    name='export_transpose_f32_6a3397f037',
    family='export',
    contract=ShaderContract(
        class_name='ExportTransposeProgram',
        shader_name='export_transpose_f32_6a3397f037',
        fields=(
            TensorFieldSpec(
                name='x',
...
void main() {
    ...
    if (idx < pc.N) {
        ...
        in_idx = in_idx * 14u + c0;
        in_idx = in_idx * 64u + c2;
