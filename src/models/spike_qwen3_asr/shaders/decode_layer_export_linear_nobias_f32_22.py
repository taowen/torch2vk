"""Generated shader: decode_layer_export_linear_nobias_f32_22."""
...
DECODE_LAYER_EXPORT_LINEAR_NOBIAS_F32_22 = ShaderVariant(
    name='decode_layer_export_linear_nobias_f32_22',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasProgram',
        shader_name='decode_layer_export_linear_nobias_f32_22',
        fields=(
            TensorFieldSpec(
                name='x',
