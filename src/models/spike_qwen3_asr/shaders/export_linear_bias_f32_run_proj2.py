"""Generated shader: export_linear_bias_f32_run_proj2."""
...
EXPORT_LINEAR_BIAS_F32_RUN_PROJ2 = ShaderVariant(
    name='export_linear_bias_f32_run_proj2',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearBiasProgram',
        shader_name='export_linear_bias_f32_run_proj2',
        fields=(
            TensorFieldSpec(
                name='x',
