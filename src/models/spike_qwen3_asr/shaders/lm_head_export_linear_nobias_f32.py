"""Generated shader: lm_head_export_linear_nobias_f32."""
...
LM_HEAD_EXPORT_LINEAR_NOBIAS_F32 = ShaderVariant(
    name='lm_head_export_linear_nobias_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasProgram',
        shader_name='lm_head_export_linear_nobias_f32',
        fields=(
            TensorFieldSpec(
                name='x',
