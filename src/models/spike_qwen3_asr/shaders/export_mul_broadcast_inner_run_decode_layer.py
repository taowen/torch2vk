"""Generated shader: export_mul_broadcast_inner_run_decode_layer."""
...
EXPORT_MUL_BROADCAST_INNER_RUN_DECODE_LAYER = ShaderVariant(
    name='export_mul_broadcast_inner_run_decode_layer',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastInnerProgram',
        shader_name='export_mul_broadcast_inner_run_decode_layer',
        fields=(
            TensorFieldSpec(
                name='x',
