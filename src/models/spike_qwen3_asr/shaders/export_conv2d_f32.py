    ...
    contract=ShaderContract(
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('in_c', PushConstantType.UINT32, 4, 1),
                PushConstantFieldSpec('in_h', PushConstantType.UINT32, 8, 128),
                PushConstantFieldSpec('in_w', PushConstantType.UINT32, 12, 100),
                PushConstantFieldSpec('out_c', PushConstantType.UINT32, 16, 480),
                PushConstantFieldSpec('out_h', PushConstantType.UINT32, 20, 64),
                PushConstantFieldSpec('out_w', PushConstantType.UINT32, 24, 50),
