"""Generated shader: export_mean_dim_f32_2416_1_1."""
...
EXPORT_MEAN_DIM_F32_2416_1_1 = ShaderVariant(
    name='export_mean_dim_f32_2416_1_1',
    family='export',
    contract=ShaderContract(
        class_name='ExportMeanDimProgram',
        shader_name='export_mean_dim_f32_2416_1_1',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            size=8,
            fields=(
                PushConstantFieldSpec('ROWS', PushConstantType.UINT32, 0, 2416),
