"""Generated shader: export_slice_f32_31."""
...
EXPORT_SLICE_F32_31 = ShaderVariant(
    name='export_slice_f32_31',
    family='export',
    contract=ShaderContract(
        class_name='ExportSliceProgram',
        shader_name='export_slice_f32_31',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            size=16,
            fields=(
                PushConstantFieldSpec('N_OUT', PushConstantType.UINT32, 0, 77312),
