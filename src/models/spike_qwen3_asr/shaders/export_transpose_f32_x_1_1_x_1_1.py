"""Generated shader: export_transpose_f32_x_1_1_x_1_1."""
...
EXPORT_TRANSPOSE_F32_X_1_1_X_1_1 = ShaderVariant(
    name='export_transpose_f32_x_1_1_x_1_1',
    family='export',
    contract=ShaderContract(
        class_name='ExportTransposeProgram',
        shader_name='export_transpose_f32_x_1_1_x_1_1',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            size=16,
            fields=(
                PushConstantFieldSpec('N', PushConstantType.UINT32, 0, 154624),
