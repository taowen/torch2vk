"""Generated shader: export_slice_f32_x_1_1_run_decode_layer."""
...
EXPORT_SLICE_F32_X_1_1_RUN_DECODE_LAYER = ShaderVariant(
    name='export_slice_f32_x_1_1_run_decode_layer',
    family='export',
    contract=ShaderContract(
        class_name='ExportSliceProgram',
        shader_name='export_slice_f32_x_1_1_run_decode_layer',
        fields=(
            TensorFieldSpec(
                name='x',
