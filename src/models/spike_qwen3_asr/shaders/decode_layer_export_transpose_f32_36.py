"""Generated shader: decode_layer_export_transpose_f32_36."""
...
DECODE_LAYER_EXPORT_TRANSPOSE_F32_36 = ShaderVariant(
    name='decode_layer_export_transpose_f32_36',
    family='export',
    contract=ShaderContract(
        class_name='ExportTransposeProgram',
        shader_name='decode_layer_export_transpose_f32_36',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('D2', PushConstantType.UINT32, 8, 1, dynamic=False),
