"""Generated shader: export_transpose_f32_9884b7b82d."""
...
EXPORT_TRANSPOSE_F32_9884B7B82D = ShaderVariant(
    name='export_transpose_f32_9884b7b82d',
    family='export',
    contract=ShaderContract(
        class_name='ExportTransposeProgram',
        shader_name='export_transpose_f32_9884b7b82d',
        fields=(
            TensorFieldSpec(
                name='x',
