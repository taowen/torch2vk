"""Generated shader: conv2d2_export_conv2d_f32."""
...
CONV2D2_EXPORT_CONV2D_F32 = ShaderVariant(
    name='conv2d2_export_conv2d_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportConv2dProgram',
        shader_name='conv2d2_export_conv2d_f32',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('in_h', PushConstantType.UINT32, 8, 64),
                PushConstantFieldSpec('in_w', PushConstantType.UINT32, 12, 50),
                PushConstantFieldSpec('out_c', PushConstantType.UINT32, 16, 480),
                PushConstantFieldSpec('out_h', PushConstantType.UINT32, 20, 32),
                PushConstantFieldSpec('out_w', PushConstantType.UINT32, 24, 25),
