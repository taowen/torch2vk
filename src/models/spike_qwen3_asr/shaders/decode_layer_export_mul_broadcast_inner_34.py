"""Generated shader: decode_layer_export_mul_broadcast_inner_34."""
...
DECODE_LAYER_EXPORT_MUL_BROADCAST_INNER_34 = ShaderVariant(
    name='decode_layer_export_mul_broadcast_inner_34',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastInnerProgram',
        shader_name='decode_layer_export_mul_broadcast_inner_34',
        fields=(
            TensorFieldSpec(
                name='x',
