"""Generated shader: export_mul_left_broadcast_x_1_1."""
...
EXPORT_MUL_LEFT_BROADCAST_X_1_1 = ShaderVariant(
    name='export_mul_left_broadcast_x_1_1',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulLeftBroadcastProgram',
        shader_name='export_mul_left_broadcast_x_1_1',
        fields=(
            TensorFieldSpec(
                name='x',
