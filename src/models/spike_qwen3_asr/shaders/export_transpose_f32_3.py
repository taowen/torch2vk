"""Generated shader: export_transpose_f32_3."""
...
EXPORT_TRANSPOSE_F32_3 = ShaderVariant(
    name='export_transpose_f32_3',
    family='export',
    contract=ShaderContract(
        class_name='ExportTransposeProgram',
        shader_name='export_transpose_f32_3',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('D1', PushConstantType.UINT32, 4, 133),
                PushConstantFieldSpec('D2', PushConstantType.UINT32, 8, 64),
                PushConstantFieldSpec('D3', PushConstantType.UINT32, 12, 1),
            ),
        ),
