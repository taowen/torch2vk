"""Generated shader: export_linear_nobias_f32_x_x_1_run_decode_layer."""
...
EXPORT_LINEAR_NOBIAS_F32_X_X_1_RUN_DECODE_LAYER = ShaderVariant(
    name='export_linear_nobias_f32_x_x_1_run_decode_layer',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasProgram',
        shader_name='export_linear_nobias_f32_x_x_1_run_decode_layer',
        fields=(
            TensorFieldSpec(
                name='x',
