"""Generated shader: decode_layer_export_linear_nobias_f32_36."""
...
DECODE_LAYER_EXPORT_LINEAR_NOBIAS_F32_36 = ShaderVariant(
    name='decode_layer_export_linear_nobias_f32_36',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasProgram',
        shader_name='decode_layer_export_linear_nobias_f32_36',
        fields=(
            TensorFieldSpec(
                name='x',
