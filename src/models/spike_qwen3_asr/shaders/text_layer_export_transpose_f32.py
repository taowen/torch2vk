"""Generated shader: text_layer_export_transpose_f32."""
...
TEXT_LAYER_EXPORT_TRANSPOSE_F32 = ShaderVariant(
    name='text_layer_export_transpose_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportTransposeProgram',
        shader_name='text_layer_export_transpose_f32',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('D2', PushConstantType.UINT32, 8, 16, dynamic=False),
