"""Generated shader: export_slice_f32_run_decode_layer."""
...
EXPORT_SLICE_F32_RUN_DECODE_LAYER = ShaderVariant(
    name='export_slice_f32_run_decode_layer',
    family='export',
    contract=ShaderContract(
        class_name='ExportSliceProgram',
        shader_name='export_slice_f32_run_decode_layer',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            size=16,
            fields=(
                PushConstantFieldSpec('N_OUT', PushConstantType.UINT32, 0, 1024),
                ...
                PushConstantFieldSpec('OFFSET', PushConstantType.UINT32, 12, 0),
            ),
        ),
