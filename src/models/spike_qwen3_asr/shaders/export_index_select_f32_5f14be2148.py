"""Generated shader: export_index_select_f32_5f14be2148."""
...
EXPORT_INDEX_SELECT_F32_5F14BE2148 = ShaderVariant(
    name='export_index_select_f32_5f14be2148',
    family='export',
    contract=ShaderContract(
        class_name='ExportIndexSelectF32Program',
        shader_name='export_index_select_f32_5f14be2148',
        fields=(
            TensorFieldSpec(
                name='x',
            ...
            TensorFieldSpec(
                ...
                io_kind=IOKind.INPUT,
                role='index',
                contract=TensorContract(dtype='int32', shape=('O',)),
            ),
            TensorFieldSpec(
                name='output',
