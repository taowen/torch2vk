"""Generated shader: export_mul_broadcast_last_run_decode_norm."""
...
EXPORT_MUL_BROADCAST_LAST_RUN_DECODE_NORM = ShaderVariant(
    name='export_mul_broadcast_last_run_decode_norm',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastLastProgram',
        shader_name='export_mul_broadcast_last_run_decode_norm',
        fields=(
            TensorFieldSpec(
                name='x',
