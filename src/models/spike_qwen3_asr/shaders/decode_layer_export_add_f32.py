"""Generated shader: decode_layer_export_add_f32."""
...
DECODE_LAYER_EXPORT_ADD_F32 = ShaderVariant(
    name='decode_layer_export_add_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportAddF32Program',
        shader_name='decode_layer_export_add_f32',
        fields=(
            TensorFieldSpec(
                name='x',
