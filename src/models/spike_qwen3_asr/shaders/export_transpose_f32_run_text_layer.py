"""Generated shader: export_transpose_f32_run_text_layer."""
...
EXPORT_TRANSPOSE_F32_RUN_TEXT_LAYER = ShaderVariant(
    name='export_transpose_f32_run_text_layer',
    family='export',
    contract=ShaderContract(
        class_name='ExportTransposeProgram',
        shader_name='export_transpose_f32_run_text_layer',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('D1', PushConstantType.UINT32, 4, 151),
