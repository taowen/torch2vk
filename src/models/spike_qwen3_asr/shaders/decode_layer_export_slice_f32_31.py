"""Generated shader: decode_layer_export_slice_f32_31."""
...
DECODE_LAYER_EXPORT_SLICE_F32_31 = ShaderVariant(
    name='decode_layer_export_slice_f32_31',
    family='export',
    contract=ShaderContract(
        class_name='ExportSliceProgram',
        shader_name='decode_layer_export_slice_f32_31',
        fields=(
            TensorFieldSpec(
                name='x',
