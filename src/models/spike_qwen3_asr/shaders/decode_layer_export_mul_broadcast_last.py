"""Generated shader: decode_layer_export_mul_broadcast_last."""
...
DECODE_LAYER_EXPORT_MUL_BROADCAST_LAST = ShaderVariant(
    name='decode_layer_export_mul_broadcast_last',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastLastProgram',
        shader_name='decode_layer_export_mul_broadcast_last',
        fields=(
            TensorFieldSpec(
                name='x',
