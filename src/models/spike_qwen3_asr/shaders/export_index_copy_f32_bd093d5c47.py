"""Generated shader: export_index_copy_f32_bd093d5c47."""
...
EXPORT_INDEX_COPY_F32_BD093D5C47 = ShaderVariant(
    name='export_index_copy_f32_bd093d5c47',
    family='export',
    contract=ShaderContract(
        class_name='ExportIndexCopyF32Program',
        shader_name='export_index_copy_f32_bd093d5c47',
        fields=(
            TensorFieldSpec(
                name='cache',
            ...
            TensorFieldSpec(
                ...
                role='index',
                contract=TensorContract(dtype='int32', shape=('S',)),
            ),
            TensorFieldSpec(
                name='src',
                io_kind=IOKind.INPUT,
