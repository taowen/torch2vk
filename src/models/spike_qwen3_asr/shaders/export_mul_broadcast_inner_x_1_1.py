"""Generated shader: export_mul_broadcast_inner_x_1_1."""
...
EXPORT_MUL_BROADCAST_INNER_X_1_1 = ShaderVariant(
    name='export_mul_broadcast_inner_x_1_1',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastInnerProgram',
        shader_name='export_mul_broadcast_inner_x_1_1',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('STRIDE', PushConstantType.UINT32, 4, 19328),
                PushConstantFieldSpec('REPEAT', PushConstantType.UINT32, 8, 8),
            ),
        ),
