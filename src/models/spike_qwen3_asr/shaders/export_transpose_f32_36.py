"""Generated shader: export_transpose_f32_36."""
...
EXPORT_TRANSPOSE_F32_36 = ShaderVariant(
    name='export_transpose_f32_36',
    family='export',
    contract=ShaderContract(
        class_name='ExportTransposeProgram',
        shader_name='export_transpose_f32_36',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            size=16,
            fields=(
                PushConstantFieldSpec('N', PushConstantType.UINT32, 0, 309248, dynamic=False),
                PushConstantFieldSpec('D1', PushConstantType.UINT32, 4, 16, dynamic=False),
                PushConstantFieldSpec('D2', PushConstantType.UINT32, 8, 151, dynamic=False),
