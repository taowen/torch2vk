"""Generated shader: decode_layer_export_slice_f32."""
...
DECODE_LAYER_EXPORT_SLICE_F32 = ShaderVariant(
    name='decode_layer_export_slice_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportSliceProgram',
        shader_name='decode_layer_export_slice_f32',
        fields=(
            TensorFieldSpec(
                name='x',
