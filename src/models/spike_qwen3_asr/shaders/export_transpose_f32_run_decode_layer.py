"""Generated shader: export_transpose_f32_run_decode_layer."""
...
EXPORT_TRANSPOSE_F32_RUN_DECODE_LAYER = ShaderVariant(
    name='export_transpose_f32_run_decode_layer',
    family='export',
    contract=ShaderContract(
        class_name='ExportTransposeProgram',
        shader_name='export_transpose_f32_run_decode_layer',
        fields=(
            TensorFieldSpec(
                name='x',
