"""Generated shader: export_linear_nobias_f32_run_lm_head."""
...
EXPORT_LINEAR_NOBIAS_F32_RUN_LM_HEAD = ShaderVariant(
    name='export_linear_nobias_f32_run_lm_head',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasProgram',
        shader_name='export_linear_nobias_f32_run_lm_head',
        fields=(
            TensorFieldSpec(
                name='x',
