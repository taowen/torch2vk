"""Generated shader: export_linear_bias_f32_x_x_1."""
...
EXPORT_LINEAR_BIAS_F32_X_X_1 = ShaderVariant(
    name='export_linear_bias_f32_x_x_1',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearBiasProgram',
        shader_name='export_linear_bias_f32_x_x_1',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('K', PushConstantType.UINT32, 4, 896),
                PushConstantFieldSpec('N', PushConstantType.UINT32, 8, 3584),
            ),
        ),
