"""Generated shader: export_linear_nobias_f32."""
...
EXPORT_LINEAR_NOBIAS_F32 = ShaderVariant(
    name='export_linear_nobias_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasProgram',
        shader_name='export_linear_nobias_f32',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            size=12,
            fields=(
                PushConstantFieldSpec('M', PushConstantType.UINT32, 0, 143),
                PushConstantFieldSpec('K', PushConstantType.UINT32, 4, 7680),
                PushConstantFieldSpec('N', PushConstantType.UINT32, 8, 896),
            ),
        ),
        dispatch=(ceil_div(143, 16), ceil_div(896, 16), 1),
    ),
    source="""\
#version 450
