"""Generated shader: export_mul_broadcast_last_run_decode_layer."""
...
EXPORT_MUL_BROADCAST_LAST_RUN_DECODE_LAYER = ShaderVariant(
    name='export_mul_broadcast_last_run_decode_layer',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastLastProgram',
        shader_name='export_mul_broadcast_last_run_decode_layer',
        fields=(
            TensorFieldSpec(
                name='x',
            ...
            TensorFieldSpec(
                ...
                io_kind=IOKind.INPUT,
                role='input',
                contract=TensorContract(dtype='float32', shape=(1, 1, 1,)),
            ),
            TensorFieldSpec(
                name='output',
