"""Generated shader: export_sub_f32."""
...
EXPORT_SUB_F32 = ShaderVariant(
    name='export_sub_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportSubF32Program',
        shader_name='export_sub_f32',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            size=4,
            fields=(
                PushConstantFieldSpec('N', PushConstantType.UINT32, 0, 'B'),
            ),
        ),
