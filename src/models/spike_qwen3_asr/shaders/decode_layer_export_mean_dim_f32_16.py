"""Generated shader: decode_layer_export_mean_dim_f32_16."""
...
DECODE_LAYER_EXPORT_MEAN_DIM_F32_16 = ShaderVariant(
    name='decode_layer_export_mean_dim_f32_16',
    family='export',
    contract=ShaderContract(
        class_name='ExportMeanDimProgram',
        shader_name='decode_layer_export_mean_dim_f32_16',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            size=8,
            fields=(
                PushConstantFieldSpec('ROWS', PushConstantType.UINT32, 0, 8, dynamic=False),
