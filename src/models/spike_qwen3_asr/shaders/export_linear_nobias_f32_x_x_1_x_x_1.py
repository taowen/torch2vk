"""Generated shader: export_linear_nobias_f32_x_x_1_x_x_1."""
...
EXPORT_LINEAR_NOBIAS_F32_X_X_1_X_X_1 = ShaderVariant(
    name='export_linear_nobias_f32_x_x_1_x_x_1',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasProgram',
        shader_name='export_linear_nobias_f32_x_x_1_x_x_1',
        fields=(
            TensorFieldSpec(
                name='x',
