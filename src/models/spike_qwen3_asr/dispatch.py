...
from models.spike_qwen3_asr.shaders.decode_layer_export_sdpa_f32 import DECODE_LAYER_EXPORT_SDPA_F32
...
def run_encoder_layer(rt, tensors):
    ...
    EXPORT_SDPA_F32(rt, q=tensors['unsqueeze'], k=tensors['unsqueeze_1'], v=tensors['unsqueeze_2'], output=tensors['scaled_dot_product_attention'])
...
def run_decode_layer(rt, tensors):
    ...
    DECODE_LAYER_EXPORT_SDPA_F32(rt, q=tensors['add_3'], k=tensors['add_4'], v=tensors['transpose_2'], output=tensors['scaled_dot_product_attention'])
...
def run_decode_norm(rt, tensors):
    _alias(rt, tensors['hidden_states'], tensors['to'])
    EXPORT_POW_SCALAR_F32(rt, x=tensors['to'], output=tensors['pow_1'])
...
def run_decode_lm_head(rt, tensors):
