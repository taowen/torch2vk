"""Generated shader: conv_transpose1d_q8_0w_f32b_f32_47."""
...
CONV_TRANSPOSE1D_Q8_0W_F32B_F32_47 = ShaderVariant(
    name='conv_transpose1d_q8_0w_f32b_f32_47',
    family='export',
    contract=ShaderContract(
        class_name='ExportConvTranspose1dQ8_0WeightF32BiasProgram',
        shader_name='conv_transpose1d_q8_0w_f32b_f32_47',
        fields=(
            TensorFieldSpec(
                name='x',
            ...
            TensorFieldSpec(
                ...
                io_kind=IOKind.INPUT,
                role='weight',
                contract=TensorContract(dtype='uint16', shape=('Ci', 102,), layout=q8_0_halfwords_layout(logical_k=192, block_size=32, halfwords_per_block=17)),
            ),
            TensorFieldSpec(
                name='bias',
                io_kind=IOKind.INPUT,
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('Kh', PushConstantType.UINT32, 20, 6, dynamic=False),
                PushConstantFieldSpec('stride', PushConstantType.UINT32, 24, 3, dynamic=False),
        ...
        params_buffer=None,
        dispatch=(ceil_div(ceil_div('Lo', 3), 32), ceil_div('Co', 16), mul('B', 3)),
    ),
