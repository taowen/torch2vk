"""Generated shader: transpose_f32_b4bb3205fc."""
...
TRANSPOSE_F32_B4BB3205FC = ShaderVariant(
    name='transpose_f32_b4bb3205fc',
    family='export',
    contract=ShaderContract(
        class_name='ExportTransposeProgram',
        shader_name='transpose_f32_b4bb3205fc',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            size=4,
            fields=(
                PushConstantFieldSpec('N', PushConstantType.UINT32, 0, 174080, dynamic=False),
            ),
        ),
        params_buffer=None,
        dispatch=(ceil_div(174080, 256), 1, 1),
    ),
