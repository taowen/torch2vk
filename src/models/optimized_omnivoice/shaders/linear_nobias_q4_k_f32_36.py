"""Generated shader: linear_nobias_q4_k_f32_36."""
...
LINEAR_NOBIAS_Q4_K_F32_36 = ShaderVariant(
    name='linear_nobias_q4_k_f32_36',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasQ4KProgram',
        shader_name='linear_nobias_q4_k_f32_36',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        params_buffer=None,
        dispatch=(ceil_div(170, 16), ceil_div(1024, 16), 1),
    ),
