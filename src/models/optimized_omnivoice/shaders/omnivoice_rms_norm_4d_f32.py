"""Generated shader: omnivoice_rms_norm_4d_f32."""
    ...
    contract=ShaderContract(
        ...
        fields=(
            TensorFieldSpec(
                ...
                role='input',
                contract=TensorContract(dtype='float16', shape=('D0', 'D1', 'D2', 'H',)),
            ),
            TensorFieldSpec(
                name='weight',
                io_kind=IOKind.INPUT,
        ...
        push_constants=PushConstantSpec(
            size=8,
            fields=(
                PushConstantFieldSpec('rows', PushConstantType.UINT32, 0, mul(mul('D0', 'D1'), 'D2'), dynamic=False),
