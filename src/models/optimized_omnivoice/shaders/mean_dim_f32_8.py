"""Generated shader: mean_dim_f32_8."""
...
MEAN_DIM_F32_8 = ShaderVariant(
    name='mean_dim_f32_8',
    family='export',
    contract=ShaderContract(
        class_name='ExportMeanDimProgram',
        shader_name='mean_dim_f32_8',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            size=8,
            fields=(
                PushConstantFieldSpec('ROWS', PushConstantType.UINT32, 0, 2720, dynamic=False),
