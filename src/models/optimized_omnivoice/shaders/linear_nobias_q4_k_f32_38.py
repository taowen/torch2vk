"""Generated shader: linear_nobias_q4_k_f32_38."""
...
LINEAR_NOBIAS_Q4_K_F32_38 = ShaderVariant(
    name='linear_nobias_q4_k_f32_38',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasQ4KProgram',
        shader_name='linear_nobias_q4_k_f32_38',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        params_buffer=None,
        dispatch=(ceil_div(170, 32), ceil_div(3072, 16), 1),
    ),
