"""Generated shader: mul_left_broadcast_f32x_f32."""
...
MUL_LEFT_BROADCAST_F32X_F32 = ShaderVariant(
    name='mul_left_broadcast_f32x_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulLeftBroadcastF32XProgram',
        shader_name='mul_left_broadcast_f32x_f32',
        fields=(
            TensorFieldSpec(
                name='x',
