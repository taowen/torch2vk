"""Export optimized OmniVoice submodules to generated Vulkan code.
...
Run from project root:
    uv run python -m models.optimized_omnivoice.export
"""
...
MODEL_PACKAGE = "models.optimized_omnivoice"
...
def main() -> int:
    ...
    for source in tensors_dir.glob("*.py"):
        source.unlink()
    for source in dispatch_dir.glob("*.py"):
        if source.name != "llm_forward.py":
            source.unlink()
