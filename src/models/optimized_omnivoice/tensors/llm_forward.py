    ...
    tensors = LlmLayerTensors(
        ...
        pow_1=_bind_tensor(
            ...
            _declare_tensor(
                checkpoint_key=None,
                reference_key='pow_1',
                spec=TensorSpec(dtype='float32', shape=(2, 256, 1024)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        mean=_bind_tensor(
            ...
            _declare_tensor(
                checkpoint_key=None,
                reference_key='mean',
                spec=TensorSpec(dtype='float32', shape=(2, 256, 1)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        linear=_bind_tensor(
            ...
            _declare_tensor(
                ...
                spec=TensorSpec(dtype='float16', shape=(2, 256, 2048)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        view=_bind_tensor(
            ...
            _declare_tensor(
                checkpoint_key=None,
                reference_key='view',
                spec=TensorSpec(dtype='float16', shape=(2, 256, 16, 128)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        pow_2=_bind_tensor(
            ...
            _declare_tensor(
                checkpoint_key=None,
                reference_key='pow_2',
                spec=TensorSpec(dtype='float32', shape=(2, 256, 16, 128)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        mean_1=_bind_tensor(
            ...
            _declare_tensor(
                ...
                spec=TensorSpec(dtype='float32', shape=(2, 256, 16, 1)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        transpose=_bind_tensor(
            ...
            _declare_tensor(
                ...
                spec=TensorSpec(dtype='float16', shape=(2, 16, 256, 128)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        view_1=_bind_tensor(
            ...
            _declare_tensor(
                ...
                spec=TensorSpec(dtype='float16', shape=(2, 256, 8, 128)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        pow_3=_bind_tensor(
            ...
            _declare_tensor(
                checkpoint_key=None,
                reference_key='pow_3',
                spec=TensorSpec(dtype='float32', shape=(2, 256, 8, 128)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        mean_2=_bind_tensor(
            ...
            _declare_tensor(
                ...
                spec=TensorSpec(dtype='float32', shape=(2, 256, 8, 1)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        transpose_1=_bind_tensor(
            ...
            _declare_tensor(
                ...
                spec=TensorSpec(dtype='float16', shape=(2, 8, 256, 128)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        unsqueeze=_bind_tensor(
            ...
            _declare_tensor(
                ...
                spec=TensorSpec(dtype='float16', shape=(2, 1, 256, 128)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        slice_1=_bind_tensor(
            ...
            _declare_tensor(
                ...
                spec=TensorSpec(dtype='float16', shape=(2, 16, 256, 64)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        slice_3=_bind_tensor(
            ...
            _declare_tensor(
                ...
                spec=TensorSpec(dtype='float16', shape=(2, 8, 256, 64)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        linear_4=_bind_tensor(
            ...
            _declare_tensor(
                ...
                spec=TensorSpec(dtype='float16', shape=(2, 256, 3072)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
    ...
    tensors = LlmForwardTensors(
        ...
        cos=_bind_tensor(
            ...
            _declare_tensor(
                checkpoint_key=None,
                reference_key=None,
                spec=TensorSpec(dtype='float16', shape=(2, 256, 128)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.INPUT,
                memory=MemoryClass.HOST_INPUT,
                lifetime=TensorLifetime.FRAME,
        ...
        attention_mask=_bind_tensor(
            ...
            _declare_tensor(
                checkpoint_key=None,
                reference_key=None,
                spec=TensorSpec(dtype='float16', shape=(2, 1, 256, 256)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.INPUT,
                memory=MemoryClass.HOST_INPUT,
                lifetime=TensorLifetime.FRAME,
