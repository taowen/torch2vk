"""Generated shader: transpose_f32_e6f353739d."""
...
TRANSPOSE_F32_E6F353739D = ShaderVariant(
    name='transpose_f32_e6f353739d',
    family='export',
    contract=ShaderContract(
        class_name='ExportTransposeProgram',
        shader_name='transpose_f32_e6f353739d',
        fields=(
            TensorFieldSpec(
                name='x',
