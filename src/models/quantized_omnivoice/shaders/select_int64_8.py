"""Generated shader: select_int64_8."""
...
SELECT_INT64_8 = ShaderVariant(
    name='select_int64_8',
    family='export',
    contract=ShaderContract(
        class_name='ExportSelectProgram',
        shader_name='select_int64_8',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('selected', PushConstantType.UINT32, 12, 5, dynamic=False),
            ),
        ),
        params_buffer=None,
