"""Generated shader: conv1d_q8_0w_f32b_f32_31."""
...
CONV1D_Q8_0W_F32B_F32_31 = ShaderVariant(
    name='conv1d_q8_0w_f32b_f32_31',
    family='export',
    contract=ShaderContract(
        class_name='ExportConv1dQ8_0WeightF32BiasProgram',
        shader_name='conv1d_q8_0w_f32b_f32_31',
        fields=(
            TensorFieldSpec(
                name='x',
            ...
            TensorFieldSpec(
                ...
                io_kind=IOKind.INPUT,
                role='weight',
                contract=TensorContract(dtype='uint16', shape=('Co', 952,), layout=q8_0_halfwords_layout(logical_k=1792, block_size=32, halfwords_per_block=17)),
            ),
            TensorFieldSpec(
                name='bias',
                io_kind=IOKind.INPUT,
