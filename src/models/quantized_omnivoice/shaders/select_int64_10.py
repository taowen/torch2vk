"""Generated shader: select_int64_10."""
...
SELECT_INT64_10 = ShaderVariant(
    name='select_int64_10',
    family='export',
    contract=ShaderContract(
        class_name='ExportSelectProgram',
        shader_name='select_int64_10',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('selected', PushConstantType.UINT32, 12, 7, dynamic=False),
            ),
        ),
        params_buffer=None,
