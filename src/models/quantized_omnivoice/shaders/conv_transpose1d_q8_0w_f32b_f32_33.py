"""Generated shader: conv_transpose1d_q8_0w_f32b_f32_33."""
...
CONV_TRANSPOSE1D_Q8_0W_F32B_F32_33 = ShaderVariant(
    name='conv_transpose1d_q8_0w_f32b_f32_33',
    family='export',
    contract=ShaderContract(
        class_name='ExportConvTranspose1dQ8_0WeightF32BiasProgram',
        shader_name='conv_transpose1d_q8_0w_f32b_f32_33',
        fields=(
            TensorFieldSpec(
                name='x',
            ...
            TensorFieldSpec(
                ...
                io_kind=IOKind.INPUT,
                role='weight',
                contract=TensorContract(dtype='uint16', shape=('Ci', 544,), layout=q8_0_halfwords_layout(logical_k=1024, block_size=32, halfwords_per_block=17)),
            ),
            TensorFieldSpec(
                name='bias',
                io_kind=IOKind.INPUT,
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('Kh', PushConstantType.UINT32, 20, 8, dynamic=False),
                PushConstantFieldSpec('stride', PushConstantType.UINT32, 24, 4, dynamic=False),
                PushConstantFieldSpec('padding', PushConstantType.UINT32, 28, 2, dynamic=False),
                PushConstantFieldSpec('dilation', PushConstantType.UINT32, 32, 1, dynamic=False),
            ),
        ),
        params_buffer=None,
        dispatch=(ceil_div(ceil_div('Lo', 4), 32), ceil_div('Co', 16), mul('B', 4)),
    ),
