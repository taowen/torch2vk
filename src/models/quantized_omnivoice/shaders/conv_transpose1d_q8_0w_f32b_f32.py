    ...
    contract=ShaderContract(
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('stride', PushConstantType.UINT32, 24, 8, dynamic=False),
                PushConstantFieldSpec('padding', PushConstantType.UINT32, 28, 4, dynamic=False),
                PushConstantFieldSpec('dilation', PushConstantType.UINT32, 32, 1, dynamic=False),
            ),
        ),
        params_buffer=None,
        dispatch=(ceil_div(ceil_div('Lo', 8), 32), ceil_div('Co', 16), mul('B', 8)),
    ),
