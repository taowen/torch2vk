"""Generated shader: conv1d_q8_0w_f32b_f32_25."""
...
CONV1D_Q8_0W_F32B_F32_25 = ShaderVariant(
    name='conv1d_q8_0w_f32b_f32_25',
    family='export',
    contract=ShaderContract(
        class_name='ExportConv1dQ8_0WeightF32BiasProgram',
        shader_name='conv1d_q8_0w_f32b_f32_25',
        fields=(
            TensorFieldSpec(
                name='x',
            ...
            TensorFieldSpec(
                ...
                io_kind=IOKind.INPUT,
                role='weight',
                contract=TensorContract(dtype='uint16', shape=('Co', 1904,), layout=q8_0_halfwords_layout(logical_k=3584, block_size=32, halfwords_per_block=17)),
            ),
            TensorFieldSpec(
                name='bias',
                io_kind=IOKind.INPUT,
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('Kh', PushConstantType.UINT32, 20, 7, dynamic=False),
                PushConstantFieldSpec('stride', PushConstantType.UINT32, 24, 1, dynamic=False),
                PushConstantFieldSpec('padding', PushConstantType.UINT32, 28, 27, dynamic=False),
                PushConstantFieldSpec('dilation', PushConstantType.UINT32, 32, 9, dynamic=False),
            ),
        ),
        params_buffer=None,
