"""Generated shader: select_int64_9."""
...
SELECT_INT64_9 = ShaderVariant(
    name='select_int64_9',
    family='export',
    contract=ShaderContract(
        class_name='ExportSelectProgram',
        shader_name='select_int64_9',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('selected', PushConstantType.UINT32, 12, 6, dynamic=False),
            ),
        ),
        params_buffer=None,
