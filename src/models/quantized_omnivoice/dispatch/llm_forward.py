...
from models.quantized_omnivoice.shaders.add_f32_38 import ADD_F32_38
...
from models.quantized_omnivoice.shaders.mul_broadcast_11 import MUL_BROADCAST_11
from models.quantized_omnivoice.shaders.mul_broadcast_18 import MUL_BROADCAST_18
from models.quantized_omnivoice.shaders.mul_broadcast_23 import MUL_BROADCAST_23
from models.quantized_omnivoice.shaders.mul_broadcast_28 import MUL_BROADCAST_28
from models.quantized_omnivoice.shaders.mul_broadcast_30 import MUL_BROADCAST_30
from models.quantized_omnivoice.shaders.mul_broadcast_32 import MUL_BROADCAST_32
...
def _run_llm_forward_with_tensors(rt: RuntimeSession, tensors: LlmForwardTensors) -> None:
    for layer_t in tensors.layers:
        ...
        MUL_BROADCAST_23(rt, x=layer_t.transpose, y=layer_t.unsqueeze, output=layer_t.mul_6)
        ...
        MUL_BROADCAST_28(rt, x=layer_t.cat, y=layer_t.unsqueeze_1, output=layer_t.mul_7)
        ADD_F32(rt, x=layer_t.mul_6, y=layer_t.mul_7, output=layer_t.add_3)
        MUL_BROADCAST_30(rt, x=layer_t.transpose_1, y=layer_t.unsqueeze, output=layer_t.mul_8)
        ...
        MUL_BROADCAST_32(rt, x=layer_t.cat_1, y=layer_t.unsqueeze_1, output=layer_t.mul_9)
        ...
        ADD_F32_35(rt, x=layer_t.to, y=layer_t.linear_3, output=layer_t.add_5)
        ...
        ADD_F32_38(rt, x=layer_t.to_6, y=layer_t.linear_6, output=layer_t.add_7)
