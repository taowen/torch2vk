...
def _run_decode_lm_head_with_tensors(rt: RuntimeSession, tensors: DecodeLmHeadTensors) -> None:
    run_quantized_linear(rt, q4=LINEAR_NOBIAS_Q4_K_MATVEC_F32, q6=LINEAR_NOBIAS_Q6_K_MATVEC_F32, q8=LINEAR_NOBIAS_Q8_0_MATVEC_F32, x=tensors.input, weight=tensors.p_weight, output=tensors.linear)
