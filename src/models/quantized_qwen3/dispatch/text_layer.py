...
from models.quantized_qwen3.shaders.add_f32_34 import ADD_F32_34
from models.quantized_qwen3.shaders.add_f32_37 import ADD_F32_37
from models.quantized_qwen3.shaders.add_scalar import ADD_SCALAR
from models.quantized_qwen3.shaders.add_scalar_10 import ADD_SCALAR_10
from models.quantized_qwen3.shaders.add_scalar_17 import ADD_SCALAR_17
from models.quantized_qwen3.shaders.cat_f32 import CAT_F32
from models.quantized_qwen3.shaders.kv_cache_write_f32 import KV_CACHE_WRITE_F32
from models.quantized_qwen3.shaders.linear_nobias_q4_k_f32 import LINEAR_NOBIAS_Q4_K_F32
from models.quantized_qwen3.shaders.linear_nobias_q6_k_f32 import LINEAR_NOBIAS_Q6_K_F32
from models.quantized_qwen3.shaders.mean_dim_f32 import MEAN_DIM_F32
from models.quantized_qwen3.shaders.mean_dim_f32_16 import MEAN_DIM_F32_16
from models.quantized_qwen3.shaders.mean_dim_f32_9 import MEAN_DIM_F32_9
from models.quantized_qwen3.shaders.mul_broadcast_inner import MUL_BROADCAST_INNER
from models.quantized_qwen3.shaders.mul_broadcast_inner_28 import MUL_BROADCAST_INNER_28
from models.quantized_qwen3.shaders.mul_broadcast_inner_30 import MUL_BROADCAST_INNER_30
from models.quantized_qwen3.shaders.mul_broadcast_last import MUL_BROADCAST_LAST
from models.quantized_qwen3.shaders.mul_broadcast_last_12 import MUL_BROADCAST_LAST_12
from models.quantized_qwen3.shaders.mul_broadcast_last_19 import MUL_BROADCAST_LAST_19
...
from models.quantized_qwen3.shaders.mul_left_broadcast_f32x_f32_13 import MUL_LEFT_BROADCAST_F32X_F32_13
from models.quantized_qwen3.shaders.mul_left_broadcast_f32x_f32_20 import MUL_LEFT_BROADCAST_F32X_F32_20
...
from models.quantized_qwen3.shaders.pow_scalar_f32_15 import POW_SCALAR_F32_15
from models.quantized_qwen3.shaders.pow_scalar_f32_8 import POW_SCALAR_F32_8
from models.quantized_qwen3.shaders.rsqrt_f32 import RSQRT_F32
from models.quantized_qwen3.shaders.rsqrt_f32_11 import RSQRT_F32_11
from models.quantized_qwen3.shaders.rsqrt_f32_18 import RSQRT_F32_18
from models.quantized_qwen3.shaders.sdpa_causal_f32 import SDPA_CAUSAL_F32
...
from models.quantized_qwen3.shaders.slice_f32_24 import SLICE_F32_24
from models.quantized_qwen3.shaders.slice_f32_29 import SLICE_F32_29
from models.quantized_qwen3.shaders.transpose_f32_18ea7e18c0 import TRANSPOSE_F32_18EA7E18C0
from models.quantized_qwen3.shaders.transpose_f32_db1599f0ff import TRANSPOSE_F32_DB1599F0FF
from models.quantized_qwen3.shaders.transpose_f32_ec88ebb72b import TRANSPOSE_F32_EC88EBB72B
...
def _run_text_layer_with_tensors(rt: RuntimeSession, tensors: TextLayerTensors) -> None:
    ...
    _linear_q4_or_q6(rt, q4=LINEAR_NOBIAS_Q4_K_F32, q6=LINEAR_NOBIAS_Q6_K_F32, x=tensors.mul_1, weight=tensors.p_attn_q_proj_weight, output=tensors.linear)
    POW_SCALAR_F32_8(rt, x=tensors.to_2, output=tensors.pow_2)
    MEAN_DIM_F32_9(rt, x=tensors.pow_2, output=tensors.mean_1)
    ADD_SCALAR_10(rt, x=tensors.mean_1, output=tensors.add_1)
    RSQRT_F32_11(rt, x=tensors.add_1, output=tensors.rsqrt_1)
    MUL_BROADCAST_LAST_12(rt, x=tensors.to_2, y=tensors.rsqrt_1, output=tensors.mul_2)
    MUL_LEFT_BROADCAST_F32X_F32_13(rt, x=tensors.p_attn_q_norm_weight, y=tensors.to_3, output=tensors.mul_3)
    TRANSPOSE_F32_18EA7E18C0(rt, x=tensors.mul_3, output=tensors.transpose)
    _linear_q4_or_q6(rt, q4=LINEAR_NOBIAS_Q4_K_F32, q6=LINEAR_NOBIAS_Q6_K_F32, x=tensors.mul_1, weight=tensors.p_attn_k_proj_weight, output=tensors.linear_1)
    ...
    TRANSPOSE_F32_EC88EBB72B(rt, x=tensors.mul_5, output=tensors.transpose_1)
    _linear_q4_or_q6(rt, q4=LINEAR_NOBIAS_Q4_K_F32, q6=LINEAR_NOBIAS_Q6_K_F32, x=tensors.mul_1, weight=tensors.p_attn_v_proj_weight, output=tensors.linear_2)
    ...
    SLICE_F32_24(rt, x=tensors.transpose, output=tensors.slice_2)
    ...
    MUL_BROADCAST_INNER_28(rt, x=tensors.transpose_1, y=tensors.unsqueeze, output=tensors.mul_8)
    ...
    MUL_BROADCAST_INNER_30(rt, x=tensors.cat_1, y=tensors.unsqueeze_1, output=tensors.mul_9)
    ...
    _linear_q4_or_q6(rt, q4=LINEAR_NOBIAS_Q4_K_F32, q6=LINEAR_NOBIAS_Q6_K_F32, x=tensors.reshape, weight=tensors.p_attn_o_proj_weight, output=tensors.linear_3)
    ADD_F32_34(rt, x=tensors.to, y=tensors.linear_3, output=tensors.add_5)
    ...
    _linear_q4_or_q6(rt, q4=LINEAR_NOBIAS_Q4_K_F32, q6=LINEAR_NOBIAS_Q6_K_F32, x=tensors.mul_11, weight=tensors.p_mlp_gate_proj_weight, output=tensors.linear_4)
    SILU_F32(rt, x=tensors.linear_4, output=tensors.silu)
    _linear_q4_or_q6(rt, q4=LINEAR_NOBIAS_Q4_K_F32, q6=LINEAR_NOBIAS_Q6_K_F32, x=tensors.mul_11, weight=tensors.p_mlp_up_proj_weight, output=tensors.linear_5)
    MUL_F32(rt, x=tensors.silu, y=tensors.linear_5, output=tensors.mul_12)
    _linear_q4_or_q6(rt, q4=LINEAR_NOBIAS_Q4_K_F32, q6=LINEAR_NOBIAS_Q6_K_F32, x=tensors.mul_12, weight=tensors.p_mlp_down_proj_weight, output=tensors.linear_6)
    ADD_F32_37(rt, x=tensors.to_6, y=tensors.linear_6, output=tensors.add_7)
