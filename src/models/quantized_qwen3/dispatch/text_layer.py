...
from models.quantized_qwen3.shaders.add_f32_39 import ADD_F32_39
from models.quantized_qwen3.shaders.add_scalar import ADD_SCALAR
from models.quantized_qwen3.shaders.add_scalar_16 import ADD_SCALAR_16
from models.quantized_qwen3.shaders.add_scalar_9 import ADD_SCALAR_9
...
from models.quantized_qwen3.shaders.linear_nobias_q8_0_f32 import LINEAR_NOBIAS_Q8_0_F32
from models.quantized_qwen3.shaders.mean_dim_f32 import MEAN_DIM_F32
from models.quantized_qwen3.shaders.mean_dim_f32_15 import MEAN_DIM_F32_15
from models.quantized_qwen3.shaders.mean_dim_f32_8 import MEAN_DIM_F32_8
from models.quantized_qwen3.shaders.mul_broadcast import MUL_BROADCAST
from models.quantized_qwen3.shaders.mul_broadcast_11 import MUL_BROADCAST_11
from models.quantized_qwen3.shaders.mul_broadcast_18 import MUL_BROADCAST_18
from models.quantized_qwen3.shaders.mul_broadcast_23 import MUL_BROADCAST_23
from models.quantized_qwen3.shaders.mul_broadcast_28 import MUL_BROADCAST_28
from models.quantized_qwen3.shaders.mul_broadcast_30 import MUL_BROADCAST_30
from models.quantized_qwen3.shaders.mul_broadcast_32 import MUL_BROADCAST_32
...
from models.quantized_qwen3.shaders.mul_left_broadcast_f32x_f32_12 import MUL_LEFT_BROADCAST_F32X_F32_12
from models.quantized_qwen3.shaders.mul_left_broadcast_f32x_f32_19 import MUL_LEFT_BROADCAST_F32X_F32_19
...
from models.quantized_qwen3.shaders.pow_scalar_f32_14 import POW_SCALAR_F32_14
from models.quantized_qwen3.shaders.pow_scalar_f32_7 import POW_SCALAR_F32_7
from models.quantized_qwen3.shaders.rsqrt_f32 import RSQRT_F32
from models.quantized_qwen3.shaders.rsqrt_f32_10 import RSQRT_F32_10
from models.quantized_qwen3.shaders.rsqrt_f32_17 import RSQRT_F32_17
...
from models.quantized_qwen3.shaders.slice_f32_31 import SLICE_F32_31
...
def _run_text_layer_with_tensors(rt: RuntimeSession, tensors: TextLayerTensors) -> None:
    ...
    MUL_BROADCAST_23(rt, x=tensors.transpose, y=tensors.unsqueeze, output=tensors.mul_6)
    ...
    MUL_BROADCAST_28(rt, x=tensors.cat, y=tensors.unsqueeze_1, output=tensors.mul_7)
    ADD_F32(rt, x=tensors.mul_6, y=tensors.mul_7, output=tensors.add_3)
    MUL_BROADCAST_30(rt, x=tensors.transpose_1, y=tensors.unsqueeze, output=tensors.mul_8)
    ...
    MUL_BROADCAST_32(rt, x=tensors.cat_1, y=tensors.unsqueeze_1, output=tensors.mul_9)
