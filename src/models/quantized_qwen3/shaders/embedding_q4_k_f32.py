"""Generated shader: embedding_q4_k_f32."""
...
EMBEDDING_Q4_K_F32 = ShaderVariant(
    ...
    contract=ShaderContract(
        ...
        fields=(
            TensorFieldSpec(
                ...
                role='weight',
                contract=TensorContract(dtype='uint32', shape=('V', 144,), layout=q4_k_words_layout(logical_k='H', block_size=256, words_per_block=36)),
            ),
            TensorFieldSpec(
                name='indices',
                io_kind=IOKind.INPUT,
...
void main() {
    ...
    output_values[idx] = float16_t(q4_k_value(uint(token_id), dim_idx));
}
""",
)
