"""Fused RMSNorm, RoPE, and transpose from float32 to float16."""
...
RMS_NORM_ROPE_TRANSPOSE_F32_TO_F16 = ShaderVariant(
    name="rms_norm_rope_transpose_f32_to_f16",
    family="quantized_qwen3",
    contract=ShaderContract(
        class_name="QuantizedQwen3RmsNormRopeTransposeF32ToF16Program",
        shader_name="rms_norm_rope_transpose_f32_to_f16",
        fields=(
            ...
            TensorFieldSpec("output", IOKind.OUTPUT, "output", TensorContract(dtype="float16", shape=("B", "G", "T", "D"))),
        ),
...
void main() {
    ...
    output_values[((b * pc.G + g) * pc.T + t) * pc.D + d] = float16_t(
