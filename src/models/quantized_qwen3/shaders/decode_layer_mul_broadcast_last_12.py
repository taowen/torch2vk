"""Generated shader: decode_layer_mul_broadcast_last_12."""
...
DECODE_LAYER_MUL_BROADCAST_LAST_12 = ShaderVariant(
    name='decode_layer_mul_broadcast_last_12',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastLastProgram',
        shader_name='decode_layer_mul_broadcast_last_12',
        fields=(
            TensorFieldSpec(
                name='x',
