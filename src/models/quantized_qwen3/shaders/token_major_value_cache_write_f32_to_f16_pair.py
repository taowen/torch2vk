"""Write token-major float32 values into two token-major float16 caches."""
...
TOKEN_MAJOR_VALUE_CACHE_WRITE_F32_TO_F16_PAIR = ShaderVariant(
    name="token_major_value_cache_write_f32_to_f16_pair",
    family="quantized_qwen3",
    contract=ShaderContract(
        class_name="QuantizedQwen3TokenMajorValueCacheWriteF32ToF16PairProgram",
        shader_name="token_major_value_cache_write_f32_to_f16_pair",
        fields=(
            TensorFieldSpec(
                "cache_a",
                IOKind.INOUT,
...
layout(set = 0, binding = 3) buffer restrict readonly SrcBuffer { float src[]; };
