...
#line 1 "/var/home/taowen/projects/agentorch/third_party/llama.cpp/ggml/src/ggml-vulkan/vulkan-shaders/mul_mm.comp"
...
#line 32 "/var/home/taowen/projects/agentorch/third_party/llama.cpp/ggml/src/ggml-vulkan/vulkan-shaders/mul_mm.comp"
...
layout(binding = 0) readonly buffer A_PACKED16 { block_q4_K_packed16 data_a_packed16[]; };


layout(binding = 0) readonly buffer A_PACKED32 { block_q4_K_packed32 data_a_packed32[]; };
...
shared f16vec2 buf_a[BM * (BK / 2 + 4)];
shared f16vec2 buf_b[BN * (BK / 2 + 4)];
...
#line 1 "/var/home/taowen/projects/agentorch/third_party/llama.cpp/ggml/src/ggml-vulkan/vulkan-shaders/mul_mm_id_funcs.glsl"
...
#line 138 "/var/home/taowen/projects/agentorch/third_party/llama.cpp/ggml/src/ggml-vulkan/vulkan-shaders/mul_mm.comp"
#line 1 "/var/home/taowen/projects/agentorch/third_party/llama.cpp/ggml/src/ggml-vulkan/vulkan-shaders/mul_mm_funcs.glsl"
 void load_a_to_shmem(const uint pos_a, const uint row, const uint col, const uint idx_m, const uint block, const uint end_k) {
            ...
            buf_a[buf_idx] = f16vec2(fma(d, q.x, m), fma(d, q.y, m));
            buf_a[buf_idx + 1] = f16vec2(fma(d, q.z, m), fma(d, q.w, m));
...
void load_b_to_shmem(const uint pos_b, const uint row, const uint col, const uint idx_n, const uint block, const uint end_k) {
            ...
            const uint buf_idx = col * (BK / 2 + 4) + row * 8 / 2;
...
#line 139 "/var/home/taowen/projects/agentorch/third_party/llama.cpp/ggml/src/ggml-vulkan/vulkan-shaders/mul_mm.comp"
...
void main() {
    ...
    const uint loadr_b = gl_LocalInvocationID.x % (BK / 8 / 1);
    const uint loadc_b = gl_LocalInvocationID.x / (BK / 8 / 1);

    const uint loadstride_a = gl_WorkGroupSize.x * 4 * 1 / BK;
    const uint loadstride_b = gl_WorkGroupSize.x * 8 * 1 / BK;
