"""Generated shader: decode_layer_mul_broadcast_inner."""
...
DECODE_LAYER_MUL_BROADCAST_INNER = ShaderVariant(
    name='decode_layer_mul_broadcast_inner',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastInnerProgram',
        shader_name='decode_layer_mul_broadcast_inner',
        fields=(
            TensorFieldSpec(
                name='x',
