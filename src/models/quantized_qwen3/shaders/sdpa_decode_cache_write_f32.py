...
SDPA_DECODE_CACHE_WRITE_F32 = ShaderVariant(
    ...
    contract=ShaderContract(
        ...
        fields=(
            TensorFieldSpec("q", IOKind.INPUT, "input", TensorContract(dtype="float16", shape=("B", "NH", "T", "D"))),
            TensorFieldSpec(
                "new_k",
                IOKind.INPUT,
                "input",
            ...
            TensorFieldSpec("output", IOKind.OUTPUT, "output", TensorContract(dtype="float16", shape=("B", "NH", "T", "D"))),
        ),
