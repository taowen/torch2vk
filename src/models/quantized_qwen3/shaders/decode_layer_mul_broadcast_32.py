"""Generated shader: decode_layer_mul_broadcast_32."""
...
DECODE_LAYER_MUL_BROADCAST_32 = ShaderVariant(
    name='decode_layer_mul_broadcast_32',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='decode_layer_mul_broadcast_32',
        fields=(
            TensorFieldSpec(
                name='x',
