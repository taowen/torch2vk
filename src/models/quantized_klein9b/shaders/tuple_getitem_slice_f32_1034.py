"""Generated shader: tuple_getitem_slice_f32_1034."""
...
TUPLE_GETITEM_SLICE_F32_1034 = ShaderVariant(
    name='tuple_getitem_slice_f32_1034',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1034',
        fields=(
            TensorFieldSpec(
                name='x',
