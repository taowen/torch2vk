"""Generated shader: tuple_getitem_unbind_f32_1005."""
...
TUPLE_GETITEM_UNBIND_F32_1005 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1005',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1005',
        fields=(
            TensorFieldSpec(
                name='x',
