"""Generated shader: tuple_getitem_unbind_f32_708."""
...
TUPLE_GETITEM_UNBIND_F32_708 = ShaderVariant(
    name='tuple_getitem_unbind_f32_708',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_708',
        fields=(
            TensorFieldSpec(
                name='x',
