"""Generated shader: tuple_getitem_unbind_f32_528."""
...
TUPLE_GETITEM_UNBIND_F32_528 = ShaderVariant(
    name='tuple_getitem_unbind_f32_528',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_528',
        fields=(
            TensorFieldSpec(
                name='x',
