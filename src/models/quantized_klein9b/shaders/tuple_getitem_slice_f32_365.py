"""Generated shader: tuple_getitem_slice_f32_365."""
...
TUPLE_GETITEM_SLICE_F32_365 = ShaderVariant(
    name='tuple_getitem_slice_f32_365',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_365',
        fields=(
            TensorFieldSpec(
                name='x',
