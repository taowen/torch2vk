"""Generated shader: tuple_getitem_slice_f32_890."""
...
TUPLE_GETITEM_SLICE_F32_890 = ShaderVariant(
    name='tuple_getitem_slice_f32_890',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_890',
        fields=(
            TensorFieldSpec(
                name='x',
