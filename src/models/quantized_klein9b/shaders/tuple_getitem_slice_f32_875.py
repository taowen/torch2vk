"""Generated shader: tuple_getitem_slice_f32_875."""
...
TUPLE_GETITEM_SLICE_F32_875 = ShaderVariant(
    name='tuple_getitem_slice_f32_875',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_875',
        fields=(
            TensorFieldSpec(
                name='x',
