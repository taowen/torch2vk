"""Generated shader: tuple_getitem_slice_f32_385."""
...
TUPLE_GETITEM_SLICE_F32_385 = ShaderVariant(
    name='tuple_getitem_slice_f32_385',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_385',
        fields=(
            TensorFieldSpec(
                name='x',
