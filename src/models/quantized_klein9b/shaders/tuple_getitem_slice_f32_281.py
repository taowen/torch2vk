"""Generated shader: tuple_getitem_slice_f32_281."""
...
TUPLE_GETITEM_SLICE_F32_281 = ShaderVariant(
    name='tuple_getitem_slice_f32_281',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_281',
        fields=(
            TensorFieldSpec(
                name='x',
