"""Generated shader: tuple_getitem_slice_f32_780."""
...
TUPLE_GETITEM_SLICE_F32_780 = ShaderVariant(
    name='tuple_getitem_slice_f32_780',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_780',
        fields=(
            TensorFieldSpec(
                name='x',
