"""Generated shader: tuple_getitem_slice_f32_536."""
...
TUPLE_GETITEM_SLICE_F32_536 = ShaderVariant(
    name='tuple_getitem_slice_f32_536',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_536',
        fields=(
            TensorFieldSpec(
                name='x',
