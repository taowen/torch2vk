"""Generated shader: tuple_getitem_slice_f32_1050."""
...
TUPLE_GETITEM_SLICE_F32_1050 = ShaderVariant(
    name='tuple_getitem_slice_f32_1050',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1050',
        fields=(
            TensorFieldSpec(
                name='x',
