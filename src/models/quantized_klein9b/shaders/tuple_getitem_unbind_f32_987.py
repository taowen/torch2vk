"""Generated shader: tuple_getitem_unbind_f32_987."""
...
TUPLE_GETITEM_UNBIND_F32_987 = ShaderVariant(
    name='tuple_getitem_unbind_f32_987',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_987',
        fields=(
            TensorFieldSpec(
                name='x',
