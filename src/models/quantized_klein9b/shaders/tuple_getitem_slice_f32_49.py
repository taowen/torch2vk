"""Generated shader: tuple_getitem_slice_f32_49."""
...
TUPLE_GETITEM_SLICE_F32_49 = ShaderVariant(
    name='tuple_getitem_slice_f32_49',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_49',
        fields=(
            TensorFieldSpec(
                name='x',
