"""Generated shader: tuple_getitem_unbind_f32_1140."""
...
TUPLE_GETITEM_UNBIND_F32_1140 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1140',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1140',
        fields=(
            TensorFieldSpec(
                name='x',
