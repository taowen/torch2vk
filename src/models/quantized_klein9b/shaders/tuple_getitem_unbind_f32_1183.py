"""Generated shader: tuple_getitem_unbind_f32_1183."""
...
TUPLE_GETITEM_UNBIND_F32_1183 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1183',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1183',
        fields=(
            TensorFieldSpec(
                name='x',
