"""Generated shader: flux_double_block_mul_broadcast_28."""
...
FLUX_DOUBLE_BLOCK_MUL_BROADCAST_28 = ShaderVariant(
    name='flux_double_block_mul_broadcast_28',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='flux_double_block_mul_broadcast_28',
        fields=(
            TensorFieldSpec(
                name='x',
