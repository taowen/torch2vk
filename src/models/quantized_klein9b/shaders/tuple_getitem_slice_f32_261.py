"""Generated shader: tuple_getitem_slice_f32_261."""
...
TUPLE_GETITEM_SLICE_F32_261 = ShaderVariant(
    name='tuple_getitem_slice_f32_261',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_261',
        fields=(
            TensorFieldSpec(
                name='x',
