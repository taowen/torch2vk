"""Generated shader: tuple_getitem_unbind_f32_110."""
...
TUPLE_GETITEM_UNBIND_F32_110 = ShaderVariant(
    name='tuple_getitem_unbind_f32_110',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_110',
        fields=(
            TensorFieldSpec(
                name='x',
