"""Generated shader: tuple_getitem_slice_f32_933."""
...
TUPLE_GETITEM_SLICE_F32_933 = ShaderVariant(
    name='tuple_getitem_slice_f32_933',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_933',
        fields=(
            TensorFieldSpec(
                name='x',
