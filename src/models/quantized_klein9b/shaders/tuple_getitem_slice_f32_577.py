"""Generated shader: tuple_getitem_slice_f32_577."""
...
TUPLE_GETITEM_SLICE_F32_577 = ShaderVariant(
    name='tuple_getitem_slice_f32_577',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_577',
        fields=(
            TensorFieldSpec(
                name='x',
