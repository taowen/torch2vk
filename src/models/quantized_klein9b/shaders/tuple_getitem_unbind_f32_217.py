"""Generated shader: tuple_getitem_unbind_f32_217."""
...
TUPLE_GETITEM_UNBIND_F32_217 = ShaderVariant(
    name='tuple_getitem_unbind_f32_217',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_217',
        fields=(
            TensorFieldSpec(
                name='x',
