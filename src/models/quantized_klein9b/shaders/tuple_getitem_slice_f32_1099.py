"""Generated shader: tuple_getitem_slice_f32_1099."""
...
TUPLE_GETITEM_SLICE_F32_1099 = ShaderVariant(
    name='tuple_getitem_slice_f32_1099',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1099',
        fields=(
            TensorFieldSpec(
                name='x',
