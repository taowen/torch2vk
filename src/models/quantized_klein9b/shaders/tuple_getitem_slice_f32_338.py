"""Generated shader: tuple_getitem_slice_f32_338."""
...
TUPLE_GETITEM_SLICE_F32_338 = ShaderVariant(
    name='tuple_getitem_slice_f32_338',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_338',
        fields=(
            TensorFieldSpec(
                name='x',
