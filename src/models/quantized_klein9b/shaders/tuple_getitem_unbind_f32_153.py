"""Generated shader: tuple_getitem_unbind_f32_153."""
...
TUPLE_GETITEM_UNBIND_F32_153 = ShaderVariant(
    name='tuple_getitem_unbind_f32_153',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_153',
        fields=(
            TensorFieldSpec(
                name='x',
