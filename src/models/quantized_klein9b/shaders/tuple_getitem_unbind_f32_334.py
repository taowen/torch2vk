"""Generated shader: tuple_getitem_unbind_f32_334."""
...
TUPLE_GETITEM_UNBIND_F32_334 = ShaderVariant(
    name='tuple_getitem_unbind_f32_334',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_334',
        fields=(
            TensorFieldSpec(
                name='x',
