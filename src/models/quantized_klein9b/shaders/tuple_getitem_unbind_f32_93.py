"""Generated shader: tuple_getitem_unbind_f32_93."""
...
TUPLE_GETITEM_UNBIND_F32_93 = ShaderVariant(
    name='tuple_getitem_unbind_f32_93',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_93',
        fields=(
            TensorFieldSpec(
                name='x',
