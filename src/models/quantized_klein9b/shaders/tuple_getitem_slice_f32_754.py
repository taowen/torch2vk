"""Generated shader: tuple_getitem_slice_f32_754."""
...
TUPLE_GETITEM_SLICE_F32_754 = ShaderVariant(
    name='tuple_getitem_slice_f32_754',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_754',
        fields=(
            TensorFieldSpec(
                name='x',
