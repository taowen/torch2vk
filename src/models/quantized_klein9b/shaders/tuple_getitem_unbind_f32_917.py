"""Generated shader: tuple_getitem_unbind_f32_917."""
...
TUPLE_GETITEM_UNBIND_F32_917 = ShaderVariant(
    name='tuple_getitem_unbind_f32_917',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_917',
        fields=(
            TensorFieldSpec(
                name='x',
