"""Generated shader: tuple_getitem_unbind_f32_392."""
...
TUPLE_GETITEM_UNBIND_F32_392 = ShaderVariant(
    name='tuple_getitem_unbind_f32_392',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_392',
        fields=(
            TensorFieldSpec(
                name='x',
