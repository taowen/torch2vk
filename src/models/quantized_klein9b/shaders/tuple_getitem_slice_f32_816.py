"""Generated shader: tuple_getitem_slice_f32_816."""
...
TUPLE_GETITEM_SLICE_F32_816 = ShaderVariant(
    name='tuple_getitem_slice_f32_816',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_816',
        fields=(
            TensorFieldSpec(
                name='x',
