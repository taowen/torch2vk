"""Generated shader: tuple_getitem_slice_f32_624."""
...
TUPLE_GETITEM_SLICE_F32_624 = ShaderVariant(
    name='tuple_getitem_slice_f32_624',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_624',
        fields=(
            TensorFieldSpec(
                name='x',
