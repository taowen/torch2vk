"""Generated shader: tuple_getitem_slice_f32_1105."""
...
TUPLE_GETITEM_SLICE_F32_1105 = ShaderVariant(
    name='tuple_getitem_slice_f32_1105',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1105',
        fields=(
            TensorFieldSpec(
                name='x',
