"""Generated shader: tuple_getitem_unbind_f32_287."""
...
TUPLE_GETITEM_UNBIND_F32_287 = ShaderVariant(
    name='tuple_getitem_unbind_f32_287',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_287',
        fields=(
            TensorFieldSpec(
                name='x',
