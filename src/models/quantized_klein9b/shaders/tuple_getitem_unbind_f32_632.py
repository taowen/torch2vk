"""Generated shader: tuple_getitem_unbind_f32_632."""
...
TUPLE_GETITEM_UNBIND_F32_632 = ShaderVariant(
    name='tuple_getitem_unbind_f32_632',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_632',
        fields=(
            TensorFieldSpec(
                name='x',
