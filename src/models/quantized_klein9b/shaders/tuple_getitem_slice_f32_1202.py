"""Generated shader: tuple_getitem_slice_f32_1202."""
...
TUPLE_GETITEM_SLICE_F32_1202 = ShaderVariant(
    name='tuple_getitem_slice_f32_1202',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1202',
        fields=(
            TensorFieldSpec(
                name='x',
