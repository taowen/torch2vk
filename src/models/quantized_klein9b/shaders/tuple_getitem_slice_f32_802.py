"""Generated shader: tuple_getitem_slice_f32_802."""
...
TUPLE_GETITEM_SLICE_F32_802 = ShaderVariant(
    name='tuple_getitem_slice_f32_802',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_802',
        fields=(
            TensorFieldSpec(
                name='x',
