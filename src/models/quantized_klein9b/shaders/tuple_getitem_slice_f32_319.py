"""Generated shader: tuple_getitem_slice_f32_319."""
...
TUPLE_GETITEM_SLICE_F32_319 = ShaderVariant(
    name='tuple_getitem_slice_f32_319',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_319',
        fields=(
            TensorFieldSpec(
                name='x',
