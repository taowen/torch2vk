"""Generated shader: tuple_getitem_slice_f32_790."""
...
TUPLE_GETITEM_SLICE_F32_790 = ShaderVariant(
    name='tuple_getitem_slice_f32_790',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_790',
        fields=(
            TensorFieldSpec(
                name='x',
