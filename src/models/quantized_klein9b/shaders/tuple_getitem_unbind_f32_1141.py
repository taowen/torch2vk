"""Generated shader: tuple_getitem_unbind_f32_1141."""
...
TUPLE_GETITEM_UNBIND_F32_1141 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1141',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1141',
        fields=(
            TensorFieldSpec(
                name='x',
