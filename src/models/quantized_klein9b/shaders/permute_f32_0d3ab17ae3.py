"""Generated shader: permute_f32_0d3ab17ae3."""
...
PERMUTE_F32_0D3AB17AE3 = ShaderVariant(
    name='permute_f32_0d3ab17ae3',
    family='export',
    contract=ShaderContract(
        class_name='ExportPermuteProgram',
        shader_name='permute_f32_0d3ab17ae3',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('I0', PushConstantType.UINT32, 24, 'I0', dynamic=False),
                PushConstantFieldSpec('I1', PushConstantType.UINT32, 28, 'I1', dynamic=False),
                PushConstantFieldSpec('I2', PushConstantType.UINT32, 32, 'I2', dynamic=False),
                PushConstantFieldSpec('I3', PushConstantType.UINT32, 36, 'I3', dynamic=False),
                PushConstantFieldSpec('I4', PushConstantType.UINT32, 40, 'I4', dynamic=False),
            ),
        ),
        params_buffer=None,
...
void main() {
    ...
    in_idx = in_idx * pc.I1 + c3;
    in_idx = in_idx * pc.I2 + c0;
    in_idx = in_idx * pc.I3 + c2;
    in_idx = in_idx * pc.I4 + c4;
