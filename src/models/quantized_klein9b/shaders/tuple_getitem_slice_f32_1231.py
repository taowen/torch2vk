"""Generated shader: tuple_getitem_slice_f32_1231."""
...
TUPLE_GETITEM_SLICE_F32_1231 = ShaderVariant(
    name='tuple_getitem_slice_f32_1231',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1231',
        fields=(
            TensorFieldSpec(
                name='x',
