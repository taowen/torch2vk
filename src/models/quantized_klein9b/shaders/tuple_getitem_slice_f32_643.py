"""Generated shader: tuple_getitem_slice_f32_643."""
...
TUPLE_GETITEM_SLICE_F32_643 = ShaderVariant(
    name='tuple_getitem_slice_f32_643',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_643',
        fields=(
            TensorFieldSpec(
                name='x',
