"""Generated shader: tuple_getitem_slice_f32_139."""
...
TUPLE_GETITEM_SLICE_F32_139 = ShaderVariant(
    name='tuple_getitem_slice_f32_139',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_139',
        fields=(
            TensorFieldSpec(
                name='x',
