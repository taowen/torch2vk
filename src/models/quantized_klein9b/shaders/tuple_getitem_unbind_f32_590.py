"""Generated shader: tuple_getitem_unbind_f32_590."""
...
TUPLE_GETITEM_UNBIND_F32_590 = ShaderVariant(
    name='tuple_getitem_unbind_f32_590',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_590',
        fields=(
            TensorFieldSpec(
                name='x',
