"""Generated shader: tuple_getitem_slice_f32_1197."""
...
TUPLE_GETITEM_SLICE_F32_1197 = ShaderVariant(
    name='tuple_getitem_slice_f32_1197',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1197',
        fields=(
            TensorFieldSpec(
                name='x',
