"""Generated shader: flux_prologue_mul_broadcast."""
...
FLUX_PROLOGUE_MUL_BROADCAST = ShaderVariant(
    name='flux_prologue_mul_broadcast',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='flux_prologue_mul_broadcast',
        fields=(
            TensorFieldSpec(
                name='x',
                io_kind=IOKind.INPUT,
                role='input',
                contract=TensorContract(dtype='float32', shape=(1, 1,)),
            ),
            TensorFieldSpec(
                name='y',
                io_kind=IOKind.INPUT,
