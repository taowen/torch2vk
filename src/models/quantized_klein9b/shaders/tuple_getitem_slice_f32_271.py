"""Generated shader: tuple_getitem_slice_f32_271."""
...
TUPLE_GETITEM_SLICE_F32_271 = ShaderVariant(
    name='tuple_getitem_slice_f32_271',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_271',
        fields=(
            TensorFieldSpec(
                name='x',
