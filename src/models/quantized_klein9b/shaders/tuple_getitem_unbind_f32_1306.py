"""Generated shader: tuple_getitem_unbind_f32_1306."""
...
TUPLE_GETITEM_UNBIND_F32_1306 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1306',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1306',
        fields=(
            TensorFieldSpec(
                name='x',
