"""Generated shader: tuple_getitem_slice_f32_1154."""
...
TUPLE_GETITEM_SLICE_F32_1154 = ShaderVariant(
    name='tuple_getitem_slice_f32_1154',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1154',
        fields=(
            TensorFieldSpec(
                name='x',
