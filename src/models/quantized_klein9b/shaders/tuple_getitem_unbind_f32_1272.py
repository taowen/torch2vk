"""Generated shader: tuple_getitem_unbind_f32_1272."""
...
TUPLE_GETITEM_UNBIND_F32_1272 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1272',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1272',
        fields=(
            TensorFieldSpec(
                name='x',
