"""Generated shader: tuple_getitem_slice_f32_1065."""
...
TUPLE_GETITEM_SLICE_F32_1065 = ShaderVariant(
    name='tuple_getitem_slice_f32_1065',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1065',
        fields=(
            TensorFieldSpec(
                name='x',
