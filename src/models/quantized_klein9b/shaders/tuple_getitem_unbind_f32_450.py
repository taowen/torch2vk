"""Generated shader: tuple_getitem_unbind_f32_450."""
...
TUPLE_GETITEM_UNBIND_F32_450 = ShaderVariant(
    name='tuple_getitem_unbind_f32_450',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_450',
        fields=(
            TensorFieldSpec(
                name='x',
