"""Generated shader: tuple_getitem_unbind_f32_1042."""
...
TUPLE_GETITEM_UNBIND_F32_1042 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1042',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1042',
        fields=(
            TensorFieldSpec(
                name='x',
