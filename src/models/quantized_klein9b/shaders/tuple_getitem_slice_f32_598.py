"""Generated shader: tuple_getitem_slice_f32_598."""
...
TUPLE_GETITEM_SLICE_F32_598 = ShaderVariant(
    name='tuple_getitem_slice_f32_598',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_598',
        fields=(
            TensorFieldSpec(
                name='x',
