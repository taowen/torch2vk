"""Generated shader: tuple_getitem_unbind_f32_683."""
...
TUPLE_GETITEM_UNBIND_F32_683 = ShaderVariant(
    name='tuple_getitem_unbind_f32_683',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_683',
        fields=(
            TensorFieldSpec(
                name='x',
