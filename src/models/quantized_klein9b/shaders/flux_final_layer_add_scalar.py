"""Generated shader: flux_final_layer_add_scalar."""
...
FLUX_FINAL_LAYER_ADD_SCALAR = ShaderVariant(
    name='flux_final_layer_add_scalar',
    family='export',
    contract=ShaderContract(
        class_name='ExportAddScalarProgram',
        shader_name='flux_final_layer_add_scalar',
        fields=(
            TensorFieldSpec(
                name='x',
