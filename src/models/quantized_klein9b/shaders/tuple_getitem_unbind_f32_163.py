"""Generated shader: tuple_getitem_unbind_f32_163."""
...
TUPLE_GETITEM_UNBIND_F32_163 = ShaderVariant(
    name='tuple_getitem_unbind_f32_163',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_163',
        fields=(
            TensorFieldSpec(
                name='x',
