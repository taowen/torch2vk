"""Generated shader: tuple_getitem_unbind_f32_1076."""
...
TUPLE_GETITEM_UNBIND_F32_1076 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1076',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1076',
        fields=(
            TensorFieldSpec(
                name='x',
