"""Generated shader: tuple_getitem_slice_f32_20."""
...
TUPLE_GETITEM_SLICE_F32_20 = ShaderVariant(
    name='tuple_getitem_slice_f32_20',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_20',
        fields=(
            TensorFieldSpec(
                name='x',
