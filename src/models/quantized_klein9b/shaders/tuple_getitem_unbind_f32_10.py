"""Generated shader: tuple_getitem_unbind_f32_10."""
...
TUPLE_GETITEM_UNBIND_F32_10 = ShaderVariant(
    name='tuple_getitem_unbind_f32_10',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_10',
        fields=(
            TensorFieldSpec(
                name='x',
