"""Generated shader: tuple_getitem_unbind_f32_911."""
...
TUPLE_GETITEM_UNBIND_F32_911 = ShaderVariant(
    name='tuple_getitem_unbind_f32_911',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_911',
        fields=(
            TensorFieldSpec(
                name='x',
