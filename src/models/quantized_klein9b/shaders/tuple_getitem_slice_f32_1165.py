"""Generated shader: tuple_getitem_slice_f32_1165."""
...
TUPLE_GETITEM_SLICE_F32_1165 = ShaderVariant(
    name='tuple_getitem_slice_f32_1165',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1165',
        fields=(
            TensorFieldSpec(
                name='x',
