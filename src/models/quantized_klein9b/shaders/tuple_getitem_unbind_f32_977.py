"""Generated shader: tuple_getitem_unbind_f32_977."""
...
TUPLE_GETITEM_UNBIND_F32_977 = ShaderVariant(
    name='tuple_getitem_unbind_f32_977',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_977',
        fields=(
            TensorFieldSpec(
                name='x',
