"""Generated shader: tuple_getitem_unbind_f32_1008."""
...
TUPLE_GETITEM_UNBIND_F32_1008 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1008',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1008',
        fields=(
            TensorFieldSpec(
                name='x',
