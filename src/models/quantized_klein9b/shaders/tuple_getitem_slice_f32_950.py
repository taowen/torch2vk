"""Generated shader: tuple_getitem_slice_f32_950."""
...
TUPLE_GETITEM_SLICE_F32_950 = ShaderVariant(
    name='tuple_getitem_slice_f32_950',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_950',
        fields=(
            TensorFieldSpec(
                name='x',
