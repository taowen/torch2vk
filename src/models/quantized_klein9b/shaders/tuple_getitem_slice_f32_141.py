"""Generated shader: tuple_getitem_slice_f32_141."""
...
TUPLE_GETITEM_SLICE_F32_141 = ShaderVariant(
    name='tuple_getitem_slice_f32_141',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_141',
        fields=(
            TensorFieldSpec(
                name='x',
