"""Generated shader: tuple_getitem_unbind_f32_386."""
...
TUPLE_GETITEM_UNBIND_F32_386 = ShaderVariant(
    name='tuple_getitem_unbind_f32_386',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_386',
        fields=(
            TensorFieldSpec(
                name='x',
