"""Generated shader: tuple_getitem_slice_f32_858."""
...
TUPLE_GETITEM_SLICE_F32_858 = ShaderVariant(
    name='tuple_getitem_slice_f32_858',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_858',
        fields=(
            TensorFieldSpec(
                name='x',
