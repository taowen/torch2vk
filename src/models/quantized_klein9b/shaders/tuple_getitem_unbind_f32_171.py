"""Generated shader: tuple_getitem_unbind_f32_171."""
...
TUPLE_GETITEM_UNBIND_F32_171 = ShaderVariant(
    name='tuple_getitem_unbind_f32_171',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_171',
        fields=(
            TensorFieldSpec(
                name='x',
