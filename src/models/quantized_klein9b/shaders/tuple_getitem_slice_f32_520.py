"""Generated shader: tuple_getitem_slice_f32_520."""
...
TUPLE_GETITEM_SLICE_F32_520 = ShaderVariant(
    name='tuple_getitem_slice_f32_520',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_520',
        fields=(
            TensorFieldSpec(
                name='x',
