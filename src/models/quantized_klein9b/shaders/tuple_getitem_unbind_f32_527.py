"""Generated shader: tuple_getitem_unbind_f32_527."""
...
TUPLE_GETITEM_UNBIND_F32_527 = ShaderVariant(
    name='tuple_getitem_unbind_f32_527',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_527',
        fields=(
            TensorFieldSpec(
                name='x',
