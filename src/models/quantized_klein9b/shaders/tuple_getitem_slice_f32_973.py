"""Generated shader: tuple_getitem_slice_f32_973."""
...
TUPLE_GETITEM_SLICE_F32_973 = ShaderVariant(
    name='tuple_getitem_slice_f32_973',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_973',
        fields=(
            TensorFieldSpec(
                name='x',
