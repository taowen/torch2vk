"""Generated shader: tuple_getitem_unbind_f32_581."""
...
TUPLE_GETITEM_UNBIND_F32_581 = ShaderVariant(
    name='tuple_getitem_unbind_f32_581',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_581',
        fields=(
            TensorFieldSpec(
                name='x',
