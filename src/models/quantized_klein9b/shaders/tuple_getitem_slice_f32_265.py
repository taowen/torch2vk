"""Generated shader: tuple_getitem_slice_f32_265."""
...
TUPLE_GETITEM_SLICE_F32_265 = ShaderVariant(
    name='tuple_getitem_slice_f32_265',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_265',
        fields=(
            TensorFieldSpec(
                name='x',
