"""Generated shader: tuple_getitem_unbind_f32_165."""
...
TUPLE_GETITEM_UNBIND_F32_165 = ShaderVariant(
    name='tuple_getitem_unbind_f32_165',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_165',
        fields=(
            TensorFieldSpec(
                name='x',
