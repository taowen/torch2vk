"""Generated shader: tuple_getitem_unbind_f32_811."""
...
TUPLE_GETITEM_UNBIND_F32_811 = ShaderVariant(
    name='tuple_getitem_unbind_f32_811',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_811',
        fields=(
            TensorFieldSpec(
                name='x',
