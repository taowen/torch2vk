"""Generated shader: tuple_getitem_unbind_f32_246."""
...
TUPLE_GETITEM_UNBIND_F32_246 = ShaderVariant(
    name='tuple_getitem_unbind_f32_246',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_246',
        fields=(
            TensorFieldSpec(
                name='x',
