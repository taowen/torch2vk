"""Generated shader: tuple_getitem_unbind_f32_1107."""
...
TUPLE_GETITEM_UNBIND_F32_1107 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1107',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1107',
        fields=(
            TensorFieldSpec(
                name='x',
