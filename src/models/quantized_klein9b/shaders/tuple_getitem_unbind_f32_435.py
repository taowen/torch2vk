"""Generated shader: tuple_getitem_unbind_f32_435."""
...
TUPLE_GETITEM_UNBIND_F32_435 = ShaderVariant(
    name='tuple_getitem_unbind_f32_435',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_435',
        fields=(
            TensorFieldSpec(
                name='x',
