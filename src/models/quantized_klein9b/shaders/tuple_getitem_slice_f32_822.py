"""Generated shader: tuple_getitem_slice_f32_822."""
...
TUPLE_GETITEM_SLICE_F32_822 = ShaderVariant(
    name='tuple_getitem_slice_f32_822',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_822',
        fields=(
            TensorFieldSpec(
                name='x',
