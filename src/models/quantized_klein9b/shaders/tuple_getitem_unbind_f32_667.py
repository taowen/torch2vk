"""Generated shader: tuple_getitem_unbind_f32_667."""
...
TUPLE_GETITEM_UNBIND_F32_667 = ShaderVariant(
    name='tuple_getitem_unbind_f32_667',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_667',
        fields=(
            TensorFieldSpec(
                name='x',
