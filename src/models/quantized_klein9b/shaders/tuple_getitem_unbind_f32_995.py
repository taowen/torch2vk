"""Generated shader: tuple_getitem_unbind_f32_995."""
...
TUPLE_GETITEM_UNBIND_F32_995 = ShaderVariant(
    name='tuple_getitem_unbind_f32_995',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_995',
        fields=(
            TensorFieldSpec(
                name='x',
