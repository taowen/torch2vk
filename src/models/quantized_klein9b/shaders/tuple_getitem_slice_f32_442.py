"""Generated shader: tuple_getitem_slice_f32_442."""
...
TUPLE_GETITEM_SLICE_F32_442 = ShaderVariant(
    name='tuple_getitem_slice_f32_442',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_442',
        fields=(
            TensorFieldSpec(
                name='x',
