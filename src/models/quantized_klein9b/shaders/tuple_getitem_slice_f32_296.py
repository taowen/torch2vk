"""Generated shader: tuple_getitem_slice_f32_296."""
...
TUPLE_GETITEM_SLICE_F32_296 = ShaderVariant(
    name='tuple_getitem_slice_f32_296',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_296',
        fields=(
            TensorFieldSpec(
                name='x',
