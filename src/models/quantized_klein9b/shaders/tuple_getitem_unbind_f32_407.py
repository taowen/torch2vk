"""Generated shader: tuple_getitem_unbind_f32_407."""
...
TUPLE_GETITEM_UNBIND_F32_407 = ShaderVariant(
    name='tuple_getitem_unbind_f32_407',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_407',
        fields=(
            TensorFieldSpec(
                name='x',
