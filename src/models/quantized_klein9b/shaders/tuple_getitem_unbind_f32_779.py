"""Generated shader: tuple_getitem_unbind_f32_779."""
...
TUPLE_GETITEM_UNBIND_F32_779 = ShaderVariant(
    name='tuple_getitem_unbind_f32_779',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_779',
        fields=(
            TensorFieldSpec(
                name='x',
