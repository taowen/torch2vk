"""Generated shader: ae_decode_mul_broadcast."""
...
AE_DECODE_MUL_BROADCAST = ShaderVariant(
    name='ae_decode_mul_broadcast',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='ae_decode_mul_broadcast',
        fields=(
            TensorFieldSpec(
                name='x',
            ...
            TensorFieldSpec(
                ...
                io_kind=IOKind.INPUT,
                role='input',
                contract=TensorContract(dtype='float16', shape=(1, 'T', 1, 1,)),
            ),
            TensorFieldSpec(
                name='output',
