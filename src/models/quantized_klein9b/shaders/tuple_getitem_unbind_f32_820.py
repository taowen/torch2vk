"""Generated shader: tuple_getitem_unbind_f32_820."""
...
TUPLE_GETITEM_UNBIND_F32_820 = ShaderVariant(
    name='tuple_getitem_unbind_f32_820',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_820',
        fields=(
            TensorFieldSpec(
                name='x',
