"""Generated shader: tuple_getitem_slice_f32_706."""
...
TUPLE_GETITEM_SLICE_F32_706 = ShaderVariant(
    name='tuple_getitem_slice_f32_706',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_706',
        fields=(
            TensorFieldSpec(
                name='x',
