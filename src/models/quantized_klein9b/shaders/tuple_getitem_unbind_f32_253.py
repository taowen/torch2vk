"""Generated shader: tuple_getitem_unbind_f32_253."""
...
TUPLE_GETITEM_UNBIND_F32_253 = ShaderVariant(
    name='tuple_getitem_unbind_f32_253',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_253',
        fields=(
            TensorFieldSpec(
                name='x',
