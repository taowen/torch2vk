"""Generated shader: tuple_getitem_unbind_f32_511."""
...
TUPLE_GETITEM_UNBIND_F32_511 = ShaderVariant(
    name='tuple_getitem_unbind_f32_511',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_511',
        fields=(
            TensorFieldSpec(
                name='x',
