"""Generated shader: tuple_getitem_unbind_f32_174."""
...
TUPLE_GETITEM_UNBIND_F32_174 = ShaderVariant(
    name='tuple_getitem_unbind_f32_174',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_174',
        fields=(
            TensorFieldSpec(
                name='x',
