"""Generated shader: flux_double_block_mul_broadcast_26."""
...
FLUX_DOUBLE_BLOCK_MUL_BROADCAST_26 = ShaderVariant(
    name='flux_double_block_mul_broadcast_26',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='flux_double_block_mul_broadcast_26',
        fields=(
            TensorFieldSpec(
                name='x',
