"""Generated shader: tuple_getitem_slice_f32_604."""
...
TUPLE_GETITEM_SLICE_F32_604 = ShaderVariant(
    name='tuple_getitem_slice_f32_604',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_604',
        fields=(
            TensorFieldSpec(
                name='x',
