"""Generated shader: tuple_getitem_unbind_f32_199."""
...
TUPLE_GETITEM_UNBIND_F32_199 = ShaderVariant(
    name='tuple_getitem_unbind_f32_199',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_199',
        fields=(
            TensorFieldSpec(
                name='x',
