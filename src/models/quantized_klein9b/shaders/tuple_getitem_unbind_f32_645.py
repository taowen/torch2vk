"""Generated shader: tuple_getitem_unbind_f32_645."""
...
TUPLE_GETITEM_UNBIND_F32_645 = ShaderVariant(
    name='tuple_getitem_unbind_f32_645',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_645',
        fields=(
            TensorFieldSpec(
                name='x',
