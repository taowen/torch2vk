"""Generated shader: tuple_getitem_slice_f32_578."""
...
TUPLE_GETITEM_SLICE_F32_578 = ShaderVariant(
    name='tuple_getitem_slice_f32_578',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_578',
        fields=(
            TensorFieldSpec(
                name='x',
