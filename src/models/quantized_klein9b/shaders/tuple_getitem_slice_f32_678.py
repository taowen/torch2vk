"""Generated shader: tuple_getitem_slice_f32_678."""
...
TUPLE_GETITEM_SLICE_F32_678 = ShaderVariant(
    name='tuple_getitem_slice_f32_678',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_678',
        fields=(
            TensorFieldSpec(
                name='x',
