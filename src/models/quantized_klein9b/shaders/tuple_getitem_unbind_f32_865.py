"""Generated shader: tuple_getitem_unbind_f32_865."""
...
TUPLE_GETITEM_UNBIND_F32_865 = ShaderVariant(
    name='tuple_getitem_unbind_f32_865',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_865',
        fields=(
            TensorFieldSpec(
                name='x',
