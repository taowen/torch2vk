"""Generated shader: tuple_getitem_slice_f32_420."""
...
TUPLE_GETITEM_SLICE_F32_420 = ShaderVariant(
    name='tuple_getitem_slice_f32_420',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_420',
        fields=(
            TensorFieldSpec(
                name='x',
