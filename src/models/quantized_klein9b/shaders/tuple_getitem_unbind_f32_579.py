"""Generated shader: tuple_getitem_unbind_f32_579."""
...
TUPLE_GETITEM_UNBIND_F32_579 = ShaderVariant(
    name='tuple_getitem_unbind_f32_579',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_579',
        fields=(
            TensorFieldSpec(
                name='x',
