"""Generated shader: flux_single_block_pow_scalar_f32."""
...
FLUX_SINGLE_BLOCK_POW_SCALAR_F32 = ShaderVariant(
    name='flux_single_block_pow_scalar_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportPowScalarF32Program',
        shader_name='flux_single_block_pow_scalar_f32',
        fields=(
            TensorFieldSpec(
                name='x',
