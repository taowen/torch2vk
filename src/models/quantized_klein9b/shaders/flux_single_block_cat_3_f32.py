"""Generated shader: flux_single_block_cat_3_f32."""
...
FLUX_SINGLE_BLOCK_CAT_3_F32 = ShaderVariant(
    name='flux_single_block_cat_3_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportCat3Program',
        shader_name='flux_single_block_cat_3_f32',
        fields=(
            TensorFieldSpec(
                name='x0',
