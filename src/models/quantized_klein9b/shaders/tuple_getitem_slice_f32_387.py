"""Generated shader: tuple_getitem_slice_f32_387."""
...
TUPLE_GETITEM_SLICE_F32_387 = ShaderVariant(
    name='tuple_getitem_slice_f32_387',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_387',
        fields=(
            TensorFieldSpec(
                name='x',
