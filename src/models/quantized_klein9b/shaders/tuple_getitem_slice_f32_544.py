"""Generated shader: tuple_getitem_slice_f32_544."""
...
TUPLE_GETITEM_SLICE_F32_544 = ShaderVariant(
    name='tuple_getitem_slice_f32_544',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_544',
        fields=(
            TensorFieldSpec(
                name='x',
