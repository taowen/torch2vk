"""Generated shader: tuple_getitem_slice_f32_158."""
...
TUPLE_GETITEM_SLICE_F32_158 = ShaderVariant(
    name='tuple_getitem_slice_f32_158',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_158',
        fields=(
            TensorFieldSpec(
                name='x',
