"""Generated shader: tuple_getitem_unbind_f32_512."""
...
TUPLE_GETITEM_UNBIND_F32_512 = ShaderVariant(
    name='tuple_getitem_unbind_f32_512',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_512',
        fields=(
            TensorFieldSpec(
                name='x',
