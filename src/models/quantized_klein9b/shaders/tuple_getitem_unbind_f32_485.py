"""Generated shader: tuple_getitem_unbind_f32_485."""
...
TUPLE_GETITEM_UNBIND_F32_485 = ShaderVariant(
    name='tuple_getitem_unbind_f32_485',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_485',
        fields=(
            TensorFieldSpec(
                name='x',
