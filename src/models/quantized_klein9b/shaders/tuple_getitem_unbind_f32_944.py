"""Generated shader: tuple_getitem_unbind_f32_944."""
...
TUPLE_GETITEM_UNBIND_F32_944 = ShaderVariant(
    name='tuple_getitem_unbind_f32_944',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_944',
        fields=(
            TensorFieldSpec(
                name='x',
