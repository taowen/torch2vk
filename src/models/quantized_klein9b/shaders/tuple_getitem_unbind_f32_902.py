"""Generated shader: tuple_getitem_unbind_f32_902."""
...
TUPLE_GETITEM_UNBIND_F32_902 = ShaderVariant(
    name='tuple_getitem_unbind_f32_902',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_902',
        fields=(
            TensorFieldSpec(
                name='x',
