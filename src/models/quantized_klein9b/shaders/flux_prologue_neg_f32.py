"""Generated shader: flux_prologue_neg_f32."""
...
FLUX_PROLOGUE_NEG_F32 = ShaderVariant(
    name='flux_prologue_neg_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportNegF32Program',
        shader_name='flux_prologue_neg_f32',
        fields=(
            TensorFieldSpec(
                name='x',
...
void main() {
    ...
    if (idx < pc.N) { output_values[idx] = float16_t(-x[idx]); }
}
""",
)
