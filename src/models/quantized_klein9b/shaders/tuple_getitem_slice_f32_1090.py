"""Generated shader: tuple_getitem_slice_f32_1090."""
...
TUPLE_GETITEM_SLICE_F32_1090 = ShaderVariant(
    name='tuple_getitem_slice_f32_1090',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1090',
        fields=(
            TensorFieldSpec(
                name='x',
