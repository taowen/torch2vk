"""Generated shader: tuple_getitem_unbind_f32_878."""
...
TUPLE_GETITEM_UNBIND_F32_878 = ShaderVariant(
    name='tuple_getitem_unbind_f32_878',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_878',
        fields=(
            TensorFieldSpec(
                name='x',
