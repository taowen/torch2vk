"""Generated shader: tuple_getitem_unbind_f32_824."""
...
TUPLE_GETITEM_UNBIND_F32_824 = ShaderVariant(
    name='tuple_getitem_unbind_f32_824',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_824',
        fields=(
            TensorFieldSpec(
                name='x',
