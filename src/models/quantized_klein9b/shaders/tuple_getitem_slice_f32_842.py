"""Generated shader: tuple_getitem_slice_f32_842."""
...
TUPLE_GETITEM_SLICE_F32_842 = ShaderVariant(
    name='tuple_getitem_slice_f32_842',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_842',
        fields=(
            TensorFieldSpec(
                name='x',
