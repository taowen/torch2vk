"""Generated shader: tuple_getitem_unbind_f32_787."""
...
TUPLE_GETITEM_UNBIND_F32_787 = ShaderVariant(
    name='tuple_getitem_unbind_f32_787',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_787',
        fields=(
            TensorFieldSpec(
                name='x',
