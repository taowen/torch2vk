"""Generated shader: tuple_getitem_slice_f32_884."""
...
TUPLE_GETITEM_SLICE_F32_884 = ShaderVariant(
    name='tuple_getitem_slice_f32_884',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_884',
        fields=(
            TensorFieldSpec(
                name='x',
