"""Generated shader: tuple_getitem_slice_f32_1126."""
...
TUPLE_GETITEM_SLICE_F32_1126 = ShaderVariant(
    name='tuple_getitem_slice_f32_1126',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1126',
        fields=(
            TensorFieldSpec(
                name='x',
