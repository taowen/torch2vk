"""Generated shader: tuple_getitem_slice_f32_1124."""
...
TUPLE_GETITEM_SLICE_F32_1124 = ShaderVariant(
    name='tuple_getitem_slice_f32_1124',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1124',
        fields=(
            TensorFieldSpec(
                name='x',
