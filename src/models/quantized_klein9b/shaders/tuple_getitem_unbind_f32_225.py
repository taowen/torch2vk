"""Generated shader: tuple_getitem_unbind_f32_225."""
...
TUPLE_GETITEM_UNBIND_F32_225 = ShaderVariant(
    name='tuple_getitem_unbind_f32_225',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_225',
        fields=(
            TensorFieldSpec(
                name='x',
