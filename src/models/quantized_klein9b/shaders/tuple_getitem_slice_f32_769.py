"""Generated shader: tuple_getitem_slice_f32_769."""
...
TUPLE_GETITEM_SLICE_F32_769 = ShaderVariant(
    name='tuple_getitem_slice_f32_769',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_769',
        fields=(
            TensorFieldSpec(
                name='x',
