"""Generated shader: tuple_getitem_slice_f32_489."""
...
TUPLE_GETITEM_SLICE_F32_489 = ShaderVariant(
    name='tuple_getitem_slice_f32_489',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_489',
        fields=(
            TensorFieldSpec(
                name='x',
