"""Generated shader: tuple_getitem_slice_f32_499."""
...
TUPLE_GETITEM_SLICE_F32_499 = ShaderVariant(
    name='tuple_getitem_slice_f32_499',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_499',
        fields=(
            TensorFieldSpec(
                name='x',
