"""Generated shader: tuple_getitem_unbind_f32_564."""
...
TUPLE_GETITEM_UNBIND_F32_564 = ShaderVariant(
    name='tuple_getitem_unbind_f32_564',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_564',
        fields=(
            TensorFieldSpec(
                name='x',
