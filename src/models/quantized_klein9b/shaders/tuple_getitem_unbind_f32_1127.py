"""Generated shader: tuple_getitem_unbind_f32_1127."""
...
TUPLE_GETITEM_UNBIND_F32_1127 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1127',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1127',
        fields=(
            TensorFieldSpec(
                name='x',
