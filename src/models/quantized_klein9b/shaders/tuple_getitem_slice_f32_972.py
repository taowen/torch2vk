"""Generated shader: tuple_getitem_slice_f32_972."""
...
TUPLE_GETITEM_SLICE_F32_972 = ShaderVariant(
    name='tuple_getitem_slice_f32_972',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_972',
        fields=(
            TensorFieldSpec(
                name='x',
