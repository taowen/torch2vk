"""Generated shader: tuple_getitem_slice_f32_1004."""
...
TUPLE_GETITEM_SLICE_F32_1004 = ShaderVariant(
    name='tuple_getitem_slice_f32_1004',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1004',
        fields=(
            TensorFieldSpec(
                name='x',
