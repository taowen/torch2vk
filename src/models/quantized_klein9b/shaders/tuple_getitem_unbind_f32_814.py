"""Generated shader: tuple_getitem_unbind_f32_814."""
...
TUPLE_GETITEM_UNBIND_F32_814 = ShaderVariant(
    name='tuple_getitem_unbind_f32_814',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_814',
        fields=(
            TensorFieldSpec(
                name='x',
