"""Generated shader: tuple_getitem_slice_f32_335."""
...
TUPLE_GETITEM_SLICE_F32_335 = ShaderVariant(
    name='tuple_getitem_slice_f32_335',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_335',
        fields=(
            TensorFieldSpec(
                name='x',
