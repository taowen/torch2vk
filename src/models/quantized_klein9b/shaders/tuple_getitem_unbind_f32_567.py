"""Generated shader: tuple_getitem_unbind_f32_567."""
...
TUPLE_GETITEM_UNBIND_F32_567 = ShaderVariant(
    name='tuple_getitem_unbind_f32_567',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_567',
        fields=(
            TensorFieldSpec(
                name='x',
