"""Generated shader: tuple_getitem_slice_f32_1131."""
...
TUPLE_GETITEM_SLICE_F32_1131 = ShaderVariant(
    name='tuple_getitem_slice_f32_1131',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1131',
        fields=(
            TensorFieldSpec(
                name='x',
