"""Generated shader: tuple_getitem_slice_f32_1039."""
...
TUPLE_GETITEM_SLICE_F32_1039 = ShaderVariant(
    name='tuple_getitem_slice_f32_1039',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1039',
        fields=(
            TensorFieldSpec(
                name='x',
