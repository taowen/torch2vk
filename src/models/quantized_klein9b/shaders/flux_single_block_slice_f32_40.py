"""Generated shader: flux_single_block_slice_f32_40."""
...
FLUX_SINGLE_BLOCK_SLICE_F32_40 = ShaderVariant(
    name='flux_single_block_slice_f32_40',
    family='export',
    contract=ShaderContract(
        class_name='ExportSliceProgram',
        shader_name='flux_single_block_slice_f32_40',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('OUT_STRIDE', PushConstantType.UINT32, 8, 131072, dynamic=False),
                PushConstantFieldSpec('OFFSET', PushConstantType.UINT32, 12, 65536, dynamic=False),
            ),
        ),
        params_buffer=None,
