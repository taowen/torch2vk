"""Generated shader: tuple_getitem_slice_f32_998."""
...
TUPLE_GETITEM_SLICE_F32_998 = ShaderVariant(
    name='tuple_getitem_slice_f32_998',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_998',
        fields=(
            TensorFieldSpec(
                name='x',
