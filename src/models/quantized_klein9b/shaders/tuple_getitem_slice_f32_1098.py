"""Generated shader: tuple_getitem_slice_f32_1098."""
...
TUPLE_GETITEM_SLICE_F32_1098 = ShaderVariant(
    name='tuple_getitem_slice_f32_1098',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1098',
        fields=(
            TensorFieldSpec(
                name='x',
