"""Generated shader: tuple_getitem_slice_f32_43."""
...
TUPLE_GETITEM_SLICE_F32_43 = ShaderVariant(
    name='tuple_getitem_slice_f32_43',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_43',
        fields=(
            TensorFieldSpec(
                name='x',
