"""Generated shader: tuple_getitem_slice_f32_1139."""
...
TUPLE_GETITEM_SLICE_F32_1139 = ShaderVariant(
    name='tuple_getitem_slice_f32_1139',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1139',
        fields=(
            TensorFieldSpec(
                name='x',
