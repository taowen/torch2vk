"""Generated shader: tuple_getitem_slice_f32_1125."""
...
TUPLE_GETITEM_SLICE_F32_1125 = ShaderVariant(
    name='tuple_getitem_slice_f32_1125',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1125',
        fields=(
            TensorFieldSpec(
                name='x',
