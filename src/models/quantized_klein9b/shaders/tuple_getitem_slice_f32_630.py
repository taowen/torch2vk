"""Generated shader: tuple_getitem_slice_f32_630."""
...
TUPLE_GETITEM_SLICE_F32_630 = ShaderVariant(
    name='tuple_getitem_slice_f32_630',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_630',
        fields=(
            TensorFieldSpec(
                name='x',
