"""Generated shader: tuple_getitem_slice_f32_482."""
...
TUPLE_GETITEM_SLICE_F32_482 = ShaderVariant(
    name='tuple_getitem_slice_f32_482',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_482',
        fields=(
            TensorFieldSpec(
                name='x',
