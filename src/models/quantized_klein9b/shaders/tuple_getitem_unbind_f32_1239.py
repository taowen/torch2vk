"""Generated shader: tuple_getitem_unbind_f32_1239."""
...
TUPLE_GETITEM_UNBIND_F32_1239 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1239',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1239',
        fields=(
            TensorFieldSpec(
                name='x',
