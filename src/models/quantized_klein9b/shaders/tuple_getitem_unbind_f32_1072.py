"""Generated shader: tuple_getitem_unbind_f32_1072."""
...
TUPLE_GETITEM_UNBIND_F32_1072 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1072',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1072',
        fields=(
            TensorFieldSpec(
                name='x',
