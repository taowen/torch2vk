"""Generated shader: tuple_getitem_slice_f32_934."""
...
TUPLE_GETITEM_SLICE_F32_934 = ShaderVariant(
    name='tuple_getitem_slice_f32_934',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_934',
        fields=(
            TensorFieldSpec(
                name='x',
