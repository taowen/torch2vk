"""Generated shader: cat_2_f32_540."""
...
CAT_2_F32_540 = ShaderVariant(
    name='cat_2_f32_540',
    family='export',
    contract=ShaderContract(
        class_name='ExportCat2Program',
        shader_name='cat_2_f32_540',
        fields=(
            TensorFieldSpec(
                name='x0',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('OUT_STRIDE', PushConstantType.UINT32, 4, 6291456, dynamic=False),
            ),
        ),
        params_buffer=None,
...
void main() {
    ...
    if (idx < pc.N_OUT) {
        ...
        if (col < 2097152u) {
            output_values[idx] = x0[row * 2097152u + (col - 0u)];
        }
        else if (col < 6291456u) {
            output_values[idx] = x1[row * 4194304u + (col - 2097152u)];
        }
    }
}
""",
