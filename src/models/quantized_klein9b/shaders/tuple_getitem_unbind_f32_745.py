"""Generated shader: tuple_getitem_unbind_f32_745."""
...
TUPLE_GETITEM_UNBIND_F32_745 = ShaderVariant(
    name='tuple_getitem_unbind_f32_745',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_745',
        fields=(
            TensorFieldSpec(
                name='x',
