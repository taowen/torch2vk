"""Generated shader: tuple_getitem_slice_f32_806."""
...
TUPLE_GETITEM_SLICE_F32_806 = ShaderVariant(
    name='tuple_getitem_slice_f32_806',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_806',
        fields=(
            TensorFieldSpec(
                name='x',
