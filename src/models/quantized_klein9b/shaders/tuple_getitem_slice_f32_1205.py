"""Generated shader: tuple_getitem_slice_f32_1205."""
...
TUPLE_GETITEM_SLICE_F32_1205 = ShaderVariant(
    name='tuple_getitem_slice_f32_1205',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1205',
        fields=(
            TensorFieldSpec(
                name='x',
