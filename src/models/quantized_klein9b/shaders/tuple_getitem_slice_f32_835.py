"""Generated shader: tuple_getitem_slice_f32_835."""
...
TUPLE_GETITEM_SLICE_F32_835 = ShaderVariant(
    name='tuple_getitem_slice_f32_835',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_835',
        fields=(
            TensorFieldSpec(
                name='x',
