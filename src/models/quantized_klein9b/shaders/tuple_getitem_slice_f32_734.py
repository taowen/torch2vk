"""Generated shader: tuple_getitem_slice_f32_734."""
...
TUPLE_GETITEM_SLICE_F32_734 = ShaderVariant(
    name='tuple_getitem_slice_f32_734',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_734',
        fields=(
            TensorFieldSpec(
                name='x',
