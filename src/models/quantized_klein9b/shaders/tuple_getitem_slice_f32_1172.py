"""Generated shader: tuple_getitem_slice_f32_1172."""
...
TUPLE_GETITEM_SLICE_F32_1172 = ShaderVariant(
    name='tuple_getitem_slice_f32_1172',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1172',
        fields=(
            TensorFieldSpec(
                name='x',
