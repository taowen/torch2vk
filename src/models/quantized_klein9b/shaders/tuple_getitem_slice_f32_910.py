"""Generated shader: tuple_getitem_slice_f32_910."""
...
TUPLE_GETITEM_SLICE_F32_910 = ShaderVariant(
    name='tuple_getitem_slice_f32_910',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_910',
        fields=(
            TensorFieldSpec(
                name='x',
