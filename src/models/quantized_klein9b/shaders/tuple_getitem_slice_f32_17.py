"""Generated shader: tuple_getitem_slice_f32_17."""
...
TUPLE_GETITEM_SLICE_F32_17 = ShaderVariant(
    name='tuple_getitem_slice_f32_17',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_17',
        fields=(
            TensorFieldSpec(
                name='x',
