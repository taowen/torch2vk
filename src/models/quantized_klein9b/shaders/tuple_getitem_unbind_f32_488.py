"""Generated shader: tuple_getitem_unbind_f32_488."""
...
TUPLE_GETITEM_UNBIND_F32_488 = ShaderVariant(
    name='tuple_getitem_unbind_f32_488',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_488',
        fields=(
            TensorFieldSpec(
                name='x',
