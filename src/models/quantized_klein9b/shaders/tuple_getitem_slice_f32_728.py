"""Generated shader: tuple_getitem_slice_f32_728."""
...
TUPLE_GETITEM_SLICE_F32_728 = ShaderVariant(
    name='tuple_getitem_slice_f32_728',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_728',
        fields=(
            TensorFieldSpec(
                name='x',
