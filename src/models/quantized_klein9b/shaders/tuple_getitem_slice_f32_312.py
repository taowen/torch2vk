"""Generated shader: tuple_getitem_slice_f32_312."""
...
TUPLE_GETITEM_SLICE_F32_312 = ShaderVariant(
    name='tuple_getitem_slice_f32_312',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_312',
        fields=(
            TensorFieldSpec(
                name='x',
