"""Generated shader: tuple_getitem_slice_f32_818."""
...
TUPLE_GETITEM_SLICE_F32_818 = ShaderVariant(
    name='tuple_getitem_slice_f32_818',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_818',
        fields=(
            TensorFieldSpec(
                name='x',
