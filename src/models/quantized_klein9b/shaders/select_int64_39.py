"""Generated shader: select_int64_39."""
...
SELECT_INT64_39 = ShaderVariant(
    name='select_int64_39',
    family='export',
    contract=ShaderContract(
        class_name='ExportSelectProgram',
        shader_name='select_int64_39',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('select_dim', PushConstantType.UINT32, 4, 'I2', dynamic=False),
                PushConstantFieldSpec('inner', PushConstantType.UINT32, 8, 1, dynamic=False),
                PushConstantFieldSpec('selected', PushConstantType.UINT32, 12, 3, dynamic=False),
            ),
        ),
        params_buffer=None,
