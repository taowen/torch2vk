"""Generated shader: tuple_getitem_unbind_f32_1010."""
...
TUPLE_GETITEM_UNBIND_F32_1010 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1010',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1010',
        fields=(
            TensorFieldSpec(
                name='x',
