"""Generated shader: tuple_getitem_unbind_f32_351."""
...
TUPLE_GETITEM_UNBIND_F32_351 = ShaderVariant(
    name='tuple_getitem_unbind_f32_351',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_351',
        fields=(
            TensorFieldSpec(
                name='x',
