...
COS_F32_78 = ShaderVariant(
    name='cos_f32_78',
    family='export',
    contract=ShaderContract(
        class_name='ExportCosF32Program',
        shader_name='cos_f32_78',
        fields=(
            TensorFieldSpec(
                name='x',
...
void main() {
    ...
    if (idx < pc.N) { output_values[idx] = float16_t(cos(float(x[idx]))); }
}
""",
)
