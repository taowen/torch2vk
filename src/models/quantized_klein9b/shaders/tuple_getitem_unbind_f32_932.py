"""Generated shader: tuple_getitem_unbind_f32_932."""
...
TUPLE_GETITEM_UNBIND_F32_932 = ShaderVariant(
    name='tuple_getitem_unbind_f32_932',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_932',
        fields=(
            TensorFieldSpec(
                name='x',
