"""Generated shader: tuple_getitem_unbind_f32_1142."""
...
TUPLE_GETITEM_UNBIND_F32_1142 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1142',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1142',
        fields=(
            TensorFieldSpec(
                name='x',
