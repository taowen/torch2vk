"""Generated shader: tuple_getitem_unbind_f32_19."""
...
TUPLE_GETITEM_UNBIND_F32_19 = ShaderVariant(
    name='tuple_getitem_unbind_f32_19',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_19',
        fields=(
            TensorFieldSpec(
                name='x',
