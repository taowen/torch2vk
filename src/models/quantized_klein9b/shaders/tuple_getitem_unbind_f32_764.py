"""Generated shader: tuple_getitem_unbind_f32_764."""
...
TUPLE_GETITEM_UNBIND_F32_764 = ShaderVariant(
    name='tuple_getitem_unbind_f32_764',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_764',
        fields=(
            TensorFieldSpec(
                name='x',
