"""Generated shader: tuple_getitem_unbind_f32_554."""
...
TUPLE_GETITEM_UNBIND_F32_554 = ShaderVariant(
    name='tuple_getitem_unbind_f32_554',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_554',
        fields=(
            TensorFieldSpec(
                name='x',
