"""Generated shader: tuple_getitem_unbind_f32_891."""
...
TUPLE_GETITEM_UNBIND_F32_891 = ShaderVariant(
    name='tuple_getitem_unbind_f32_891',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_891',
        fields=(
            TensorFieldSpec(
                name='x',
