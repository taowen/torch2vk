"""Generated shader: tuple_getitem_unbind_f32_876."""
...
TUPLE_GETITEM_UNBIND_F32_876 = ShaderVariant(
    name='tuple_getitem_unbind_f32_876',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_876',
        fields=(
            TensorFieldSpec(
                name='x',
