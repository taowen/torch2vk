"""Generated shader: tuple_getitem_slice_f32_375."""
...
TUPLE_GETITEM_SLICE_F32_375 = ShaderVariant(
    name='tuple_getitem_slice_f32_375',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_375',
        fields=(
            TensorFieldSpec(
                name='x',
