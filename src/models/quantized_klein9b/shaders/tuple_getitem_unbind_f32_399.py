"""Generated shader: tuple_getitem_unbind_f32_399."""
...
TUPLE_GETITEM_UNBIND_F32_399 = ShaderVariant(
    name='tuple_getitem_unbind_f32_399',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_399',
        fields=(
            TensorFieldSpec(
                name='x',
