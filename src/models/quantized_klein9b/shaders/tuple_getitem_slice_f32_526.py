"""Generated shader: tuple_getitem_slice_f32_526."""
...
TUPLE_GETITEM_SLICE_F32_526 = ShaderVariant(
    name='tuple_getitem_slice_f32_526',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_526',
        fields=(
            TensorFieldSpec(
                name='x',
