"""Generated shader: tuple_getitem_unbind_f32_538."""
...
TUPLE_GETITEM_UNBIND_F32_538 = ShaderVariant(
    name='tuple_getitem_unbind_f32_538',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_538',
        fields=(
            TensorFieldSpec(
                name='x',
