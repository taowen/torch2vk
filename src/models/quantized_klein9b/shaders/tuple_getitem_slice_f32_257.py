"""Generated shader: tuple_getitem_slice_f32_257."""
...
TUPLE_GETITEM_SLICE_F32_257 = ShaderVariant(
    name='tuple_getitem_slice_f32_257',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_257',
        fields=(
            TensorFieldSpec(
                name='x',
