"""Generated shader: flux_double_block_add_scalar."""
...
FLUX_DOUBLE_BLOCK_ADD_SCALAR = ShaderVariant(
    name='flux_double_block_add_scalar',
    family='export',
    contract=ShaderContract(
        class_name='ExportAddScalarProgram',
        shader_name='flux_double_block_add_scalar',
        fields=(
            TensorFieldSpec(
                name='x',
