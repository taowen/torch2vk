"""Generated shader: tuple_getitem_slice_f32_1073."""
...
TUPLE_GETITEM_SLICE_F32_1073 = ShaderVariant(
    name='tuple_getitem_slice_f32_1073',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1073',
        fields=(
            TensorFieldSpec(
                name='x',
