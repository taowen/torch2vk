"""Generated shader: tuple_getitem_unbind_f32_261."""
...
TUPLE_GETITEM_UNBIND_F32_261 = ShaderVariant(
    name='tuple_getitem_unbind_f32_261',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_261',
        fields=(
            TensorFieldSpec(
                name='x',
