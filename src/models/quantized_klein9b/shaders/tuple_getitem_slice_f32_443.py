"""Generated shader: tuple_getitem_slice_f32_443."""
...
TUPLE_GETITEM_SLICE_F32_443 = ShaderVariant(
    name='tuple_getitem_slice_f32_443',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_443',
        fields=(
            TensorFieldSpec(
                name='x',
