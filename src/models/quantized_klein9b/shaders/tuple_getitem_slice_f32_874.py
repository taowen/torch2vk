"""Generated shader: tuple_getitem_slice_f32_874."""
...
TUPLE_GETITEM_SLICE_F32_874 = ShaderVariant(
    name='tuple_getitem_slice_f32_874',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_874',
        fields=(
            TensorFieldSpec(
                name='x',
