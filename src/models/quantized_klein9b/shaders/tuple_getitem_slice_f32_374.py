"""Generated shader: tuple_getitem_slice_f32_374."""
...
TUPLE_GETITEM_SLICE_F32_374 = ShaderVariant(
    name='tuple_getitem_slice_f32_374',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_374',
        fields=(
            TensorFieldSpec(
                name='x',
