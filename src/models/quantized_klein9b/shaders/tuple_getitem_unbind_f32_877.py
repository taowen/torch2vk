"""Generated shader: tuple_getitem_unbind_f32_877."""
...
TUPLE_GETITEM_UNBIND_F32_877 = ShaderVariant(
    name='tuple_getitem_unbind_f32_877',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_877',
        fields=(
            TensorFieldSpec(
                name='x',
