"""Generated shader: tuple_getitem_slice_f32_622."""
...
TUPLE_GETITEM_SLICE_F32_622 = ShaderVariant(
    name='tuple_getitem_slice_f32_622',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_622',
        fields=(
            TensorFieldSpec(
                name='x',
