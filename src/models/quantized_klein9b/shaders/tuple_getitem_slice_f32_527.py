"""Generated shader: tuple_getitem_slice_f32_527."""
...
TUPLE_GETITEM_SLICE_F32_527 = ShaderVariant(
    name='tuple_getitem_slice_f32_527',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_527',
        fields=(
            TensorFieldSpec(
                name='x',
