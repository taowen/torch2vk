"""Generated shader: tuple_getitem_slice_f32_12."""
...
TUPLE_GETITEM_SLICE_F32_12 = ShaderVariant(
    name='tuple_getitem_slice_f32_12',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_12',
        fields=(
            TensorFieldSpec(
                name='x',
