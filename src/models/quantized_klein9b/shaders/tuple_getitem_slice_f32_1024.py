"""Generated shader: tuple_getitem_slice_f32_1024."""
...
TUPLE_GETITEM_SLICE_F32_1024 = ShaderVariant(
    name='tuple_getitem_slice_f32_1024',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1024',
        fields=(
            TensorFieldSpec(
                name='x',
