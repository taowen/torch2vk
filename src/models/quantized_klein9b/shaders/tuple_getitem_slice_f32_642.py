"""Generated shader: tuple_getitem_slice_f32_642."""
...
TUPLE_GETITEM_SLICE_F32_642 = ShaderVariant(
    name='tuple_getitem_slice_f32_642',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_642',
        fields=(
            TensorFieldSpec(
                name='x',
