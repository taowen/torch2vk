"""Generated shader: tuple_getitem_slice_f32_670."""
...
TUPLE_GETITEM_SLICE_F32_670 = ShaderVariant(
    name='tuple_getitem_slice_f32_670',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_670',
        fields=(
            TensorFieldSpec(
                name='x',
