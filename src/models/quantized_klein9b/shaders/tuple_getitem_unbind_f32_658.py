"""Generated shader: tuple_getitem_unbind_f32_658."""
...
TUPLE_GETITEM_UNBIND_F32_658 = ShaderVariant(
    name='tuple_getitem_unbind_f32_658',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_658',
        fields=(
            TensorFieldSpec(
                name='x',
