"""Generated shader: tuple_getitem_slice_f32_1062."""
...
TUPLE_GETITEM_SLICE_F32_1062 = ShaderVariant(
    name='tuple_getitem_slice_f32_1062',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1062',
        fields=(
            TensorFieldSpec(
                name='x',
