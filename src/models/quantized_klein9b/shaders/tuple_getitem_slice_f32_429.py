"""Generated shader: tuple_getitem_slice_f32_429."""
...
TUPLE_GETITEM_SLICE_F32_429 = ShaderVariant(
    name='tuple_getitem_slice_f32_429',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_429',
        fields=(
            TensorFieldSpec(
                name='x',
