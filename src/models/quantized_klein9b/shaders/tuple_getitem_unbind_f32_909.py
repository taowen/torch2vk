"""Generated shader: tuple_getitem_unbind_f32_909."""
...
TUPLE_GETITEM_UNBIND_F32_909 = ShaderVariant(
    name='tuple_getitem_unbind_f32_909',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_909',
        fields=(
            TensorFieldSpec(
                name='x',
