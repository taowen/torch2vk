"""Generated shader: tuple_getitem_unbind_f32_844."""
...
TUPLE_GETITEM_UNBIND_F32_844 = ShaderVariant(
    name='tuple_getitem_unbind_f32_844',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_844',
        fields=(
            TensorFieldSpec(
                name='x',
