"""Generated shader: linear_nobias_f16w_f32."""
...
LINEAR_NOBIAS_F16W_F32 = ShaderVariant(
    name='linear_nobias_f16w_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasF16WeightProgram',
        shader_name='linear_nobias_f16w_f32',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        params_buffer=None,
        dispatch=(ceil_div('X0', 16), ceil_div('W0', 64), 1),
    ),
