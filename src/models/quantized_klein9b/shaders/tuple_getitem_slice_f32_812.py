"""Generated shader: tuple_getitem_slice_f32_812."""
...
TUPLE_GETITEM_SLICE_F32_812 = ShaderVariant(
    name='tuple_getitem_slice_f32_812',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_812',
        fields=(
            TensorFieldSpec(
                name='x',
