"""Generated shader: tuple_getitem_unbind_f32_1009."""
...
TUPLE_GETITEM_UNBIND_F32_1009 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1009',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1009',
        fields=(
            TensorFieldSpec(
                name='x',
