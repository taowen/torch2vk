"""Generated shader: tuple_getitem_unbind_f32_647."""
...
TUPLE_GETITEM_UNBIND_F32_647 = ShaderVariant(
    name='tuple_getitem_unbind_f32_647',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_647',
        fields=(
            TensorFieldSpec(
                name='x',
