...
MUL_SCALAR_2 = ShaderVariant(
    name='mul_scalar_2',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulScalarProgram',
        shader_name='mul_scalar_2',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('scalar', PushConstantType.FLOAT32, 4, -9.210340371976184, dynamic=False),
            ),
        ),
        params_buffer=None,
