"""Generated shader: tuple_getitem_slice_f32_25."""
...
TUPLE_GETITEM_SLICE_F32_25 = ShaderVariant(
    name='tuple_getitem_slice_f32_25',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_25',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('IN_STRIDE', PushConstantType.UINT32, 4, 12288, dynamic=False),
                PushConstantFieldSpec('OUT_STRIDE', PushConstantType.UINT32, 8, 4096, dynamic=False),
                PushConstantFieldSpec('OFFSET', PushConstantType.UINT32, 12, 8192, dynamic=False),
            ),
        ),
        params_buffer=None,
