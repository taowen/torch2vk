"""Generated shader: tuple_getitem_unbind_f32_502."""
...
TUPLE_GETITEM_UNBIND_F32_502 = ShaderVariant(
    name='tuple_getitem_unbind_f32_502',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_502',
        fields=(
            TensorFieldSpec(
                name='x',
