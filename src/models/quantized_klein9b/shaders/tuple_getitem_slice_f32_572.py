"""Generated shader: tuple_getitem_slice_f32_572."""
...
TUPLE_GETITEM_SLICE_F32_572 = ShaderVariant(
    name='tuple_getitem_slice_f32_572',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_572',
        fields=(
            TensorFieldSpec(
                name='x',
