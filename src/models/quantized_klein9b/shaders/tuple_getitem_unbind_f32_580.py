"""Generated shader: tuple_getitem_unbind_f32_580."""
...
TUPLE_GETITEM_UNBIND_F32_580 = ShaderVariant(
    name='tuple_getitem_unbind_f32_580',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_580',
        fields=(
            TensorFieldSpec(
                name='x',
