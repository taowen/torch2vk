"""Generated shader: tuple_getitem_unbind_f32_711."""
...
TUPLE_GETITEM_UNBIND_F32_711 = ShaderVariant(
    name='tuple_getitem_unbind_f32_711',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_711',
        fields=(
            TensorFieldSpec(
                name='x',
