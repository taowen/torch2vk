"""Generated shader: tuple_getitem_unbind_f32_1044."""
...
TUPLE_GETITEM_UNBIND_F32_1044 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1044',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1044',
        fields=(
            TensorFieldSpec(
                name='x',
