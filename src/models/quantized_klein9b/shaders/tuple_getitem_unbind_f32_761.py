"""Generated shader: tuple_getitem_unbind_f32_761."""
...
TUPLE_GETITEM_UNBIND_F32_761 = ShaderVariant(
    name='tuple_getitem_unbind_f32_761',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_761',
        fields=(
            TensorFieldSpec(
                name='x',
