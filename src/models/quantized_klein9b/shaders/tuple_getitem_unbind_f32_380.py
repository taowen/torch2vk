"""Generated shader: tuple_getitem_unbind_f32_380."""
...
TUPLE_GETITEM_UNBIND_F32_380 = ShaderVariant(
    name='tuple_getitem_unbind_f32_380',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_380',
        fields=(
            TensorFieldSpec(
                name='x',
