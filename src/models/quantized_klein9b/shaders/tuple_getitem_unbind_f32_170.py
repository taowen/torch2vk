"""Generated shader: tuple_getitem_unbind_f32_170."""
...
TUPLE_GETITEM_UNBIND_F32_170 = ShaderVariant(
    name='tuple_getitem_unbind_f32_170',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_170',
        fields=(
            TensorFieldSpec(
                name='x',
