"""Generated shader: tuple_getitem_unbind_f32_159."""
...
TUPLE_GETITEM_UNBIND_F32_159 = ShaderVariant(
    name='tuple_getitem_unbind_f32_159',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_159',
        fields=(
            TensorFieldSpec(
                name='x',
