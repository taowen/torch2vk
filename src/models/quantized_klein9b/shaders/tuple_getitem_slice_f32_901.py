"""Generated shader: tuple_getitem_slice_f32_901."""
...
TUPLE_GETITEM_SLICE_F32_901 = ShaderVariant(
    name='tuple_getitem_slice_f32_901',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_901',
        fields=(
            TensorFieldSpec(
                name='x',
