"""Generated shader: tuple_getitem_slice_f32_240."""
...
TUPLE_GETITEM_SLICE_F32_240 = ShaderVariant(
    name='tuple_getitem_slice_f32_240',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_240',
        fields=(
            TensorFieldSpec(
                name='x',
