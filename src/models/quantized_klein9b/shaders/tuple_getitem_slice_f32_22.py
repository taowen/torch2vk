"""Generated shader: tuple_getitem_slice_f32_22."""
...
TUPLE_GETITEM_SLICE_F32_22 = ShaderVariant(
    name='tuple_getitem_slice_f32_22',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_22',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('OFFSET', PushConstantType.UINT32, 12, 20480, dynamic=False),
            ),
        ),
        params_buffer=None,
