"""Generated shader: tuple_getitem_unbind_f32_563."""
...
TUPLE_GETITEM_UNBIND_F32_563 = ShaderVariant(
    name='tuple_getitem_unbind_f32_563',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_563',
        fields=(
            TensorFieldSpec(
                name='x',
