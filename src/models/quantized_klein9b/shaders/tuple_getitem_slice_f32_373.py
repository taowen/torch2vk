"""Generated shader: tuple_getitem_slice_f32_373."""
...
TUPLE_GETITEM_SLICE_F32_373 = ShaderVariant(
    name='tuple_getitem_slice_f32_373',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_373',
        fields=(
            TensorFieldSpec(
                name='x',
