"""Generated shader: tuple_getitem_slice_f32_1270."""
...
TUPLE_GETITEM_SLICE_F32_1270 = ShaderVariant(
    name='tuple_getitem_slice_f32_1270',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1270',
        fields=(
            TensorFieldSpec(
                name='x',
