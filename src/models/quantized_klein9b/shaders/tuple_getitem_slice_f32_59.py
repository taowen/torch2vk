"""Generated shader: tuple_getitem_slice_f32_59."""
...
TUPLE_GETITEM_SLICE_F32_59 = ShaderVariant(
    name='tuple_getitem_slice_f32_59',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_59',
        fields=(
            TensorFieldSpec(
                name='x',
