"""Generated shader: tuple_getitem_slice_f32_952."""
...
TUPLE_GETITEM_SLICE_F32_952 = ShaderVariant(
    name='tuple_getitem_slice_f32_952',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_952',
        fields=(
            TensorFieldSpec(
                name='x',
