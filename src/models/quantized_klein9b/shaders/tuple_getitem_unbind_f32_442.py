"""Generated shader: tuple_getitem_unbind_f32_442."""
...
TUPLE_GETITEM_UNBIND_F32_442 = ShaderVariant(
    name='tuple_getitem_unbind_f32_442',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_442',
        fields=(
            TensorFieldSpec(
                name='x',
