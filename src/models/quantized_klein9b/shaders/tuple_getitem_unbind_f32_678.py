"""Generated shader: tuple_getitem_unbind_f32_678."""
...
TUPLE_GETITEM_UNBIND_F32_678 = ShaderVariant(
    name='tuple_getitem_unbind_f32_678',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_678',
        fields=(
            TensorFieldSpec(
                name='x',
