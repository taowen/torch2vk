"""Generated shader: tuple_getitem_slice_f32_930."""
...
TUPLE_GETITEM_SLICE_F32_930 = ShaderVariant(
    name='tuple_getitem_slice_f32_930',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_930',
        fields=(
            TensorFieldSpec(
                name='x',
