"""Generated shader: tuple_getitem_unbind_f32_448."""
...
TUPLE_GETITEM_UNBIND_F32_448 = ShaderVariant(
    name='tuple_getitem_unbind_f32_448',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_448',
        fields=(
            TensorFieldSpec(
                name='x',
