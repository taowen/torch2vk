"""Generated shader: tuple_getitem_unbind_f32_839."""
...
TUPLE_GETITEM_UNBIND_F32_839 = ShaderVariant(
    name='tuple_getitem_unbind_f32_839',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_839',
        fields=(
            TensorFieldSpec(
                name='x',
