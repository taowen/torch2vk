"""Generated shader: tuple_getitem_slice_f32_637."""
...
TUPLE_GETITEM_SLICE_F32_637 = ShaderVariant(
    name='tuple_getitem_slice_f32_637',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_637',
        fields=(
            TensorFieldSpec(
                name='x',
