"""Generated shader: tuple_getitem_unbind_f32_388."""
...
TUPLE_GETITEM_UNBIND_F32_388 = ShaderVariant(
    name='tuple_getitem_unbind_f32_388',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_388',
        fields=(
            TensorFieldSpec(
                name='x',
