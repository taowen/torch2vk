"""Generated shader: tuple_getitem_unbind_f32_288."""
...
TUPLE_GETITEM_UNBIND_F32_288 = ShaderVariant(
    name='tuple_getitem_unbind_f32_288',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_288',
        fields=(
            TensorFieldSpec(
                name='x',
