"""Generated shader: tuple_getitem_unbind_f32_325."""
...
TUPLE_GETITEM_UNBIND_F32_325 = ShaderVariant(
    name='tuple_getitem_unbind_f32_325',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_325',
        fields=(
            TensorFieldSpec(
                name='x',
