"""Generated shader: tuple_getitem_slice_f32_146."""
...
TUPLE_GETITEM_SLICE_F32_146 = ShaderVariant(
    name='tuple_getitem_slice_f32_146',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_146',
        fields=(
            TensorFieldSpec(
                name='x',
