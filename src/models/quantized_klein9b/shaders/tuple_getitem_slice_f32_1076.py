"""Generated shader: tuple_getitem_slice_f32_1076."""
...
TUPLE_GETITEM_SLICE_F32_1076 = ShaderVariant(
    name='tuple_getitem_slice_f32_1076',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1076',
        fields=(
            TensorFieldSpec(
                name='x',
