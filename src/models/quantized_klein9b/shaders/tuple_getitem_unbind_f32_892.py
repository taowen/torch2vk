"""Generated shader: tuple_getitem_unbind_f32_892."""
...
TUPLE_GETITEM_UNBIND_F32_892 = ShaderVariant(
    name='tuple_getitem_unbind_f32_892',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_892',
        fields=(
            TensorFieldSpec(
                name='x',
