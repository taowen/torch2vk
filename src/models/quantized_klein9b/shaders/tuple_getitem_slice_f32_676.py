"""Generated shader: tuple_getitem_slice_f32_676."""
...
TUPLE_GETITEM_SLICE_F32_676 = ShaderVariant(
    name='tuple_getitem_slice_f32_676',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_676',
        fields=(
            TensorFieldSpec(
                name='x',
