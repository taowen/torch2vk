"""Generated shader: tuple_getitem_slice_f32_1106."""
...
TUPLE_GETITEM_SLICE_F32_1106 = ShaderVariant(
    name='tuple_getitem_slice_f32_1106',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1106',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('IN_STRIDE', PushConstantType.UINT32, 4, 36864, dynamic=False),
                PushConstantFieldSpec('OUT_STRIDE', PushConstantType.UINT32, 8, 24576, dynamic=False),
