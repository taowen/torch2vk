"""Generated shader: tuple_getitem_unbind_f32_164."""
...
TUPLE_GETITEM_UNBIND_F32_164 = ShaderVariant(
    name='tuple_getitem_unbind_f32_164',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_164',
        fields=(
            TensorFieldSpec(
                name='x',
