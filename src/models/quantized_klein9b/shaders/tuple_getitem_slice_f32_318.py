"""Generated shader: tuple_getitem_slice_f32_318."""
...
TUPLE_GETITEM_SLICE_F32_318 = ShaderVariant(
    name='tuple_getitem_slice_f32_318',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_318',
        fields=(
            TensorFieldSpec(
                name='x',
