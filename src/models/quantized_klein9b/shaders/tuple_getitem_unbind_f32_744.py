"""Generated shader: tuple_getitem_unbind_f32_744."""
...
TUPLE_GETITEM_UNBIND_F32_744 = ShaderVariant(
    name='tuple_getitem_unbind_f32_744',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_744',
        fields=(
            TensorFieldSpec(
                name='x',
