"""Generated shader: tuple_getitem_unbind_f32_798."""
...
TUPLE_GETITEM_UNBIND_F32_798 = ShaderVariant(
    name='tuple_getitem_unbind_f32_798',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_798',
        fields=(
            TensorFieldSpec(
                name='x',
