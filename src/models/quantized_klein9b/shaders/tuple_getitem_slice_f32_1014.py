"""Generated shader: tuple_getitem_slice_f32_1014."""
...
TUPLE_GETITEM_SLICE_F32_1014 = ShaderVariant(
    name='tuple_getitem_slice_f32_1014',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1014',
        fields=(
            TensorFieldSpec(
                name='x',
