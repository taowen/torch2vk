"""Generated shader: tuple_getitem_slice_f32_916."""
...
TUPLE_GETITEM_SLICE_F32_916 = ShaderVariant(
    name='tuple_getitem_slice_f32_916',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_916',
        fields=(
            TensorFieldSpec(
                name='x',
