"""Generated shader: tuple_getitem_unbind_f32_1156."""
...
TUPLE_GETITEM_UNBIND_F32_1156 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1156',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1156',
        fields=(
            TensorFieldSpec(
                name='x',
