"""Generated shader: tuple_getitem_unbind_f32_631."""
...
TUPLE_GETITEM_UNBIND_F32_631 = ShaderVariant(
    name='tuple_getitem_unbind_f32_631',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_631',
        fields=(
            TensorFieldSpec(
                name='x',
