"""Generated shader: tuple_getitem_slice_f32_571."""
...
TUPLE_GETITEM_SLICE_F32_571 = ShaderVariant(
    name='tuple_getitem_slice_f32_571',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_571',
        fields=(
            TensorFieldSpec(
                name='x',
