"""Generated shader: tuple_getitem_unbind_f32_813."""
...
TUPLE_GETITEM_UNBIND_F32_813 = ShaderVariant(
    name='tuple_getitem_unbind_f32_813',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_813',
        fields=(
            TensorFieldSpec(
                name='x',
