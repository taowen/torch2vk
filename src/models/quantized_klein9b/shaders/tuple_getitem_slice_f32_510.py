"""Generated shader: tuple_getitem_slice_f32_510."""
...
TUPLE_GETITEM_SLICE_F32_510 = ShaderVariant(
    name='tuple_getitem_slice_f32_510',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_510',
        fields=(
            TensorFieldSpec(
                name='x',
