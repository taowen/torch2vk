"""Generated shader: tuple_getitem_unbind_f32_341."""
...
TUPLE_GETITEM_UNBIND_F32_341 = ShaderVariant(
    name='tuple_getitem_unbind_f32_341',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_341',
        fields=(
            TensorFieldSpec(
                name='x',
