"""Generated shader: tuple_getitem_unbind_f32_616."""
...
TUPLE_GETITEM_UNBIND_F32_616 = ShaderVariant(
    name='tuple_getitem_unbind_f32_616',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_616',
        fields=(
            TensorFieldSpec(
                name='x',
