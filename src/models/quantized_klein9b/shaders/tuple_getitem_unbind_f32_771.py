"""Generated shader: tuple_getitem_unbind_f32_771."""
...
TUPLE_GETITEM_UNBIND_F32_771 = ShaderVariant(
    name='tuple_getitem_unbind_f32_771',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_771',
        fields=(
            TensorFieldSpec(
                name='x',
