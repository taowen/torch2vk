"""Generated shader: tuple_getitem_unbind_f32_254."""
...
TUPLE_GETITEM_UNBIND_F32_254 = ShaderVariant(
    name='tuple_getitem_unbind_f32_254',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_254',
        fields=(
            TensorFieldSpec(
                name='x',
