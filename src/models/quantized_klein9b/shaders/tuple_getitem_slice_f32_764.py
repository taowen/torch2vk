"""Generated shader: tuple_getitem_slice_f32_764."""
...
TUPLE_GETITEM_SLICE_F32_764 = ShaderVariant(
    name='tuple_getitem_slice_f32_764',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_764',
        fields=(
            TensorFieldSpec(
                name='x',
