"""Generated shader: tuple_getitem_unbind_f32_979."""
...
TUPLE_GETITEM_UNBIND_F32_979 = ShaderVariant(
    name='tuple_getitem_unbind_f32_979',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_979',
        fields=(
            TensorFieldSpec(
                name='x',
