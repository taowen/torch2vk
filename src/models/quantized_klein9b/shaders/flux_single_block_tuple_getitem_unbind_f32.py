"""Generated shader: flux_single_block_tuple_getitem_unbind_f32."""
...
FLUX_SINGLE_BLOCK_TUPLE_GETITEM_UNBIND_F32 = ShaderVariant(
    name='flux_single_block_tuple_getitem_unbind_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='flux_single_block_tuple_getitem_unbind_f32',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('INNER', PushConstantType.UINT32, 8, 6291456, dynamic=False),
