"""Generated shader: tuple_getitem_slice_f32_966."""
...
TUPLE_GETITEM_SLICE_F32_966 = ShaderVariant(
    name='tuple_getitem_slice_f32_966',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_966',
        fields=(
            TensorFieldSpec(
                name='x',
