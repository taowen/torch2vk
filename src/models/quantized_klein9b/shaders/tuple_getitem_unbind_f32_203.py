"""Generated shader: tuple_getitem_unbind_f32_203."""
...
TUPLE_GETITEM_UNBIND_F32_203 = ShaderVariant(
    name='tuple_getitem_unbind_f32_203',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_203',
        fields=(
            TensorFieldSpec(
                name='x',
