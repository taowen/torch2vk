"""Generated shader: tuple_getitem_unbind_f32_1043."""
...
TUPLE_GETITEM_UNBIND_F32_1043 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1043',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1043',
        fields=(
            TensorFieldSpec(
                name='x',
