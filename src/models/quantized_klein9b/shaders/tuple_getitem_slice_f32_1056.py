"""Generated shader: tuple_getitem_slice_f32_1056."""
...
TUPLE_GETITEM_SLICE_F32_1056 = ShaderVariant(
    name='tuple_getitem_slice_f32_1056',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1056',
        fields=(
            TensorFieldSpec(
                name='x',
