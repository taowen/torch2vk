"""Generated shader: tuple_getitem_slice_f32_33."""
...
TUPLE_GETITEM_SLICE_F32_33 = ShaderVariant(
    name='tuple_getitem_slice_f32_33',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_33',
        fields=(
            TensorFieldSpec(
                name='x',
