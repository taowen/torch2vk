"""Generated shader: tuple_getitem_slice_f32_203."""
...
TUPLE_GETITEM_SLICE_F32_203 = ShaderVariant(
    name='tuple_getitem_slice_f32_203',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_203',
        fields=(
            TensorFieldSpec(
                name='x',
