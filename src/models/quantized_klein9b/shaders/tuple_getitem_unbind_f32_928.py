"""Generated shader: tuple_getitem_unbind_f32_928."""
...
TUPLE_GETITEM_UNBIND_F32_928 = ShaderVariant(
    name='tuple_getitem_unbind_f32_928',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_928',
        fields=(
            TensorFieldSpec(
                name='x',
