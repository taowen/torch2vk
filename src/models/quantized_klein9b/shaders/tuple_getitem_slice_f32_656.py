"""Generated shader: tuple_getitem_slice_f32_656."""
...
TUPLE_GETITEM_SLICE_F32_656 = ShaderVariant(
    name='tuple_getitem_slice_f32_656',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_656',
        fields=(
            TensorFieldSpec(
                name='x',
