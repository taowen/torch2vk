"""Generated shader: flux_double_block_linear_nobias_f16w_f32."""
...
FLUX_DOUBLE_BLOCK_LINEAR_NOBIAS_F16W_F32 = ShaderVariant(
    name='flux_double_block_linear_nobias_f16w_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasF16WeightProgram',
        shader_name='flux_double_block_linear_nobias_f16w_f32',
        fields=(
            TensorFieldSpec(
                name='x',
