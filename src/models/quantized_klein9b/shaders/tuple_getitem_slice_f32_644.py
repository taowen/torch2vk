"""Generated shader: tuple_getitem_slice_f32_644."""
...
TUPLE_GETITEM_SLICE_F32_644 = ShaderVariant(
    name='tuple_getitem_slice_f32_644',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_644',
        fields=(
            TensorFieldSpec(
                name='x',
