"""Generated shader: tuple_getitem_unbind_f32_400."""
...
TUPLE_GETITEM_UNBIND_F32_400 = ShaderVariant(
    name='tuple_getitem_unbind_f32_400',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_400',
        fields=(
            TensorFieldSpec(
                name='x',
