"""Generated shader: tuple_getitem_slice_f32_187."""
...
TUPLE_GETITEM_SLICE_F32_187 = ShaderVariant(
    name='tuple_getitem_slice_f32_187',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_187',
        fields=(
            TensorFieldSpec(
                name='x',
