"""Generated shader: tuple_getitem_slice_f32_212."""
...
TUPLE_GETITEM_SLICE_F32_212 = ShaderVariant(
    name='tuple_getitem_slice_f32_212',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_212',
        fields=(
            TensorFieldSpec(
                name='x',
