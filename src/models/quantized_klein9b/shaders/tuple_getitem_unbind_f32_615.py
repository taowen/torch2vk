"""Generated shader: tuple_getitem_unbind_f32_615."""
...
TUPLE_GETITEM_UNBIND_F32_615 = ShaderVariant(
    name='tuple_getitem_unbind_f32_615',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_615',
        fields=(
            TensorFieldSpec(
                name='x',
