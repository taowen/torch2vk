"""Generated shader: tuple_getitem_slice_f32_1304."""
...
TUPLE_GETITEM_SLICE_F32_1304 = ShaderVariant(
    name='tuple_getitem_slice_f32_1304',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1304',
        fields=(
            TensorFieldSpec(
                name='x',
