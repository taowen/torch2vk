"""Generated shader: tuple_getitem_slice_f32_1330."""
...
TUPLE_GETITEM_SLICE_F32_1330 = ShaderVariant(
    name='tuple_getitem_slice_f32_1330',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1330',
        fields=(
            TensorFieldSpec(
                name='x',
