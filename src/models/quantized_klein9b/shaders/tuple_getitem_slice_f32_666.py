"""Generated shader: tuple_getitem_slice_f32_666."""
...
TUPLE_GETITEM_SLICE_F32_666 = ShaderVariant(
    name='tuple_getitem_slice_f32_666',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_666',
        fields=(
            TensorFieldSpec(
                name='x',
