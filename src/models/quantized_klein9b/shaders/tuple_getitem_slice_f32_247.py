"""Generated shader: tuple_getitem_slice_f32_247."""
...
TUPLE_GETITEM_SLICE_F32_247 = ShaderVariant(
    name='tuple_getitem_slice_f32_247',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_247',
        fields=(
            TensorFieldSpec(
                name='x',
