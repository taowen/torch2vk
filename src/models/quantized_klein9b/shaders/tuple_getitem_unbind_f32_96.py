"""Generated shader: tuple_getitem_unbind_f32_96."""
...
TUPLE_GETITEM_UNBIND_F32_96 = ShaderVariant(
    name='tuple_getitem_unbind_f32_96',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_96',
        fields=(
            TensorFieldSpec(
                name='x',
