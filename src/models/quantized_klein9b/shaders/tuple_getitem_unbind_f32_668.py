"""Generated shader: tuple_getitem_unbind_f32_668."""
...
TUPLE_GETITEM_UNBIND_F32_668 = ShaderVariant(
    name='tuple_getitem_unbind_f32_668',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_668',
        fields=(
            TensorFieldSpec(
                name='x',
