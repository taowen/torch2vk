"""Generated shader: tuple_getitem_slice_f32_978."""
...
TUPLE_GETITEM_SLICE_F32_978 = ShaderVariant(
    name='tuple_getitem_slice_f32_978',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_978',
        fields=(
            TensorFieldSpec(
                name='x',
