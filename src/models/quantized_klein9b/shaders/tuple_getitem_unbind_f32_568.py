"""Generated shader: tuple_getitem_unbind_f32_568."""
...
TUPLE_GETITEM_UNBIND_F32_568 = ShaderVariant(
    name='tuple_getitem_unbind_f32_568',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_568',
        fields=(
            TensorFieldSpec(
                name='x',
