"""Generated shader: tuple_getitem_slice_f32_530."""
...
TUPLE_GETITEM_SLICE_F32_530 = ShaderVariant(
    name='tuple_getitem_slice_f32_530',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_530',
        fields=(
            TensorFieldSpec(
                name='x',
