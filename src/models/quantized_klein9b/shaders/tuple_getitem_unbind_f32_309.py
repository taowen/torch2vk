"""Generated shader: tuple_getitem_unbind_f32_309."""
...
TUPLE_GETITEM_UNBIND_F32_309 = ShaderVariant(
    name='tuple_getitem_unbind_f32_309',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_309',
        fields=(
            TensorFieldSpec(
                name='x',
