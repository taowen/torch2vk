"""Generated shader: tuple_getitem_slice_f32_718."""
...
TUPLE_GETITEM_SLICE_F32_718 = ShaderVariant(
    name='tuple_getitem_slice_f32_718',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_718',
        fields=(
            TensorFieldSpec(
                name='x',
