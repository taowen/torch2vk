"""Generated shader: tuple_getitem_unbind_f32_344."""
...
TUPLE_GETITEM_UNBIND_F32_344 = ShaderVariant(
    name='tuple_getitem_unbind_f32_344',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_344',
        fields=(
            TensorFieldSpec(
                name='x',
