"""Generated shader: tuple_getitem_unbind_f32_1208."""
...
TUPLE_GETITEM_UNBIND_F32_1208 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1208',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1208',
        fields=(
            TensorFieldSpec(
                name='x',
