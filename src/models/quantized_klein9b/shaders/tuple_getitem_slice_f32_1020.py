"""Generated shader: tuple_getitem_slice_f32_1020."""
...
TUPLE_GETITEM_SLICE_F32_1020 = ShaderVariant(
    name='tuple_getitem_slice_f32_1020',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1020',
        fields=(
            TensorFieldSpec(
                name='x',
