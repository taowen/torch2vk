"""Generated shader: tuple_getitem_slice_f32_1042."""
...
TUPLE_GETITEM_SLICE_F32_1042 = ShaderVariant(
    name='tuple_getitem_slice_f32_1042',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1042',
        fields=(
            TensorFieldSpec(
                name='x',
