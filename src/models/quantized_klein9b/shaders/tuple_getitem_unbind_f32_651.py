"""Generated shader: tuple_getitem_unbind_f32_651."""
...
TUPLE_GETITEM_UNBIND_F32_651 = ShaderVariant(
    name='tuple_getitem_unbind_f32_651',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_651',
        fields=(
            TensorFieldSpec(
                name='x',
