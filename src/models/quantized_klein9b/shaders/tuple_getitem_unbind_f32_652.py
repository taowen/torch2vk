"""Generated shader: tuple_getitem_unbind_f32_652."""
...
TUPLE_GETITEM_UNBIND_F32_652 = ShaderVariant(
    name='tuple_getitem_unbind_f32_652',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_652',
        fields=(
            TensorFieldSpec(
                name='x',
