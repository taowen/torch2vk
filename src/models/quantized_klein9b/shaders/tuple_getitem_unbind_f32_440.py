"""Generated shader: tuple_getitem_unbind_f32_440."""
...
TUPLE_GETITEM_UNBIND_F32_440 = ShaderVariant(
    name='tuple_getitem_unbind_f32_440',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_440',
        fields=(
            TensorFieldSpec(
                name='x',
