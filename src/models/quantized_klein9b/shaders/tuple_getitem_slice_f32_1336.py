"""Generated shader: tuple_getitem_slice_f32_1336."""
...
TUPLE_GETITEM_SLICE_F32_1336 = ShaderVariant(
    name='tuple_getitem_slice_f32_1336',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1336',
        fields=(
            TensorFieldSpec(
                name='x',
