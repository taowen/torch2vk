"""Generated shader: tuple_getitem_unbind_f32_843."""
...
TUPLE_GETITEM_UNBIND_F32_843 = ShaderVariant(
    name='tuple_getitem_unbind_f32_843',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_843',
        fields=(
            TensorFieldSpec(
                name='x',
