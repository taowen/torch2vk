"""Generated shader: tuple_getitem_slice_f32_742."""
...
TUPLE_GETITEM_SLICE_F32_742 = ShaderVariant(
    name='tuple_getitem_slice_f32_742',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_742',
        fields=(
            TensorFieldSpec(
                name='x',
