"""Generated shader: flux_final_layer_slice_f32."""
...
FLUX_FINAL_LAYER_SLICE_F32 = ShaderVariant(
    name='flux_final_layer_slice_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportSliceProgram',
        shader_name='flux_final_layer_slice_f32',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('IN_STRIDE', PushConstantType.UINT32, 4, 6291456, dynamic=False),
                PushConstantFieldSpec('OUT_STRIDE', PushConstantType.UINT32, 8, 4194304, dynamic=False),
                PushConstantFieldSpec('OFFSET', PushConstantType.UINT32, 12, 2097152, dynamic=False),
            ),
        ),
        params_buffer=None,
