"""Generated shader: tuple_getitem_slice_f32_692."""
...
TUPLE_GETITEM_SLICE_F32_692 = ShaderVariant(
    name='tuple_getitem_slice_f32_692',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_692',
        fields=(
            TensorFieldSpec(
                name='x',
