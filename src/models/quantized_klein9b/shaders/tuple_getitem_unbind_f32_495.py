"""Generated shader: tuple_getitem_unbind_f32_495."""
...
TUPLE_GETITEM_UNBIND_F32_495 = ShaderVariant(
    name='tuple_getitem_unbind_f32_495',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_495',
        fields=(
            TensorFieldSpec(
                name='x',
