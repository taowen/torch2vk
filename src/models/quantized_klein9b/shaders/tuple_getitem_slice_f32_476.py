"""Generated shader: tuple_getitem_slice_f32_476."""
...
TUPLE_GETITEM_SLICE_F32_476 = ShaderVariant(
    name='tuple_getitem_slice_f32_476',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_476',
        fields=(
            TensorFieldSpec(
                name='x',
