"""Generated shader: tuple_getitem_unbind_f32_212."""
...
TUPLE_GETITEM_UNBIND_F32_212 = ShaderVariant(
    name='tuple_getitem_unbind_f32_212',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_212',
        fields=(
            TensorFieldSpec(
                name='x',
