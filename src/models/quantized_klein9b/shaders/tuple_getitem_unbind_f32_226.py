"""Generated shader: tuple_getitem_unbind_f32_226."""
...
TUPLE_GETITEM_UNBIND_F32_226 = ShaderVariant(
    name='tuple_getitem_unbind_f32_226',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_226',
        fields=(
            TensorFieldSpec(
                name='x',
