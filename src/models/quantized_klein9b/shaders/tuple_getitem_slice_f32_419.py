"""Generated shader: tuple_getitem_slice_f32_419."""
...
TUPLE_GETITEM_SLICE_F32_419 = ShaderVariant(
    name='tuple_getitem_slice_f32_419',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_419',
        fields=(
            TensorFieldSpec(
                name='x',
