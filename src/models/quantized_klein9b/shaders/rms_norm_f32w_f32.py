"""Generated shader: rms_norm_f32w_f32."""
...
RMS_NORM_F32W_F32 = ShaderVariant(
    name='rms_norm_f32w_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportRmsNormF32WeightProgram',
        shader_name='rms_norm_f32w_f32',
        fields=(
            TensorFieldSpec(
                name='x',
...
void main() {
    ...
    for (uint c = tid; c < pc.COLS; c += 256u) {
        ...
        output_values[idx] = float(x[idx]) * inv_rms * float(weight[c]);
    }
}
""",
)
