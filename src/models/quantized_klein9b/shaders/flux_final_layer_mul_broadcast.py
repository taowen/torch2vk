"""Generated shader: flux_final_layer_mul_broadcast."""
...
FLUX_FINAL_LAYER_MUL_BROADCAST = ShaderVariant(
    name='flux_final_layer_mul_broadcast',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='flux_final_layer_mul_broadcast',
        fields=(
            TensorFieldSpec(
                name='x',
