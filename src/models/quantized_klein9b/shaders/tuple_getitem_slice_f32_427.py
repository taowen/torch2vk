"""Generated shader: tuple_getitem_slice_f32_427."""
...
TUPLE_GETITEM_SLICE_F32_427 = ShaderVariant(
    name='tuple_getitem_slice_f32_427',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_427',
        fields=(
            TensorFieldSpec(
                name='x',
