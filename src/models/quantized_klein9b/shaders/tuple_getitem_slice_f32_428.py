"""Generated shader: tuple_getitem_slice_f32_428."""
...
TUPLE_GETITEM_SLICE_F32_428 = ShaderVariant(
    name='tuple_getitem_slice_f32_428',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_428',
        fields=(
            TensorFieldSpec(
                name='x',
