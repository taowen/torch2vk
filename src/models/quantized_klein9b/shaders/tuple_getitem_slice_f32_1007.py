"""Generated shader: tuple_getitem_slice_f32_1007."""
...
TUPLE_GETITEM_SLICE_F32_1007 = ShaderVariant(
    name='tuple_getitem_slice_f32_1007',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1007',
        fields=(
            TensorFieldSpec(
                name='x',
