"""Generated shader: flux_double_block_tuple_getitem_slice_f32."""
...
FLUX_DOUBLE_BLOCK_TUPLE_GETITEM_SLICE_F32 = ShaderVariant(
    name='flux_double_block_tuple_getitem_slice_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='flux_double_block_tuple_getitem_slice_f32',
        fields=(
            TensorFieldSpec(
                name='x',
