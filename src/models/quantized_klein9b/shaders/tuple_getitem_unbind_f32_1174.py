"""Generated shader: tuple_getitem_unbind_f32_1174."""
...
TUPLE_GETITEM_UNBIND_F32_1174 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1174',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1174',
        fields=(
            TensorFieldSpec(
                name='x',
