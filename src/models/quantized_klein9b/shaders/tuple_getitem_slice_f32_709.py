"""Generated shader: tuple_getitem_slice_f32_709."""
...
TUPLE_GETITEM_SLICE_F32_709 = ShaderVariant(
    name='tuple_getitem_slice_f32_709',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_709',
        fields=(
            TensorFieldSpec(
                name='x',
