"""Generated shader: flux_double_block_mul_broadcast_21."""
...
FLUX_DOUBLE_BLOCK_MUL_BROADCAST_21 = ShaderVariant(
    name='flux_double_block_mul_broadcast_21',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='flux_double_block_mul_broadcast_21',
        fields=(
            TensorFieldSpec(
                name='x',
