"""Generated shader: tuple_getitem_unbind_f32_379."""
...
TUPLE_GETITEM_UNBIND_F32_379 = ShaderVariant(
    name='tuple_getitem_unbind_f32_379',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_379',
        fields=(
            TensorFieldSpec(
                name='x',
