"""Generated shader: tuple_getitem_slice_f32_986."""
...
TUPLE_GETITEM_SLICE_F32_986 = ShaderVariant(
    name='tuple_getitem_slice_f32_986',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_986',
        fields=(
            TensorFieldSpec(
                name='x',
