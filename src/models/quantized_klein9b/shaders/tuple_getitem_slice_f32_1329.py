"""Generated shader: tuple_getitem_slice_f32_1329."""
...
TUPLE_GETITEM_SLICE_F32_1329 = ShaderVariant(
    name='tuple_getitem_slice_f32_1329',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1329',
        fields=(
            TensorFieldSpec(
                name='x',
