"""Generated shader: tuple_getitem_slice_f32_744."""
...
TUPLE_GETITEM_SLICE_F32_744 = ShaderVariant(
    name='tuple_getitem_slice_f32_744',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_744',
        fields=(
            TensorFieldSpec(
                name='x',
