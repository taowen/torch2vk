"""Generated shader: tuple_getitem_unbind_f32_387."""
...
TUPLE_GETITEM_UNBIND_F32_387 = ShaderVariant(
    name='tuple_getitem_unbind_f32_387',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_387',
        fields=(
            TensorFieldSpec(
                name='x',
