"""Generated shader: tuple_getitem_slice_f32_796."""
...
TUPLE_GETITEM_SLICE_F32_796 = ShaderVariant(
    name='tuple_getitem_slice_f32_796',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_796',
        fields=(
            TensorFieldSpec(
                name='x',
