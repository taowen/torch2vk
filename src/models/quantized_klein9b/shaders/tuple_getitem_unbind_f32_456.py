"""Generated shader: tuple_getitem_unbind_f32_456."""
...
TUPLE_GETITEM_UNBIND_F32_456 = ShaderVariant(
    name='tuple_getitem_unbind_f32_456',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_456',
        fields=(
            TensorFieldSpec(
                name='x',
