"""Generated shader: tuple_getitem_unbind_f32_247."""
...
TUPLE_GETITEM_UNBIND_F32_247 = ShaderVariant(
    name='tuple_getitem_unbind_f32_247',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_247',
        fields=(
            TensorFieldSpec(
                name='x',
