"""Generated shader: tuple_getitem_unbind_f32_657."""
...
TUPLE_GETITEM_UNBIND_F32_657 = ShaderVariant(
    name='tuple_getitem_unbind_f32_657',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_657',
        fields=(
            TensorFieldSpec(
                name='x',
