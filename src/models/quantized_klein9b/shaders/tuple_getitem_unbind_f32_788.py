"""Generated shader: tuple_getitem_unbind_f32_788."""
...
TUPLE_GETITEM_UNBIND_F32_788 = ShaderVariant(
    name='tuple_getitem_unbind_f32_788',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_788',
        fields=(
            TensorFieldSpec(
                name='x',
