"""Generated shader: tuple_getitem_slice_f32_768."""
...
TUPLE_GETITEM_SLICE_F32_768 = ShaderVariant(
    name='tuple_getitem_slice_f32_768',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_768',
        fields=(
            TensorFieldSpec(
                name='x',
