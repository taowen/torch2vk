"""Generated shader: tuple_getitem_unbind_f32_975."""
...
TUPLE_GETITEM_UNBIND_F32_975 = ShaderVariant(
    name='tuple_getitem_unbind_f32_975',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_975',
        fields=(
            TensorFieldSpec(
                name='x',
