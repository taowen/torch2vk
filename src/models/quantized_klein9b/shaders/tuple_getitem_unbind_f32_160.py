"""Generated shader: tuple_getitem_unbind_f32_160."""
...
TUPLE_GETITEM_UNBIND_F32_160 = ShaderVariant(
    name='tuple_getitem_unbind_f32_160',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_160',
        fields=(
            TensorFieldSpec(
                name='x',
