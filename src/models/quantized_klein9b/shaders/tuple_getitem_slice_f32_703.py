"""Generated shader: tuple_getitem_slice_f32_703."""
...
TUPLE_GETITEM_SLICE_F32_703 = ShaderVariant(
    name='tuple_getitem_slice_f32_703',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_703',
        fields=(
            TensorFieldSpec(
                name='x',
