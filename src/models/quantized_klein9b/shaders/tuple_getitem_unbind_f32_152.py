"""Generated shader: tuple_getitem_unbind_f32_152."""
...
TUPLE_GETITEM_UNBIND_F32_152 = ShaderVariant(
    name='tuple_getitem_unbind_f32_152',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_152',
        fields=(
            TensorFieldSpec(
                name='x',
