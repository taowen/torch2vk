"""Generated shader: tuple_getitem_unbind_f32_332."""
...
TUPLE_GETITEM_UNBIND_F32_332 = ShaderVariant(
    name='tuple_getitem_unbind_f32_332',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_332',
        fields=(
            TensorFieldSpec(
                name='x',
