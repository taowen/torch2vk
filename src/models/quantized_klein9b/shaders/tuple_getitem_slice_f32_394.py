"""Generated shader: tuple_getitem_slice_f32_394."""
...
TUPLE_GETITEM_SLICE_F32_394 = ShaderVariant(
    name='tuple_getitem_slice_f32_394',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_394',
        fields=(
            TensorFieldSpec(
                name='x',
