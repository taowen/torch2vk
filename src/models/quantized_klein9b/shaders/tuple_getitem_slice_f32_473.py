"""Generated shader: tuple_getitem_slice_f32_473."""
...
TUPLE_GETITEM_SLICE_F32_473 = ShaderVariant(
    name='tuple_getitem_slice_f32_473',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_473',
        fields=(
            TensorFieldSpec(
                name='x',
