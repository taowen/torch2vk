"""Generated shader: tuple_getitem_slice_f32_942."""
...
TUPLE_GETITEM_SLICE_F32_942 = ShaderVariant(
    name='tuple_getitem_slice_f32_942',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_942',
        fields=(
            TensorFieldSpec(
                name='x',
