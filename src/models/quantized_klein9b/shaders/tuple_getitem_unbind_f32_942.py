"""Generated shader: tuple_getitem_unbind_f32_942."""
...
TUPLE_GETITEM_UNBIND_F32_942 = ShaderVariant(
    name='tuple_getitem_unbind_f32_942',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_942',
        fields=(
            TensorFieldSpec(
                name='x',
