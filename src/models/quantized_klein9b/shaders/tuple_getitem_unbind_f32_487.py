"""Generated shader: tuple_getitem_unbind_f32_487."""
...
TUPLE_GETITEM_UNBIND_F32_487 = ShaderVariant(
    name='tuple_getitem_unbind_f32_487',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_487',
        fields=(
            TensorFieldSpec(
                name='x',
