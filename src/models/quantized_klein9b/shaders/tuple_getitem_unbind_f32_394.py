"""Generated shader: tuple_getitem_unbind_f32_394."""
...
TUPLE_GETITEM_UNBIND_F32_394 = ShaderVariant(
    name='tuple_getitem_unbind_f32_394',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_394',
        fields=(
            TensorFieldSpec(
                name='x',
