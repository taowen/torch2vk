"""Generated shader: tuple_getitem_unbind_f32_1212."""
...
TUPLE_GETITEM_UNBIND_F32_1212 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1212',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1212',
        fields=(
            TensorFieldSpec(
                name='x',
