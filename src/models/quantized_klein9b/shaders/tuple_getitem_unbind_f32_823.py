"""Generated shader: tuple_getitem_unbind_f32_823."""
...
TUPLE_GETITEM_UNBIND_F32_823 = ShaderVariant(
    name='tuple_getitem_unbind_f32_823',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_823',
        fields=(
            TensorFieldSpec(
                name='x',
