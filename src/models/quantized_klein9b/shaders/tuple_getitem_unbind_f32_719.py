"""Generated shader: tuple_getitem_unbind_f32_719."""
...
TUPLE_GETITEM_UNBIND_F32_719 = ShaderVariant(
    name='tuple_getitem_unbind_f32_719',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_719',
        fields=(
            TensorFieldSpec(
                name='x',
