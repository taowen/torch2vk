"""Generated shader: tuple_getitem_slice_f32_194."""
...
TUPLE_GETITEM_SLICE_F32_194 = ShaderVariant(
    name='tuple_getitem_slice_f32_194',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_194',
        fields=(
            TensorFieldSpec(
                name='x',
