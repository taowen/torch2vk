"""Generated shader: tuple_getitem_unbind_f32_904."""
...
TUPLE_GETITEM_UNBIND_F32_904 = ShaderVariant(
    name='tuple_getitem_unbind_f32_904',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_904',
        fields=(
            TensorFieldSpec(
                name='x',
