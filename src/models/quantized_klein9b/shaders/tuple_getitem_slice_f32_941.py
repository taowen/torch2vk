"""Generated shader: tuple_getitem_slice_f32_941."""
...
TUPLE_GETITEM_SLICE_F32_941 = ShaderVariant(
    name='tuple_getitem_slice_f32_941',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_941',
        fields=(
            TensorFieldSpec(
                name='x',
