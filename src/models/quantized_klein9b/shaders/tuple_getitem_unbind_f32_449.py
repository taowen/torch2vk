"""Generated shader: tuple_getitem_unbind_f32_449."""
...
TUPLE_GETITEM_UNBIND_F32_449 = ShaderVariant(
    name='tuple_getitem_unbind_f32_449',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_449',
        fields=(
            TensorFieldSpec(
                name='x',
