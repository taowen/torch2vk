"""Generated shader: tuple_getitem_unbind_f32_1074."""
...
TUPLE_GETITEM_UNBIND_F32_1074 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1074',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1074',
        fields=(
            TensorFieldSpec(
                name='x',
