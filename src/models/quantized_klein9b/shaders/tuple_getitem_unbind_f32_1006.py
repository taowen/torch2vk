"""Generated shader: tuple_getitem_unbind_f32_1006."""
...
TUPLE_GETITEM_UNBIND_F32_1006 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1006',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1006',
        fields=(
            TensorFieldSpec(
                name='x',
