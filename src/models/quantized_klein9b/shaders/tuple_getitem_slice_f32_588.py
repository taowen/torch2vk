"""Generated shader: tuple_getitem_slice_f32_588."""
...
TUPLE_GETITEM_SLICE_F32_588 = ShaderVariant(
    name='tuple_getitem_slice_f32_588',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_588',
        fields=(
            TensorFieldSpec(
                name='x',
