"""Generated shader: flux_final_layer_tuple_getitem_slice_f32."""
...
FLUX_FINAL_LAYER_TUPLE_GETITEM_SLICE_F32 = ShaderVariant(
    name='flux_final_layer_tuple_getitem_slice_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='flux_final_layer_tuple_getitem_slice_f32',
        fields=(
            TensorFieldSpec(
                name='x',
