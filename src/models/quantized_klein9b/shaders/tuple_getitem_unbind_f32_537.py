"""Generated shader: tuple_getitem_unbind_f32_537."""
...
TUPLE_GETITEM_UNBIND_F32_537 = ShaderVariant(
    name='tuple_getitem_unbind_f32_537',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_537',
        fields=(
            TensorFieldSpec(
                name='x',
