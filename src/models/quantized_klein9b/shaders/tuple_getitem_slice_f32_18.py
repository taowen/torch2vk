"""Generated shader: tuple_getitem_slice_f32_18."""
...
TUPLE_GETITEM_SLICE_F32_18 = ShaderVariant(
    name='tuple_getitem_slice_f32_18',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_18',
        fields=(
            TensorFieldSpec(
                name='x',
