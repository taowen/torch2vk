"""Generated shader: tuple_getitem_slice_f32_1264."""
...
TUPLE_GETITEM_SLICE_F32_1264 = ShaderVariant(
    name='tuple_getitem_slice_f32_1264',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1264',
        fields=(
            TensorFieldSpec(
                name='x',
