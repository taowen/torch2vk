"""Generated shader: flux_single_block_tuple_getitem_slice_f32."""
...
FLUX_SINGLE_BLOCK_TUPLE_GETITEM_SLICE_F32 = ShaderVariant(
    name='flux_single_block_tuple_getitem_slice_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='flux_single_block_tuple_getitem_slice_f32',
        fields=(
            TensorFieldSpec(
                name='x',
