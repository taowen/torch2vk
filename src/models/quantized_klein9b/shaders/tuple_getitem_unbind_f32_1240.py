"""Generated shader: tuple_getitem_unbind_f32_1240."""
...
TUPLE_GETITEM_UNBIND_F32_1240 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1240',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1240',
        fields=(
            TensorFieldSpec(
                name='x',
