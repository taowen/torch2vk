"""Generated shader: tuple_getitem_slice_f32_1046."""
...
TUPLE_GETITEM_SLICE_F32_1046 = ShaderVariant(
    name='tuple_getitem_slice_f32_1046',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1046',
        fields=(
            TensorFieldSpec(
                name='x',
