"""Generated shader: tuple_getitem_unbind_f32_18."""
...
TUPLE_GETITEM_UNBIND_F32_18 = ShaderVariant(
    name='tuple_getitem_unbind_f32_18',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_18',
        fields=(
            TensorFieldSpec(
                name='x',
