"""Generated shader: tuple_getitem_unbind_f32_707."""
...
TUPLE_GETITEM_UNBIND_F32_707 = ShaderVariant(
    name='tuple_getitem_unbind_f32_707',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_707',
        fields=(
            TensorFieldSpec(
                name='x',
