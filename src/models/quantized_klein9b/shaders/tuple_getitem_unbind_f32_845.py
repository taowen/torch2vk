"""Generated shader: tuple_getitem_unbind_f32_845."""
...
TUPLE_GETITEM_UNBIND_F32_845 = ShaderVariant(
    name='tuple_getitem_unbind_f32_845',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_845',
        fields=(
            TensorFieldSpec(
                name='x',
