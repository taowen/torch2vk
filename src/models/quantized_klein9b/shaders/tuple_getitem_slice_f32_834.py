"""Generated shader: tuple_getitem_slice_f32_834."""
...
TUPLE_GETITEM_SLICE_F32_834 = ShaderVariant(
    name='tuple_getitem_slice_f32_834',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_834',
        fields=(
            TensorFieldSpec(
                name='x',
