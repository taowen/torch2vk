"""Generated shader: tuple_getitem_slice_f32_311."""
...
TUPLE_GETITEM_SLICE_F32_311 = ShaderVariant(
    name='tuple_getitem_slice_f32_311',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_311',
        fields=(
            TensorFieldSpec(
                name='x',
