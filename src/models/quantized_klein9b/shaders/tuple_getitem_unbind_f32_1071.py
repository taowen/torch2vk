"""Generated shader: tuple_getitem_unbind_f32_1071."""
...
TUPLE_GETITEM_UNBIND_F32_1071 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1071',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1071',
        fields=(
            TensorFieldSpec(
                name='x',
