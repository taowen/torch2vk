"""Generated shader: flux_single_block_slice_f32."""
...
FLUX_SINGLE_BLOCK_SLICE_F32 = ShaderVariant(
    name='flux_single_block_slice_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportSliceProgram',
        shader_name='flux_single_block_slice_f32',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('OUT_STRIDE', PushConstantType.UINT32, 8, 0, dynamic=False),
