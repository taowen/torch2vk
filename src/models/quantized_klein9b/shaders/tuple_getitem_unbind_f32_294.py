"""Generated shader: tuple_getitem_unbind_f32_294."""
...
TUPLE_GETITEM_UNBIND_F32_294 = ShaderVariant(
    name='tuple_getitem_unbind_f32_294',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_294',
        fields=(
            TensorFieldSpec(
                name='x',
