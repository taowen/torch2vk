"""Generated shader: tuple_getitem_slice_f32_51."""
...
TUPLE_GETITEM_SLICE_F32_51 = ShaderVariant(
    name='tuple_getitem_slice_f32_51',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_51',
        fields=(
            TensorFieldSpec(
                name='x',
