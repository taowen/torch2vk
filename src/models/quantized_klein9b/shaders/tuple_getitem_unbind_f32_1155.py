"""Generated shader: tuple_getitem_unbind_f32_1155."""
...
TUPLE_GETITEM_UNBIND_F32_1155 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1155',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1155',
        fields=(
            TensorFieldSpec(
                name='x',
