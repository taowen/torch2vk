"""Generated shader: tuple_getitem_slice_f32_988."""
...
TUPLE_GETITEM_SLICE_F32_988 = ShaderVariant(
    name='tuple_getitem_slice_f32_988',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_988',
        fields=(
            TensorFieldSpec(
                name='x',
