"""Generated shader: tuple_getitem_unbind_f32_260."""
...
TUPLE_GETITEM_UNBIND_F32_260 = ShaderVariant(
    name='tuple_getitem_unbind_f32_260',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_260',
        fields=(
            TensorFieldSpec(
                name='x',
