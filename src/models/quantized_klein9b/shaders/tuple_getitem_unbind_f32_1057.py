"""Generated shader: tuple_getitem_unbind_f32_1057."""
...
TUPLE_GETITEM_UNBIND_F32_1057 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1057',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1057',
        fields=(
            TensorFieldSpec(
                name='x',
