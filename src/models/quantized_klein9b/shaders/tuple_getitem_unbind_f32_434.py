"""Generated shader: tuple_getitem_unbind_f32_434."""
...
TUPLE_GETITEM_UNBIND_F32_434 = ShaderVariant(
    name='tuple_getitem_unbind_f32_434',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_434',
        fields=(
            TensorFieldSpec(
                name='x',
