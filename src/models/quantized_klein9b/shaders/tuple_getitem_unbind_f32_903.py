"""Generated shader: tuple_getitem_unbind_f32_903."""
...
TUPLE_GETITEM_UNBIND_F32_903 = ShaderVariant(
    name='tuple_getitem_unbind_f32_903',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_903',
        fields=(
            TensorFieldSpec(
                name='x',
