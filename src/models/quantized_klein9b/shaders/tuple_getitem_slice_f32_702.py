"""Generated shader: tuple_getitem_slice_f32_702."""
...
TUPLE_GETITEM_SLICE_F32_702 = ShaderVariant(
    name='tuple_getitem_slice_f32_702',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_702',
        fields=(
            TensorFieldSpec(
                name='x',
