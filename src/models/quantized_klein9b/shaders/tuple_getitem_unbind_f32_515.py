"""Generated shader: tuple_getitem_unbind_f32_515."""
...
TUPLE_GETITEM_UNBIND_F32_515 = ShaderVariant(
    name='tuple_getitem_unbind_f32_515',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_515',
        fields=(
            TensorFieldSpec(
                name='x',
