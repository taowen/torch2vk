"""Generated shader: tuple_getitem_slice_f32_570."""
...
TUPLE_GETITEM_SLICE_F32_570 = ShaderVariant(
    name='tuple_getitem_slice_f32_570',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_570',
        fields=(
            TensorFieldSpec(
                name='x',
