"""Generated shader: tuple_getitem_slice_f32_710."""
...
TUPLE_GETITEM_SLICE_F32_710 = ShaderVariant(
    name='tuple_getitem_slice_f32_710',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_710',
        fields=(
            TensorFieldSpec(
                name='x',
