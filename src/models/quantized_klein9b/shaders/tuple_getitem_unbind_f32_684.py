"""Generated shader: tuple_getitem_unbind_f32_684."""
...
TUPLE_GETITEM_UNBIND_F32_684 = ShaderVariant(
    name='tuple_getitem_unbind_f32_684',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_684',
        fields=(
            TensorFieldSpec(
                name='x',
