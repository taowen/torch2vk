"""Generated shader: tuple_getitem_unbind_f32_1109."""
...
TUPLE_GETITEM_UNBIND_F32_1109 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1109',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1109',
        fields=(
            TensorFieldSpec(
                name='x',
