"""Generated shader: tuple_getitem_slice_f32_1102."""
...
TUPLE_GETITEM_SLICE_F32_1102 = ShaderVariant(
    name='tuple_getitem_slice_f32_1102',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1102',
        fields=(
            TensorFieldSpec(
                name='x',
