"""Generated shader: tuple_getitem_unbind_f32_94."""
...
TUPLE_GETITEM_UNBIND_F32_94 = ShaderVariant(
    name='tuple_getitem_unbind_f32_94',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_94',
        fields=(
            TensorFieldSpec(
                name='x',
