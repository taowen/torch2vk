"""Generated shader: tuple_getitem_unbind_f32_326."""
...
TUPLE_GETITEM_UNBIND_F32_326 = ShaderVariant(
    name='tuple_getitem_unbind_f32_326',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_326',
        fields=(
            TensorFieldSpec(
                name='x',
