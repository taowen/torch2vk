"""Generated shader: tuple_getitem_unbind_f32_1015."""
...
TUPLE_GETITEM_UNBIND_F32_1015 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1015',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1015',
        fields=(
            TensorFieldSpec(
                name='x',
