"""Generated shader: slice_f32_414."""
...
SLICE_F32_414 = ShaderVariant(
    name='slice_f32_414',
    family='export',
    contract=ShaderContract(
        class_name='ExportSliceProgram',
        shader_name='slice_f32_414',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('OUT_STRIDE', PushConstantType.UINT32, 8, 2097152, dynamic=False),
