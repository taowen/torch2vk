"""Generated shader: tuple_getitem_slice_f32_650."""
...
TUPLE_GETITEM_SLICE_F32_650 = ShaderVariant(
    name='tuple_getitem_slice_f32_650',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_650',
        fields=(
            TensorFieldSpec(
                name='x',
