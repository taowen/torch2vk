"""Generated shader: tuple_getitem_slice_f32_634."""
...
TUPLE_GETITEM_SLICE_F32_634 = ShaderVariant(
    name='tuple_getitem_slice_f32_634',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_634',
        fields=(
            TensorFieldSpec(
                name='x',
