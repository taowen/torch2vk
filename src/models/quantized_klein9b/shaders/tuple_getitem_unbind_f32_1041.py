"""Generated shader: tuple_getitem_unbind_f32_1041."""
...
TUPLE_GETITEM_UNBIND_F32_1041 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1041',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1041',
        fields=(
            TensorFieldSpec(
                name='x',
