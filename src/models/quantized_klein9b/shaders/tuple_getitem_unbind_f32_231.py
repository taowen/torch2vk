"""Generated shader: tuple_getitem_unbind_f32_231."""
...
TUPLE_GETITEM_UNBIND_F32_231 = ShaderVariant(
    name='tuple_getitem_unbind_f32_231',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_231',
        fields=(
            TensorFieldSpec(
                name='x',
