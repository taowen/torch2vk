"""Generated shader: tuple_getitem_unbind_f32_1075."""
...
TUPLE_GETITEM_UNBIND_F32_1075 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1075',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1075',
        fields=(
            TensorFieldSpec(
                name='x',
