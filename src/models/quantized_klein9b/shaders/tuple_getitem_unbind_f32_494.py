"""Generated shader: tuple_getitem_unbind_f32_494."""
...
TUPLE_GETITEM_UNBIND_F32_494 = ShaderVariant(
    name='tuple_getitem_unbind_f32_494',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_494',
        fields=(
            TensorFieldSpec(
                name='x',
