"""Generated shader: tuple_getitem_slice_f32_922."""
...
TUPLE_GETITEM_SLICE_F32_922 = ShaderVariant(
    name='tuple_getitem_slice_f32_922',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_922',
        fields=(
            TensorFieldSpec(
                name='x',
