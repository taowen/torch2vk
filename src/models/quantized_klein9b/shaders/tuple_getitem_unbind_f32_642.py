"""Generated shader: tuple_getitem_unbind_f32_642."""
...
TUPLE_GETITEM_UNBIND_F32_642 = ShaderVariant(
    name='tuple_getitem_unbind_f32_642',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_642',
        fields=(
            TensorFieldSpec(
                name='x',
