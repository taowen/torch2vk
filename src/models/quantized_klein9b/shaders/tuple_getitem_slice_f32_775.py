"""Generated shader: tuple_getitem_slice_f32_775."""
...
TUPLE_GETITEM_SLICE_F32_775 = ShaderVariant(
    name='tuple_getitem_slice_f32_775',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_775',
        fields=(
            TensorFieldSpec(
                name='x',
