"""Generated shader: tuple_getitem_unbind_f32_546."""
...
TUPLE_GETITEM_UNBIND_F32_546 = ShaderVariant(
    name='tuple_getitem_unbind_f32_546',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_546',
        fields=(
            TensorFieldSpec(
                name='x',
