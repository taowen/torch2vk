"""Generated shader: tuple_getitem_slice_f32_864."""
...
TUPLE_GETITEM_SLICE_F32_864 = ShaderVariant(
    name='tuple_getitem_slice_f32_864',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_864',
        fields=(
            TensorFieldSpec(
                name='x',
