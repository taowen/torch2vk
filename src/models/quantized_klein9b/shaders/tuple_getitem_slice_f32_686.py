"""Generated shader: tuple_getitem_slice_f32_686."""
...
TUPLE_GETITEM_SLICE_F32_686 = ShaderVariant(
    name='tuple_getitem_slice_f32_686',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_686',
        fields=(
            TensorFieldSpec(
                name='x',
