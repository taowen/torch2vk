"""Generated shader: tuple_getitem_slice_f32_234."""
...
TUPLE_GETITEM_SLICE_F32_234 = ShaderVariant(
    name='tuple_getitem_slice_f32_234',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_234',
        fields=(
            TensorFieldSpec(
                name='x',
