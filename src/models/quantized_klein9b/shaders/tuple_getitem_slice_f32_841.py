"""Generated shader: tuple_getitem_slice_f32_841."""
...
TUPLE_GETITEM_SLICE_F32_841 = ShaderVariant(
    name='tuple_getitem_slice_f32_841',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_841',
        fields=(
            TensorFieldSpec(
                name='x',
