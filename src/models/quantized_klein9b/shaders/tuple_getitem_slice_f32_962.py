"""Generated shader: tuple_getitem_slice_f32_962."""
...
TUPLE_GETITEM_SLICE_F32_962 = ShaderVariant(
    name='tuple_getitem_slice_f32_962',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_962',
        fields=(
            TensorFieldSpec(
                name='x',
