"""Generated shader: tuple_getitem_unbind_f32_1305."""
...
TUPLE_GETITEM_UNBIND_F32_1305 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1305',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1305',
        fields=(
            TensorFieldSpec(
                name='x',
