"""Generated shader: tuple_getitem_unbind_f32_736."""
...
TUPLE_GETITEM_UNBIND_F32_736 = ShaderVariant(
    name='tuple_getitem_unbind_f32_736',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_736',
        fields=(
            TensorFieldSpec(
                name='x',
