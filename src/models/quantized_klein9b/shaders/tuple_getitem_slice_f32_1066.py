"""Generated shader: tuple_getitem_slice_f32_1066."""
...
TUPLE_GETITEM_SLICE_F32_1066 = ShaderVariant(
    name='tuple_getitem_slice_f32_1066',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1066',
        fields=(
            TensorFieldSpec(
                name='x',
