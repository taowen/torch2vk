"""Generated shader: tuple_getitem_unbind_f32_810."""
...
TUPLE_GETITEM_UNBIND_F32_810 = ShaderVariant(
    name='tuple_getitem_unbind_f32_810',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_810',
        fields=(
            TensorFieldSpec(
                name='x',
