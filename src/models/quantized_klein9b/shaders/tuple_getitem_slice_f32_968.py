"""Generated shader: tuple_getitem_slice_f32_968."""
...
TUPLE_GETITEM_SLICE_F32_968 = ShaderVariant(
    name='tuple_getitem_slice_f32_968',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_968',
        fields=(
            TensorFieldSpec(
                name='x',
