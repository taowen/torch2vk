"""Generated shader: tuple_getitem_unbind_f32_230."""
...
TUPLE_GETITEM_UNBIND_F32_230 = ShaderVariant(
    name='tuple_getitem_unbind_f32_230',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_230',
        fields=(
            TensorFieldSpec(
                name='x',
