"""Generated shader: tuple_getitem_slice_f32_16."""
...
TUPLE_GETITEM_SLICE_F32_16 = ShaderVariant(
    name='tuple_getitem_slice_f32_16',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_16',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('OFFSET', PushConstantType.UINT32, 12, 16384, dynamic=False),
            ),
        ),
        params_buffer=None,
