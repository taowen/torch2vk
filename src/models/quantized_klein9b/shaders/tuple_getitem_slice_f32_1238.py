"""Generated shader: tuple_getitem_slice_f32_1238."""
...
TUPLE_GETITEM_SLICE_F32_1238 = ShaderVariant(
    name='tuple_getitem_slice_f32_1238',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1238',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('IN_STRIDE', PushConstantType.UINT32, 4, mul('I1', 1), dynamic=False),
                PushConstantFieldSpec('OUT_STRIDE', PushConstantType.UINT32, 8, mul('O1', 1), dynamic=False),
                PushConstantFieldSpec('OFFSET', PushConstantType.UINT32, 12, mul(4096, 1), dynamic=False),
            ),
        ),
        params_buffer=None,
