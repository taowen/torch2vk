"""Generated shader: tuple_getitem_unbind_f32_746."""
...
TUPLE_GETITEM_UNBIND_F32_746 = ShaderVariant(
    name='tuple_getitem_unbind_f32_746',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_746',
        fields=(
            TensorFieldSpec(
                name='x',
