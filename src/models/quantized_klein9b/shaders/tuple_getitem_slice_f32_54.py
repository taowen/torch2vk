"""Generated shader: tuple_getitem_slice_f32_54."""
...
TUPLE_GETITEM_SLICE_F32_54 = ShaderVariant(
    name='tuple_getitem_slice_f32_54',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_54',
        fields=(
            TensorFieldSpec(
                name='x',
