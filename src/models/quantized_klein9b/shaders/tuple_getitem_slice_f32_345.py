"""Generated shader: tuple_getitem_slice_f32_345."""
...
TUPLE_GETITEM_SLICE_F32_345 = ShaderVariant(
    name='tuple_getitem_slice_f32_345',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_345',
        fields=(
            TensorFieldSpec(
                name='x',
