"""Generated shader: tuple_getitem_unbind_f32_12."""
...
TUPLE_GETITEM_UNBIND_F32_12 = ShaderVariant(
    name='tuple_getitem_unbind_f32_12',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_12',
        fields=(
            TensorFieldSpec(
                name='x',
