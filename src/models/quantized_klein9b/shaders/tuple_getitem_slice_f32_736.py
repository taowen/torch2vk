"""Generated shader: tuple_getitem_slice_f32_736."""
...
TUPLE_GETITEM_SLICE_F32_736 = ShaderVariant(
    name='tuple_getitem_slice_f32_736',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_736',
        fields=(
            TensorFieldSpec(
                name='x',
