"""Generated shader: tuple_getitem_slice_f32_1164."""
...
TUPLE_GETITEM_SLICE_F32_1164 = ShaderVariant(
    name='tuple_getitem_slice_f32_1164',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1164',
        fields=(
            TensorFieldSpec(
                name='x',
