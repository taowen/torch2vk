"""Generated shader: tuple_getitem_slice_f32_1174."""
...
TUPLE_GETITEM_SLICE_F32_1174 = ShaderVariant(
    name='tuple_getitem_slice_f32_1174',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1174',
        fields=(
            TensorFieldSpec(
                name='x',
