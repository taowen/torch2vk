"""Generated shader: tuple_getitem_slice_f32_908."""
...
TUPLE_GETITEM_SLICE_F32_908 = ShaderVariant(
    name='tuple_getitem_slice_f32_908',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_908',
        fields=(
            TensorFieldSpec(
                name='x',
