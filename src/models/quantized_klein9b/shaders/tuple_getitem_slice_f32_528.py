"""Generated shader: tuple_getitem_slice_f32_528."""
...
TUPLE_GETITEM_SLICE_F32_528 = ShaderVariant(
    name='tuple_getitem_slice_f32_528',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_528',
        fields=(
            TensorFieldSpec(
                name='x',
