"""Generated shader: tuple_getitem_unbind_f32_712."""
...
TUPLE_GETITEM_UNBIND_F32_712 = ShaderVariant(
    name='tuple_getitem_unbind_f32_712',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_712',
        fields=(
            TensorFieldSpec(
                name='x',
