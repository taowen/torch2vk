"""Generated shader: tuple_getitem_slice_f32_698."""
...
TUPLE_GETITEM_SLICE_F32_698 = ShaderVariant(
    name='tuple_getitem_slice_f32_698',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_698',
        fields=(
            TensorFieldSpec(
                name='x',
