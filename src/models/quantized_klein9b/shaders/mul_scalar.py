    ...
    contract=ShaderContract(
        ...
        fields=(
            TensorFieldSpec(
                ...
                role='input',
                contract=TensorContract(dtype='float16', shape=(1,)),
            ),
            TensorFieldSpec(
                name='output',
        ...
        push_constants=PushConstantSpec(
            size=8,
            fields=(
                PushConstantFieldSpec('N', PushConstantType.UINT32, 0, 1, dynamic=False),
                PushConstantFieldSpec('scalar', PushConstantType.FLOAT32, 4, 1000.0, dynamic=False),
            ),
        ),
        params_buffer=None,
        dispatch=(ceil_div(1, 256), 1, 1),
    ),
