"""Generated shader: tuple_getitem_slice_f32_603."""
...
TUPLE_GETITEM_SLICE_F32_603 = ShaderVariant(
    name='tuple_getitem_slice_f32_603',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_603',
        fields=(
            TensorFieldSpec(
                name='x',
