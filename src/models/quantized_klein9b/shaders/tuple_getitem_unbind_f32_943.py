"""Generated shader: tuple_getitem_unbind_f32_943."""
...
TUPLE_GETITEM_UNBIND_F32_943 = ShaderVariant(
    name='tuple_getitem_unbind_f32_943',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_943',
        fields=(
            TensorFieldSpec(
                name='x',
