"""Generated shader: tuple_getitem_slice_f32_967."""
...
TUPLE_GETITEM_SLICE_F32_967 = ShaderVariant(
    name='tuple_getitem_slice_f32_967',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_967',
        fields=(
            TensorFieldSpec(
                name='x',
