"""Generated shader: tuple_getitem_slice_f32_867."""
...
TUPLE_GETITEM_SLICE_F32_867 = ShaderVariant(
    name='tuple_getitem_slice_f32_867',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_867',
        fields=(
            TensorFieldSpec(
                name='x',
