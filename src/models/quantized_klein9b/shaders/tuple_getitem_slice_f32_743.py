"""Generated shader: tuple_getitem_slice_f32_743."""
...
TUPLE_GETITEM_SLICE_F32_743 = ShaderVariant(
    name='tuple_getitem_slice_f32_743',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_743',
        fields=(
            TensorFieldSpec(
                name='x',
