"""Generated shader: tuple_getitem_slice_f32_907."""
...
TUPLE_GETITEM_SLICE_F32_907 = ShaderVariant(
    name='tuple_getitem_slice_f32_907',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_907',
        fields=(
            TensorFieldSpec(
                name='x',
