"""Generated shader: tuple_getitem_slice_f32_1032."""
...
TUPLE_GETITEM_SLICE_F32_1032 = ShaderVariant(
    name='tuple_getitem_slice_f32_1032',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1032',
        fields=(
            TensorFieldSpec(
                name='x',
