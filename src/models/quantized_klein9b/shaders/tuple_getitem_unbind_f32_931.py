"""Generated shader: tuple_getitem_unbind_f32_931."""
...
TUPLE_GETITEM_UNBIND_F32_931 = ShaderVariant(
    name='tuple_getitem_unbind_f32_931',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_931',
        fields=(
            TensorFieldSpec(
                name='x',
