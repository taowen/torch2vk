"""Generated shader: tuple_getitem_slice_f32_1030."""
...
TUPLE_GETITEM_SLICE_F32_1030 = ShaderVariant(
    name='tuple_getitem_slice_f32_1030',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1030',
        fields=(
            TensorFieldSpec(
                name='x',
