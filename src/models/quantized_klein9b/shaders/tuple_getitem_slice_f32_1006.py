"""Generated shader: tuple_getitem_slice_f32_1006."""
...
TUPLE_GETITEM_SLICE_F32_1006 = ShaderVariant(
    name='tuple_getitem_slice_f32_1006',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1006',
        fields=(
            TensorFieldSpec(
                name='x',
