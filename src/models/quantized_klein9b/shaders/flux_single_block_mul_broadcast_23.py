"""Generated shader: flux_single_block_mul_broadcast_23."""
...
FLUX_SINGLE_BLOCK_MUL_BROADCAST_23 = ShaderVariant(
    name='flux_single_block_mul_broadcast_23',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='flux_single_block_mul_broadcast_23',
        fields=(
            TensorFieldSpec(
                name='x',
