"""Generated shader: tuple_getitem_unbind_f32_7."""
...
TUPLE_GETITEM_UNBIND_F32_7 = ShaderVariant(
    name='tuple_getitem_unbind_f32_7',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_7',
        fields=(
            TensorFieldSpec(
                name='x',
