"""Generated shader: tuple_getitem_unbind_f32_1083."""
...
TUPLE_GETITEM_UNBIND_F32_1083 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1083',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1083',
        fields=(
            TensorFieldSpec(
                name='x',
