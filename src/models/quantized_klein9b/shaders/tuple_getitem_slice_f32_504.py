"""Generated shader: tuple_getitem_slice_f32_504."""
...
TUPLE_GETITEM_SLICE_F32_504 = ShaderVariant(
    name='tuple_getitem_slice_f32_504',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_504',
        fields=(
            TensorFieldSpec(
                name='x',
