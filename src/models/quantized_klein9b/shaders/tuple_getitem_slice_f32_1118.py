"""Generated shader: tuple_getitem_slice_f32_1118."""
...
TUPLE_GETITEM_SLICE_F32_1118 = ShaderVariant(
    name='tuple_getitem_slice_f32_1118',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1118',
        fields=(
            TensorFieldSpec(
                name='x',
