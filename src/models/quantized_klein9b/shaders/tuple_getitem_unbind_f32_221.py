"""Generated shader: tuple_getitem_unbind_f32_221."""
...
TUPLE_GETITEM_UNBIND_F32_221 = ShaderVariant(
    name='tuple_getitem_unbind_f32_221',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_221',
        fields=(
            TensorFieldSpec(
                name='x',
