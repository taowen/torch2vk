"""Generated shader: tuple_getitem_slice_f32_1072."""
...
TUPLE_GETITEM_SLICE_F32_1072 = ShaderVariant(
    name='tuple_getitem_slice_f32_1072',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1072',
        fields=(
            TensorFieldSpec(
                name='x',
