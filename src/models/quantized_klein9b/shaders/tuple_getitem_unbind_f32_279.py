"""Generated shader: tuple_getitem_unbind_f32_279."""
...
TUPLE_GETITEM_UNBIND_F32_279 = ShaderVariant(
    name='tuple_getitem_unbind_f32_279',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_279',
        fields=(
            TensorFieldSpec(
                name='x',
