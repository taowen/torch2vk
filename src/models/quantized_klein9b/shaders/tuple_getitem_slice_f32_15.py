"""Generated shader: tuple_getitem_slice_f32_15."""
...
TUPLE_GETITEM_SLICE_F32_15 = ShaderVariant(
    name='tuple_getitem_slice_f32_15',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_15',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('OFFSET', PushConstantType.UINT32, 12, mul(16384, 1), dynamic=False),
            ),
        ),
        params_buffer=None,
