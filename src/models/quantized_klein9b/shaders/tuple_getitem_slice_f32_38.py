"""Generated shader: tuple_getitem_slice_f32_38."""
...
TUPLE_GETITEM_SLICE_F32_38 = ShaderVariant(
    name='tuple_getitem_slice_f32_38',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_38',
        fields=(
            TensorFieldSpec(
                name='x',
