"""Generated shader: tuple_getitem_slice_f32_157."""
...
TUPLE_GETITEM_SLICE_F32_157 = ShaderVariant(
    name='tuple_getitem_slice_f32_157',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_157',
        fields=(
            TensorFieldSpec(
                name='x',
