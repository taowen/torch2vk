"""Generated shader: tuple_getitem_slice_f32_1108."""
...
TUPLE_GETITEM_SLICE_F32_1108 = ShaderVariant(
    name='tuple_getitem_slice_f32_1108',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1108',
        fields=(
            TensorFieldSpec(
                name='x',
