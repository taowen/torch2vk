"""Generated shader: tuple_getitem_unbind_f32_302."""
...
TUPLE_GETITEM_UNBIND_F32_302 = ShaderVariant(
    name='tuple_getitem_unbind_f32_302',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_302',
        fields=(
            TensorFieldSpec(
                name='x',
