"""Generated shader: tuple_getitem_unbind_f32_1031."""
...
TUPLE_GETITEM_UNBIND_F32_1031 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1031',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1031',
        fields=(
            TensorFieldSpec(
                name='x',
