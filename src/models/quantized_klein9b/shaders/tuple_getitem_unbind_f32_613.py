"""Generated shader: tuple_getitem_unbind_f32_613."""
...
TUPLE_GETITEM_UNBIND_F32_613 = ShaderVariant(
    name='tuple_getitem_unbind_f32_613',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_613',
        fields=(
            TensorFieldSpec(
                name='x',
