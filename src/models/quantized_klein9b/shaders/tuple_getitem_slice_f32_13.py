"""Generated shader: tuple_getitem_slice_f32_13."""
...
TUPLE_GETITEM_SLICE_F32_13 = ShaderVariant(
    name='tuple_getitem_slice_f32_13',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_13',
        fields=(
            TensorFieldSpec(
                name='x',
