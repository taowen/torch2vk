"""Generated shader: mul_right_broadcast."""
...
MUL_RIGHT_BROADCAST = ShaderVariant(
    ...
    contract=ShaderContract(
        ...
        fields=(
            ...
            TensorFieldSpec(
                ...
                io_kind=IOKind.INPUT,
                role='input',
                contract=TensorContract(dtype='float16', shape=('D',)),
            ),
            TensorFieldSpec(
                name='output',
...
void main() {
    ...
    if (idx < pc.N) { output_values[idx] = float(x[idx]) * float(y[idx % pc.H]); }
}
""",
)
