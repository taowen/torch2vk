"""Generated shader: tuple_getitem_unbind_f32_333."""
...
TUPLE_GETITEM_UNBIND_F32_333 = ShaderVariant(
    name='tuple_getitem_unbind_f32_333',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_333',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('INNER', PushConstantType.UINT32, 8, 2097152, dynamic=False),
