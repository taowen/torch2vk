"""Generated shader: flux_single_block_slice_f32_39."""
...
FLUX_SINGLE_BLOCK_SLICE_F32_39 = ShaderVariant(
    name='flux_single_block_slice_f32_39',
    family='export',
    contract=ShaderContract(
        class_name='ExportSliceProgram',
        shader_name='flux_single_block_slice_f32_39',
        fields=(
            TensorFieldSpec(
                name='x',
