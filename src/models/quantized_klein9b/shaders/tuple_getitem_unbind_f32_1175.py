"""Generated shader: tuple_getitem_unbind_f32_1175."""
...
TUPLE_GETITEM_UNBIND_F32_1175 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1175',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1175',
        fields=(
            TensorFieldSpec(
                name='x',
