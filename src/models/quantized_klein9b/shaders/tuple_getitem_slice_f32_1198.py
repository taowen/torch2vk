"""Generated shader: tuple_getitem_slice_f32_1198."""
...
TUPLE_GETITEM_SLICE_F32_1198 = ShaderVariant(
    name='tuple_getitem_slice_f32_1198',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1198',
        fields=(
            TensorFieldSpec(
                name='x',
