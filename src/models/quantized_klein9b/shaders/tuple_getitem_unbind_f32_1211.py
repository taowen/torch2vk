"""Generated shader: tuple_getitem_unbind_f32_1211."""
...
TUPLE_GETITEM_UNBIND_F32_1211 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1211',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1211',
        fields=(
            TensorFieldSpec(
                name='x',
