"""Generated shader: tuple_getitem_unbind_f32_507."""
...
TUPLE_GETITEM_UNBIND_F32_507 = ShaderVariant(
    name='tuple_getitem_unbind_f32_507',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_507',
        fields=(
            TensorFieldSpec(
                name='x',
