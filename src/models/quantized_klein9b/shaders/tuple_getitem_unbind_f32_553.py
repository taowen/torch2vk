"""Generated shader: tuple_getitem_unbind_f32_553."""
...
TUPLE_GETITEM_UNBIND_F32_553 = ShaderVariant(
    name='tuple_getitem_unbind_f32_553',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_553',
        fields=(
            TensorFieldSpec(
                name='x',
