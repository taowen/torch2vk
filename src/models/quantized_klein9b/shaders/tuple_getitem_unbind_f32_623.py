"""Generated shader: tuple_getitem_unbind_f32_623."""
...
TUPLE_GETITEM_UNBIND_F32_623 = ShaderVariant(
    name='tuple_getitem_unbind_f32_623',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_623',
        fields=(
            TensorFieldSpec(
                name='x',
