"""Generated shader: tuple_getitem_unbind_f32_1128."""
...
TUPLE_GETITEM_UNBIND_F32_1128 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1128',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1128',
        fields=(
            TensorFieldSpec(
                name='x',
