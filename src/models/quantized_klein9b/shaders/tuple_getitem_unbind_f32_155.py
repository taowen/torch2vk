"""Generated shader: tuple_getitem_unbind_f32_155."""
...
TUPLE_GETITEM_UNBIND_F32_155 = ShaderVariant(
    name='tuple_getitem_unbind_f32_155',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_155',
        fields=(
            TensorFieldSpec(
                name='x',
