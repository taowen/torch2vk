"""Generated shader: tuple_getitem_slice_f32_23."""
...
TUPLE_GETITEM_SLICE_F32_23 = ShaderVariant(
    name='tuple_getitem_slice_f32_23',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_23',
        fields=(
            TensorFieldSpec(
                name='x',
