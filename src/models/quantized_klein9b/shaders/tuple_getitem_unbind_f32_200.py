"""Generated shader: tuple_getitem_unbind_f32_200."""
...
TUPLE_GETITEM_UNBIND_F32_200 = ShaderVariant(
    name='tuple_getitem_unbind_f32_200',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_200',
        fields=(
            TensorFieldSpec(
                name='x',
