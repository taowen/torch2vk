"""Generated shader: tuple_getitem_unbind_f32_875."""
...
TUPLE_GETITEM_UNBIND_F32_875 = ShaderVariant(
    name='tuple_getitem_unbind_f32_875',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_875',
        fields=(
            TensorFieldSpec(
                name='x',
