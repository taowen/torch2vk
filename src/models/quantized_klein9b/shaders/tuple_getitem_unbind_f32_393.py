"""Generated shader: tuple_getitem_unbind_f32_393."""
...
TUPLE_GETITEM_UNBIND_F32_393 = ShaderVariant(
    name='tuple_getitem_unbind_f32_393',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_393',
        fields=(
            TensorFieldSpec(
                name='x',
