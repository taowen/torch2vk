"""Generated shader: tuple_getitem_slice_f32_320."""
...
TUPLE_GETITEM_SLICE_F32_320 = ShaderVariant(
    name='tuple_getitem_slice_f32_320',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_320',
        fields=(
            TensorFieldSpec(
                name='x',
