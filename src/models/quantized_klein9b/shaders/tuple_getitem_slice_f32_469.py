"""Generated shader: tuple_getitem_slice_f32_469."""
...
TUPLE_GETITEM_SLICE_F32_469 = ShaderVariant(
    name='tuple_getitem_slice_f32_469',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_469',
        fields=(
            TensorFieldSpec(
                name='x',
