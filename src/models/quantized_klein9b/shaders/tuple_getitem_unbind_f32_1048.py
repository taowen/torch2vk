"""Generated shader: tuple_getitem_unbind_f32_1048."""
...
TUPLE_GETITEM_UNBIND_F32_1048 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1048',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1048',
        fields=(
            TensorFieldSpec(
                name='x',
