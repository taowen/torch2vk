"""Generated shader: tuple_getitem_slice_f32_848."""
...
TUPLE_GETITEM_SLICE_F32_848 = ShaderVariant(
    name='tuple_getitem_slice_f32_848',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_848',
        fields=(
            TensorFieldSpec(
                name='x',
