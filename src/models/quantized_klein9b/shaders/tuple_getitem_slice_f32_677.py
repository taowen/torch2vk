"""Generated shader: tuple_getitem_slice_f32_677."""
...
TUPLE_GETITEM_SLICE_F32_677 = ShaderVariant(
    name='tuple_getitem_slice_f32_677',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_677',
        fields=(
            TensorFieldSpec(
                name='x',
