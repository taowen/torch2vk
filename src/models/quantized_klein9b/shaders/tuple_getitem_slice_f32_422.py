"""Generated shader: tuple_getitem_slice_f32_422."""
...
TUPLE_GETITEM_SLICE_F32_422 = ShaderVariant(
    name='tuple_getitem_slice_f32_422',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_422',
        fields=(
            TensorFieldSpec(
                name='x',
