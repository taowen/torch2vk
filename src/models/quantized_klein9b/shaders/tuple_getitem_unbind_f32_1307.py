"""Generated shader: tuple_getitem_unbind_f32_1307."""
...
TUPLE_GETITEM_UNBIND_F32_1307 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1307',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1307',
        fields=(
            TensorFieldSpec(
                name='x',
