"""Generated shader: tuple_getitem_unbind_f32_735."""
...
TUPLE_GETITEM_UNBIND_F32_735 = ShaderVariant(
    name='tuple_getitem_unbind_f32_735',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_735',
        fields=(
            TensorFieldSpec(
                name='x',
