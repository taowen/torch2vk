"""Generated shader: tuple_getitem_unbind_f32_1022."""
...
TUPLE_GETITEM_UNBIND_F32_1022 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1022',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1022',
        fields=(
            TensorFieldSpec(
                name='x',
