"""Generated shader: tuple_getitem_unbind_f32_358."""
...
TUPLE_GETITEM_UNBIND_F32_358 = ShaderVariant(
    name='tuple_getitem_unbind_f32_358',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_358',
        fields=(
            TensorFieldSpec(
                name='x',
