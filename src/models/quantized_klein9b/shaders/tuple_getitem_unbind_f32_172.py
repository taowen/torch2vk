"""Generated shader: tuple_getitem_unbind_f32_172."""
...
TUPLE_GETITEM_UNBIND_F32_172 = ShaderVariant(
    name='tuple_getitem_unbind_f32_172',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_172',
        fields=(
            TensorFieldSpec(
                name='x',
