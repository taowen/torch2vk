"""Generated shader: tuple_getitem_slice_f32_556."""
...
TUPLE_GETITEM_SLICE_F32_556 = ShaderVariant(
    name='tuple_getitem_slice_f32_556',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_556',
        fields=(
            TensorFieldSpec(
                name='x',
