"""Generated shader: tuple_getitem_slice_f32_762."""
...
TUPLE_GETITEM_SLICE_F32_762 = ShaderVariant(
    name='tuple_getitem_slice_f32_762',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_762',
        fields=(
            TensorFieldSpec(
                name='x',
