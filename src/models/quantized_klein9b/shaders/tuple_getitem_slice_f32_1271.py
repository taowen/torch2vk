"""Generated shader: tuple_getitem_slice_f32_1271."""
...
TUPLE_GETITEM_SLICE_F32_1271 = ShaderVariant(
    name='tuple_getitem_slice_f32_1271',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1271',
        fields=(
            TensorFieldSpec(
                name='x',
