"""Generated shader: tuple_getitem_unbind_f32_345."""
...
TUPLE_GETITEM_UNBIND_F32_345 = ShaderVariant(
    name='tuple_getitem_unbind_f32_345',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_345',
        fields=(
            TensorFieldSpec(
                name='x',
