"""Generated shader: tuple_getitem_slice_f32_1109."""
...
TUPLE_GETITEM_SLICE_F32_1109 = ShaderVariant(
    name='tuple_getitem_slice_f32_1109',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1109',
        fields=(
            TensorFieldSpec(
                name='x',
