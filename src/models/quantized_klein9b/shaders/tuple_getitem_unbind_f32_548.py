"""Generated shader: tuple_getitem_unbind_f32_548."""
...
TUPLE_GETITEM_UNBIND_F32_548 = ShaderVariant(
    name='tuple_getitem_unbind_f32_548',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_548',
        fields=(
            TensorFieldSpec(
                name='x',
