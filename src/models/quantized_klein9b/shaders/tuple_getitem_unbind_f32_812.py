"""Generated shader: tuple_getitem_unbind_f32_812."""
...
TUPLE_GETITEM_UNBIND_F32_812 = ShaderVariant(
    name='tuple_getitem_unbind_f32_812',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_812',
        fields=(
            TensorFieldSpec(
                name='x',
