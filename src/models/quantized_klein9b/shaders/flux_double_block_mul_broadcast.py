"""Generated shader: flux_double_block_mul_broadcast."""
...
FLUX_DOUBLE_BLOCK_MUL_BROADCAST = ShaderVariant(
    name='flux_double_block_mul_broadcast',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='flux_double_block_mul_broadcast',
        fields=(
            TensorFieldSpec(
                name='x',
