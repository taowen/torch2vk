"""Generated shader: tuple_getitem_slice_f32_56."""
...
TUPLE_GETITEM_SLICE_F32_56 = ShaderVariant(
    name='tuple_getitem_slice_f32_56',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_56',
        fields=(
            TensorFieldSpec(
                name='x',
