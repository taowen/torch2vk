"""Generated shader: tuple_getitem_unbind_f32_310."""
...
TUPLE_GETITEM_UNBIND_F32_310 = ShaderVariant(
    name='tuple_getitem_unbind_f32_310',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_310',
        fields=(
            TensorFieldSpec(
                name='x',
