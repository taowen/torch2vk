"""Generated shader: tuple_getitem_unbind_f32_849."""
...
TUPLE_GETITEM_UNBIND_F32_849 = ShaderVariant(
    name='tuple_getitem_unbind_f32_849',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_849',
        fields=(
            TensorFieldSpec(
                name='x',
