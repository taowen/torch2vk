"""Generated shader: tuple_getitem_unbind_f32_641."""
...
TUPLE_GETITEM_UNBIND_F32_641 = ShaderVariant(
    name='tuple_getitem_unbind_f32_641',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_641',
        fields=(
            TensorFieldSpec(
                name='x',
