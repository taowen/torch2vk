"""Generated shader: tuple_getitem_unbind_f32_224."""
...
TUPLE_GETITEM_UNBIND_F32_224 = ShaderVariant(
    name='tuple_getitem_unbind_f32_224',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_224',
        fields=(
            TensorFieldSpec(
                name='x',
