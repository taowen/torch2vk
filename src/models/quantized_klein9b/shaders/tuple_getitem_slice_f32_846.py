"""Generated shader: tuple_getitem_slice_f32_846."""
...
TUPLE_GETITEM_SLICE_F32_846 = ShaderVariant(
    name='tuple_getitem_slice_f32_846',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_846',
        fields=(
            TensorFieldSpec(
                name='x',
