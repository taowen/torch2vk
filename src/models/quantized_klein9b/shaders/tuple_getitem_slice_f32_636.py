"""Generated shader: tuple_getitem_slice_f32_636."""
...
TUPLE_GETITEM_SLICE_F32_636 = ShaderVariant(
    name='tuple_getitem_slice_f32_636',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_636',
        fields=(
            TensorFieldSpec(
                name='x',
