"""Generated shader: tuple_getitem_slice_f32_920."""
...
TUPLE_GETITEM_SLICE_F32_920 = ShaderVariant(
    name='tuple_getitem_slice_f32_920',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_920',
        fields=(
            TensorFieldSpec(
                name='x',
