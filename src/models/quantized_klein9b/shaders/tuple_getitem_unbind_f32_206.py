"""Generated shader: tuple_getitem_unbind_f32_206."""
...
TUPLE_GETITEM_UNBIND_F32_206 = ShaderVariant(
    name='tuple_getitem_unbind_f32_206',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_206',
        fields=(
            TensorFieldSpec(
                name='x',
