"""Generated shader: flux_double_block_silu_f32."""
...
FLUX_DOUBLE_BLOCK_SILU_F32 = ShaderVariant(
    name='flux_double_block_silu_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportSiluF32Program',
        shader_name='flux_double_block_silu_f32',
        fields=(
            TensorFieldSpec(
                name='x',
