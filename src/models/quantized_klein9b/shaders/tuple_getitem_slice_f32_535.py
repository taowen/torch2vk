"""Generated shader: tuple_getitem_slice_f32_535."""
...
TUPLE_GETITEM_SLICE_F32_535 = ShaderVariant(
    name='tuple_getitem_slice_f32_535',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_535',
        fields=(
            TensorFieldSpec(
                name='x',
