"""Generated shader: tuple_getitem_unbind_f32_954."""
...
TUPLE_GETITEM_UNBIND_F32_954 = ShaderVariant(
    name='tuple_getitem_unbind_f32_954',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_954',
        fields=(
            TensorFieldSpec(
                name='x',
