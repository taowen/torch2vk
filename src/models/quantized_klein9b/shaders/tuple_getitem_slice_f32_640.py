"""Generated shader: tuple_getitem_slice_f32_640."""
...
TUPLE_GETITEM_SLICE_F32_640 = ShaderVariant(
    name='tuple_getitem_slice_f32_640',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_640',
        fields=(
            TensorFieldSpec(
                name='x',
