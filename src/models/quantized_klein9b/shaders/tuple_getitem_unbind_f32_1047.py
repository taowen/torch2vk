"""Generated shader: tuple_getitem_unbind_f32_1047."""
...
TUPLE_GETITEM_UNBIND_F32_1047 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1047',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1047',
        fields=(
            TensorFieldSpec(
                name='x',
