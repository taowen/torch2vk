"""Generated shader: tuple_getitem_unbind_f32_173."""
...
TUPLE_GETITEM_UNBIND_F32_173 = ShaderVariant(
    name='tuple_getitem_unbind_f32_173',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_173',
        fields=(
            TensorFieldSpec(
                name='x',
