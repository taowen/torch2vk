"""Generated shader: tuple_getitem_slice_f32_483."""
...
TUPLE_GETITEM_SLICE_F32_483 = ShaderVariant(
    name='tuple_getitem_slice_f32_483',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_483',
        fields=(
            TensorFieldSpec(
                name='x',
