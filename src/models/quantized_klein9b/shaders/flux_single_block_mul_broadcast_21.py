"""Generated shader: flux_single_block_mul_broadcast_21."""
...
FLUX_SINGLE_BLOCK_MUL_BROADCAST_21 = ShaderVariant(
    name='flux_single_block_mul_broadcast_21',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='flux_single_block_mul_broadcast_21',
        fields=(
            TensorFieldSpec(
                name='x',
