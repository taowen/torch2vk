"""Generated shader: tuple_getitem_unbind_f32_433."""
...
TUPLE_GETITEM_UNBIND_F32_433 = ShaderVariant(
    name='tuple_getitem_unbind_f32_433',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_433',
        fields=(
            TensorFieldSpec(
                name='x',
