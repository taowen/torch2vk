"""Generated shader: tuple_getitem_unbind_f32_20."""
...
TUPLE_GETITEM_UNBIND_F32_20 = ShaderVariant(
    name='tuple_getitem_unbind_f32_20',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_20',
        fields=(
            TensorFieldSpec(
                name='x',
