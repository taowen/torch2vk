"""Generated shader: tuple_getitem_slice_f32_760."""
...
TUPLE_GETITEM_SLICE_F32_760 = ShaderVariant(
    name='tuple_getitem_slice_f32_760',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_760',
        fields=(
            TensorFieldSpec(
                name='x',
