"""Generated shader: tuple_getitem_slice_f32_204."""
...
TUPLE_GETITEM_SLICE_F32_204 = ShaderVariant(
    name='tuple_getitem_slice_f32_204',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_204',
        fields=(
            TensorFieldSpec(
                name='x',
