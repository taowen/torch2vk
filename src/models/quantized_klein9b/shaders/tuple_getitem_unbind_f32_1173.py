"""Generated shader: tuple_getitem_unbind_f32_1173."""
...
TUPLE_GETITEM_UNBIND_F32_1173 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1173',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1173',
        fields=(
            TensorFieldSpec(
                name='x',
