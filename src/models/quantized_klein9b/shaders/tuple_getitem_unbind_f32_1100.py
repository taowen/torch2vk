"""Generated shader: tuple_getitem_unbind_f32_1100."""
...
TUPLE_GETITEM_UNBIND_F32_1100 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1100',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1100',
        fields=(
            TensorFieldSpec(
                name='x',
