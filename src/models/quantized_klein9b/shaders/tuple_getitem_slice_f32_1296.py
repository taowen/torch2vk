"""Generated shader: tuple_getitem_slice_f32_1296."""
...
TUPLE_GETITEM_SLICE_F32_1296 = ShaderVariant(
    name='tuple_getitem_slice_f32_1296',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1296',
        fields=(
            TensorFieldSpec(
                name='x',
