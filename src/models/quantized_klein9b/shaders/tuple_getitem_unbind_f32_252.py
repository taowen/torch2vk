"""Generated shader: tuple_getitem_unbind_f32_252."""
...
TUPLE_GETITEM_UNBIND_F32_252 = ShaderVariant(
    name='tuple_getitem_unbind_f32_252',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_252',
        fields=(
            TensorFieldSpec(
                name='x',
