"""Generated shader: tuple_getitem_unbind_f32_848."""
...
TUPLE_GETITEM_UNBIND_F32_848 = ShaderVariant(
    name='tuple_getitem_unbind_f32_848',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_848',
        fields=(
            TensorFieldSpec(
                name='x',
