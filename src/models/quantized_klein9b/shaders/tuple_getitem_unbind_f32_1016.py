"""Generated shader: tuple_getitem_unbind_f32_1016."""
...
TUPLE_GETITEM_UNBIND_F32_1016 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1016',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1016',
        fields=(
            TensorFieldSpec(
                name='x',
