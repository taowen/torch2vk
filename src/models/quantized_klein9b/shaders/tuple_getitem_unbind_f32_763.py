"""Generated shader: tuple_getitem_unbind_f32_763."""
...
TUPLE_GETITEM_UNBIND_F32_763 = ShaderVariant(
    name='tuple_getitem_unbind_f32_763',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_763',
        fields=(
            TensorFieldSpec(
                name='x',
