"""Generated shader: tuple_getitem_unbind_f32_486."""
...
TUPLE_GETITEM_UNBIND_F32_486 = ShaderVariant(
    name='tuple_getitem_unbind_f32_486',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_486',
        fields=(
            TensorFieldSpec(
                name='x',
