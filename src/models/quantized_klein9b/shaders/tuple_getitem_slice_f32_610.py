"""Generated shader: tuple_getitem_slice_f32_610."""
...
TUPLE_GETITEM_SLICE_F32_610 = ShaderVariant(
    name='tuple_getitem_slice_f32_610',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_610',
        fields=(
            TensorFieldSpec(
                name='x',
