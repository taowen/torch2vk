"""Generated shader: tuple_getitem_unbind_f32_953."""
...
TUPLE_GETITEM_UNBIND_F32_953 = ShaderVariant(
    name='tuple_getitem_unbind_f32_953',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_953',
        fields=(
            TensorFieldSpec(
                name='x',
