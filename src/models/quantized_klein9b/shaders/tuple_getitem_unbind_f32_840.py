"""Generated shader: tuple_getitem_unbind_f32_840."""
...
TUPLE_GETITEM_UNBIND_F32_840 = ShaderVariant(
    name='tuple_getitem_unbind_f32_840',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_840',
        fields=(
            TensorFieldSpec(
                name='x',
