"""Generated shader: tuple_getitem_slice_f32_735."""
...
TUPLE_GETITEM_SLICE_F32_735 = ShaderVariant(
    name='tuple_getitem_slice_f32_735',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_735',
        fields=(
            TensorFieldSpec(
                name='x',
