"""Generated shader: euler_update_mul_broadcast."""
...
EULER_UPDATE_MUL_BROADCAST = ShaderVariant(
    name='euler_update_mul_broadcast',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='euler_update_mul_broadcast',
        fields=(
            TensorFieldSpec(
                name='x',
