"""Generated shader: tuple_getitem_unbind_f32_501."""
...
TUPLE_GETITEM_UNBIND_F32_501 = ShaderVariant(
    name='tuple_getitem_unbind_f32_501',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_501',
        fields=(
            TensorFieldSpec(
                name='x',
