"""Generated shader: tuple_getitem_unbind_f32_1274."""
...
TUPLE_GETITEM_UNBIND_F32_1274 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1274',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1274',
        fields=(
            TensorFieldSpec(
                name='x',
