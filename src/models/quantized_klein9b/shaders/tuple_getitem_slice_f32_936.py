"""Generated shader: tuple_getitem_slice_f32_936."""
...
TUPLE_GETITEM_SLICE_F32_936 = ShaderVariant(
    name='tuple_getitem_slice_f32_936',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_936',
        fields=(
            TensorFieldSpec(
                name='x',
