"""Generated shader: tuple_getitem_slice_f32_1297."""
...
TUPLE_GETITEM_SLICE_F32_1297 = ShaderVariant(
    name='tuple_getitem_slice_f32_1297',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1297',
        fields=(
            TensorFieldSpec(
                name='x',
