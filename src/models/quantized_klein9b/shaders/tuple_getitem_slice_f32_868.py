"""Generated shader: tuple_getitem_slice_f32_868."""
...
TUPLE_GETITEM_SLICE_F32_868 = ShaderVariant(
    name='tuple_getitem_slice_f32_868',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_868',
        fields=(
            TensorFieldSpec(
                name='x',
