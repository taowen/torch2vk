"""Generated shader: tuple_getitem_slice_f32_712."""
...
TUPLE_GETITEM_SLICE_F32_712 = ShaderVariant(
    name='tuple_getitem_slice_f32_712',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_712',
        fields=(
            TensorFieldSpec(
                name='x',
