"""Generated shader: tuple_getitem_slice_f32_198."""
...
TUPLE_GETITEM_SLICE_F32_198 = ShaderVariant(
    name='tuple_getitem_slice_f32_198',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_198',
        fields=(
            TensorFieldSpec(
                name='x',
