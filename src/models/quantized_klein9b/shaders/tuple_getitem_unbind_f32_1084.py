"""Generated shader: tuple_getitem_unbind_f32_1084."""
...
TUPLE_GETITEM_UNBIND_F32_1084 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1084',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1084',
        fields=(
            TensorFieldSpec(
                name='x',
