"""Generated shader: tuple_getitem_unbind_f32_204."""
...
TUPLE_GETITEM_UNBIND_F32_204 = ShaderVariant(
    name='tuple_getitem_unbind_f32_204',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_204',
        fields=(
            TensorFieldSpec(
                name='x',
