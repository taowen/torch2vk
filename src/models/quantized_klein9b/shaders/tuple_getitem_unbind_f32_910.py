"""Generated shader: tuple_getitem_unbind_f32_910."""
...
TUPLE_GETITEM_UNBIND_F32_910 = ShaderVariant(
    name='tuple_getitem_unbind_f32_910',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_910',
        fields=(
            TensorFieldSpec(
                name='x',
