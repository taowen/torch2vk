"""Generated shader: tuple_getitem_slice_f32_492."""
...
TUPLE_GETITEM_SLICE_F32_492 = ShaderVariant(
    name='tuple_getitem_slice_f32_492',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_492',
        fields=(
            TensorFieldSpec(
                name='x',
