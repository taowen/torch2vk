"""Generated shader: tuple_getitem_slice_f32_41."""
...
TUPLE_GETITEM_SLICE_F32_41 = ShaderVariant(
    name='tuple_getitem_slice_f32_41',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_41',
        fields=(
            TensorFieldSpec(
                name='x',
