"""Generated shader: tuple_getitem_unbind_f32_408."""
...
TUPLE_GETITEM_UNBIND_F32_408 = ShaderVariant(
    name='tuple_getitem_unbind_f32_408',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_408',
        fields=(
            TensorFieldSpec(
                name='x',
