"""Generated shader: tuple_getitem_unbind_f32_348."""
...
TUPLE_GETITEM_UNBIND_F32_348 = ShaderVariant(
    name='tuple_getitem_unbind_f32_348',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_348',
        fields=(
            TensorFieldSpec(
                name='x',
