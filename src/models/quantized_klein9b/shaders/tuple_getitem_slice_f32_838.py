"""Generated shader: tuple_getitem_slice_f32_838."""
...
TUPLE_GETITEM_SLICE_F32_838 = ShaderVariant(
    name='tuple_getitem_slice_f32_838',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_838',
        fields=(
            TensorFieldSpec(
                name='x',
