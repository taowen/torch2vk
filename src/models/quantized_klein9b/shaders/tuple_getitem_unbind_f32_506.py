"""Generated shader: tuple_getitem_unbind_f32_506."""
...
TUPLE_GETITEM_UNBIND_F32_506 = ShaderVariant(
    name='tuple_getitem_unbind_f32_506',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_506',
        fields=(
            TensorFieldSpec(
                name='x',
