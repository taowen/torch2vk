"""Generated shader: tuple_getitem_unbind_f32_1207."""
...
TUPLE_GETITEM_UNBIND_F32_1207 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1207',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1207',
        fields=(
            TensorFieldSpec(
                name='x',
