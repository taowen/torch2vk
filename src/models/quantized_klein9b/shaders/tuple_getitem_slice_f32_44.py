"""Generated shader: tuple_getitem_slice_f32_44."""
...
TUPLE_GETITEM_SLICE_F32_44 = ShaderVariant(
    name='tuple_getitem_slice_f32_44',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_44',
        fields=(
            TensorFieldSpec(
                name='x',
