"""Generated shader: tuple_getitem_slice_f32_801."""
...
TUPLE_GETITEM_SLICE_F32_801 = ShaderVariant(
    name='tuple_getitem_slice_f32_801',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_801',
        fields=(
            TensorFieldSpec(
                name='x',
