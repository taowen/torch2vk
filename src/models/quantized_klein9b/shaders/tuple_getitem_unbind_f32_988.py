"""Generated shader: tuple_getitem_unbind_f32_988."""
...
TUPLE_GETITEM_UNBIND_F32_988 = ShaderVariant(
    name='tuple_getitem_unbind_f32_988',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_988',
        fields=(
            TensorFieldSpec(
                name='x',
