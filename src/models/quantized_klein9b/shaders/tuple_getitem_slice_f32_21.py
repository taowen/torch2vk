"""Generated shader: tuple_getitem_slice_f32_21."""
...
TUPLE_GETITEM_SLICE_F32_21 = ShaderVariant(
    name='tuple_getitem_slice_f32_21',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_21',
        fields=(
            TensorFieldSpec(
                name='x',
