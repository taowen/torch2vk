"""Generated shader: flux_single_block_linear_nobias_f16w_f32."""
...
FLUX_SINGLE_BLOCK_LINEAR_NOBIAS_F16W_F32 = ShaderVariant(
    name='flux_single_block_linear_nobias_f16w_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasF16WeightProgram',
        shader_name='flux_single_block_linear_nobias_f16w_f32',
        fields=(
            TensorFieldSpec(
                name='x',
