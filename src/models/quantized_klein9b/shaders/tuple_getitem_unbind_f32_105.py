"""Generated shader: tuple_getitem_unbind_f32_105."""
...
TUPLE_GETITEM_UNBIND_F32_105 = ShaderVariant(
    name='tuple_getitem_unbind_f32_105',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_105',
        fields=(
            TensorFieldSpec(
                name='x',
