"""Generated shader: tuple_getitem_unbind_f32_624."""
...
TUPLE_GETITEM_UNBIND_F32_624 = ShaderVariant(
    name='tuple_getitem_unbind_f32_624',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_624',
        fields=(
            TensorFieldSpec(
                name='x',
