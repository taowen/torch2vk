"""Generated shader: tuple_getitem_slice_f32_382."""
...
TUPLE_GETITEM_SLICE_F32_382 = ShaderVariant(
    name='tuple_getitem_slice_f32_382',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_382',
        fields=(
            TensorFieldSpec(
                name='x',
