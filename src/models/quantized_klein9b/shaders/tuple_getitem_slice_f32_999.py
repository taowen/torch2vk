"""Generated shader: tuple_getitem_slice_f32_999."""
...
TUPLE_GETITEM_SLICE_F32_999 = ShaderVariant(
    name='tuple_getitem_slice_f32_999',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_999',
        fields=(
            TensorFieldSpec(
                name='x',
