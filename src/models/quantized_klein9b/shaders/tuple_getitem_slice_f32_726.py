"""Generated shader: tuple_getitem_slice_f32_726."""
...
TUPLE_GETITEM_SLICE_F32_726 = ShaderVariant(
    name='tuple_getitem_slice_f32_726',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_726',
        fields=(
            TensorFieldSpec(
                name='x',
