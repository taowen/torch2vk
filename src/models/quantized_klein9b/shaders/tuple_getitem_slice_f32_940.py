"""Generated shader: tuple_getitem_slice_f32_940."""
...
TUPLE_GETITEM_SLICE_F32_940 = ShaderVariant(
    name='tuple_getitem_slice_f32_940',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_940',
        fields=(
            TensorFieldSpec(
                name='x',
