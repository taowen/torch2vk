"""Generated shader: tuple_getitem_unbind_f32_1058."""
...
TUPLE_GETITEM_UNBIND_F32_1058 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1058',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1058',
        fields=(
            TensorFieldSpec(
                name='x',
