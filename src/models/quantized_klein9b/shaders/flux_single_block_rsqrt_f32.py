"""Generated shader: flux_single_block_rsqrt_f32."""
...
FLUX_SINGLE_BLOCK_RSQRT_F32 = ShaderVariant(
    name='flux_single_block_rsqrt_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportRsqrtF32Program',
        shader_name='flux_single_block_rsqrt_f32',
        fields=(
            TensorFieldSpec(
                name='x',
