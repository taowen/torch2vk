"""Generated shader: tuple_getitem_slice_f32_1070."""
...
TUPLE_GETITEM_SLICE_F32_1070 = ShaderVariant(
    name='tuple_getitem_slice_f32_1070',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1070',
        fields=(
            TensorFieldSpec(
                name='x',
