"""Generated shader: tuple_getitem_unbind_f32_106."""
...
TUPLE_GETITEM_UNBIND_F32_106 = ShaderVariant(
    name='tuple_getitem_unbind_f32_106',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_106',
        fields=(
            TensorFieldSpec(
                name='x',
