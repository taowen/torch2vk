"""Generated shader: tuple_getitem_unbind_f32_109."""
...
TUPLE_GETITEM_UNBIND_F32_109 = ShaderVariant(
    name='tuple_getitem_unbind_f32_109',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_109',
        fields=(
            TensorFieldSpec(
                name='x',
