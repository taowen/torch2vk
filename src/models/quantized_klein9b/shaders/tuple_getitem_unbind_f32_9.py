"""Generated shader: tuple_getitem_unbind_f32_9."""
...
TUPLE_GETITEM_UNBIND_F32_9 = ShaderVariant(
    name='tuple_getitem_unbind_f32_9',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_9',
        fields=(
            TensorFieldSpec(
                name='x',
