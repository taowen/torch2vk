"""Generated shader: tuple_getitem_unbind_f32_605."""
...
TUPLE_GETITEM_UNBIND_F32_605 = ShaderVariant(
    name='tuple_getitem_unbind_f32_605',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_605',
        fields=(
            TensorFieldSpec(
                name='x',
