"""Generated shader: tuple_getitem_slice_f32_289."""
...
TUPLE_GETITEM_SLICE_F32_289 = ShaderVariant(
    name='tuple_getitem_slice_f32_289',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_289',
        fields=(
            TensorFieldSpec(
                name='x',
