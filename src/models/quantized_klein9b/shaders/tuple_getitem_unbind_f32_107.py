"""Generated shader: tuple_getitem_unbind_f32_107."""
...
TUPLE_GETITEM_UNBIND_F32_107 = ShaderVariant(
    name='tuple_getitem_unbind_f32_107',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_107',
        fields=(
            TensorFieldSpec(
                name='x',
