"""Generated shader: flux_double_block_mean_dim_f32."""
...
FLUX_DOUBLE_BLOCK_MEAN_DIM_F32 = ShaderVariant(
    name='flux_double_block_mean_dim_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportMeanDimProgram',
        shader_name='flux_double_block_mean_dim_f32',
        fields=(
            TensorFieldSpec(
                name='x',
