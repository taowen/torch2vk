"""Generated shader: tuple_getitem_unbind_f32_1021."""
...
TUPLE_GETITEM_UNBIND_F32_1021 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1021',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1021',
        fields=(
            TensorFieldSpec(
                name='x',
