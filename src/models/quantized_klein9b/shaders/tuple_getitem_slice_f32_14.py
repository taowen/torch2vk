"""Generated shader: tuple_getitem_slice_f32_14."""
...
TUPLE_GETITEM_SLICE_F32_14 = ShaderVariant(
    name='tuple_getitem_slice_f32_14',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_14',
        fields=(
            TensorFieldSpec(
                name='x',
