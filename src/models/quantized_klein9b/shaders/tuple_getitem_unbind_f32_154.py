"""Generated shader: tuple_getitem_unbind_f32_154."""
...
TUPLE_GETITEM_UNBIND_F32_154 = ShaderVariant(
    name='tuple_getitem_unbind_f32_154',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_154',
        fields=(
            TensorFieldSpec(
                name='x',
