"""Generated shader: tuple_getitem_slice_f32_1146."""
...
TUPLE_GETITEM_SLICE_F32_1146 = ShaderVariant(
    name='tuple_getitem_slice_f32_1146',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1146',
        fields=(
            TensorFieldSpec(
                name='x',
