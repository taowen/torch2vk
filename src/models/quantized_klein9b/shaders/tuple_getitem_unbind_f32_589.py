"""Generated shader: tuple_getitem_unbind_f32_589."""
...
TUPLE_GETITEM_UNBIND_F32_589 = ShaderVariant(
    name='tuple_getitem_unbind_f32_589',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_589',
        fields=(
            TensorFieldSpec(
                name='x',
