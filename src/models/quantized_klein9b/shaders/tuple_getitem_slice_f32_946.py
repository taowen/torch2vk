"""Generated shader: tuple_getitem_slice_f32_946."""
...
TUPLE_GETITEM_SLICE_F32_946 = ShaderVariant(
    name='tuple_getitem_slice_f32_946',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_946',
        fields=(
            TensorFieldSpec(
                name='x',
