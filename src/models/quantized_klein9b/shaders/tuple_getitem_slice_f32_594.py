"""Generated shader: tuple_getitem_slice_f32_594."""
...
TUPLE_GETITEM_SLICE_F32_594 = ShaderVariant(
    name='tuple_getitem_slice_f32_594',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_594',
        fields=(
            TensorFieldSpec(
                name='x',
