"""Generated shader: tuple_getitem_slice_f32_1092."""
...
TUPLE_GETITEM_SLICE_F32_1092 = ShaderVariant(
    name='tuple_getitem_slice_f32_1092',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1092',
        fields=(
            TensorFieldSpec(
                name='x',
