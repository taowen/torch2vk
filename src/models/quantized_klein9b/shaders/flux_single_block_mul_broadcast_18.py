"""Generated shader: flux_single_block_mul_broadcast_18."""
...
FLUX_SINGLE_BLOCK_MUL_BROADCAST_18 = ShaderVariant(
    name='flux_single_block_mul_broadcast_18',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='flux_single_block_mul_broadcast_18',
        fields=(
            TensorFieldSpec(
                name='x',
