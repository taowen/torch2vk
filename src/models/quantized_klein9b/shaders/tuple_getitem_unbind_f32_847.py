"""Generated shader: tuple_getitem_unbind_f32_847."""
...
TUPLE_GETITEM_UNBIND_F32_847 = ShaderVariant(
    name='tuple_getitem_unbind_f32_847',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_847',
        fields=(
            TensorFieldSpec(
                name='x',
