"""Generated shader: tuple_getitem_unbind_f32_1099."""
...
TUPLE_GETITEM_UNBIND_F32_1099 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1099',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1099',
        fields=(
            TensorFieldSpec(
                name='x',
