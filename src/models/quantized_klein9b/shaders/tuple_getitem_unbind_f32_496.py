"""Generated shader: tuple_getitem_unbind_f32_496."""
...
TUPLE_GETITEM_UNBIND_F32_496 = ShaderVariant(
    name='tuple_getitem_unbind_f32_496',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_496',
        fields=(
            TensorFieldSpec(
                name='x',
