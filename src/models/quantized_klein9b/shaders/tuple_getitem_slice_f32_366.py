"""Generated shader: tuple_getitem_slice_f32_366."""
...
TUPLE_GETITEM_SLICE_F32_366 = ShaderVariant(
    name='tuple_getitem_slice_f32_366',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_366',
        fields=(
            TensorFieldSpec(
                name='x',
