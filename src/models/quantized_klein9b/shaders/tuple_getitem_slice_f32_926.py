"""Generated shader: tuple_getitem_slice_f32_926."""
...
TUPLE_GETITEM_SLICE_F32_926 = ShaderVariant(
    name='tuple_getitem_slice_f32_926',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_926',
        fields=(
            TensorFieldSpec(
                name='x',
