"""Generated shader: tuple_getitem_slice_f32_1082."""
...
TUPLE_GETITEM_SLICE_F32_1082 = ShaderVariant(
    name='tuple_getitem_slice_f32_1082',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1082',
        fields=(
            TensorFieldSpec(
                name='x',
