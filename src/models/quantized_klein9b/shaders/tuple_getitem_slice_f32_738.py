"""Generated shader: tuple_getitem_slice_f32_738."""
...
TUPLE_GETITEM_SLICE_F32_738 = ShaderVariant(
    name='tuple_getitem_slice_f32_738',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_738',
        fields=(
            TensorFieldSpec(
                name='x',
