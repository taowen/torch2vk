"""Generated shader: tuple_getitem_slice_f32_669."""
...
TUPLE_GETITEM_SLICE_F32_669 = ShaderVariant(
    name='tuple_getitem_slice_f32_669',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_669',
        fields=(
            TensorFieldSpec(
                name='x',
