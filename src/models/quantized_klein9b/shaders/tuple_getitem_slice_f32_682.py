"""Generated shader: tuple_getitem_slice_f32_682."""
...
TUPLE_GETITEM_SLICE_F32_682 = ShaderVariant(
    name='tuple_getitem_slice_f32_682',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_682',
        fields=(
            TensorFieldSpec(
                name='x',
