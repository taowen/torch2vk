"""Generated shader: tuple_getitem_unbind_f32_777."""
...
TUPLE_GETITEM_UNBIND_F32_777 = ShaderVariant(
    name='tuple_getitem_unbind_f32_777',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_777',
        fields=(
            TensorFieldSpec(
                name='x',
