"""Generated shader: tuple_getitem_unbind_f32_457."""
...
TUPLE_GETITEM_UNBIND_F32_457 = ShaderVariant(
    name='tuple_getitem_unbind_f32_457',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_457',
        fields=(
            TensorFieldSpec(
                name='x',
