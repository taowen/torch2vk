"""Generated shader: tuple_getitem_slice_f32_900."""
...
TUPLE_GETITEM_SLICE_F32_900 = ShaderVariant(
    name='tuple_getitem_slice_f32_900',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_900',
        fields=(
            TensorFieldSpec(
                name='x',
