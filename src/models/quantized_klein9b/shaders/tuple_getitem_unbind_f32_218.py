"""Generated shader: tuple_getitem_unbind_f32_218."""
...
TUPLE_GETITEM_UNBIND_F32_218 = ShaderVariant(
    name='tuple_getitem_unbind_f32_218',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_218',
        fields=(
            TensorFieldSpec(
                name='x',
