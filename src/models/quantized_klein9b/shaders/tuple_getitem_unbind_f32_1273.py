"""Generated shader: tuple_getitem_unbind_f32_1273."""
...
TUPLE_GETITEM_UNBIND_F32_1273 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1273',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1273',
        fields=(
            TensorFieldSpec(
                name='x',
