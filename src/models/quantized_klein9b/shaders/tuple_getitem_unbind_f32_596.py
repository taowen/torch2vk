"""Generated shader: tuple_getitem_unbind_f32_596."""
...
TUPLE_GETITEM_UNBIND_F32_596 = ShaderVariant(
    name='tuple_getitem_unbind_f32_596',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_596',
        fields=(
            TensorFieldSpec(
                name='x',
