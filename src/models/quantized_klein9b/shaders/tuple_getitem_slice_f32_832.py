"""Generated shader: tuple_getitem_slice_f32_832."""
...
TUPLE_GETITEM_SLICE_F32_832 = ShaderVariant(
    name='tuple_getitem_slice_f32_832',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_832',
        fields=(
            TensorFieldSpec(
                name='x',
