"""Generated shader: tuple_getitem_slice_f32_810."""
...
TUPLE_GETITEM_SLICE_F32_810 = ShaderVariant(
    name='tuple_getitem_slice_f32_810',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_810',
        fields=(
            TensorFieldSpec(
                name='x',
