"""Generated shader: pow_base_scalar_f32."""
...
POW_BASE_SCALAR_F32 = ShaderVariant(
    name='pow_base_scalar_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportPowBaseScalarF32Program',
        shader_name='pow_base_scalar_f32',
        fields=(
            TensorFieldSpec(
                name='x',
...
void main() {
    ...
    if (idx < pc.N) { output_values[idx] = float16_t(pow(2000, float(x[idx]))); }
}
""",
)
