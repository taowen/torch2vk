"""Generated shader: flux_double_block_pow_scalar_f32."""
...
FLUX_DOUBLE_BLOCK_POW_SCALAR_F32 = ShaderVariant(
    name='flux_double_block_pow_scalar_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportPowScalarF32Program',
        shader_name='flux_double_block_pow_scalar_f32',
        fields=(
            TensorFieldSpec(
                name='x',
