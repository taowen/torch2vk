"""Generated shader: tuple_getitem_unbind_f32_679."""
...
TUPLE_GETITEM_UNBIND_F32_679 = ShaderVariant(
    name='tuple_getitem_unbind_f32_679',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_679',
        fields=(
            TensorFieldSpec(
                name='x',
