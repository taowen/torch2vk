"""Generated shader: tuple_getitem_unbind_f32_1073."""
...
TUPLE_GETITEM_UNBIND_F32_1073 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1073',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1073',
        fields=(
            TensorFieldSpec(
                name='x',
