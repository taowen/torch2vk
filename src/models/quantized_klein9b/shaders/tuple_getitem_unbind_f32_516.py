"""Generated shader: tuple_getitem_unbind_f32_516."""
...
TUPLE_GETITEM_UNBIND_F32_516 = ShaderVariant(
    name='tuple_getitem_unbind_f32_516',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_516',
        fields=(
            TensorFieldSpec(
                name='x',
