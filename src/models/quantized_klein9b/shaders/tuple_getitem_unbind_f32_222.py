"""Generated shader: tuple_getitem_unbind_f32_222."""
...
TUPLE_GETITEM_UNBIND_F32_222 = ShaderVariant(
    name='tuple_getitem_unbind_f32_222',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_222',
        fields=(
            TensorFieldSpec(
                name='x',
