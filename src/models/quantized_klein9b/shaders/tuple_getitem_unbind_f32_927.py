"""Generated shader: tuple_getitem_unbind_f32_927."""
...
TUPLE_GETITEM_UNBIND_F32_927 = ShaderVariant(
    name='tuple_getitem_unbind_f32_927',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_927',
        fields=(
            TensorFieldSpec(
                name='x',
