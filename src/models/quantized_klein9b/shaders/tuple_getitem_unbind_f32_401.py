"""Generated shader: tuple_getitem_unbind_f32_401."""
...
TUPLE_GETITEM_UNBIND_F32_401 = ShaderVariant(
    name='tuple_getitem_unbind_f32_401',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_401',
        fields=(
            TensorFieldSpec(
                name='x',
