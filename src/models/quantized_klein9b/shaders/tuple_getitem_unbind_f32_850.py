"""Generated shader: tuple_getitem_unbind_f32_850."""
...
TUPLE_GETITEM_UNBIND_F32_850 = ShaderVariant(
    name='tuple_getitem_unbind_f32_850',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_850',
        fields=(
            TensorFieldSpec(
                name='x',
