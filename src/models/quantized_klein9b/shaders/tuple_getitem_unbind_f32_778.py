"""Generated shader: tuple_getitem_unbind_f32_778."""
...
TUPLE_GETITEM_UNBIND_F32_778 = ShaderVariant(
    name='tuple_getitem_unbind_f32_778',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_778',
        fields=(
            TensorFieldSpec(
                name='x',
