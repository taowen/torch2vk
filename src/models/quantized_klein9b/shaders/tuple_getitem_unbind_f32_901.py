"""Generated shader: tuple_getitem_unbind_f32_901."""
...
TUPLE_GETITEM_UNBIND_F32_901 = ShaderVariant(
    name='tuple_getitem_unbind_f32_901',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_901',
        fields=(
            TensorFieldSpec(
                name='x',
