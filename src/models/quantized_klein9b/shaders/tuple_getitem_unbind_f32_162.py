"""Generated shader: tuple_getitem_unbind_f32_162."""
...
TUPLE_GETITEM_UNBIND_F32_162 = ShaderVariant(
    name='tuple_getitem_unbind_f32_162',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_162',
        fields=(
            TensorFieldSpec(
                name='x',
