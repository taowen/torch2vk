"""Generated shader: tuple_getitem_unbind_f32_996."""
...
TUPLE_GETITEM_UNBIND_F32_996 = ShaderVariant(
    name='tuple_getitem_unbind_f32_996',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_996',
        fields=(
            TensorFieldSpec(
                name='x',
