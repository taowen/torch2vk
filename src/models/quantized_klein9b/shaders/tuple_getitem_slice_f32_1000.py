"""Generated shader: tuple_getitem_slice_f32_1000."""
...
TUPLE_GETITEM_SLICE_F32_1000 = ShaderVariant(
    name='tuple_getitem_slice_f32_1000',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1000',
        fields=(
            TensorFieldSpec(
                name='x',
