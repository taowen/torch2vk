"""Generated shader: tuple_getitem_unbind_f32_458."""
...
TUPLE_GETITEM_UNBIND_F32_458 = ShaderVariant(
    name='tuple_getitem_unbind_f32_458',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_458',
        fields=(
            TensorFieldSpec(
                name='x',
