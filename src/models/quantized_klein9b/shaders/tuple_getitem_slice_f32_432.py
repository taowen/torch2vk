"""Generated shader: tuple_getitem_slice_f32_432."""
...
TUPLE_GETITEM_SLICE_F32_432 = ShaderVariant(
    name='tuple_getitem_slice_f32_432',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_432',
        fields=(
            TensorFieldSpec(
                name='x',
