"""Generated shader: tuple_getitem_unbind_f32_395."""
...
TUPLE_GETITEM_UNBIND_F32_395 = ShaderVariant(
    name='tuple_getitem_unbind_f32_395',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_395',
        fields=(
            TensorFieldSpec(
                name='x',
