"""Generated shader: tuple_getitem_slice_f32_147."""
...
TUPLE_GETITEM_SLICE_F32_147 = ShaderVariant(
    name='tuple_getitem_slice_f32_147',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_147',
        fields=(
            TensorFieldSpec(
                name='x',
