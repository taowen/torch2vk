"""Generated shader: tuple_getitem_unbind_f32_646."""
...
TUPLE_GETITEM_UNBIND_F32_646 = ShaderVariant(
    name='tuple_getitem_unbind_f32_646',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_646',
        fields=(
            TensorFieldSpec(
                name='x',
