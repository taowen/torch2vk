"""Generated shader: tuple_getitem_unbind_f32_614."""
...
TUPLE_GETITEM_UNBIND_F32_614 = ShaderVariant(
    name='tuple_getitem_unbind_f32_614',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_614',
        fields=(
            TensorFieldSpec(
                name='x',
