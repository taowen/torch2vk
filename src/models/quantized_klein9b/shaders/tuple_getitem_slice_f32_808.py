"""Generated shader: tuple_getitem_slice_f32_808."""
...
TUPLE_GETITEM_SLICE_F32_808 = ShaderVariant(
    name='tuple_getitem_slice_f32_808',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_808',
        fields=(
            TensorFieldSpec(
                name='x',
