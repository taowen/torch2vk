"""Generated shader: flux_join_cat_2_f32."""
...
FLUX_JOIN_CAT_2_F32 = ShaderVariant(
    name='flux_join_cat_2_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportCat2Program',
        shader_name='flux_join_cat_2_f32',
        fields=(
            TensorFieldSpec(
                name='x0',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('OUT_STRIDE', PushConstantType.UINT32, 4, mul('O1', 'O2'), dynamic=False),
                PushConstantFieldSpec('END0', PushConstantType.UINT32, 8, mul('I0_1', 'I0_2'), dynamic=False),
                PushConstantFieldSpec('STRIDE0', PushConstantType.UINT32, 12, mul('I0_1', 'I0_2'), dynamic=False),
                PushConstantFieldSpec('END1', PushConstantType.UINT32, 16, add(mul('I0_1', 'I0_2'), mul('I1_1', 'I1_2')), dynamic=False),
                PushConstantFieldSpec('STRIDE1', PushConstantType.UINT32, 20, mul('I1_1', 'I1_2'), dynamic=False),
            ),
        ),
        params_buffer=None,
