"""Generated shader: tuple_getitem_unbind_f32_359."""
...
TUPLE_GETITEM_UNBIND_F32_359 = ShaderVariant(
    name='tuple_getitem_unbind_f32_359',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_359',
        fields=(
            TensorFieldSpec(
                name='x',
