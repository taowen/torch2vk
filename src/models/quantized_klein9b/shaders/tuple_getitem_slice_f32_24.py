"""Generated shader: tuple_getitem_slice_f32_24."""
...
TUPLE_GETITEM_SLICE_F32_24 = ShaderVariant(
    name='tuple_getitem_slice_f32_24',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_24',
        fields=(
            TensorFieldSpec(
                name='x',
