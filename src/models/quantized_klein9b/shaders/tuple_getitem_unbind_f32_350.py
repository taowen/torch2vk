"""Generated shader: tuple_getitem_unbind_f32_350."""
...
TUPLE_GETITEM_UNBIND_F32_350 = ShaderVariant(
    name='tuple_getitem_unbind_f32_350',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_350',
        fields=(
            TensorFieldSpec(
                name='x',
