"""Generated shader: tuple_getitem_slice_f32_474."""
...
TUPLE_GETITEM_SLICE_F32_474 = ShaderVariant(
    name='tuple_getitem_slice_f32_474',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_474',
        fields=(
            TensorFieldSpec(
                name='x',
