"""Generated shader: tuple_getitem_unbind_f32_335."""
...
TUPLE_GETITEM_UNBIND_F32_335 = ShaderVariant(
    name='tuple_getitem_unbind_f32_335',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_335',
        fields=(
            TensorFieldSpec(
                name='x',
