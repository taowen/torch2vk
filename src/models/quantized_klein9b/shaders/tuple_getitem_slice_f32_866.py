"""Generated shader: tuple_getitem_slice_f32_866."""
...
TUPLE_GETITEM_SLICE_F32_866 = ShaderVariant(
    name='tuple_getitem_slice_f32_866',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_866',
        fields=(
            TensorFieldSpec(
                name='x',
