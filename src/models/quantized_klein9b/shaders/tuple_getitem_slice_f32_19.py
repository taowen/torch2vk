"""Generated shader: tuple_getitem_slice_f32_19."""
...
TUPLE_GETITEM_SLICE_F32_19 = ShaderVariant(
    name='tuple_getitem_slice_f32_19',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_19',
        fields=(
            TensorFieldSpec(
                name='x',
