"""Generated shader: flux_single_block_silu_f32."""
...
FLUX_SINGLE_BLOCK_SILU_F32 = ShaderVariant(
    name='flux_single_block_silu_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportSiluF32Program',
        shader_name='flux_single_block_silu_f32',
        fields=(
            TensorFieldSpec(
                name='x',
