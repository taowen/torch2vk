"""Generated shader: tuple_getitem_unbind_f32_271."""
...
TUPLE_GETITEM_UNBIND_F32_271 = ShaderVariant(
    name='tuple_getitem_unbind_f32_271',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_271',
        fields=(
            TensorFieldSpec(
                name='x',
