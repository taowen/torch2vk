"""Generated shader: tuple_getitem_unbind_f32_1032."""
...
TUPLE_GETITEM_UNBIND_F32_1032 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1032',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1032',
        fields=(
            TensorFieldSpec(
                name='x',
