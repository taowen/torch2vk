"""Generated shader: tuple_getitem_slice_f32_211."""
...
TUPLE_GETITEM_SLICE_F32_211 = ShaderVariant(
    name='tuple_getitem_slice_f32_211',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_211',
        fields=(
            TensorFieldSpec(
                name='x',
