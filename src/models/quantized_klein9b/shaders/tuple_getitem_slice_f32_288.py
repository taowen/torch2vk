"""Generated shader: tuple_getitem_slice_f32_288."""
...
TUPLE_GETITEM_SLICE_F32_288 = ShaderVariant(
    name='tuple_getitem_slice_f32_288',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_288',
        fields=(
            TensorFieldSpec(
                name='x',
