"""Generated shader: tuple_getitem_slice_f32_1230."""
...
TUPLE_GETITEM_SLICE_F32_1230 = ShaderVariant(
    name='tuple_getitem_slice_f32_1230',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1230',
        fields=(
            TensorFieldSpec(
                name='x',
