"""Generated shader: tuple_getitem_slice_f32_660."""
...
TUPLE_GETITEM_SLICE_F32_660 = ShaderVariant(
    name='tuple_getitem_slice_f32_660',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_660',
        fields=(
            TensorFieldSpec(
                name='x',
