"""Generated shader: tuple_getitem_unbind_f32_8."""
...
TUPLE_GETITEM_UNBIND_F32_8 = ShaderVariant(
    name='tuple_getitem_unbind_f32_8',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_8',
        fields=(
            TensorFieldSpec(
                name='x',
