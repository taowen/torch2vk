"""Generated shader: tuple_getitem_unbind_f32_547."""
...
TUPLE_GETITEM_UNBIND_F32_547 = ShaderVariant(
    name='tuple_getitem_unbind_f32_547',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_547',
        fields=(
            TensorFieldSpec(
                name='x',
