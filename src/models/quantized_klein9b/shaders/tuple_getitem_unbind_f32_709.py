"""Generated shader: tuple_getitem_unbind_f32_709."""
...
TUPLE_GETITEM_UNBIND_F32_709 = ShaderVariant(
    name='tuple_getitem_unbind_f32_709',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_709',
        fields=(
            TensorFieldSpec(
                name='x',
