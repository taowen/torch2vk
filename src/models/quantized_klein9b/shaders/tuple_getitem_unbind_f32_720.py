"""Generated shader: tuple_getitem_unbind_f32_720."""
...
TUPLE_GETITEM_UNBIND_F32_720 = ShaderVariant(
    name='tuple_getitem_unbind_f32_720',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_720',
        fields=(
            TensorFieldSpec(
                name='x',
