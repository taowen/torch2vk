"""Generated shader: tuple_getitem_slice_f32_1263."""
...
TUPLE_GETITEM_SLICE_F32_1263 = ShaderVariant(
    name='tuple_getitem_slice_f32_1263',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1263',
        fields=(
            TensorFieldSpec(
                name='x',
