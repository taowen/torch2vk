"""Generated shader: tuple_getitem_slice_f32_148."""
...
TUPLE_GETITEM_SLICE_F32_148 = ShaderVariant(
    name='tuple_getitem_slice_f32_148',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_148',
        fields=(
            TensorFieldSpec(
                name='x',
