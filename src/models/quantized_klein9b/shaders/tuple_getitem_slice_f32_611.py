"""Generated shader: tuple_getitem_slice_f32_611."""
...
TUPLE_GETITEM_SLICE_F32_611 = ShaderVariant(
    name='tuple_getitem_slice_f32_611',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_611',
        fields=(
            TensorFieldSpec(
                name='x',
