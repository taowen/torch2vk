"""Generated shader: tuple_getitem_unbind_f32_970."""
...
TUPLE_GETITEM_UNBIND_F32_970 = ShaderVariant(
    name='tuple_getitem_unbind_f32_970',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_970',
        fields=(
            TensorFieldSpec(
                name='x',
