"""Generated shader: tuple_getitem_slice_f32_485."""
...
TUPLE_GETITEM_SLICE_F32_485 = ShaderVariant(
    name='tuple_getitem_slice_f32_485',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_485',
        fields=(
            TensorFieldSpec(
                name='x',
