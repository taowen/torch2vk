"""Generated shader: flux_single_block_mean_dim_f32."""
...
FLUX_SINGLE_BLOCK_MEAN_DIM_F32 = ShaderVariant(
    name='flux_single_block_mean_dim_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportMeanDimProgram',
        shader_name='flux_single_block_mean_dim_f32',
        fields=(
            TensorFieldSpec(
                name='x',
