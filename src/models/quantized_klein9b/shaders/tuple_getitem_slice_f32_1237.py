"""Generated shader: tuple_getitem_slice_f32_1237."""
...
TUPLE_GETITEM_SLICE_F32_1237 = ShaderVariant(
    name='tuple_getitem_slice_f32_1237',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1237',
        fields=(
            TensorFieldSpec(
                name='x',
