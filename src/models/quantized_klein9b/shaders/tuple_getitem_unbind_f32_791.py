"""Generated shader: tuple_getitem_unbind_f32_791."""
...
TUPLE_GETITEM_UNBIND_F32_791 = ShaderVariant(
    name='tuple_getitem_unbind_f32_791',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_791',
        fields=(
            TensorFieldSpec(
                name='x',
