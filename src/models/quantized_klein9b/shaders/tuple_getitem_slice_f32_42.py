"""Generated shader: tuple_getitem_slice_f32_42."""
...
TUPLE_GETITEM_SLICE_F32_42 = ShaderVariant(
    name='tuple_getitem_slice_f32_42',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_42',
        fields=(
            TensorFieldSpec(
                name='x',
