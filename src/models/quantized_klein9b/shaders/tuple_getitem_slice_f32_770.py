"""Generated shader: tuple_getitem_slice_f32_770."""
...
TUPLE_GETITEM_SLICE_F32_770 = ShaderVariant(
    name='tuple_getitem_slice_f32_770',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_770',
        fields=(
            TensorFieldSpec(
                name='x',
