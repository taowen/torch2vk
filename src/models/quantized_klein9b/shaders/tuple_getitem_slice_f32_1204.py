"""Generated shader: tuple_getitem_slice_f32_1204."""
...
TUPLE_GETITEM_SLICE_F32_1204 = ShaderVariant(
    name='tuple_getitem_slice_f32_1204',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1204',
        fields=(
            TensorFieldSpec(
                name='x',
