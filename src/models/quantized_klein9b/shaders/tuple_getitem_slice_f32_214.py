"""Generated shader: tuple_getitem_slice_f32_214."""
...
TUPLE_GETITEM_SLICE_F32_214 = ShaderVariant(
    name='tuple_getitem_slice_f32_214',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_214',
        fields=(
            TensorFieldSpec(
                name='x',
