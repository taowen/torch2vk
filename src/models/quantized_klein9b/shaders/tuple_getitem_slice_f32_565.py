"""Generated shader: tuple_getitem_slice_f32_565."""
...
TUPLE_GETITEM_SLICE_F32_565 = ShaderVariant(
    name='tuple_getitem_slice_f32_565',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_565',
        fields=(
            TensorFieldSpec(
                name='x',
