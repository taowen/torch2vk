"""Generated shader: ae_decode_add_scalar."""
...
AE_DECODE_ADD_SCALAR = ShaderVariant(
    name='ae_decode_add_scalar',
    family='export',
    contract=ShaderContract(
        class_name='ExportAddScalarProgram',
        shader_name='ae_decode_add_scalar',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('scalar', PushConstantType.FLOAT32, 4, 0.0001, dynamic=False),
            ),
        ),
        params_buffer=None,
