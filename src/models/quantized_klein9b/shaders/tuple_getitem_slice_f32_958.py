"""Generated shader: tuple_getitem_slice_f32_958."""
...
TUPLE_GETITEM_SLICE_F32_958 = ShaderVariant(
    name='tuple_getitem_slice_f32_958',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_958',
        fields=(
            TensorFieldSpec(
                name='x',
