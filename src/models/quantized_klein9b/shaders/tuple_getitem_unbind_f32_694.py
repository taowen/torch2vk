"""Generated shader: tuple_getitem_unbind_f32_694."""
...
TUPLE_GETITEM_UNBIND_F32_694 = ShaderVariant(
    name='tuple_getitem_unbind_f32_694',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_694',
        fields=(
            TensorFieldSpec(
                name='x',
