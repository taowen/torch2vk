"""Generated shader: tuple_getitem_slice_f32_582."""
...
TUPLE_GETITEM_SLICE_F32_582 = ShaderVariant(
    name='tuple_getitem_slice_f32_582',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_582',
        fields=(
            TensorFieldSpec(
                name='x',
