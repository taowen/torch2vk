"""Generated shader: tuple_getitem_slice_f32_149."""
...
TUPLE_GETITEM_SLICE_F32_149 = ShaderVariant(
    name='tuple_getitem_slice_f32_149',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_149',
        fields=(
            TensorFieldSpec(
                name='x',
