"""Generated shader: tuple_getitem_slice_f32_266."""
...
TUPLE_GETITEM_SLICE_F32_266 = ShaderVariant(
    name='tuple_getitem_slice_f32_266',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_266',
        fields=(
            TensorFieldSpec(
                name='x',
