"""Generated shader: tuple_getitem_slice_f32_1303."""
...
TUPLE_GETITEM_SLICE_F32_1303 = ShaderVariant(
    name='tuple_getitem_slice_f32_1303',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1303',
        fields=(
            TensorFieldSpec(
                name='x',
