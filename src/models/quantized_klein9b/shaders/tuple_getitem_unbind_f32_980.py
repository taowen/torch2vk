"""Generated shader: tuple_getitem_unbind_f32_980."""
...
TUPLE_GETITEM_UNBIND_F32_980 = ShaderVariant(
    name='tuple_getitem_unbind_f32_980',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_980',
        fields=(
            TensorFieldSpec(
                name='x',
