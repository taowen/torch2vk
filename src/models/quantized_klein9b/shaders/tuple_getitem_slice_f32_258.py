"""Generated shader: tuple_getitem_slice_f32_258."""
...
TUPLE_GETITEM_SLICE_F32_258 = ShaderVariant(
    name='tuple_getitem_slice_f32_258',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_258',
        fields=(
            TensorFieldSpec(
                name='x',
