"""Generated shader: tuple_getitem_slice_f32_608."""
...
TUPLE_GETITEM_SLICE_F32_608 = ShaderVariant(
    name='tuple_getitem_slice_f32_608',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_608',
        fields=(
            TensorFieldSpec(
                name='x',
