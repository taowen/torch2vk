"""Generated shader: tuple_getitem_unbind_f32_293."""
...
TUPLE_GETITEM_UNBIND_F32_293 = ShaderVariant(
    name='tuple_getitem_unbind_f32_293',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_293',
        fields=(
            TensorFieldSpec(
                name='x',
