"""Generated shader: tuple_getitem_unbind_f32_960."""
...
TUPLE_GETITEM_UNBIND_F32_960 = ShaderVariant(
    name='tuple_getitem_unbind_f32_960',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_960',
        fields=(
            TensorFieldSpec(
                name='x',
