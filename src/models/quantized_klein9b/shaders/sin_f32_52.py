...
SIN_F32_52 = ShaderVariant(
    name='sin_f32_52',
    family='export',
    contract=ShaderContract(
        class_name='ExportSinF32Program',
        shader_name='sin_f32_52',
        fields=(
            TensorFieldSpec(
                name='x',
...
void main() {
    ...
    if (idx < pc.N) { output_values[idx] = float16_t(sin(float(x[idx]))); }
}
""",
)
