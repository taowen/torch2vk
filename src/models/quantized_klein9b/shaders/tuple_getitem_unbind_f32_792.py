"""Generated shader: tuple_getitem_unbind_f32_792."""
...
TUPLE_GETITEM_UNBIND_F32_792 = ShaderVariant(
    name='tuple_getitem_unbind_f32_792',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_792',
        fields=(
            TensorFieldSpec(
                name='x',
