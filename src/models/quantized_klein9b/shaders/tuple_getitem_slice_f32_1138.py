"""Generated shader: tuple_getitem_slice_f32_1138."""
...
TUPLE_GETITEM_SLICE_F32_1138 = ShaderVariant(
    name='tuple_getitem_slice_f32_1138',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1138',
        fields=(
            TensorFieldSpec(
                name='x',
