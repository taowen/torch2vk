"""Generated shader: tuple_getitem_slice_f32_1210."""
...
TUPLE_GETITEM_SLICE_F32_1210 = ShaderVariant(
    name='tuple_getitem_slice_f32_1210',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1210',
        fields=(
            TensorFieldSpec(
                name='x',
