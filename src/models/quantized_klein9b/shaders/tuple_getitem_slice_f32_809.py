"""Generated shader: tuple_getitem_slice_f32_809."""
...
TUPLE_GETITEM_SLICE_F32_809 = ShaderVariant(
    name='tuple_getitem_slice_f32_809',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_809',
        fields=(
            TensorFieldSpec(
                name='x',
