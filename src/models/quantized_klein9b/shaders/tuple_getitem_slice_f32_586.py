"""Generated shader: tuple_getitem_slice_f32_586."""
...
TUPLE_GETITEM_SLICE_F32_586 = ShaderVariant(
    name='tuple_getitem_slice_f32_586',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_586',
        fields=(
            TensorFieldSpec(
                name='x',
