"""Generated shader: tuple_getitem_slice_f32_894."""
...
TUPLE_GETITEM_SLICE_F32_894 = ShaderVariant(
    name='tuple_getitem_slice_f32_894',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_894',
        fields=(
            TensorFieldSpec(
                name='x',
