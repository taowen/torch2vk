"""Generated shader: tuple_getitem_unbind_f32_278."""
...
TUPLE_GETITEM_UNBIND_F32_278 = ShaderVariant(
    name='tuple_getitem_unbind_f32_278',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_278',
        fields=(
            TensorFieldSpec(
                name='x',
