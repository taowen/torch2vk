"""Generated shader: tuple_getitem_unbind_f32_762."""
...
TUPLE_GETITEM_UNBIND_F32_762 = ShaderVariant(
    name='tuple_getitem_unbind_f32_762',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_762',
        fields=(
            TensorFieldSpec(
                name='x',
