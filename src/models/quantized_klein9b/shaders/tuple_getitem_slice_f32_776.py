"""Generated shader: tuple_getitem_slice_f32_776."""
...
TUPLE_GETITEM_SLICE_F32_776 = ShaderVariant(
    name='tuple_getitem_slice_f32_776',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_776',
        fields=(
            TensorFieldSpec(
                name='x',
