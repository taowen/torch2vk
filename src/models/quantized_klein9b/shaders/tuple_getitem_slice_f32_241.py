"""Generated shader: tuple_getitem_slice_f32_241."""
...
TUPLE_GETITEM_SLICE_F32_241 = ShaderVariant(
    name='tuple_getitem_slice_f32_241',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_241',
        fields=(
            TensorFieldSpec(
                name='x',
