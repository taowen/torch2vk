"""Generated shader: tuple_getitem_slice_f32_552."""
...
TUPLE_GETITEM_SLICE_F32_552 = ShaderVariant(
    name='tuple_getitem_slice_f32_552',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_552',
        fields=(
            TensorFieldSpec(
                name='x',
