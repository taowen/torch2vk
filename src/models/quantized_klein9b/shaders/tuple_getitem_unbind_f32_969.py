"""Generated shader: tuple_getitem_unbind_f32_969."""
...
TUPLE_GETITEM_UNBIND_F32_969 = ShaderVariant(
    name='tuple_getitem_unbind_f32_969',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_969',
        fields=(
            TensorFieldSpec(
                name='x',
