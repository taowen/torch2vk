"""Generated shader: tuple_getitem_unbind_f32_1108."""
...
TUPLE_GETITEM_UNBIND_F32_1108 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1108',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1108',
        fields=(
            TensorFieldSpec(
                name='x',
