"""Generated shader: tuple_getitem_unbind_f32_340."""
...
TUPLE_GETITEM_UNBIND_F32_340 = ShaderVariant(
    name='tuple_getitem_unbind_f32_340',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_340',
        fields=(
            TensorFieldSpec(
                name='x',
