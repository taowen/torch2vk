"""Generated shader: tuple_getitem_slice_f32_1182."""
...
TUPLE_GETITEM_SLICE_F32_1182 = ShaderVariant(
    name='tuple_getitem_slice_f32_1182',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1182',
        fields=(
            TensorFieldSpec(
                name='x',
