"""Generated shader: tuple_getitem_slice_f32_191."""
...
TUPLE_GETITEM_SLICE_F32_191 = ShaderVariant(
    name='tuple_getitem_slice_f32_191',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_191',
        fields=(
            TensorFieldSpec(
                name='x',
