"""Generated shader: tuple_getitem_unbind_f32_280."""
...
TUPLE_GETITEM_UNBIND_F32_280 = ShaderVariant(
    name='tuple_getitem_unbind_f32_280',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_280',
        fields=(
            TensorFieldSpec(
                name='x',
