"""Generated shader: tuple_getitem_slice_f32_481."""
...
TUPLE_GETITEM_SLICE_F32_481 = ShaderVariant(
    name='tuple_getitem_slice_f32_481',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_481',
        fields=(
            TensorFieldSpec(
                name='x',
