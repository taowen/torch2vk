"""Generated shader: tuple_getitem_unbind_f32_797."""
...
TUPLE_GETITEM_UNBIND_F32_797 = ShaderVariant(
    name='tuple_getitem_unbind_f32_797',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_797',
        fields=(
            TensorFieldSpec(
                name='x',
