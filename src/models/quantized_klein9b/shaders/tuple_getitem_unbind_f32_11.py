"""Generated shader: tuple_getitem_unbind_f32_11."""
...
TUPLE_GETITEM_UNBIND_F32_11 = ShaderVariant(
    name='tuple_getitem_unbind_f32_11',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_11',
        fields=(
            TensorFieldSpec(
                name='x',
