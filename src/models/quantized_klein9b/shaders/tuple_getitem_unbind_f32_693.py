"""Generated shader: tuple_getitem_unbind_f32_693."""
...
TUPLE_GETITEM_UNBIND_F32_693 = ShaderVariant(
    name='tuple_getitem_unbind_f32_693',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_693',
        fields=(
            TensorFieldSpec(
                name='x',
