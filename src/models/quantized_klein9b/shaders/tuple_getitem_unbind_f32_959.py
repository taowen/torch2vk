"""Generated shader: tuple_getitem_unbind_f32_959."""
...
TUPLE_GETITEM_UNBIND_F32_959 = ShaderVariant(
    name='tuple_getitem_unbind_f32_959',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_959',
        fields=(
            TensorFieldSpec(
                name='x',
