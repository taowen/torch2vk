"""Generated shader: tuple_getitem_slice_f32_543."""
...
TUPLE_GETITEM_SLICE_F32_543 = ShaderVariant(
    name='tuple_getitem_slice_f32_543',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_543',
        fields=(
            TensorFieldSpec(
                name='x',
