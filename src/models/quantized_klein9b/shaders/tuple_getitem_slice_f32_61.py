"""Generated shader: tuple_getitem_slice_f32_61."""
...
TUPLE_GETITEM_SLICE_F32_61 = ShaderVariant(
    name='tuple_getitem_slice_f32_61',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_61',
        fields=(
            TensorFieldSpec(
                name='x',
