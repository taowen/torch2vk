"""Generated shader: tuple_getitem_slice_f32_974."""
...
TUPLE_GETITEM_SLICE_F32_974 = ShaderVariant(
    name='tuple_getitem_slice_f32_974',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_974',
        fields=(
            TensorFieldSpec(
                name='x',
