"""Generated shader: tuple_getitem_unbind_f32_336."""
...
TUPLE_GETITEM_UNBIND_F32_336 = ShaderVariant(
    name='tuple_getitem_unbind_f32_336',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_336',
        fields=(
            TensorFieldSpec(
                name='x',
