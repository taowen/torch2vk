"""Generated shader: tuple_getitem_slice_f32_708."""
...
TUPLE_GETITEM_SLICE_F32_708 = ShaderVariant(
    name='tuple_getitem_slice_f32_708',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_708',
        fields=(
            TensorFieldSpec(
                name='x',
