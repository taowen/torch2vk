"""Generated shader: tuple_getitem_unbind_f32_713."""
...
TUPLE_GETITEM_UNBIND_F32_713 = ShaderVariant(
    name='tuple_getitem_unbind_f32_713',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_713',
        fields=(
            TensorFieldSpec(
                name='x',
