"""Generated shader: tuple_getitem_unbind_f32_819."""
...
TUPLE_GETITEM_UNBIND_F32_819 = ShaderVariant(
    name='tuple_getitem_unbind_f32_819',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_819',
        fields=(
            TensorFieldSpec(
                name='x',
