"""Generated shader: tuple_getitem_unbind_f32_347."""
...
TUPLE_GETITEM_UNBIND_F32_347 = ShaderVariant(
    name='tuple_getitem_unbind_f32_347',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_347',
        fields=(
            TensorFieldSpec(
                name='x',
