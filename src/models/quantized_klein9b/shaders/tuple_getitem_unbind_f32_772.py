"""Generated shader: tuple_getitem_unbind_f32_772."""
...
TUPLE_GETITEM_UNBIND_F32_772 = ShaderVariant(
    name='tuple_getitem_unbind_f32_772',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_772',
        fields=(
            TensorFieldSpec(
                name='x',
