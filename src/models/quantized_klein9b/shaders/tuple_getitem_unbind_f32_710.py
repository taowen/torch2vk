"""Generated shader: tuple_getitem_unbind_f32_710."""
...
TUPLE_GETITEM_UNBIND_F32_710 = ShaderVariant(
    name='tuple_getitem_unbind_f32_710',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_710',
        fields=(
            TensorFieldSpec(
                name='x',
