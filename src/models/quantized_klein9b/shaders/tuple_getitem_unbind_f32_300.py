"""Generated shader: tuple_getitem_unbind_f32_300."""
...
TUPLE_GETITEM_UNBIND_F32_300 = ShaderVariant(
    name='tuple_getitem_unbind_f32_300',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_300',
        fields=(
            TensorFieldSpec(
                name='x',
