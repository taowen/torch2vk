"""Generated shader: flux_single_block_mul_broadcast."""
...
FLUX_SINGLE_BLOCK_MUL_BROADCAST = ShaderVariant(
    name='flux_single_block_mul_broadcast',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='flux_single_block_mul_broadcast',
        fields=(
            TensorFieldSpec(
                name='x',
