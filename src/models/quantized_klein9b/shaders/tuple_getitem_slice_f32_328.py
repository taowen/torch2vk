"""Generated shader: tuple_getitem_slice_f32_328."""
...
TUPLE_GETITEM_SLICE_F32_328 = ShaderVariant(
    name='tuple_getitem_slice_f32_328',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_328',
        fields=(
            TensorFieldSpec(
                name='x',
