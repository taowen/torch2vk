"""Generated shader: tuple_getitem_unbind_f32_680."""
...
TUPLE_GETITEM_UNBIND_F32_680 = ShaderVariant(
    name='tuple_getitem_unbind_f32_680',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_680',
        fields=(
            TensorFieldSpec(
                name='x',
