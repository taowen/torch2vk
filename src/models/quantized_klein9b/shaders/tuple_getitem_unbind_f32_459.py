"""Generated shader: tuple_getitem_unbind_f32_459."""
...
TUPLE_GETITEM_UNBIND_F32_459 = ShaderVariant(
    name='tuple_getitem_unbind_f32_459',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_459',
        fields=(
            TensorFieldSpec(
                name='x',
