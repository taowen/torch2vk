"""Generated shader: tuple_getitem_unbind_f32_866."""
...
TUPLE_GETITEM_UNBIND_F32_866 = ShaderVariant(
    name='tuple_getitem_unbind_f32_866',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_866',
        fields=(
            TensorFieldSpec(
                name='x',
