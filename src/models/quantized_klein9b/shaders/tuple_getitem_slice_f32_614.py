"""Generated shader: tuple_getitem_slice_f32_614."""
...
TUPLE_GETITEM_SLICE_F32_614 = ShaderVariant(
    name='tuple_getitem_slice_f32_614',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_614',
        fields=(
            TensorFieldSpec(
                name='x',
