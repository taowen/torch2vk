"""Generated shader: tuple_getitem_unbind_f32_612."""
...
TUPLE_GETITEM_UNBIND_F32_612 = ShaderVariant(
    name='tuple_getitem_unbind_f32_612',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_612',
        fields=(
            TensorFieldSpec(
                name='x',
