"""Generated shader: tuple_getitem_unbind_f32_918."""
...
TUPLE_GETITEM_UNBIND_F32_918 = ShaderVariant(
    name='tuple_getitem_unbind_f32_918',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_918',
        fields=(
            TensorFieldSpec(
                name='x',
