"""Generated shader: tuple_getitem_slice_f32_1040."""
...
TUPLE_GETITEM_SLICE_F32_1040 = ShaderVariant(
    name='tuple_getitem_slice_f32_1040',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1040',
        fields=(
            TensorFieldSpec(
                name='x',
