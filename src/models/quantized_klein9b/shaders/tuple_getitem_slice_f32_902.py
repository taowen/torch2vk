"""Generated shader: tuple_getitem_slice_f32_902."""
...
TUPLE_GETITEM_SLICE_F32_902 = ShaderVariant(
    name='tuple_getitem_slice_f32_902',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_902',
        fields=(
            TensorFieldSpec(
                name='x',
