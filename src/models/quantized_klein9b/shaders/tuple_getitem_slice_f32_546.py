"""Generated shader: tuple_getitem_slice_f32_546."""
...
TUPLE_GETITEM_SLICE_F32_546 = ShaderVariant(
    name='tuple_getitem_slice_f32_546',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_546',
        fields=(
            TensorFieldSpec(
                name='x',
