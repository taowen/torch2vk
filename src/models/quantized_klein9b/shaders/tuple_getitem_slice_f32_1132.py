"""Generated shader: tuple_getitem_slice_f32_1132."""
...
TUPLE_GETITEM_SLICE_F32_1132 = ShaderVariant(
    name='tuple_getitem_slice_f32_1132',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_1132',
        fields=(
            TensorFieldSpec(
                name='x',
