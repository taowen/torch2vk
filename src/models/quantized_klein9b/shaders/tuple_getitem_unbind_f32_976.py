"""Generated shader: tuple_getitem_unbind_f32_976."""
...
TUPLE_GETITEM_UNBIND_F32_976 = ShaderVariant(
    name='tuple_getitem_unbind_f32_976',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_976',
        fields=(
            TensorFieldSpec(
                name='x',
