"""Generated shader: tuple_getitem_slice_f32_786."""
...
TUPLE_GETITEM_SLICE_F32_786 = ShaderVariant(
    name='tuple_getitem_slice_f32_786',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_786',
        fields=(
            TensorFieldSpec(
                name='x',
