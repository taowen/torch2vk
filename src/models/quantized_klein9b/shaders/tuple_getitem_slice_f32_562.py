"""Generated shader: tuple_getitem_slice_f32_562."""
...
TUPLE_GETITEM_SLICE_F32_562 = ShaderVariant(
    name='tuple_getitem_slice_f32_562',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemSliceProgram',
        shader_name='tuple_getitem_slice_f32_562',
        fields=(
            TensorFieldSpec(
                name='x',
