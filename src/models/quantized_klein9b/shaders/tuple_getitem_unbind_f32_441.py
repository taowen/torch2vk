"""Generated shader: tuple_getitem_unbind_f32_441."""
...
TUPLE_GETITEM_UNBIND_F32_441 = ShaderVariant(
    name='tuple_getitem_unbind_f32_441',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_441',
        fields=(
            TensorFieldSpec(
                name='x',
