"""Generated shader: tuple_getitem_unbind_f32_1184."""
...
TUPLE_GETITEM_UNBIND_F32_1184 = ShaderVariant(
    name='tuple_getitem_unbind_f32_1184',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_1184',
        fields=(
            TensorFieldSpec(
                name='x',
