"""Generated shader: tuple_getitem_unbind_f32_402."""
...
TUPLE_GETITEM_UNBIND_F32_402 = ShaderVariant(
    name='tuple_getitem_unbind_f32_402',
    family='export',
    contract=ShaderContract(
        class_name='ExportTupleGetitemUnbindProgram',
        shader_name='tuple_getitem_unbind_f32_402',
        fields=(
            TensorFieldSpec(
                name='x',
