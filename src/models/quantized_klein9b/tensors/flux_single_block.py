...
def create_flux_single_block(
    ...
    *,
    ...
    slice_6: LogicalTensor | None = None,
    ...
    tensors = FluxSingleBlockTensors(
        ...
        linear=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=prefix,
                spec=TensorSpec(dtype='float16', shape=(1, text_seq_len + image_seq_len, 36864)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        getitem=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=prefix,
                spec=TensorSpec(dtype='float16', shape=(1, text_seq_len + image_seq_len, 12288)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        getitem_1=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=prefix,
                spec=TensorSpec(dtype='float16', shape=(1, text_seq_len + image_seq_len, 24576)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        reshape=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=prefix,
                spec=TensorSpec(dtype='float16', shape=(1, text_seq_len + image_seq_len, 3, 32, 128)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        permute=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=prefix,
                spec=TensorSpec(dtype='float16', shape=(3, 1, 32, text_seq_len + image_seq_len, 128)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        slice_5=_bind_tensor(
            ...
            _declare_tensor(
                ...
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
                request_state='slice_5' in request_state_outputs,
            ),
        ),
        slice_6=_bind_tensor(
            slice_6,
            _declare_tensor(
                checkpoint=None,
                checkpoint_key=None,
                ...
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
                request_state='slice_6' in request_state_outputs,
            ),
        ),
        slice_7=_bind_tensor(
            slice_7,
            _declare_tensor(
                checkpoint=None,
                checkpoint_key=None,
                ...
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
                request_state='slice_7' in request_state_outputs,
            ),
        ),
        slice_8=_bind_tensor(
            slice_8,
            _declare_tensor(
                checkpoint=None,
                checkpoint_key=None,
                ...
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
                request_state='slice_8' in request_state_outputs,
            ),
        ),
        slice_9=_bind_tensor(
            slice_9,
            _declare_tensor(
                checkpoint=None,
                checkpoint_key=None,
        ...
        scaled_dot_product_attention_1=_bind_tensor(
            ...
            _declare_tensor(
                ...
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
                request_state='scaled_dot_product_attention_1' in request_state_outputs,
            ),
        ),
        cat_3=_bind_tensor(
            cat_3,
        ...
        cat_4=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key='cat_4',
                layer=prefix,
                spec=TensorSpec(dtype='float16', shape=(1, text_seq_len + image_seq_len, 16384)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
                request_state='cat_4' in request_state_outputs,
            ),
        ),
