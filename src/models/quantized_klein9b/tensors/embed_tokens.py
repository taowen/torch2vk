    ...
    tensors = EmbedTokensTensors(
        p_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                layer=None,
                spec=_quantized_weight_spec("model.embed_tokens.weight", dtype='float32', shape=(151936, 4096)),
                layout=_quantized_weight_layout("model.embed_tokens.weight", dtype='float32', shape=(151936, 4096)),
