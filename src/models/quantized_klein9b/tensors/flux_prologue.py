    ...
    tensors = FluxPrologueTensors(
        ...
        timesteps=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(1,)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.INPUT,
                memory=MemoryClass.HOST_INPUT,
                lifetime=TensorLifetime.FRAME,
        ...
        arange=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(128,)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        unsqueeze=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(1, 1)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        unsqueeze_1=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(1, 128)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        cat=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key='cat',
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(1, 256)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        linear_2=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(1, 24576)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        unsqueeze_2=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(1, 1, 24576)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        linear_4=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(1, 12288)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        unsqueeze_4=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(1, 1, 12288)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        div_1=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key='div_1',
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(16,)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        einsum=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(1, image_seq_len, 16)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        stack=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key='stack',
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(1, image_seq_len, 16, 4)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        reshape=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(1, image_seq_len, 16, 2, 2)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        cat_1=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key='cat_1',
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(1, image_seq_len, 64, 2, 2)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        einsum_4=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(1, text_seq_len, 16)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        stack_4=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(1, text_seq_len, 16, 4)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        reshape_4=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(1, text_seq_len, 16, 2, 2)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        cat_2=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key='cat_2',
                layer=None,
                spec=TensorSpec(dtype='float16', shape=(1, text_seq_len, 64, 2, 2)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
