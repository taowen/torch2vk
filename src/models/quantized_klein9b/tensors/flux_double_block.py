...
def create_flux_double_block(
    ...
    *,
    ...
    tensors = FluxDoubleBlockTensors(
        ...
        to_10=_bind_tensor(
            ...
            _declare_tensor(
                ...
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
                request_state='to_10' in request_state_outputs,
            ),
        ),
        to_11=_bind_tensor(
            to_11,
        ...
        cat_5=_bind_tensor(
            ...
            _declare_tensor(
                ...
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
                request_state='cat_5' in request_state_outputs,
            ),
        ),
        cat_6=_bind_tensor(
            cat_6,
            _declare_tensor(
                ...
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
                request_state='cat_6' in request_state_outputs,
            ),
        ),
        ...
        cat_7=_bind_tensor(
            ...
            _declare_tensor(
                ...
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
                request_state='cat_7' in request_state_outputs,
            ),
        ),
    ...
    _bind_alias_source(tensors.cat_1, tensors.to_12)
    _bind_alias_source(tensors.to_12, tensors.reshape_2)
    _bind_alias_source(tensors.cat_2, tensors.to_13)
