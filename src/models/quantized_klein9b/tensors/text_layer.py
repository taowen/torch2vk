...
def create_text_layer(
    ...
    *,
    ...
    tensors = TextLayerTensors(
        p_attn_q_proj_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                layer=prefix,
                spec=_quantized_weight_spec(f"model.layers.{layer_idx}.self_attn.q_proj.weight", dtype='float32', shape=(4096, 4096)),
                layout=_quantized_weight_layout(f"model.layers.{layer_idx}.self_attn.q_proj.weight", dtype='float32', shape=(4096, 4096)),
        ...
        p_attn_k_proj_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                layer=prefix,
                spec=_quantized_weight_spec(f"model.layers.{layer_idx}.self_attn.k_proj.weight", dtype='float32', shape=(1024, 4096)),
                layout=_quantized_weight_layout(f"model.layers.{layer_idx}.self_attn.k_proj.weight", dtype='float32', shape=(1024, 4096)),
                role=TensorRole.WEIGHT,
                memory=MemoryClass.MODEL_WEIGHT,
                lifetime=TensorLifetime.MODEL,
        ...
        p_attn_v_proj_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                layer=prefix,
                spec=_quantized_weight_spec(f"model.layers.{layer_idx}.self_attn.v_proj.weight", dtype='float32', shape=(1024, 4096)),
                layout=_quantized_weight_layout(f"model.layers.{layer_idx}.self_attn.v_proj.weight", dtype='float32', shape=(1024, 4096)),
                role=TensorRole.WEIGHT,
                memory=MemoryClass.MODEL_WEIGHT,
                lifetime=TensorLifetime.MODEL,
        ...
        p_attn_o_proj_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                layer=prefix,
                spec=_quantized_weight_spec(f"model.layers.{layer_idx}.self_attn.o_proj.weight", dtype='float32', shape=(4096, 4096)),
                layout=_quantized_weight_layout(f"model.layers.{layer_idx}.self_attn.o_proj.weight", dtype='float32', shape=(4096, 4096)),
                role=TensorRole.WEIGHT,
                memory=MemoryClass.MODEL_WEIGHT,
                lifetime=TensorLifetime.MODEL,
        ...
        p_mlp_gate_proj_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                layer=prefix,
                spec=_quantized_weight_spec(f"model.layers.{layer_idx}.mlp.gate_proj.weight", dtype='float32', shape=(12288, 4096)),
                layout=_quantized_weight_layout(f"model.layers.{layer_idx}.mlp.gate_proj.weight", dtype='float32', shape=(12288, 4096)),
                role=TensorRole.WEIGHT,
                memory=MemoryClass.MODEL_WEIGHT,
                lifetime=TensorLifetime.MODEL,
        ...
        p_mlp_up_proj_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                layer=prefix,
                spec=_quantized_weight_spec(f"model.layers.{layer_idx}.mlp.up_proj.weight", dtype='float32', shape=(12288, 4096)),
                layout=_quantized_weight_layout(f"model.layers.{layer_idx}.mlp.up_proj.weight", dtype='float32', shape=(12288, 4096)),
                role=TensorRole.WEIGHT,
                memory=MemoryClass.MODEL_WEIGHT,
                lifetime=TensorLifetime.MODEL,
        ...
        p_mlp_down_proj_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                layer=prefix,
                spec=_quantized_weight_spec(f"model.layers.{layer_idx}.mlp.down_proj.weight", dtype='float32', shape=(4096, 12288)),
                layout=_quantized_weight_layout(f"model.layers.{layer_idx}.mlp.down_proj.weight", dtype='float32', shape=(4096, 12288)),
                role=TensorRole.WEIGHT,
                memory=MemoryClass.MODEL_WEIGHT,
                lifetime=TensorLifetime.MODEL,
        ...
        p_input_layernorm_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                layer=prefix,
                spec=_quantized_weight_spec(f"model.layers.{layer_idx}.input_layernorm.weight", dtype='float32', shape=(4096,)),
                layout=_quantized_weight_layout(f"model.layers.{layer_idx}.input_layernorm.weight", dtype='float32', shape=(4096,)),
                role=TensorRole.WEIGHT,
                memory=MemoryClass.MODEL_WEIGHT,
                lifetime=TensorLifetime.MODEL,
        ...
        p_post_attention_layernorm_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                layer=prefix,
                spec=_quantized_weight_spec(f"model.layers.{layer_idx}.post_attention_layernorm.weight", dtype='float32', shape=(4096,)),
                layout=_quantized_weight_layout(f"model.layers.{layer_idx}.post_attention_layernorm.weight", dtype='float32', shape=(4096,)),
                role=TensorRole.WEIGHT,
                memory=MemoryClass.MODEL_WEIGHT,
                lifetime=TensorLifetime.MODEL,
        ...
        view=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key='view',
                layer=prefix,
                spec=TensorSpec(dtype='float16', shape=(1, sequence_length, 32, 128)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        pow_2=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key='pow_2',
                layer=prefix,
                spec=TensorSpec(dtype='float32', shape=(1, sequence_length, 32, 128)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        mean_1=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=prefix,
                spec=TensorSpec(dtype='float32', shape=(1, sequence_length, 32, 1)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        transpose=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=prefix,
                spec=TensorSpec(dtype='float16', shape=(1, 32, sequence_length, 128)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        mean_2=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=prefix,
                spec=TensorSpec(dtype='float32', shape=(1, sequence_length, 8, 1)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        slice_1=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=prefix,
                spec=TensorSpec(dtype='float16', shape=(1, 32, sequence_length, 64)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
        ...
        linear_4=_bind_tensor(
            ...
            _declare_tensor(
                ...
                layer=prefix,
                spec=TensorSpec(dtype='float16', shape=(1, sequence_length, 12288)),
                layout=CONTIGUOUS_LAYOUT,
                role=TensorRole.ACTIVATION,
                memory=MemoryClass.FRAME_WORKSPACE,
                lifetime=TensorLifetime.FRAME,
    ...
    _bind_alias_source(tensors.transpose_3, tensors.contiguous)
    _bind_alias_source(tensors.contiguous, tensors.reshape)
