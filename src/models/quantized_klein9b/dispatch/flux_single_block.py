...
from models.quantized_klein9b.shaders.flux_single_block_mul_broadcast_23 import FLUX_SINGLE_BLOCK_MUL_BROADCAST_23
...
def _run_flux_single_block_with_tensors(rt: RuntimeSession, tensors: FluxSingleBlockTensors) -> None:
    ...
    FLUX_SINGLE_BLOCK_MUL_BROADCAST_18(rt, x=tensors.to_2, y=tensors.rsqrt_1, output=tensors.mul_3)
    ...
    FLUX_SINGLE_BLOCK_MUL_BROADCAST_23(rt, x=tensors.select_2, y=tensors.select_3, output=tensors.mul_6)
