...
from models.quantized_klein9b.shaders.add_f32_48 import ADD_F32_48
from models.quantized_klein9b.shaders.add_f32_50 import ADD_F32_50
...
from models.quantized_klein9b.shaders.tuple_getitem_slice_f32_44 import TUPLE_GETITEM_SLICE_F32_44
from models.quantized_klein9b.shaders.tuple_getitem_slice_f32_49 import TUPLE_GETITEM_SLICE_F32_49
...
def _run_flux_double_block_with_tensors(rt: RuntimeSession, tensors: FluxDoubleBlockTensors) -> None:
    ...
    SLICE_F32_41(rt, x=tensors.reshape_6, output=tensors.slice_2)
    ...
    ADD_F32_42(rt, x=tensors.img, y=tensors.mul_14, output=tensors.add_10)
    ...
    TUPLE_GETITEM_SLICE_F32_44(rt, x=tensors.linear_3, output=tensors.getitem_7)
    ...
    ADD_F32_47(rt, x=tensors.add_10, y=tensors.mul_17, output=tensors.add_13)
    ...
    ADD_F32_48(rt, x=tensors.txt, y=tensors.mul_18, output=tensors.add_14)
    ...
    TUPLE_GETITEM_SLICE_F32_49(rt, x=tensors.linear_6, output=tensors.getitem_9)
    ...
    ADD_F32_50(rt, x=tensors.add_14, y=tensors.mul_21, output=tensors.add_17)
