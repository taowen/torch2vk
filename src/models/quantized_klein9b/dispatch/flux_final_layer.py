...
def _run_flux_final_layer_with_tensors(rt: RuntimeSession, tensors: FluxFinalLayerTensors) -> None:
    ...
    LINEAR_NOBIAS_Q8_0_MATVEC_F32(rt, x=tensors.silu, weight=tensors.p_final_layer_adaln_modulation_1_weight, output=tensors.linear)
    ...
    LINEAR_NOBIAS_Q8_0_F32(rt, x=tensors.add_1, weight=tensors.p_final_layer_linear_weight, output=tensors.linear_1)
