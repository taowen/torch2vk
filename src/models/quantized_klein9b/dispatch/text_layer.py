...
from models.quantized_klein9b.shaders.add_f32_33 import ADD_F32_33
from models.quantized_klein9b.shaders.add_f32_36 import ADD_F32_36
...
from models.quantized_klein9b.shaders.add_scalar_9 import ADD_SCALAR_9
...
from models.quantized_klein9b.shaders.mean_dim_f32_15 import MEAN_DIM_F32_15
from models.quantized_klein9b.shaders.mean_dim_f32_8 import MEAN_DIM_F32_8
from models.quantized_klein9b.shaders.mul_broadcast import MUL_BROADCAST
from models.quantized_klein9b.shaders.mul_broadcast_11 import MUL_BROADCAST_11
from models.quantized_klein9b.shaders.mul_broadcast_18 import MUL_BROADCAST_18
from models.quantized_klein9b.shaders.mul_broadcast_21 import MUL_BROADCAST_21
from models.quantized_klein9b.shaders.mul_broadcast_26 import MUL_BROADCAST_26
from models.quantized_klein9b.shaders.mul_broadcast_28 import MUL_BROADCAST_28
from models.quantized_klein9b.shaders.mul_broadcast_30 import MUL_BROADCAST_30
from models.quantized_klein9b.shaders.mul_f32 import MUL_F32
from models.quantized_klein9b.shaders.mul_left_broadcast_f32x_f32 import MUL_LEFT_BROADCAST_F32X_F32
from models.quantized_klein9b.shaders.mul_left_broadcast_f32x_f32_12 import MUL_LEFT_BROADCAST_F32X_F32_12
from models.quantized_klein9b.shaders.mul_left_broadcast_f32x_f32_19 import MUL_LEFT_BROADCAST_F32X_F32_19
...
from models.quantized_klein9b.shaders.pow_scalar_f32_14 import POW_SCALAR_F32_14
from models.quantized_klein9b.shaders.pow_scalar_f32_7 import POW_SCALAR_F32_7
from models.quantized_klein9b.shaders.rsqrt_f32 import RSQRT_F32
from models.quantized_klein9b.shaders.rsqrt_f32_10 import RSQRT_F32_10
from models.quantized_klein9b.shaders.rsqrt_f32_17 import RSQRT_F32_17
from models.quantized_klein9b.shaders.sdpa_causal_f32 import SDPA_CAUSAL_F32
...
from models.quantized_klein9b.shaders.slice_f32_23 import SLICE_F32_23
from models.quantized_klein9b.shaders.slice_f32_29 import SLICE_F32_29
from models.quantized_klein9b.shaders.transpose_f32_2dc99c47fa import TRANSPOSE_F32_2DC99C47FA
from models.quantized_klein9b.shaders.transpose_f32_7fc420207d import TRANSPOSE_F32_7FC420207D
from models.quantized_klein9b.shaders.transpose_f32_9ce66395f4 import TRANSPOSE_F32_9CE66395F4
from models.quantized_klein9b.tensors.text_layer import TextLayerTensors
...
def _run_text_layer_with_tensors(rt: RuntimeSession, tensors: TextLayerTensors) -> None:
    ...
    LINEAR_NOBIAS_Q8_0_F32(rt, x=tensors.mul_1, weight=tensors.p_attn_q_proj_weight, output=tensors.linear)
    ...
    MUL_BROADCAST_11(rt, x=tensors.to_2, y=tensors.rsqrt_1, output=tensors.mul_2)
    MUL_LEFT_BROADCAST_F32X_F32_12(rt, x=tensors.p_attn_q_norm_weight, y=tensors.to_3, output=tensors.mul_3)
    TRANSPOSE_F32_2DC99C47FA(rt, x=tensors.mul_3, output=tensors.transpose)
    LINEAR_NOBIAS_Q8_0_F32(rt, x=tensors.mul_1, weight=tensors.p_attn_k_proj_weight, output=tensors.linear_1)
    ...
    MUL_BROADCAST_18(rt, x=tensors.to_4, y=tensors.rsqrt_2, output=tensors.mul_4)
    MUL_LEFT_BROADCAST_F32X_F32_19(rt, x=tensors.p_attn_k_norm_weight, y=tensors.to_5, output=tensors.mul_5)
    TRANSPOSE_F32_7FC420207D(rt, x=tensors.mul_5, output=tensors.transpose_1)
    LINEAR_NOBIAS_Q8_0_F32(rt, x=tensors.mul_1, weight=tensors.p_attn_v_proj_weight, output=tensors.linear_2)
    TRANSPOSE_F32_7FC420207D(rt, x=tensors.view_2, output=tensors.transpose_2)
    MUL_BROADCAST_21(rt, x=tensors.transpose, y=tensors.unsqueeze, output=tensors.mul_6)
    ...
    MUL_BROADCAST_26(rt, x=tensors.cat, y=tensors.unsqueeze_1, output=tensors.mul_7)
    ADD_F32(rt, x=tensors.mul_6, y=tensors.mul_7, output=tensors.add_3)
    MUL_BROADCAST_28(rt, x=tensors.transpose_1, y=tensors.unsqueeze, output=tensors.mul_8)
    ...
    MUL_BROADCAST_30(rt, x=tensors.cat_1, y=tensors.unsqueeze_1, output=tensors.mul_9)
    ...
    TRANSPOSE_F32_9CE66395F4(rt, x=tensors.scaled_dot_product_attention, output=tensors.transpose_3)
    LINEAR_NOBIAS_Q8_0_F32(rt, x=tensors.reshape, weight=tensors.p_attn_o_proj_weight, output=tensors.linear_3)
    ...
    MUL_BROADCAST(rt, x=tensors.to_6, y=tensors.rsqrt_3, output=tensors.mul_10)
    MUL_LEFT_BROADCAST_F32X_F32(rt, x=tensors.p_post_attention_layernorm_weight, y=tensors.to_7, output=tensors.mul_11)
    LINEAR_NOBIAS_Q8_0_F32(rt, x=tensors.mul_11, weight=tensors.p_mlp_gate_proj_weight, output=tensors.linear_4)
    SILU_F32(rt, x=tensors.linear_4, output=tensors.silu)
    LINEAR_NOBIAS_Q8_0_F32(rt, x=tensors.mul_11, weight=tensors.p_mlp_up_proj_weight, output=tensors.linear_5)
    MUL_F32(rt, x=tensors.silu, y=tensors.linear_5, output=tensors.mul_12)
    LINEAR_NOBIAS_Q8_0_F32(rt, x=tensors.mul_12, weight=tensors.p_mlp_down_proj_weight, output=tensors.linear_6)
