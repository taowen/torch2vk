...
from models.quantized_klein9b.shaders.conv2d_q8_0w_f32b_f16_10 import CONV2D_Q8_0W_F32B_F16_10
from models.quantized_klein9b.shaders.conv2d_q8_0w_f32b_f16_11 import CONV2D_Q8_0W_F32B_F16_11
from models.quantized_klein9b.shaders.conv2d_q8_0w_f32b_f16_13 import CONV2D_Q8_0W_F32B_F16_13
...
from models.quantized_klein9b.shaders.conv2d_q8_0w_f32b_f16_19 import CONV2D_Q8_0W_F32B_F16_19
...
from models.quantized_klein9b.shaders.conv2d_q8_0w_f32b_f16_29 import CONV2D_Q8_0W_F32B_F16_29
...
from models.quantized_klein9b.shaders.conv2d_q8_0w_f32b_f16_6 import CONV2D_Q8_0W_F32B_F16_6
...
def _run_ae_decode_with_tensors(rt: RuntimeSession, tensors: AeDecodeTensors) -> None:
    ...
    AE_DECODE_MUL_BROADCAST(rt, x=tensors.tokens, y=tensors.sqrt, output=tensors.mul)
    AE_DECODE_ADD_BROADCAST_INNER(rt, x=tensors.mul, y=tensors.view_1, output=tensors.add_1)
    PERMUTE_F32_3CCD7BC8AF(rt, x=tensors.reshape, output=tensors.permute)
    ...
    CONV2D_Q8_0W_F32B_F16_6(rt, x=tensors.conv2d, weight=tensors.p_decoder_conv_in_weight, bias=tensors.p_decoder_conv_in_bias, output=tensors.conv2d_1)
    ...
    CONV2D_Q8_0W_F32B_F16_10(rt, x=tensors.mul_5, weight=tensors.p_decoder_mid_block_1_conv1_weight, bias=tensors.p_decoder_mid_block_1_conv1_bias, output=tensors.conv2d_2)
    ...
    CONV2D_Q8_0W_F32B_F16_11(rt, x=tensors.mul_8, weight=tensors.p_decoder_mid_block_1_conv2_weight, bias=tensors.p_decoder_mid_block_1_conv2_bias, output=tensors.conv2d_3)
    ...
    CONV2D_Q8_0W_F32B_F16_13(rt, x=tensors.group_norm_2, weight=tensors.p_decoder_mid_attn_1_q_weight, bias=tensors.p_decoder_mid_attn_1_q_bias, output=tensors.conv2d_4)
    CONV2D_Q8_0W_F32B_F16_14(rt, x=tensors.group_norm_2, weight=tensors.p_decoder_mid_attn_1_k_weight, bias=tensors.p_decoder_mid_attn_1_k_bias, output=tensors.conv2d_5)
    CONV2D_Q8_0W_F32B_F16_15(rt, x=tensors.group_norm_2, weight=tensors.p_decoder_mid_attn_1_v_weight, bias=tensors.p_decoder_mid_attn_1_v_bias, output=tensors.conv2d_6)
    PERMUTE_F32_671CD9AFC1(rt, x=tensors.conv2d_4, output=tensors.permute_1)
    PERMUTE_F32_671CD9AFC1(rt, x=tensors.conv2d_5, output=tensors.permute_2)
    PERMUTE_F32_671CD9AFC1(rt, x=tensors.conv2d_6, output=tensors.permute_3)
    SDPA_WIDE_F16(rt, q=tensors.contiguous, k=tensors.contiguous_1, v=tensors.contiguous_2, output=tensors.scaled_dot_product_attention)
    PERMUTE_F32_79954A5639(rt, x=tensors.reshape_5, output=tensors.permute_4)
    CONV2D_Q8_0W_F32B_F16_19(rt, x=tensors.permute_4, weight=tensors.p_decoder_mid_attn_1_proj_out_weight, bias=tensors.p_decoder_mid_attn_1_proj_out_bias, output=tensors.conv2d_7)
    ...
    CONV2D_Q8_0W_F32B_F16_20(rt, x=tensors.mul_17, weight=tensors.p_decoder_mid_block_2_conv1_weight, bias=tensors.p_decoder_mid_block_2_conv1_bias, output=tensors.conv2d_8)
    ...
    CONV2D_Q8_0W_F32B_F16_21(rt, x=tensors.mul_20, weight=tensors.p_decoder_mid_block_2_conv2_weight, bias=tensors.p_decoder_mid_block_2_conv2_bias, output=tensors.conv2d_9)
    ...
    CONV2D_Q8_0W_F32B_F16_22(rt, x=tensors.mul_23, weight=tensors.p_decoder_up_3_block_0_conv1_weight, bias=tensors.p_decoder_up_3_block_0_conv1_bias, output=tensors.conv2d_10)
    ...
    CONV2D_Q8_0W_F32B_F16_23(rt, x=tensors.mul_26, weight=tensors.p_decoder_up_3_block_0_conv2_weight, bias=tensors.p_decoder_up_3_block_0_conv2_bias, output=tensors.conv2d_11)
    ...
    CONV2D_Q8_0W_F32B_F16_24(rt, x=tensors.mul_29, weight=tensors.p_decoder_up_3_block_1_conv1_weight, bias=tensors.p_decoder_up_3_block_1_conv1_bias, output=tensors.conv2d_12)
    ...
    CONV2D_Q8_0W_F32B_F16_25(rt, x=tensors.mul_32, weight=tensors.p_decoder_up_3_block_1_conv2_weight, bias=tensors.p_decoder_up_3_block_1_conv2_bias, output=tensors.conv2d_13)
    ...
    CONV2D_Q8_0W_F32B_F16_26(rt, x=tensors.mul_35, weight=tensors.p_decoder_up_3_block_2_conv1_weight, bias=tensors.p_decoder_up_3_block_2_conv1_bias, output=tensors.conv2d_14)
    ...
    CONV2D_Q8_0W_F32B_F16_27(rt, x=tensors.mul_38, weight=tensors.p_decoder_up_3_block_2_conv2_weight, bias=tensors.p_decoder_up_3_block_2_conv2_bias, output=tensors.conv2d_15)
    ...
    CONV2D_Q8_0W_F32B_F16_29(rt, x=tensors.upsample_nearest2d, weight=tensors.p_decoder_up_3_upsample_conv_weight, bias=tensors.p_decoder_up_3_upsample_conv_bias, output=tensors.conv2d_16)
    ...
    CONV2D_Q8_0W_F32B_F16_30(rt, x=tensors.mul_41, weight=tensors.p_decoder_up_2_block_0_conv1_weight, bias=tensors.p_decoder_up_2_block_0_conv1_bias, output=tensors.conv2d_17)
    ...
    CONV2D_Q8_0W_F32B_F16_31(rt, x=tensors.mul_44, weight=tensors.p_decoder_up_2_block_0_conv2_weight, bias=tensors.p_decoder_up_2_block_0_conv2_bias, output=tensors.conv2d_18)
    ...
    CONV2D_Q8_0W_F32B_F16_32(rt, x=tensors.mul_47, weight=tensors.p_decoder_up_2_block_1_conv1_weight, bias=tensors.p_decoder_up_2_block_1_conv1_bias, output=tensors.conv2d_19)
    ...
    CONV2D_Q8_0W_F32B_F16_33(rt, x=tensors.mul_50, weight=tensors.p_decoder_up_2_block_1_conv2_weight, bias=tensors.p_decoder_up_2_block_1_conv2_bias, output=tensors.conv2d_20)
    ...
    CONV2D_Q8_0W_F32B_F16_34(rt, x=tensors.mul_53, weight=tensors.p_decoder_up_2_block_2_conv1_weight, bias=tensors.p_decoder_up_2_block_2_conv1_bias, output=tensors.conv2d_21)
    ...
    CONV2D_Q8_0W_F32B_F16_35(rt, x=tensors.mul_56, weight=tensors.p_decoder_up_2_block_2_conv2_weight, bias=tensors.p_decoder_up_2_block_2_conv2_bias, output=tensors.conv2d_22)
    ...
    CONV2D_Q8_0W_F32B_F16_36(rt, x=tensors.upsample_nearest2d_1, weight=tensors.p_decoder_up_2_upsample_conv_weight, bias=tensors.p_decoder_up_2_upsample_conv_bias, output=tensors.conv2d_23)
    ...
    CONV2D_Q8_0W_F32B_F16_37(rt, x=tensors.mul_59, weight=tensors.p_decoder_up_1_block_0_conv1_weight, bias=tensors.p_decoder_up_1_block_0_conv1_bias, output=tensors.conv2d_24)
    ...
    CONV2D_Q8_0W_F32B_F16_38(rt, x=tensors.mul_62, weight=tensors.p_decoder_up_1_block_0_conv2_weight, bias=tensors.p_decoder_up_1_block_0_conv2_bias, output=tensors.conv2d_25)
    CONV2D_Q8_0W_F32B_F16_39(rt, x=tensors.conv2d_23, weight=tensors.p_decoder_up_1_block_0_nin_shortcut_weight, bias=tensors.p_decoder_up_1_block_0_nin_shortcut_bias, output=tensors.conv2d_26)
    ...
    CONV2D_Q8_0W_F32B_F16_40(rt, x=tensors.mul_65, weight=tensors.p_decoder_up_1_block_1_conv1_weight, bias=tensors.p_decoder_up_1_block_1_conv1_bias, output=tensors.conv2d_27)
    ...
    CONV2D_Q8_0W_F32B_F16_41(rt, x=tensors.mul_68, weight=tensors.p_decoder_up_1_block_1_conv2_weight, bias=tensors.p_decoder_up_1_block_1_conv2_bias, output=tensors.conv2d_28)
    ...
    CONV2D_Q8_0W_F32B_F16_42(rt, x=tensors.mul_71, weight=tensors.p_decoder_up_1_block_2_conv1_weight, bias=tensors.p_decoder_up_1_block_2_conv1_bias, output=tensors.conv2d_29)
    ...
    CONV2D_Q8_0W_F32B_F16_43(rt, x=tensors.mul_74, weight=tensors.p_decoder_up_1_block_2_conv2_weight, bias=tensors.p_decoder_up_1_block_2_conv2_bias, output=tensors.conv2d_30)
    ...
    CONV2D_Q8_0W_F32B_F16_44(rt, x=tensors.upsample_nearest2d_2, weight=tensors.p_decoder_up_1_upsample_conv_weight, bias=tensors.p_decoder_up_1_upsample_conv_bias, output=tensors.conv2d_31)
    ...
    CONV2D_Q8_0W_F32B_F16_45(rt, x=tensors.mul_77, weight=tensors.p_decoder_up_0_block_0_conv1_weight, bias=tensors.p_decoder_up_0_block_0_conv1_bias, output=tensors.conv2d_32)
    ...
    CONV2D_Q8_0W_F32B_F16_46(rt, x=tensors.mul_80, weight=tensors.p_decoder_up_0_block_0_conv2_weight, bias=tensors.p_decoder_up_0_block_0_conv2_bias, output=tensors.conv2d_33)
    CONV2D_Q8_0W_F32B_F16_47(rt, x=tensors.conv2d_31, weight=tensors.p_decoder_up_0_block_0_nin_shortcut_weight, bias=tensors.p_decoder_up_0_block_0_nin_shortcut_bias, output=tensors.conv2d_34)
    ...
    CONV2D_Q8_0W_F32B_F16_48(rt, x=tensors.mul_83, weight=tensors.p_decoder_up_0_block_1_conv1_weight, bias=tensors.p_decoder_up_0_block_1_conv1_bias, output=tensors.conv2d_35)
    ...
    CONV2D_Q8_0W_F32B_F16_49(rt, x=tensors.mul_86, weight=tensors.p_decoder_up_0_block_1_conv2_weight, bias=tensors.p_decoder_up_0_block_1_conv2_bias, output=tensors.conv2d_36)
    ...
    CONV2D_Q8_0W_F32B_F16_50(rt, x=tensors.mul_89, weight=tensors.p_decoder_up_0_block_2_conv1_weight, bias=tensors.p_decoder_up_0_block_2_conv1_bias, output=tensors.conv2d_37)
    ...
    CONV2D_Q8_0W_F32B_F16_51(rt, x=tensors.mul_92, weight=tensors.p_decoder_up_0_block_2_conv2_weight, bias=tensors.p_decoder_up_0_block_2_conv2_bias, output=tensors.conv2d_38)
    ...
    CONV2D_Q8_0W_F32B_F16_52(rt, x=tensors.mul_95, weight=tensors.p_decoder_conv_out_weight, bias=tensors.p_decoder_conv_out_bias, output=tensors.conv2d_39)
