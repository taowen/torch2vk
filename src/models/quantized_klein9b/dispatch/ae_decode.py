...
def _run_ae_decode_with_tensors(rt: RuntimeSession, tensors: AeDecodeTensors) -> None:
    ...
    rt.release_frame_workspace(tensors.sqrt)
    ...
    rt.release_frame_workspace(tensors.conv2d)
    ...
    rt.release_frame_workspace(tensors.group_norm)
    rt.release_frame_workspace(tensors.sigmoid)
    ...
    rt.release_frame_workspace(tensors.conv2d_2)
    ...
    rt.release_frame_workspace(tensors.group_norm_1)
    rt.release_frame_workspace(tensors.sigmoid_1)
    ...
    rt.release_frame_workspace(tensors.conv2d_1)
    rt.release_frame_workspace(tensors.conv2d_3)
    ...
    rt.release_frame_workspace(tensors.conv2d_7)
    ...
    rt.release_frame_workspace(tensors.group_norm_3)
    rt.release_frame_workspace(tensors.sigmoid_2)
    ...
    rt.release_frame_workspace(tensors.conv2d_8)
    ...
    rt.release_frame_workspace(tensors.group_norm_4)
    rt.release_frame_workspace(tensors.sigmoid_3)
    ...
    rt.release_frame_workspace(tensors.conv2d_9)
    ...
    rt.release_frame_workspace(tensors.group_norm_5)
    rt.release_frame_workspace(tensors.sigmoid_4)
    ...
    rt.release_frame_workspace(tensors.conv2d_10)
    ...
    rt.release_frame_workspace(tensors.group_norm_6)
    rt.release_frame_workspace(tensors.sigmoid_5)
    ...
    rt.release_frame_workspace(tensors.conv2d_11)
    ...
    rt.release_frame_workspace(tensors.group_norm_7)
    rt.release_frame_workspace(tensors.sigmoid_6)
    ...
    rt.release_frame_workspace(tensors.conv2d_12)
    ...
    rt.release_frame_workspace(tensors.group_norm_8)
    rt.release_frame_workspace(tensors.sigmoid_7)
    ...
    rt.release_frame_workspace(tensors.conv2d_13)
    ...
    rt.release_frame_workspace(tensors.group_norm_9)
    rt.release_frame_workspace(tensors.sigmoid_8)
    ...
    rt.release_frame_workspace(tensors.conv2d_14)
    ...
    rt.release_frame_workspace(tensors.group_norm_10)
    rt.release_frame_workspace(tensors.sigmoid_9)
    ...
    rt.release_frame_workspace(tensors.conv2d_15)
    ...
    rt.release_frame_workspace(tensors.upsample_nearest2d)
    ...
    rt.release_frame_workspace(tensors.group_norm_11)
    rt.release_frame_workspace(tensors.sigmoid_10)
    ...
    rt.release_frame_workspace(tensors.conv2d_17)
    ...
    rt.release_frame_workspace(tensors.group_norm_12)
    rt.release_frame_workspace(tensors.sigmoid_11)
    ...
    rt.release_frame_workspace(tensors.conv2d_16)
    rt.release_frame_workspace(tensors.conv2d_18)
    ...
    rt.release_frame_workspace(tensors.group_norm_13)
    rt.release_frame_workspace(tensors.sigmoid_12)
    ...
    rt.release_frame_workspace(tensors.conv2d_19)
    ...
    rt.release_frame_workspace(tensors.group_norm_14)
    rt.release_frame_workspace(tensors.sigmoid_13)
    ...
    rt.release_frame_workspace(tensors.conv2d_20)
    ...
    rt.release_frame_workspace(tensors.group_norm_15)
    rt.release_frame_workspace(tensors.sigmoid_14)
    ...
    rt.release_frame_workspace(tensors.conv2d_21)
    ...
    rt.release_frame_workspace(tensors.group_norm_16)
    rt.release_frame_workspace(tensors.sigmoid_15)
    ...
    rt.release_frame_workspace(tensors.conv2d_22)
    ...
    rt.release_frame_workspace(tensors.upsample_nearest2d_1)
    ...
    rt.release_frame_workspace(tensors.group_norm_17)
    rt.release_frame_workspace(tensors.sigmoid_16)
    ...
    rt.release_frame_workspace(tensors.conv2d_24)
    ...
    rt.release_frame_workspace(tensors.group_norm_18)
    rt.release_frame_workspace(tensors.sigmoid_17)
    ...
    rt.release_frame_workspace(tensors.conv2d_23)
    ADD_F32(rt, x=tensors.conv2d_26, y=tensors.conv2d_25, output=tensors.add_11)
    rt.release_frame_workspace(tensors.conv2d_25)
    rt.release_frame_workspace(tensors.conv2d_26)
    ...
    rt.release_frame_workspace(tensors.group_norm_19)
    rt.release_frame_workspace(tensors.sigmoid_18)
    ...
    rt.release_frame_workspace(tensors.conv2d_27)
    ...
    rt.release_frame_workspace(tensors.group_norm_20)
    rt.release_frame_workspace(tensors.sigmoid_19)
    ...
    rt.release_frame_workspace(tensors.conv2d_28)
    ...
    rt.release_frame_workspace(tensors.group_norm_21)
    rt.release_frame_workspace(tensors.sigmoid_20)
    ...
    rt.release_frame_workspace(tensors.conv2d_29)
    ...
    rt.release_frame_workspace(tensors.group_norm_22)
    rt.release_frame_workspace(tensors.sigmoid_21)
    ...
    rt.release_frame_workspace(tensors.conv2d_30)
    ...
    rt.release_frame_workspace(tensors.upsample_nearest2d_2)
    ...
    rt.release_frame_workspace(tensors.group_norm_23)
    rt.release_frame_workspace(tensors.sigmoid_22)
    ...
    rt.release_frame_workspace(tensors.conv2d_32)
    ...
    rt.release_frame_workspace(tensors.group_norm_24)
    rt.release_frame_workspace(tensors.sigmoid_23)
    ...
    rt.release_frame_workspace(tensors.conv2d_31)
    ADD_F32(rt, x=tensors.conv2d_34, y=tensors.conv2d_33, output=tensors.add_14)
    rt.release_frame_workspace(tensors.conv2d_33)
    rt.release_frame_workspace(tensors.conv2d_34)
    ...
    rt.release_frame_workspace(tensors.group_norm_25)
    rt.release_frame_workspace(tensors.sigmoid_24)
    ...
    rt.release_frame_workspace(tensors.conv2d_35)
    ...
    rt.release_frame_workspace(tensors.group_norm_26)
    rt.release_frame_workspace(tensors.sigmoid_25)
    ...
    rt.release_frame_workspace(tensors.conv2d_36)
    ...
    rt.release_frame_workspace(tensors.group_norm_27)
    rt.release_frame_workspace(tensors.sigmoid_26)
    ...
    rt.release_frame_workspace(tensors.conv2d_37)
    ...
    rt.release_frame_workspace(tensors.group_norm_28)
    rt.release_frame_workspace(tensors.sigmoid_27)
    ...
    rt.release_frame_workspace(tensors.conv2d_38)
    ...
    rt.release_frame_workspace(tensors.group_norm_29)
    rt.release_frame_workspace(tensors.sigmoid_28)
