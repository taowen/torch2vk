...
def _run_ae_decode_with_tensors(rt: RuntimeSession, tensors: AeDecodeTensors) -> None:
    PERMUTE_F32_43FEE4AC2B(rt, x=tensors.reshape, output=tensors.permute)
    ...
    PERMUTE_F32_3CCD7BC8AF(rt, x=tensors.reshape_1, output=tensors.permute_1)
    CONV2D_Q8_0W_F32B_F16(rt, x=tensors.reshape_2, weight=tensors.p_decoder_post_quant_conv_weight, bias=tensors.p_decoder_post_quant_conv_bias, output=tensors.conv2d)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm, y=tensors.sigmoid, output=tensors.mul_1)
    CONV2D_Q8_0W_F32B_F16_11(rt, x=tensors.mul_1, weight=tensors.p_decoder_mid_block_1_conv1_weight, bias=tensors.p_decoder_mid_block_1_conv1_bias, output=tensors.conv2d_2)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_1, y=tensors.sigmoid_1, output=tensors.mul_2)
    CONV2D_Q8_0W_F32B_F16_12(rt, x=tensors.mul_2, weight=tensors.p_decoder_mid_block_1_conv2_weight, bias=tensors.p_decoder_mid_block_1_conv2_bias, output=tensors.conv2d_3)
    ...
    PERMUTE_F32_79954A5639(rt, x=tensors.reshape_6, output=tensors.permute_5)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_3, y=tensors.sigmoid_2, output=tensors.mul_3)
    CONV2D_Q8_0W_F32B_F16_21(rt, x=tensors.mul_3, weight=tensors.p_decoder_mid_block_2_conv1_weight, bias=tensors.p_decoder_mid_block_2_conv1_bias, output=tensors.conv2d_8)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_4, y=tensors.sigmoid_3, output=tensors.mul_4)
    CONV2D_Q8_0W_F32B_F16_22(rt, x=tensors.mul_4, weight=tensors.p_decoder_mid_block_2_conv2_weight, bias=tensors.p_decoder_mid_block_2_conv2_bias, output=tensors.conv2d_9)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_5, y=tensors.sigmoid_4, output=tensors.mul_5)
    CONV2D_Q8_0W_F32B_F16_23(rt, x=tensors.mul_5, weight=tensors.p_decoder_up_3_block_0_conv1_weight, bias=tensors.p_decoder_up_3_block_0_conv1_bias, output=tensors.conv2d_10)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_6, y=tensors.sigmoid_5, output=tensors.mul_6)
    CONV2D_Q8_0W_F32B_F16_24(rt, x=tensors.mul_6, weight=tensors.p_decoder_up_3_block_0_conv2_weight, bias=tensors.p_decoder_up_3_block_0_conv2_bias, output=tensors.conv2d_11)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_7, y=tensors.sigmoid_6, output=tensors.mul_7)
    CONV2D_Q8_0W_F32B_F16_25(rt, x=tensors.mul_7, weight=tensors.p_decoder_up_3_block_1_conv1_weight, bias=tensors.p_decoder_up_3_block_1_conv1_bias, output=tensors.conv2d_12)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_8, y=tensors.sigmoid_7, output=tensors.mul_8)
    CONV2D_Q8_0W_F32B_F16_26(rt, x=tensors.mul_8, weight=tensors.p_decoder_up_3_block_1_conv2_weight, bias=tensors.p_decoder_up_3_block_1_conv2_bias, output=tensors.conv2d_13)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_9, y=tensors.sigmoid_8, output=tensors.mul_9)
    CONV2D_Q8_0W_F32B_F16_27(rt, x=tensors.mul_9, weight=tensors.p_decoder_up_3_block_2_conv1_weight, bias=tensors.p_decoder_up_3_block_2_conv1_bias, output=tensors.conv2d_14)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_10, y=tensors.sigmoid_9, output=tensors.mul_10)
    CONV2D_Q8_0W_F32B_F16_28(rt, x=tensors.mul_10, weight=tensors.p_decoder_up_3_block_2_conv2_weight, bias=tensors.p_decoder_up_3_block_2_conv2_bias, output=tensors.conv2d_15)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_11, y=tensors.sigmoid_10, output=tensors.mul_11)
    CONV2D_Q8_0W_F32B_F16_31(rt, x=tensors.mul_11, weight=tensors.p_decoder_up_2_block_0_conv1_weight, bias=tensors.p_decoder_up_2_block_0_conv1_bias, output=tensors.conv2d_17)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_12, y=tensors.sigmoid_11, output=tensors.mul_12)
    CONV2D_Q8_0W_F32B_F16_32(rt, x=tensors.mul_12, weight=tensors.p_decoder_up_2_block_0_conv2_weight, bias=tensors.p_decoder_up_2_block_0_conv2_bias, output=tensors.conv2d_18)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_13, y=tensors.sigmoid_12, output=tensors.mul_13)
    CONV2D_Q8_0W_F32B_F16_33(rt, x=tensors.mul_13, weight=tensors.p_decoder_up_2_block_1_conv1_weight, bias=tensors.p_decoder_up_2_block_1_conv1_bias, output=tensors.conv2d_19)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_14, y=tensors.sigmoid_13, output=tensors.mul_14)
    CONV2D_Q8_0W_F32B_F16_34(rt, x=tensors.mul_14, weight=tensors.p_decoder_up_2_block_1_conv2_weight, bias=tensors.p_decoder_up_2_block_1_conv2_bias, output=tensors.conv2d_20)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_15, y=tensors.sigmoid_14, output=tensors.mul_15)
    CONV2D_Q8_0W_F32B_F16_35(rt, x=tensors.mul_15, weight=tensors.p_decoder_up_2_block_2_conv1_weight, bias=tensors.p_decoder_up_2_block_2_conv1_bias, output=tensors.conv2d_21)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_16, y=tensors.sigmoid_15, output=tensors.mul_16)
    CONV2D_Q8_0W_F32B_F16_36(rt, x=tensors.mul_16, weight=tensors.p_decoder_up_2_block_2_conv2_weight, bias=tensors.p_decoder_up_2_block_2_conv2_bias, output=tensors.conv2d_22)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_17, y=tensors.sigmoid_16, output=tensors.mul_17)
    CONV2D_Q8_0W_F32B_F16_38(rt, x=tensors.mul_17, weight=tensors.p_decoder_up_1_block_0_conv1_weight, bias=tensors.p_decoder_up_1_block_0_conv1_bias, output=tensors.conv2d_24)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_18, y=tensors.sigmoid_17, output=tensors.mul_18)
    CONV2D_Q8_0W_F32B_F16_39(rt, x=tensors.mul_18, weight=tensors.p_decoder_up_1_block_0_conv2_weight, bias=tensors.p_decoder_up_1_block_0_conv2_bias, output=tensors.conv2d_25)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_19, y=tensors.sigmoid_18, output=tensors.mul_19)
    CONV2D_Q8_0W_F32B_F16_41(rt, x=tensors.mul_19, weight=tensors.p_decoder_up_1_block_1_conv1_weight, bias=tensors.p_decoder_up_1_block_1_conv1_bias, output=tensors.conv2d_27)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_20, y=tensors.sigmoid_19, output=tensors.mul_20)
    CONV2D_Q8_0W_F32B_F16_42(rt, x=tensors.mul_20, weight=tensors.p_decoder_up_1_block_1_conv2_weight, bias=tensors.p_decoder_up_1_block_1_conv2_bias, output=tensors.conv2d_28)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_21, y=tensors.sigmoid_20, output=tensors.mul_21)
    CONV2D_Q8_0W_F32B_F16_43(rt, x=tensors.mul_21, weight=tensors.p_decoder_up_1_block_2_conv1_weight, bias=tensors.p_decoder_up_1_block_2_conv1_bias, output=tensors.conv2d_29)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_22, y=tensors.sigmoid_21, output=tensors.mul_22)
    CONV2D_Q8_0W_F32B_F16_44(rt, x=tensors.mul_22, weight=tensors.p_decoder_up_1_block_2_conv2_weight, bias=tensors.p_decoder_up_1_block_2_conv2_bias, output=tensors.conv2d_30)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_23, y=tensors.sigmoid_22, output=tensors.mul_23)
    CONV2D_Q8_0W_F32B_F16_46(rt, x=tensors.mul_23, weight=tensors.p_decoder_up_0_block_0_conv1_weight, bias=tensors.p_decoder_up_0_block_0_conv1_bias, output=tensors.conv2d_32)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_24, y=tensors.sigmoid_23, output=tensors.mul_24)
    CONV2D_Q8_0W_F32B_F16_47(rt, x=tensors.mul_24, weight=tensors.p_decoder_up_0_block_0_conv2_weight, bias=tensors.p_decoder_up_0_block_0_conv2_bias, output=tensors.conv2d_33)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_25, y=tensors.sigmoid_24, output=tensors.mul_25)
    CONV2D_Q8_0W_F32B_F16_49(rt, x=tensors.mul_25, weight=tensors.p_decoder_up_0_block_1_conv1_weight, bias=tensors.p_decoder_up_0_block_1_conv1_bias, output=tensors.conv2d_35)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_26, y=tensors.sigmoid_25, output=tensors.mul_26)
    CONV2D_Q8_0W_F32B_F16_50(rt, x=tensors.mul_26, weight=tensors.p_decoder_up_0_block_1_conv2_weight, bias=tensors.p_decoder_up_0_block_1_conv2_bias, output=tensors.conv2d_36)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_27, y=tensors.sigmoid_26, output=tensors.mul_27)
    CONV2D_Q8_0W_F32B_F16_51(rt, x=tensors.mul_27, weight=tensors.p_decoder_up_0_block_2_conv1_weight, bias=tensors.p_decoder_up_0_block_2_conv1_bias, output=tensors.conv2d_37)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_28, y=tensors.sigmoid_27, output=tensors.mul_28)
    CONV2D_Q8_0W_F32B_F16_52(rt, x=tensors.mul_28, weight=tensors.p_decoder_up_0_block_2_conv2_weight, bias=tensors.p_decoder_up_0_block_2_conv2_bias, output=tensors.conv2d_38)
    ...
    AE_DECODE_MUL_F32(rt, x=tensors.group_norm_29, y=tensors.sigmoid_28, output=tensors.mul_29)
    CONV2D_Q8_0W_F32B_F16_53(rt, x=tensors.mul_29, weight=tensors.p_decoder_conv_out_weight, bias=tensors.p_decoder_conv_out_bias, output=tensors.conv2d_39)
