...
Run from project root:
    .venv/bin/python -m models.quantized_qwen3_asr.compare
"""
...
from models.quantized_qwen3_asr import reference
...
def compare_decode_steps(
    *,
    ...
    if max_new_tokens != 1:
        raise ValueError("quantized_qwen3_asr compare covers prefill only; use run.py for decode replay")
