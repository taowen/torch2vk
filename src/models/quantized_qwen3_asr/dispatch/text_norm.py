...
from models.quantized_qwen3_asr.tensors.text_norm import TextNormTensors
from torch2vk.runtime.session import RuntimeSession


def _run_text_norm_with_tensors(rt: RuntimeSession, tensors: TextNormTensors) -> None:
    RMS_NORM_F32W_F32(rt, x=tensors.hidden_states, weight=tensors.p_weight, output=tensors.rms_norm)
