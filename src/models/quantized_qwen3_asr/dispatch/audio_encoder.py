...
from models.quantized_qwen3_asr.shaders.conv2d_q8_0w_f32b_f32 import CONV2D_Q8_0W_F32B_F32
from models.quantized_qwen3_asr.shaders.conv2d_q8_0w_f32b_f32_2 import CONV2D_Q8_0W_F32B_F32_2
from models.quantized_qwen3_asr.shaders.conv2d_q8_0w_f32b_f32_3 import CONV2D_Q8_0W_F32B_F32_3
...
def _run_audio_encoder_with_tensors(rt: RuntimeSession, tensors: AudioEncoderTensors) -> None:
    CONV2D_Q8_0W_F32B_F32(rt, x=tensors.x, weight=tensors.p_audio_tower_conv2d1_weight, bias=tensors.p_audio_tower_conv2d1_bias, output=tensors.conv2d)
    GELU_F32(rt, x=tensors.conv2d, output=tensors.gelu)
    CONV2D_Q8_0W_F32B_F32_2(rt, x=tensors.gelu, weight=tensors.p_audio_tower_conv2d2_weight, bias=tensors.p_audio_tower_conv2d2_bias, output=tensors.conv2d_1)
    ...
    for layer_t in tensors.layers:
        ...
        LINEAR_BIAS_Q8_0W_F32B_F32_ACT_F32(rt, x=layer_t.layer_norm, weight=layer_t.p_audio_tower_layers_0_self_attn_q_proj_weight, bias=layer_t.p_audio_tower_layers_0_self_attn_q_proj_bias, output=layer_t.linear_1)
        LINEAR_BIAS_Q8_0W_F32B_F32_ACT_F32(rt, x=layer_t.layer_norm, weight=layer_t.p_audio_tower_layers_0_self_attn_k_proj_weight, bias=layer_t.p_audio_tower_layers_0_self_attn_k_proj_bias, output=layer_t.linear_2)
        LINEAR_BIAS_Q8_0W_F32B_F32_ACT_F32(rt, x=layer_t.layer_norm, weight=layer_t.p_audio_tower_layers_0_self_attn_v_proj_weight, bias=layer_t.p_audio_tower_layers_0_self_attn_v_proj_bias, output=layer_t.linear_3)
        ...
        LINEAR_BIAS_Q8_0W_F32B_F32_ACT_F32(rt, x=layer_t.reshape_5, weight=layer_t.p_audio_tower_layers_0_self_attn_out_proj_weight, bias=layer_t.p_audio_tower_layers_0_self_attn_out_proj_bias, output=layer_t.linear_4)
        ...
        LINEAR_BIAS_Q8_0W_F32B_F32_ACT_F32(rt, x=layer_t.layer_norm_1, weight=layer_t.p_audio_tower_layers_0_fc1_weight, bias=layer_t.p_audio_tower_layers_0_fc1_bias, output=layer_t.linear_5)
        GELU_F32_18(rt, x=layer_t.linear_5, output=layer_t.gelu_3)
        LINEAR_BIAS_Q8_0W_F32B_F32_ACT_F32(rt, x=layer_t.gelu_3, weight=layer_t.p_audio_tower_layers_0_fc2_weight, bias=layer_t.p_audio_tower_layers_0_fc2_bias, output=layer_t.linear_6)
    ...
    LINEAR_BIAS_Q8_0W_F32B_F32_ACT_F32(rt, x=tensors.layer_norm_36, weight=tensors.p_audio_tower_proj1_weight, bias=tensors.p_audio_tower_proj1_bias, output=tensors.linear_109)
    GELU_F32_88(rt, x=tensors.linear_109, output=tensors.gelu_21)
    LINEAR_BIAS_Q8_0W_F32B_F32_ACT_F32(rt, x=tensors.gelu_21, weight=tensors.p_audio_tower_proj2_weight, bias=tensors.p_audio_tower_proj2_bias, output=tensors.linear_110)
