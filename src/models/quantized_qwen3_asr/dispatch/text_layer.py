...
from models.quantized_qwen3_asr.shaders.linear_nobias_q4_k_f32_act_f32 import LINEAR_NOBIAS_Q4_K_F32_ACT_F32
from models.quantized_qwen3_asr.shaders.linear_nobias_q6_k_f32_act_f32 import LINEAR_NOBIAS_Q6_K_F32_ACT_F32
...
def _run_text_layer_with_tensors(rt: RuntimeSession, tensors: TextLayerTensors) -> None:
    ...
    run_quantized_linear(rt, q4=LINEAR_NOBIAS_Q4_K_F32_ACT_F32, q6=LINEAR_NOBIAS_Q6_K_F32_ACT_F32, q8=LINEAR_NOBIAS_Q8_0_F32_ACT_F32, x=tensors.mul_1, weight=tensors.p_attn_q_proj_weight, output=tensors.linear)
    ...
    run_quantized_linear(rt, q4=LINEAR_NOBIAS_Q4_K_F32_ACT_F32, q6=LINEAR_NOBIAS_Q6_K_F32_ACT_F32, q8=LINEAR_NOBIAS_Q8_0_F32_ACT_F32, x=tensors.mul_1, weight=tensors.p_attn_k_proj_weight, output=tensors.linear_1)
    ...
    run_quantized_linear(rt, q4=LINEAR_NOBIAS_Q4_K_F32_ACT_F32, q6=LINEAR_NOBIAS_Q6_K_F32_ACT_F32, q8=LINEAR_NOBIAS_Q8_0_F32_ACT_F32, x=tensors.mul_1, weight=tensors.p_attn_v_proj_weight, output=tensors.linear_2)
    ...
    run_quantized_linear(rt, q4=LINEAR_NOBIAS_Q4_K_F32_ACT_F32, q6=LINEAR_NOBIAS_Q6_K_F32_ACT_F32, q8=LINEAR_NOBIAS_Q8_0_F32_ACT_F32, x=tensors.reshape, weight=tensors.p_attn_o_proj_weight, output=tensors.linear_3)
    ...
    run_quantized_linear(rt, q4=LINEAR_NOBIAS_Q4_K_F32_ACT_F32, q6=LINEAR_NOBIAS_Q6_K_F32_ACT_F32, q8=LINEAR_NOBIAS_Q8_0_F32_ACT_F32, x=tensors.mul_11, weight=tensors.p_mlp_gate_proj_weight, output=tensors.linear_4)
    SILU_F32(rt, x=tensors.linear_4, output=tensors.silu)
    run_quantized_linear(rt, q4=LINEAR_NOBIAS_Q4_K_F32_ACT_F32, q6=LINEAR_NOBIAS_Q6_K_F32_ACT_F32, q8=LINEAR_NOBIAS_Q8_0_F32_ACT_F32, x=tensors.mul_11, weight=tensors.p_mlp_up_proj_weight, output=tensors.linear_5)
    MUL_F32(rt, x=tensors.silu, y=tensors.linear_5, output=tensors.mul_12)
    run_quantized_linear(rt, q4=LINEAR_NOBIAS_Q4_K_F32_ACT_F32, q6=LINEAR_NOBIAS_Q6_K_F32_ACT_F32, q8=LINEAR_NOBIAS_Q8_0_F32_ACT_F32, x=tensors.mul_12, weight=tensors.p_mlp_down_proj_weight, output=tensors.linear_6)
