...
from models.quantized_qwen3_asr.shaders.add_f32_38 import ADD_F32_38
from models.quantized_qwen3_asr.shaders.add_f32_44 import ADD_F32_44
...
from models.quantized_qwen3_asr.shaders.decode_layer_cat_f32 import DECODE_LAYER_CAT_F32
from models.quantized_qwen3_asr.shaders.decode_layer_cat_f32_32 import DECODE_LAYER_CAT_F32_32
from models.quantized_qwen3_asr.shaders.decode_layer_mean_dim_f32 import DECODE_LAYER_MEAN_DIM_F32
from models.quantized_qwen3_asr.shaders.decode_layer_mean_dim_f32_16 import DECODE_LAYER_MEAN_DIM_F32_16
from models.quantized_qwen3_asr.shaders.decode_layer_mean_dim_f32_8 import DECODE_LAYER_MEAN_DIM_F32_8
from models.quantized_qwen3_asr.shaders.decode_layer_mul_broadcast_inner import DECODE_LAYER_MUL_BROADCAST_INNER
from models.quantized_qwen3_asr.shaders.decode_layer_mul_broadcast_inner_29 import DECODE_LAYER_MUL_BROADCAST_INNER_29
from models.quantized_qwen3_asr.shaders.decode_layer_mul_broadcast_inner_33 import DECODE_LAYER_MUL_BROADCAST_INNER_33
from models.quantized_qwen3_asr.shaders.decode_layer_mul_broadcast_last import DECODE_LAYER_MUL_BROADCAST_LAST
from models.quantized_qwen3_asr.shaders.decode_layer_mul_broadcast_last_11 import DECODE_LAYER_MUL_BROADCAST_LAST_11
from models.quantized_qwen3_asr.shaders.decode_layer_mul_broadcast_last_19 import DECODE_LAYER_MUL_BROADCAST_LAST_19
from models.quantized_qwen3_asr.shaders.decode_layer_slice_f32 import DECODE_LAYER_SLICE_F32
from models.quantized_qwen3_asr.shaders.decode_layer_slice_f32_25 import DECODE_LAYER_SLICE_F32_25
from models.quantized_qwen3_asr.shaders.decode_layer_slice_f32_30 import DECODE_LAYER_SLICE_F32_30
from models.quantized_qwen3_asr.shaders.decode_layer_slice_f32_31 import DECODE_LAYER_SLICE_F32_31
...
from models.quantized_qwen3_asr.shaders.linear_nobias_q4_k_matvec_f32_14 import LINEAR_NOBIAS_Q4_K_MATVEC_F32_14
from models.quantized_qwen3_asr.shaders.linear_nobias_q4_k_matvec_f32_22 import LINEAR_NOBIAS_Q4_K_MATVEC_F32_22
from models.quantized_qwen3_asr.shaders.linear_nobias_q4_k_matvec_f32_37 import LINEAR_NOBIAS_Q4_K_MATVEC_F32_37
from models.quantized_qwen3_asr.shaders.linear_nobias_q4_k_matvec_f32_39 import LINEAR_NOBIAS_Q4_K_MATVEC_F32_39
from models.quantized_qwen3_asr.shaders.linear_nobias_q4_k_matvec_f32_41 import LINEAR_NOBIAS_Q4_K_MATVEC_F32_41
from models.quantized_qwen3_asr.shaders.linear_nobias_q4_k_matvec_f32_43 import LINEAR_NOBIAS_Q4_K_MATVEC_F32_43
