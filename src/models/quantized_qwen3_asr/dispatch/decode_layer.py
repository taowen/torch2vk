...
from models.quantized_qwen3_asr.shaders.add_f32_34 import ADD_F32_34
from models.quantized_qwen3_asr.shaders.add_f32_37 import ADD_F32_37
from models.quantized_qwen3_asr.shaders.add_scalar import ADD_SCALAR
from models.quantized_qwen3_asr.shaders.add_scalar_10 import ADD_SCALAR_10
from models.quantized_qwen3_asr.shaders.add_scalar_17 import ADD_SCALAR_17
...
from models.quantized_qwen3_asr.shaders.decode_layer_mul_broadcast_inner import DECODE_LAYER_MUL_BROADCAST_INNER
from models.quantized_qwen3_asr.shaders.decode_layer_mul_broadcast_inner_28 import DECODE_LAYER_MUL_BROADCAST_INNER_28
from models.quantized_qwen3_asr.shaders.decode_layer_mul_broadcast_inner_30 import DECODE_LAYER_MUL_BROADCAST_INNER_30
from models.quantized_qwen3_asr.shaders.decode_layer_mul_broadcast_last import DECODE_LAYER_MUL_BROADCAST_LAST
from models.quantized_qwen3_asr.shaders.decode_layer_mul_broadcast_last_12 import DECODE_LAYER_MUL_BROADCAST_LAST_12
from models.quantized_qwen3_asr.shaders.decode_layer_mul_broadcast_last_19 import DECODE_LAYER_MUL_BROADCAST_LAST_19
...
from models.quantized_qwen3_asr.shaders.mean_dim_f32_16 import MEAN_DIM_F32_16
from models.quantized_qwen3_asr.shaders.mean_dim_f32_9 import MEAN_DIM_F32_9
...
from models.quantized_qwen3_asr.shaders.mul_left_broadcast_f32x_f32_13 import MUL_LEFT_BROADCAST_F32X_F32_13
from models.quantized_qwen3_asr.shaders.mul_left_broadcast_f32x_f32_20 import MUL_LEFT_BROADCAST_F32X_F32_20
...
from models.quantized_qwen3_asr.shaders.pow_scalar_f32_15 import POW_SCALAR_F32_15
from models.quantized_qwen3_asr.shaders.pow_scalar_f32_8 import POW_SCALAR_F32_8
from models.quantized_qwen3_asr.shaders.rsqrt_f32 import RSQRT_F32
from models.quantized_qwen3_asr.shaders.rsqrt_f32_11 import RSQRT_F32_11
from models.quantized_qwen3_asr.shaders.rsqrt_f32_18 import RSQRT_F32_18
...
from models.quantized_qwen3_asr.shaders.slice_f32_24 import SLICE_F32_24
...
def _run_decode_layer_with_tensors(rt: RuntimeSession, tensors: DecodeLayerTensors) -> None:
    ...
    _linear_q4_or_q6(rt, q4=LINEAR_NOBIAS_Q4_K_MATVEC_F32, q6=LINEAR_NOBIAS_Q6_K_MATVEC_F32, x=tensors.mul_1, weight=tensors.p_attn_q_proj_weight, output=tensors.linear)
    ...
    DECODE_LAYER_MUL_BROADCAST_LAST_12(rt, x=tensors.to_2, y=tensors.rsqrt_1, output=tensors.mul_2)
    ...
    _linear_q4_or_q6(rt, q4=LINEAR_NOBIAS_Q4_K_MATVEC_F32, q6=LINEAR_NOBIAS_Q6_K_MATVEC_F32, x=tensors.mul_1, weight=tensors.p_attn_k_proj_weight, output=tensors.linear_1)
    ...
    _linear_q4_or_q6(rt, q4=LINEAR_NOBIAS_Q4_K_MATVEC_F32, q6=LINEAR_NOBIAS_Q6_K_MATVEC_F32, x=tensors.mul_1, weight=tensors.p_attn_v_proj_weight, output=tensors.linear_2)
    ...
    DECODE_LAYER_MUL_BROADCAST_INNER_28(rt, x=tensors.transpose_1, y=tensors.unsqueeze, output=tensors.mul_8)
    ...
    DECODE_LAYER_MUL_BROADCAST_INNER_30(rt, x=tensors.cat_1, y=tensors.unsqueeze_1, output=tensors.mul_9)
    ...
    _linear_q4_or_q6(rt, q4=LINEAR_NOBIAS_Q4_K_MATVEC_F32, q6=LINEAR_NOBIAS_Q6_K_MATVEC_F32, x=tensors.reshape, weight=tensors.p_attn_o_proj_weight, output=tensors.linear_3)
    ...
    _linear_q4_or_q6(rt, q4=LINEAR_NOBIAS_Q4_K_MATVEC_F32, q6=LINEAR_NOBIAS_Q6_K_MATVEC_F32, x=tensors.mul_11, weight=tensors.p_mlp_gate_proj_weight, output=tensors.linear_4)
    SILU_F32(rt, x=tensors.linear_4, output=tensors.silu)
    _linear_q4_or_q6(rt, q4=LINEAR_NOBIAS_Q4_K_MATVEC_F32, q6=LINEAR_NOBIAS_Q6_K_MATVEC_F32, x=tensors.mul_11, weight=tensors.p_mlp_up_proj_weight, output=tensors.linear_5)
    MUL_F32(rt, x=tensors.silu, y=tensors.linear_5, output=tensors.mul_12)
    _linear_q4_or_q6(rt, q4=LINEAR_NOBIAS_Q4_K_MATVEC_F32, q6=LINEAR_NOBIAS_Q6_K_MATVEC_F32, x=tensors.mul_12, weight=tensors.p_mlp_down_proj_weight, output=tensors.linear_6)
