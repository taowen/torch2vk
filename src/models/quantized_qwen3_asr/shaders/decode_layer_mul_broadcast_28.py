"""Generated shader: decode_layer_mul_broadcast_28."""
...
DECODE_LAYER_MUL_BROADCAST_28 = ShaderVariant(
    name='decode_layer_mul_broadcast_28',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='decode_layer_mul_broadcast_28',
        fields=(
            TensorFieldSpec(
                name='x',
