"""Generated shader: linear_nobias_q8_0_f32_act_f32."""
...
LINEAR_NOBIAS_Q8_0_F32_ACT_F32 = ShaderVariant(
    name='linear_nobias_q8_0_f32_act_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasQ8_0Program',
        shader_name='linear_nobias_q8_0_f32_act_f32',
        fields=(
            TensorFieldSpec(
                name='x',
