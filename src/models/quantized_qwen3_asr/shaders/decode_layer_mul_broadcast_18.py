"""Generated shader: decode_layer_mul_broadcast_18."""
...
DECODE_LAYER_MUL_BROADCAST_18 = ShaderVariant(
    name='decode_layer_mul_broadcast_18',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastProgram',
        shader_name='decode_layer_mul_broadcast_18',
        fields=(
            TensorFieldSpec(
                name='x',
