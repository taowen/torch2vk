"""Generated shader: decode_layer_mul_broadcast_inner_28."""
...
DECODE_LAYER_MUL_BROADCAST_INNER_28 = ShaderVariant(
    name='decode_layer_mul_broadcast_inner_28',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastInnerProgram',
        shader_name='decode_layer_mul_broadcast_inner_28',
        fields=(
            TensorFieldSpec(
                name='x',
