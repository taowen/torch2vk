"""Generated shader: linear_nobias_q6_k_f32_act_f32."""
...
LINEAR_NOBIAS_Q6_K_F32_ACT_F32 = ShaderVariant(
    name='linear_nobias_q6_k_f32_act_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasQ6KProgram',
        shader_name='linear_nobias_q6_k_f32_act_f32',
        fields=(
            TensorFieldSpec(
                name='x',
