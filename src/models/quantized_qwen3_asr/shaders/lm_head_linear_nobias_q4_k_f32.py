"""Generated shader: lm_head_linear_nobias_q4_k_f32."""
...
LM_HEAD_LINEAR_NOBIAS_Q4_K_F32 = ShaderVariant(
    name='lm_head_linear_nobias_q4_k_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasQ4KProgram',
        shader_name='lm_head_linear_nobias_q4_k_f32',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        params_buffer=None,
        dispatch=(ceil_div(151, 32), ceil_div(151936, 16), 1),
    ),
