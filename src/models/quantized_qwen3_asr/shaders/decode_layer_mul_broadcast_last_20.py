"""Generated shader: decode_layer_mul_broadcast_last_20."""
...
DECODE_LAYER_MUL_BROADCAST_LAST_20 = ShaderVariant(
    name='decode_layer_mul_broadcast_last_20',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastLastProgram',
        shader_name='decode_layer_mul_broadcast_last_20',
        fields=(
            TensorFieldSpec(
                name='x',
