"""Generated shader: decode_layer_mul_broadcast_inner_29."""
...
DECODE_LAYER_MUL_BROADCAST_INNER_29 = ShaderVariant(
    name='decode_layer_mul_broadcast_inner_29',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastInnerProgram',
        shader_name='decode_layer_mul_broadcast_inner_29',
        fields=(
            TensorFieldSpec(
                name='x',
