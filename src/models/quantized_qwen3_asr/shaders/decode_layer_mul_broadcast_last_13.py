"""Generated shader: decode_layer_mul_broadcast_last_13."""
...
DECODE_LAYER_MUL_BROADCAST_LAST_13 = ShaderVariant(
    name='decode_layer_mul_broadcast_last_13',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastLastProgram',
        shader_name='decode_layer_mul_broadcast_last_13',
        fields=(
            TensorFieldSpec(
                name='x',
