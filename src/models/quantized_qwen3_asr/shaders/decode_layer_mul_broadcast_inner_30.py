"""Generated shader: decode_layer_mul_broadcast_inner_30."""
...
DECODE_LAYER_MUL_BROADCAST_INNER_30 = ShaderVariant(
    name='decode_layer_mul_broadcast_inner_30',
    family='export',
    contract=ShaderContract(
        class_name='ExportMulBroadcastInnerProgram',
        shader_name='decode_layer_mul_broadcast_inner_30',
        fields=(
            TensorFieldSpec(
                name='x',
