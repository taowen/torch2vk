...
Run from project root:
    uv run python -m models.optimized_qwen3.benchmark
"""
...
from models.optimized_qwen3.export_gguf import REPO_ID
from models.optimized_qwen3.input_prep import (
    DEFAULT_PROMPT,
    load_qwen3_tokenizer,
    prepare_qwen3_inputs,
)
from models.optimized_qwen3.run import Qwen3RunResult, main as run_torch2vk_qwen3
