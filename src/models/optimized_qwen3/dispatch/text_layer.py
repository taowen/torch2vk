...
from models.optimized_qwen3.shaders.linear_nobias_q4_k_pair_f32 import LINEAR_NOBIAS_Q4_K_PAIR_F32
from models.optimized_qwen3.shaders.linear_nobias_q4_k_triple_f32 import LINEAR_NOBIAS_Q4_K_TRIPLE_F32
...
from models.optimized_qwen3.shaders.linear_nobias_q6_k_f32 import LINEAR_NOBIAS_Q6_K_F32
...
from models.optimized_qwen3.shaders.sdpa_causal_cache_write_f32 import SDPA_CAUSAL_CACHE_WRITE_F32
from models.optimized_qwen3.shaders.slice_last_token_f16 import SLICE_LAST_TOKEN_F16
...
def _attn_qkv(rt: RuntimeSession, tensors: TextLayerTensors) -> None:
    if tensors.p_attn_v_proj_weight.spec.dtype == "uint16":
        ...
        LINEAR_NOBIAS_Q6_K_F32(rt, x=tensors.mul_1, weight=tensors.p_attn_v_proj_weight, output=tensors.linear_2)
        return
...
def _run_text_last_layer_tail_with_tensors(rt: RuntimeSession, tensors: TextLayerTensors) -> None:
    ...
    _attn_qkv(rt, tensors)
    RMS_NORM_ROPE_TRANSPOSE_F16(rt, x=tensors.to_2, weight=tensors.p_attn_q_norm_weight, cos=tensors.position_embeddings_0, sin=tensors.position_embeddings_1, output=tensors.add_3)
    RMS_NORM_ROPE_TRANSPOSE_F16(rt, x=tensors.to_4, weight=tensors.p_attn_k_norm_weight, cos=tensors.position_embeddings_0, sin=tensors.position_embeddings_1, output=tensors.add_4)
    SDPA_CAUSAL_CACHE_WRITE_F32(
        rt,
        q=tensors.add_3,
        k=tensors.add_4,
