...
from models.optimized_qwen3.tensors.decode_lm_head import DecodeLmHeadTensors
from torch2vk.runtime.session import RuntimeSession


def _run_decode_lm_head_with_tensors(rt: RuntimeSession, tensors: DecodeLmHeadTensors) -> None:
    LINEAR_NOBIAS_Q6_K_MATVEC_F32(rt, x=tensors.input, weight=tensors.p_weight, output=tensors.linear)
