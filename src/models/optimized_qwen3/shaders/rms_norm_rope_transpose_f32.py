"""Fused RMSNorm, RoPE, and transpose with float32 output."""
...
RMS_NORM_ROPE_TRANSPOSE_F32 = ShaderVariant(
    name="rms_norm_rope_transpose_f32",
    family="optimized_qwen3",
    contract=ShaderContract(
        class_name="OptimizedQwen3RmsNormRopeTransposeF32Program",
        shader_name="rms_norm_rope_transpose_f32",
        fields=(
            ...
            TensorFieldSpec("output", IOKind.OUTPUT, "output", TensorContract(dtype="float32", shape=("B", "G", "T", "D"))),
        ),
...
void main() {
    ...
    output_values[((b * pc.G + g) * pc.T + t) * pc.D + d] =
