"""Fused RMSNorm + weight multiply for 4D float16 activations."""
...
RMS_NORM_MUL_4D_F16_F32 = ShaderVariant(
    name="rms_norm_mul_4d_f16_f32",
    family="optimized_qwen3",
    contract=ShaderContract(
        class_name="OptimizedQwen3RmsNormMul4dF16F32Program",
        shader_name="rms_norm_mul_4d_f16_f32",
        fields=(
            TensorFieldSpec(
                name="x",
                io_kind=IOKind.INPUT,
                role="input",
                contract=TensorContract(dtype="float16", shape=("B", "T", "G", "H")),
            ),
            TensorFieldSpec(
                name="weight",
                io_kind=IOKind.INPUT,
