"""llama.cpp generated Q6_K prefill matmul shader."""
...
_SOURCE = (Path(__file__).with_name("llama_matmul_q6_k_f32.glsl")).read_text(
    encoding="utf-8"
)
...
def _variant(*, name: str, tile: int, block_size: int, bn: int, wn: int) -> ShaderVariant:
    return ShaderVariant(
        ...
        contract=ShaderContract(
            class_name="LlamaMatmulQ6KF32Program",
            shader_name=name,
            fields=(
                TensorFieldSpec(
                    name="weight",
...
LLAMA_MATMUL_Q6_K_F32_M = _variant(
    name="llama_matmul_q6_k_f32_m",
    tile=64,
    block_size=128,
    bn=64,
    wn=32,
)
LLAMA_MATMUL_Q6_K_F32_L = _variant(
    name="llama_matmul_q6_k_f32_l",
    tile=128,
    block_size=256,
    bn=128,
    wn=64,
