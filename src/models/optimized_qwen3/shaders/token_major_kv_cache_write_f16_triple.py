"""Write one token-major float16 K/V tensor into three token-major caches."""
...
TOKEN_MAJOR_KV_CACHE_WRITE_F16_TRIPLE = ShaderVariant(
    name="token_major_kv_cache_write_f16_triple",
    family="optimized_qwen3",
    contract=ShaderContract(
        class_name="OptimizedQwen3TokenMajorKvCacheWriteF16TripleProgram",
        shader_name="token_major_kv_cache_write_f16_triple",
        fields=(
            TensorFieldSpec(
                "cache_a",
                IOKind.INOUT,
...
layout(set = 0, binding = 4) buffer restrict readonly SrcBuffer { float16_t src[]; };
