"""Fused RMSNorm and RoPE with token-major float16 output."""
...
RMS_NORM_ROPE_TOKEN_F32_TO_F16 = ShaderVariant(
    name="rms_norm_rope_token_f32_to_f16",
    family="optimized_qwen3",
    contract=ShaderContract(
        class_name="OptimizedQwen3RmsNormRopeTokenF32ToF16Program",
        shader_name="rms_norm_rope_token_f32_to_f16",
        fields=(
            ...
            TensorFieldSpec("output", IOKind.OUTPUT, "output", TensorContract(dtype="float16", shape=("B", "T", "G", "D"))),
        ),
...
void main() {
    ...
    output_values[((b * pc.T + t) * pc.G + g) * pc.D + d] = float16_t(
