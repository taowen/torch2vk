"""Qwen3-ASR RoPE cos/sin table generator."""
...
QWEN3_ASR_ROPE_TABLE_F32 = ShaderVariant(
    name="qwen3_asr_rope_table_f32",
    family="qwen3_asr.text",
    contract=ShaderContract(
        class_name="Qwen3AsrRopeTableF32Program",
        shader_name="qwen3_asr_rope_table_f32",
        fields=(
            TensorFieldSpec(
                name="start_position",
