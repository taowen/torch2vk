"""Generated shader: decode_lm_head_linear_nobias_q4_k_matvec_f32."""
...
DECODE_LM_HEAD_LINEAR_NOBIAS_Q4_K_MATVEC_F32 = ShaderVariant(
    name='decode_lm_head_linear_nobias_q4_k_matvec_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportLinearNobiasQ4KMatvecProgram',
        shader_name='decode_lm_head_linear_nobias_q4_k_matvec_f32',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        params_buffer=None,
        dispatch=(ceil_div(151936, 2), 1, 1),
    ),
