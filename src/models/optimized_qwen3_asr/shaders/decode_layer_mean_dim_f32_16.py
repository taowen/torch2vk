"""Generated shader: decode_layer_mean_dim_f32_16."""
...
DECODE_LAYER_MEAN_DIM_F32_16 = ShaderVariant(
    name='decode_layer_mean_dim_f32_16',
    family='export',
    contract=ShaderContract(
        class_name='ExportMeanDimProgram',
        shader_name='decode_layer_mean_dim_f32_16',
        fields=(
            TensorFieldSpec(
                name='x',
