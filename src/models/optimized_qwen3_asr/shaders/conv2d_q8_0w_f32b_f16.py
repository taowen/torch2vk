"""Generated shader: conv2d_q8_0w_f32b_f16."""
...
CONV2D_Q8_0W_F32B_F16 = ShaderVariant(
    name='conv2d_q8_0w_f32b_f16',
    family='export',
    contract=ShaderContract(
        class_name='ExportConv2dQ8_0WeightF32BiasProgram',
        shader_name='conv2d_q8_0w_f32b_f16',
        fields=(
            TensorFieldSpec(
                name='x',
            ...
            TensorFieldSpec(
                ...
                io_kind=IOKind.INPUT,
                role='weight',
                contract=TensorContract(dtype='uint16', shape=('Co', 17,), layout=q8_0_halfwords_layout(logical_k=9, block_size=32, halfwords_per_block=17)),
            ),
            TensorFieldSpec(
                name='bias',
                io_kind=IOKind.INPUT,
