"""Generated shader: decode_embed_embedding_q8_0_f32."""
...
DECODE_EMBED_EMBEDDING_Q8_0_F32 = ShaderVariant(
    name='decode_embed_embedding_q8_0_f32',
    family='export',
    contract=ShaderContract(
        class_name='ExportEmbeddingQ8_0Program',
        shader_name='decode_embed_embedding_q8_0_f32',
        fields=(
            TensorFieldSpec(
                name='weight',
