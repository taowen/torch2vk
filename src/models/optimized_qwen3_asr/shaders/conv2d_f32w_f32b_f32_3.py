"""Generated shader: conv2d_f32w_f32b_f32_3."""
...
CONV2D_F32W_F32B_F32_3 = ShaderVariant(
    name='conv2d_f32w_f32b_f32_3',
    family='export',
    contract=ShaderContract(
        class_name='ExportConv2dF32WeightF32BiasProgram',
        shader_name='conv2d_f32w_f32b_f32_3',
        fields=(
            TensorFieldSpec(
                name='x',
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec('in_h', PushConstantType.UINT32, 8, 32, dynamic=False),
                PushConstantFieldSpec('in_w', PushConstantType.UINT32, 12, 25, dynamic=False),
                PushConstantFieldSpec('out_c', PushConstantType.UINT32, 16, 480, dynamic=False),
                PushConstantFieldSpec('out_h', PushConstantType.UINT32, 20, 16, dynamic=False),
                PushConstantFieldSpec('out_w', PushConstantType.UINT32, 24, 13, dynamic=False),
        ...
        params_buffer=None,
        dispatch=(ceil_div(208, 16), ceil_div(480, 16), 11),
    ),
