"""Generated shader: index_select_f32_c6680f8d95."""
...
INDEX_SELECT_F32_C6680F8D95 = ShaderVariant(
    name='index_select_f32_c6680f8d95',
    family='export',
    contract=ShaderContract(
        class_name='ExportIndexSelectF32Program',
        shader_name='index_select_f32_c6680f8d95',
        fields=(
            TensorFieldSpec(
                name='x',
                io_kind=IOKind.INPUT,
                role='input',
                contract=TensorContract(dtype='float16', shape=('N', 'H',)),
            ),
            TensorFieldSpec(
                name='index',
                io_kind=IOKind.INPUT,
            ...
            TensorFieldSpec(
                ...
                role='output',
                contract=TensorContract(dtype='float16', shape=('O', 'H',)),
            ),
        ),
