...
def create_decode_layer(
    ...
    *,
    ...
    tensors = DecodeLayerTensors(
        p_attn_q_proj_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                spec=_quantized_weight_spec(
                    f"thinker.model.layers.{layer_idx}.self_attn.q_proj.weight",
                    dtype="float32",
                    shape=(2048, 1024),
                ),
                layout=_quantized_weight_layout(
                    f"thinker.model.layers.{layer_idx}.self_attn.q_proj.weight",
                    dtype="float32",
                    shape=(2048, 1024),
                ),
        ...
        p_attn_k_proj_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                spec=_quantized_weight_spec(
                    f"thinker.model.layers.{layer_idx}.self_attn.k_proj.weight",
                    dtype="float32",
                    shape=(1024, 1024),
                ),
                layout=_quantized_weight_layout(
        ...
        p_attn_v_proj_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                spec=_quantized_weight_spec(
                    f"thinker.model.layers.{layer_idx}.self_attn.v_proj.weight",
                    dtype="float32",
                    shape=(1024, 1024),
                ),
                layout=_quantized_weight_layout(
        ...
        p_attn_o_proj_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                spec=_quantized_weight_spec(
                    f"thinker.model.layers.{layer_idx}.self_attn.o_proj.weight",
                    dtype="float32",
                    shape=(1024, 2048),
                ),
                layout=_quantized_weight_layout(
        ...
        p_attn_q_norm_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                spec=_quantized_weight_spec(
                    f"thinker.model.layers.{layer_idx}.self_attn.q_norm.weight",
                    dtype="float32",
                    shape=(128,),
                ),
                layout=_quantized_weight_layout(
        ...
        p_attn_k_norm_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                spec=_quantized_weight_spec(
                    f"thinker.model.layers.{layer_idx}.self_attn.k_norm.weight",
                    dtype="float32",
                    shape=(128,),
                ),
                layout=_quantized_weight_layout(
        ...
        p_mlp_gate_proj_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                spec=_quantized_weight_spec(
                    f"thinker.model.layers.{layer_idx}.mlp.gate_proj.weight",
                    dtype="float32",
                    shape=(3072, 1024),
                ),
                layout=_quantized_weight_layout(
        ...
        p_mlp_up_proj_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                spec=_quantized_weight_spec(
                    f"thinker.model.layers.{layer_idx}.mlp.up_proj.weight",
                    dtype="float32",
                    shape=(3072, 1024),
                ),
                layout=_quantized_weight_layout(
        ...
        p_mlp_down_proj_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                spec=_quantized_weight_spec(
                    f"thinker.model.layers.{layer_idx}.mlp.down_proj.weight",
                    dtype="float32",
                    shape=(1024, 3072),
                ),
                layout=_quantized_weight_layout(
        ...
        p_input_layernorm_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                spec=_quantized_weight_spec(
                    f"thinker.model.layers.{layer_idx}.input_layernorm.weight",
                    dtype="float32",
                    shape=(1024,),
                ),
                layout=_quantized_weight_layout(
        ...
        p_post_attention_layernorm_weight=_bind_tensor(
            ...
            _declare_tensor(
                ...
                reference_key=None,
                spec=_quantized_weight_spec(
                    f"thinker.model.layers.{layer_idx}.post_attention_layernorm.weight",
                    dtype="float32",
                    shape=(1024,),
                ),
                layout=_quantized_weight_layout(
    ...
    _bind_alias_source(tensors.scaled_dot_product_attention, tensors.transpose_3)
...
_Q6_TENSOR_NAMES = frozenset(
    (
        ...
        "thinker.model.layers.0.self_attn.v_proj.weight",
        "thinker.model.layers.1.mlp.down_proj.weight",
        "thinker.model.layers.1.self_attn.v_proj.weight",
        "thinker.model.layers.11.mlp.down_proj.weight",
        "thinker.model.layers.11.self_attn.v_proj.weight",
        "thinker.model.layers.14.mlp.down_proj.weight",
        "thinker.model.layers.14.self_attn.v_proj.weight",
        "thinker.model.layers.17.mlp.down_proj.weight",
        "thinker.model.layers.17.self_attn.v_proj.weight",
        "thinker.model.layers.2.mlp.down_proj.weight",
        "thinker.model.layers.2.self_attn.v_proj.weight",
        "thinker.model.layers.20.mlp.down_proj.weight",
        "thinker.model.layers.20.self_attn.v_proj.weight",
        "thinker.model.layers.23.mlp.down_proj.weight",
        "thinker.model.layers.23.self_attn.v_proj.weight",
        "thinker.model.layers.24.mlp.down_proj.weight",
        "thinker.model.layers.24.self_attn.v_proj.weight",
        "thinker.model.layers.25.mlp.down_proj.weight",
        "thinker.model.layers.25.self_attn.v_proj.weight",
        "thinker.model.layers.26.mlp.down_proj.weight",
        "thinker.model.layers.26.self_attn.v_proj.weight",
        "thinker.model.layers.27.mlp.down_proj.weight",
        "thinker.model.layers.27.self_attn.v_proj.weight",
        "thinker.model.layers.5.mlp.down_proj.weight",
        "thinker.model.layers.5.self_attn.v_proj.weight",
        "thinker.model.layers.8.mlp.down_proj.weight",
        "thinker.model.layers.8.self_attn.v_proj.weight",
    )
)
_Q6_TENSOR_PREFIXES = ()
...
def _quantized_weight_spec(
    checkpoint_key: str, *, dtype: str, shape: tuple[int, ...]
) -> TensorSpec:
...
def _bind_tensor(
    ...
    if bound.spec != tensor.spec:
        ...
        raise ValueError(
            f"{bound_name} spec {bound.spec} does not match {tensor_name} spec {tensor.spec}"
        )
    return bound
