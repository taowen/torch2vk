...
from models.optimized_qwen3_asr.shaders.lm_head_linear_nobias_q4_k_f32 import LM_HEAD_LINEAR_NOBIAS_Q4_K_F32
...
def _run_lm_head_with_tensors(rt: RuntimeSession, tensors: LmHeadTensors) -> None:
    LM_HEAD_LINEAR_NOBIAS_Q4_K_F32(rt, x=tensors.input, weight=tensors.p_weight, output=tensors.linear)
