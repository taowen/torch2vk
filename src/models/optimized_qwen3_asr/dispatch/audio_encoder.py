...
from models.optimized_qwen3_asr.shaders.add_f32 import ADD_F32
from models.optimized_qwen3_asr.shaders.add_f32_17 import ADD_F32_17
from models.optimized_qwen3_asr.shaders.add_f32_21 import ADD_F32_21
from models.optimized_qwen3_asr.shaders.conv2d_f32w_f32b_f32 import CONV2D_F32W_F32B_F32
from models.optimized_qwen3_asr.shaders.conv2d_f32w_f32b_f32_2 import CONV2D_F32W_F32B_F32_2
from models.optimized_qwen3_asr.shaders.conv2d_f32w_f32b_f32_3 import CONV2D_F32W_F32B_F32_3
from models.optimized_qwen3_asr.shaders.gelu_f32 import GELU_F32
from models.optimized_qwen3_asr.shaders.gelu_f32_124 import GELU_F32_124
from models.optimized_qwen3_asr.shaders.gelu_f32_19 import GELU_F32_19
from models.optimized_qwen3_asr.shaders.index_select_f32_c6680f8d95 import INDEX_SELECT_F32_C6680F8D95
from models.optimized_qwen3_asr.shaders.layer_norm_f32w_f32b_f32 import LAYER_NORM_F32W_F32B_F32
from models.optimized_qwen3_asr.shaders.linear_bias_q8_0w_f32b_f32 import LINEAR_BIAS_Q8_0W_F32B_F32
from models.optimized_qwen3_asr.shaders.linear_bias_q8_0w_f32b_f32_125 import LINEAR_BIAS_Q8_0W_F32B_F32_125
from models.optimized_qwen3_asr.shaders.linear_bias_q8_0w_f32b_f32_18 import LINEAR_BIAS_Q8_0W_F32B_F32_18
from models.optimized_qwen3_asr.shaders.linear_bias_q8_0w_f32b_f32_20 import LINEAR_BIAS_Q8_0W_F32B_F32_20
from models.optimized_qwen3_asr.shaders.linear_nobias_q8_0_f32 import LINEAR_NOBIAS_Q8_0_F32
from models.optimized_qwen3_asr.shaders.sdpa_masked_f32 import SDPA_MASKED_F32
from models.optimized_qwen3_asr.shaders.transpose_f32_48d16b9b88 import TRANSPOSE_F32_48D16B9B88
from models.optimized_qwen3_asr.shaders.transpose_f32_6a3397f037 import TRANSPOSE_F32_6A3397F037
from models.optimized_qwen3_asr.shaders.transpose_f32_d95ce920ac import TRANSPOSE_F32_D95CE920AC
from models.optimized_qwen3_asr.tensors.audio_encoder import AudioEncoderTensors
from torch2vk.runtime.session import RuntimeSession


def _run_audio_encoder_with_tensors(rt: RuntimeSession, tensors: AudioEncoderTensors) -> None:
    CONV2D_F32W_F32B_F32(rt, x=tensors.x, weight=tensors.p_audio_tower_conv2d1_weight, bias=tensors.p_audio_tower_conv2d1_bias, output=tensors.conv2d)
    GELU_F32(rt, x=tensors.conv2d, output=tensors.gelu)
    CONV2D_F32W_F32B_F32_2(rt, x=tensors.gelu, weight=tensors.p_audio_tower_conv2d2_weight, bias=tensors.p_audio_tower_conv2d2_bias, output=tensors.conv2d_1)
    GELU_F32(rt, x=tensors.conv2d_1, output=tensors.gelu_1)
    CONV2D_F32W_F32B_F32_3(rt, x=tensors.gelu_1, weight=tensors.p_audio_tower_conv2d3_weight, bias=tensors.p_audio_tower_conv2d3_bias, output=tensors.conv2d_2)
    ...
    for layer_t in tensors.layers:
        ...
        LINEAR_BIAS_Q8_0W_F32B_F32_18(rt, x=layer_t.layer_norm_1, weight=layer_t.p_audio_tower_layers_0_fc1_weight, bias=layer_t.p_audio_tower_layers_0_fc1_bias, output=layer_t.linear_5)
        GELU_F32_19(rt, x=layer_t.linear_5, output=layer_t.gelu_3)
        LINEAR_BIAS_Q8_0W_F32B_F32_20(rt, x=layer_t.gelu_3, weight=layer_t.p_audio_tower_layers_0_fc2_weight, bias=layer_t.p_audio_tower_layers_0_fc2_bias, output=layer_t.linear_6)
    ...
    LINEAR_BIAS_Q8_0W_F32B_F32_125(rt, x=tensors.gelu_21, weight=tensors.p_audio_tower_proj2_weight, bias=tensors.p_audio_tower_proj2_bias, output=tensors.linear_110)
