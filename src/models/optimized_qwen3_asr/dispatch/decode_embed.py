...
from models.optimized_qwen3_asr.shaders.decode_embed_embedding_q8_0_f32 import DECODE_EMBED_EMBEDDING_Q8_0_F32
from models.optimized_qwen3_asr.tensors.decode_embed import DecodeEmbedTensors
from torch2vk.runtime.session import RuntimeSession


def _run_decode_embed_with_tensors(rt: RuntimeSession, tensors: DecodeEmbedTensors) -> None:
    DECODE_EMBED_EMBEDDING_Q8_0_F32(rt, weight=tensors.p_weight, indices=tensors.input, output=tensors.embedding)
