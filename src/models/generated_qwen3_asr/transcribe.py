...
from models.generated_qwen3_asr.export import load_qwen3_asr_export_spec
...
class GeneratedQwen3AsrRecognizer:
    def __init__(
        ...
        *,
        ...
        self._spec = load_qwen3_asr_export_spec(model_dir=model_dir)
    ...
    def transcribe_with_tokens(
        ...
        *,
        ...
        audio_tensors = declare_generated_qwen3_asr_audio_tower_tensors(
            ...
            hidden_size=layout.audio_hidden_size,
            output_size=layout.audio_output_size,
            downsample_hidden_size=layout.audio_downsample_hidden_size,
            encoder_layers=layout.audio_encoder_layers,
            encoder_ffn_dim=layout.audio_encoder_ffn_dim,
        )
        text_tensors = declare_generated_qwen3_asr_text_tensors(
            ...
            hidden_size=layout.text_hidden_size,
            intermediate_size=layout.text_intermediate_size,
            vocab_size=layout.text_vocab_size,
            decoder_layers=layout.text_decoder_layers,
            num_attention_heads=layout.text_num_attention_heads,
            num_key_value_heads=layout.text_num_key_value_heads,
            head_dim=layout.text_head_dim,
        ...
        if prefill_input_features is None or prefill_feature_attention_mask is None:
            raise RuntimeError("Generated Qwen3-ASR text tensors are missing prefill audio inputs")
        self._rt.register_inputs(
            {
                ...
                text_tensors.token_select.eos_token_ids: np.array(
                    runtime.eos_token_ids, dtype=np.int64
                ),
            }
        )
        generated = run_generated_qwen3_asr_greedy_decode_loop(
            ...
            text_tensors,
            max_new_tokens=max_new_tokens,
            rope_theta=runtime.text_rope_theta,
            mrope_section=runtime.text_mrope_section,
            pytorch_compare=compare,
            stop_on_eos=True,
        )
        generated_length = int(
            self._rt.read_request_state(text_tensors.token_store.generated_length)[0]
        )
