...
from torch2vk.exportv2.shaders import ROPE_TABLE_F32
...
def run_generated_qwen3_asr_replay_decode_loop(
    ...
    *,
    ...
    del mode
    return run_generated_qwen3_asr_greedy_decode_loop(
        rt,
        tensors,
...
def _initialize_token_store_state(
    rt: RuntimeSession, tensors: GeneratedQwen3AsrTextTensors
) -> None:
