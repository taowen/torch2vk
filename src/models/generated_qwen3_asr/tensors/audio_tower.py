...
def declare_generated_qwen3_asr_audio_tower_tensors(
    *,
    ...
    return GeneratedQwen3AsrAudioTowerTensors(
        input_features=LogicalTensor(
            name="generated_qwen3_asr.audio_tower.input_features",
        ...
        feature_lens=LogicalTensor(
            name="generated_qwen3_asr.audio_tower.feature_lens",
        ...
        conv2d1_gelu=LogicalTensor(
            name="generated_qwen3_asr.audio_tower.conv2d1.gelu",
            spec=TensorSpec(
                dtype="float32",
        ...
        conv2d2_gelu=LogicalTensor(
            name="generated_qwen3_asr.audio_tower.conv2d2.gelu",
            spec=TensorSpec(
                dtype="float32",
        ...
        conv2d3_gelu=LogicalTensor(
            name="generated_qwen3_asr.audio_tower.conv2d3.gelu",
            spec=TensorSpec(
        ...
        conv_out=LogicalTensor(
            name="generated_qwen3_asr.audio_tower.conv_out",
        ...
        conv_out_add_position=LogicalTensor(
            name="generated_qwen3_asr.audio_tower.conv_out.add_position",
            spec=TensorSpec(dtype="float32", shape=padded_hidden_shape),
            **output_common,
        ),
        hidden_states=LogicalTensor(
            name="generated_qwen3_asr.audio_tower.hidden_states",
        ...
        cu_seqlens=LogicalTensor(
            name="generated_qwen3_asr.audio_tower.cu_seqlens",
        ...
        ln_post=LogicalTensor(
            name="generated_qwen3_asr.audio_tower.ln_post",
            spec=TensorSpec(dtype="float32", shape=hidden_shape),
            compare=ComparePolicy(kind="tensor", rtol=2e-3, atol=2e-2),
        ...
        proj1_gelu=LogicalTensor(
            name="generated_qwen3_asr.audio_tower.proj1.gelu",
            spec=TensorSpec(dtype="float32", shape=hidden_shape),
            **output_common,
        ),
        ...
        last_hidden_state=LogicalTensor(
            name="generated_qwen3_asr.audio_tower.last_hidden_state",
