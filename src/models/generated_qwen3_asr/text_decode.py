"""Generated generated_qwen3_asr.text_decode frame scaffold."""
...
from models.generated_qwen3_asr.tensors.text import GeneratedQwen3AsrTextDecodeTensors
...
def run_generated_qwen3_asr_text_decode(
    ...
    **_kw,
    ...
    with rt.frame("generated_qwen3_asr.text_decode"):
        TEXT_EMBED_LOOKUP_F32(
            rt,
