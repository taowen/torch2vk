...
QWEN3_ASR_TOKEN_STORE_EOS_F32 = ShaderVariant(
    name="qwen3_asr_token_store_eos_f32",
    family=QWEN3_ASR_TOKEN_STORE_F32.family,
    contract=ShaderContract(
        class_name="Qwen3AsrTokenStoreEosF32Program",
        shader_name="qwen3_asr_token_store_eos_f32",
        fields=QWEN3_ASR_TOKEN_STORE_F32.contract.fields,
        push_constants=PushConstantSpec(
            size=8,
            fields=(
                PushConstantFieldSpec("G", PushConstantType.UINT32, 0, "G"),
        ...
        dispatch=QWEN3_ASR_TOKEN_STORE_F32.contract.dispatch,
    ),
    execution_requirements=QWEN3_ASR_TOKEN_STORE_F32.execution_requirements,
    source=QWEN3_ASR_TOKEN_STORE_F32.source,
)
