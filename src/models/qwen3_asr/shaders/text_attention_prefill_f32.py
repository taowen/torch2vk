...
QWEN3_ASR_TEXT_ATTENTION_PREFILL_F32 = ShaderVariant(
    name="qwen3_asr_text_attention_prefill_f32",
    family="qwen3_asr.text",
    contract=ShaderContract(
        class_name="Qwen3AsrTextAttentionPrefillF32Program",
        shader_name="qwen3_asr_text_attention_prefill_f32",
        fields=(
            TensorFieldSpec(
                name="q",
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec("num_q_heads", PushConstantType.UINT32, 4, ceil_div("QH", "D")),
