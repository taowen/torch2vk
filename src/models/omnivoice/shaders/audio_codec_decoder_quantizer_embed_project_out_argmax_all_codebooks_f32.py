...
"""Generated OmniVoice audio codec decoder quantizer embed project out argmax all codebooks f32 shader scaffold."""
...
OMNIVOICE_AUDIO_CODEC_DECODER_QUANTIZER_EMBED_PROJECT_OUT_ARGMAX_ALL_CODEBOOKS_F32 = ShaderVariant(
    name="omnivoice_audio_codec_decoder_quantizer_embed_project_out_argmax_all_codebooks_f32",
    family="omnivoice.audio_codec",
    contract=ShaderContract(
        class_name="OmniVoiceAudioCodecDecoderQuantizerEmbedProjectOutArgmaxAllCodebooksF32Program",
        shader_name="omnivoice_audio_codec_decoder_quantizer_embed_project_out_argmax_all_codebooks_f32",
        fields=(),
        dispatch=(1, 1, 1),
    ),
    source="""
