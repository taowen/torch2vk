...
"""Generated OmniVoice audio head matmul f16 f32 f16acc large shader scaffold."""
...
OMNIVOICE_AUDIO_HEAD_MATMUL_F16_F32_F16ACC_LARGE = ShaderVariant(
    name="omnivoice_audio_head_matmul_f16_f32_f16acc_large",
    family="omnivoice.text",
    contract=ShaderContract(
        class_name="OmniVoiceAudioHeadMatmulF16F32F16AccLargeProgram",
        shader_name="omnivoice_audio_head_matmul_f16_f32_f16acc_large",
        fields=(),
        dispatch=(1, 1, 1),
    ),
    source="""
