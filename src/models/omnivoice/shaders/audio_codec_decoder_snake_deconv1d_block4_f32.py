...
"""Generated OmniVoice audio codec decoder snake deconv1d block4 f32 shader scaffold."""
...
OMNIVOICE_AUDIO_CODEC_DECODER_SNAKE_DECONV1D_BLOCK4_F32 = ShaderVariant(
    name="omnivoice_audio_codec_decoder_snake_deconv1d_block4_f32",
    family="omnivoice.audio_codec",
    contract=ShaderContract(
        class_name="OmniVoiceAudioCodecDecoderSnakeDeconv1dBlock4F32Program",
        shader_name="omnivoice_audio_codec_decoder_snake_deconv1d_block4_f32",
        fields=(),
        dispatch=(1, 1, 1),
    ),
    source="""
