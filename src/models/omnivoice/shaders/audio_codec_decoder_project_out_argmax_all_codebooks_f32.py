...
"""Generated OmniVoice audio codec decoder project out argmax all codebooks f32 shader scaffold."""
...
OMNIVOICE_AUDIO_CODEC_DECODER_PROJECT_OUT_ARGMAX_ALL_CODEBOOKS_F32 = ShaderVariant(
    name="omnivoice_audio_codec_decoder_project_out_argmax_all_codebooks_f32",
    family="omnivoice.audio_codec",
    contract=ShaderContract(
        class_name="OmniVoiceAudioCodecDecoderProjectOutArgmaxAllCodebooksF32Program",
        shader_name="omnivoice_audio_codec_decoder_project_out_argmax_all_codebooks_f32",
        fields=(),
        dispatch=(1, 1, 1),
    ),
    source="""
