...
"""Generated OmniVoice audio codec decoder conv1d k7 f32 shader scaffold."""
...
OMNIVOICE_AUDIO_CODEC_DECODER_CONV1D_K7_F32 = ShaderVariant(
    name="omnivoice_audio_codec_decoder_conv1d_k7_f32",
    family="omnivoice.audio_codec",
    contract=ShaderContract(
        class_name="OmniVoiceAudioCodecDecoderConv1dK7F32Program",
        shader_name="omnivoice_audio_codec_decoder_conv1d_k7_f32",
        fields=(),
        dispatch=(1, 1, 1),
    ),
    source="""
