...
"""Generated OmniVoice audio codec decoder snake conv1d k1 residual add f32 shader scaffold."""
...
OMNIVOICE_AUDIO_CODEC_DECODER_SNAKE_CONV1D_K1_RESIDUAL_ADD_F32 = ShaderVariant(
    name="omnivoice_audio_codec_decoder_snake_conv1d_k1_residual_add_f32",
    family="omnivoice.audio_codec",
    contract=ShaderContract(
        class_name="OmniVoiceAudioCodecDecoderSnakeConv1dK1ResidualAddF32Program",
        shader_name="omnivoice_audio_codec_decoder_snake_conv1d_k1_residual_add_f32",
        fields=(),
        dispatch=(1, 1, 1),
    ),
    source="""
