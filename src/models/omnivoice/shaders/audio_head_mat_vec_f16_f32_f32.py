...
"""Generated OmniVoice audio head mat vec f16 f32 f32 shader scaffold."""
...
OMNIVOICE_AUDIO_HEAD_MAT_VEC_F16_F32_F32 = ShaderVariant(
    name="omnivoice_audio_head_mat_vec_f16_f32_f32",
    family="omnivoice.text",
    contract=ShaderContract(
        class_name="OmniVoiceAudioHeadMatVecF16F32F32Program",
        shader_name="omnivoice_audio_head_mat_vec_f16_f32_f32",
        fields=(),
        dispatch=(1, 1, 1),
    ),
    source="""
