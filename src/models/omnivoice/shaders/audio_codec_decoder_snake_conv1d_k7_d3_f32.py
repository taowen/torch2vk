...
"""Generated OmniVoice audio codec decoder snake conv1d k7 d3 f32 shader scaffold."""
...
OMNIVOICE_AUDIO_CODEC_DECODER_SNAKE_CONV1D_K7_D3_F32 = ShaderVariant(
    name="omnivoice_audio_codec_decoder_snake_conv1d_k7_d3_f32",
    family="omnivoice.audio_codec",
    contract=ShaderContract(
        class_name="OmniVoiceAudioCodecDecoderSnakeConv1dK7D3F32Program",
        shader_name="omnivoice_audio_codec_decoder_snake_conv1d_k7_d3_f32",
        fields=(),
        dispatch=(1, 1, 1),
    ),
    source="""
