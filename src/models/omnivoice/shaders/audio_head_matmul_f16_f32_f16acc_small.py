...
"""Generated OmniVoice audio head matmul f16 f32 f16acc small shader scaffold."""
...
OMNIVOICE_AUDIO_HEAD_MATMUL_F16_F32_F16ACC_SMALL = ShaderVariant(
    name="omnivoice_audio_head_matmul_f16_f32_f16acc_small",
    family="omnivoice.text",
    contract=ShaderContract(
        class_name="OmniVoiceAudioHeadMatmulF16F32F16AccSmallProgram",
        shader_name="omnivoice_audio_head_matmul_f16_f32_f16acc_small",
        fields=(),
        dispatch=(1, 1, 1),
    ),
    source="""
