...
"""Generated OmniVoice audio codec decoder deconv1d block0 f32 shader scaffold."""
...
OMNIVOICE_AUDIO_CODEC_DECODER_DECONV1D_BLOCK0_F32 = ShaderVariant(
    name="omnivoice_audio_codec_decoder_deconv1d_block0_f32",
    family="omnivoice.audio_codec",
    contract=ShaderContract(
        class_name="OmniVoiceAudioCodecDecoderDeconv1dBlock0F32Program",
        shader_name="omnivoice_audio_codec_decoder_deconv1d_block0_f32",
        fields=(),
        dispatch=(1, 1, 1),
    ),
    source="""
