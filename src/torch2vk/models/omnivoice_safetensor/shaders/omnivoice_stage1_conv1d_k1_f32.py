"""Omnivoice Stage1 Conv1D K1 F32."""
...
OMNIVOICE_STAGE1_CONV1D_K1_F32 = ShaderVariant(
    name="omnivoice_stage1_conv1d_k1_f32",
    family="omnivoice_stage1",
    contract=ShaderContract(
        name="omnivoice_stage1_conv1d_k1_f32",
        inputs={
            "x": TensorContract(dtype="float32", shape=("B", "S", "IC")),
            "weight": TensorContract(dtype="float32", shape=("OC", "IC")),
        ...
        uniforms=(UniformBlock("sizes", 4, ("S", "B", "IC", "OC")),),
