"""Omnivoice Stage1 Snake Deconv1D Block3 F32."""
...
OMNIVOICE_STAGE1_SNAKE_DECONV1D_BLOCK3_F32 = ShaderVariant(
    name="omnivoice_stage1_snake_deconv1d_block3_f32",
    ...
    contract=ShaderContract(
        ...
        inputs={
            ...
            "weight": TensorContract(dtype="float32", shape=("IC", "OC", 4)),
