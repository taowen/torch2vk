"""Omnivoice Codebook Argmax Scores F32."""
...
OMNIVOICE_CODEBOOK_ARGMAX_SCORES_F32 = ShaderVariant(
    ...
    family="omnivoice_codebook_argmax",
    contract=ShaderContract(
        ...
        bindings=(
            ...
            Binding("logits", 2, BindingAccess.READ),
            Binding("codebook_offsets", 3, BindingAccess.READ),
        ),
        uniforms=(UniformBlock("sizes", 4, ("S", "B", "V", "C")),),
        dispatch=("C", "S", "B"),
        push_constants=None,
    ),
    source=_SOURCE,
