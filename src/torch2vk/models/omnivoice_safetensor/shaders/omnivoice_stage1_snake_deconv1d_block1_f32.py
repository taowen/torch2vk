"""Omnivoice Stage1 Snake Deconv1D Block1 F32."""
...
OMNIVOICE_STAGE1_SNAKE_DECONV1D_BLOCK1_F32 = ShaderVariant(
    name="omnivoice_stage1_snake_deconv1d_block1_f32",
    ...
    contract=ShaderContract(
        ...
        inputs={
            ...
            "weight": TensorContract(dtype="float32", shape=("IC", "OC", 10)),
