...
def run_qwen3_prefill(
    ...
    *,
    ...
    _run_qwen3_forward(ctx, spec=spec, tensors=tensors, weights=weights)
...
def run_qwen3_minimal_prefill(
    ...
    *,
    ...
    run_qwen3_prefill(ctx, spec=spec, tensors=tensors, weights=weights)
...
def _run_qwen3_layer(
    ...
    *,
    ...
    SWIGLU_F32(ctx, gate=layer.mlp_gate, up=layer.mlp_up, output=layer.mlp_gated)
    LINEAR_BF16_F32(
        ctx,
        x=layer.mlp_gated,
