"""Exact llama.cpp add_f32_f32_f32_norepeat shader binding."""
...
ADD_F32_F32_F32_NOREPEAT = shader_variant(
    name="add_f32_f32_f32_norepeat",
    family="add_f32_f32_f32_norepeat",
    contract=shader_contract(
        class_name="AddF32F32F32NorepeatProgram",
        shader_name="add_f32_f32_f32_norepeat",
        fields=(
            input_tensor(
                name="lhs",
                binding="t_lhs",
        ...
        push_constants=binary_push_constant_block(
            src0_name="lhs", src1_name="rhs", dst_name="output"
        ),
        dispatch=(1, ceil_div(mul(mul("B", "S"), "H"), 512), 1),
        tensor_defaults=(
            tensor_binding_default(
                field_name="partial_sums_placeholder", source_field_name="output"
            ),
        ),
        bindings=(
