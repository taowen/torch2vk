"""Exact llama.cpp rms_norm_mul_f32 shader binding."""
...
RMS_NORM_F32_F32_WEIGHT_LLAMA_WG512 = shader_variant(
    name="rms_norm_f32_f32_weight_llama_wg512",
    family="rms_norm_f32_f32_weight",
    contract=shader_contract(
        class_name="RmsNormF32F32WeightLlamaWg512Program",
        shader_name="rms_norm_f32_f32_weight_llama_wg512",
        fields=(
            input_tensor(
                name="x",
                binding="t_input",
            ...
            input_tensor(
                name="partial_sums_placeholder",
                binding="t_partial_sums_placeholder",
                role="partial_sums_placeholder",
                dtypes=("float32",),
                shape=("B", "S", "H"),
            ),
        ),
        ...
        tensor_defaults=(
            tensor_binding_default(
                field_name="partial_sums_placeholder",
        ...
        bindings=(
            ...
            storage_buffer_binding(name="t_partial_sums_placeholder", binding=3),
        ),
    ),
    specialization_constants={0: 0, 1: 1},
    source=_RMS_NORM_COMP_SOURCE,
)
