"""Exact llama.cpp `fa_split_k_reduce` shader binding."""
...
FA_SPLIT_K_REDUCE = shader_variant(
    name="fa_split_k_reduce",
    family="fa_split_k_reduce",
    default_output_field="output",
    contract=shader_contract(
        class_name="FlashAttnSplitKReduceProgram",
        shader_name="fa_split_k_reduce",
        fields=(
            input_tensor(
                name="split_k_input",
        ...
        uniforms=(),
        push_constants=push_constant_block(
            size=24,
            fields=(
                push_uint32(name="D", offset=0, value="D"),
                push_uint32(name="ne1", offset=4, value="QH"),
                push_uint32(name="ne2", offset=8, value="S"),
                push_uint32(name="ne3", offset=12, value="B"),
                push_uint32(name="k_num", offset=16, value=push_constant_input("k_num")),
                push_uint32(name="sinks", offset=20, value=0),
            ),
        ),
        dispatch=("QH", ceil_div("D", 64), mul("B", "S")),
        tensor_defaults=(
            tensor_binding_default(field_name="sinks_placeholder", source_field_name="output"),
        ),
        bindings=(
            storage_buffer_binding(name="t_split_k_input", binding=0),
            storage_buffer_binding(name="t_sinks_placeholder", binding=1),
