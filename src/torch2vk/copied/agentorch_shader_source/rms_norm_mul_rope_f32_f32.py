"""Exact llama.cpp fused `rms_norm_mul_rope_f32_f32` shader binding."""
...
RMS_NORM_MUL_ROPE_F32_F32 = shader_variant(
    name="rms_norm_mul_rope_f32_f32",
    family="rms_norm_mul_rope_f32_f32",
    contract=shader_contract(
        class_name="RmsNormMulRopeF32F32Program",
        shader_name="rms_norm_mul_rope_f32_f32",
        fields=(
            input_tensor(
                name="x",
                binding="t_input",
