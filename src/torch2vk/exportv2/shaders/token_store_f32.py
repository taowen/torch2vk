...
TOKEN_STORE_F32 = ShaderVariant(
    ...
    contract=ShaderContract(
        ...
        fields=(
            TensorFieldSpec(
                "next_token", IOKind.INPUT, "next_token", TensorContract(dtype="int64", shape=(1,))
            ),
            TensorFieldSpec(
                "token_index",
                IOKind.INPUT,
            ...
            TensorFieldSpec(
                "done", IOKind.INPUT, "done", TensorContract(dtype="uint32", shape=(1,))
            ),
            TensorFieldSpec(
                "generated_tokens",
                IOKind.INOUT,
                "generated_tokens",
                TensorContract(dtype="int64", shape=(1, "G")),
            ),
            TensorFieldSpec(
                "generated_length",
                IOKind.INOUT,
            ...
            TensorFieldSpec(
                "stopped", IOKind.INOUT, "stopped", TensorContract(dtype="uint32", shape=(1,))
            ),
        ),
