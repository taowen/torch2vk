...
TEXT_KV_CACHE_WRITE_F32 = ShaderVariant(
    name="text_kv_cache_write_f32",
    family="qwen3_asr.text",
    contract=ShaderContract(
        class_name="Qwen3AsrTextKvCacheWriteF32Program",
        shader_name="text_kv_cache_write_f32",
        fields=(
            TensorFieldSpec(
                name="k",
...
TEXT_KV_CACHE_WRITE_DECODE_F32 = ShaderVariant(
    name="text_kv_cache_write_decode_f32",
    family="qwen3_asr.text",
    contract=ShaderContract(
        class_name="Qwen3AsrTextKvCacheWriteDecodeF32Program",
        shader_name="text_kv_cache_write_decode_f32",
        fields=(
            TensorFieldSpec(
                name="k",
                io_kind=IOKind.INPUT,
