...
def _linear_variant(*, name: str, class_name: str, apply_gelu: bool) -> ShaderVariant:
    return ShaderVariant(
        ...
        source=_LINEAR_SOURCE.format(
            gelu_define="#define APPLY_GELU 1" if apply_gelu else "#define APPLY_GELU 0"
        ),
    )


LINEAR_F32 = _linear_variant(
    name="linear_f32",
    class_name="Qwen3AsrLinearF32Program",
    apply_gelu=False,
)

LINEAR_GELU_F32 = _linear_variant(
    name="linear_gelu_f32",
