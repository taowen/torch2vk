...
TEXT_LM_HEAD_SELECT_PARTIAL_T1_F32 = ShaderVariant(
    name="text_lm_head_select_partial_t1_f32",
    family="torch2vk.text",
    contract=ShaderContract(
        class_name="TextLmHeadSelectPartialT1F32Program",
        shader_name="text_lm_head_select_partial_t1_f32",
        fields=(
            TensorFieldSpec(
                name="x",
        ...
        push_constants=PushConstantSpec(
            ...
            fields=(
                ...
                PushConstantFieldSpec(
                    "partial_count", PushConstantType.UINT32, 8, ceil_div("N", 4)
                ),
            ),
        ),
...
TEXT_LM_HEAD_SELECT_REDUCE_T1_F32 = ShaderVariant(
    name="text_lm_head_select_reduce_t1_f32",
    family=TEXT_LM_HEAD_SELECT_PARTIAL_T1_F32.family,
    contract=ShaderContract(
        class_name="TextLmHeadSelectReduceT1F32Program",
        shader_name="text_lm_head_select_reduce_t1_f32",
        fields=(
            TensorFieldSpec(
                name="scratch",
                io_kind=IOKind.INPUT,
