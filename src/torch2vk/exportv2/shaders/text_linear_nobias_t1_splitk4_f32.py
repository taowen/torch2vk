...
TEXT_LINEAR_NOBIAS_T1_SPLITK4_F32 = ShaderVariant(
    name="text_linear_nobias_t1_splitk4_f32",
    family="torch2vk.text",
    contract=ShaderContract(
        class_name="TextLinearNobiasT1Splitk4F32Program",
        shader_name="text_linear_nobias_t1_splitk4_f32",
        fields=(
            TensorFieldSpec(
                name="x",
