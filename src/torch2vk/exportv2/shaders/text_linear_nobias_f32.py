...
TEXT_LINEAR_NOBIAS_F32 = ShaderVariant(
    ...
    contract=ShaderContract(
        ...
        fields=(
            TensorFieldSpec(
                "x", IOKind.INPUT, "input", TensorContract(dtype="float32", shape=(1, "T", "K"))
            ),
            TensorFieldSpec(
                "weight", IOKind.INPUT, "weight", TensorContract(dtype="bfloat16", shape=("N", "K"))
            ),
            TensorFieldSpec(
                "output",
                IOKind.OUTPUT,
                "output",
                TensorContract(dtype="float32", shape=(1, "T", "N")),
            ),
        ),
