...
DEFAULT_REGISTRY = ShaderRegistry(
    [
        ...
        ShaderBinding("aten.rms_norm.default", make_rms_norm_variant),
        ...
        ShaderBinding("aten.group_norm.default", make_group_norm_variant),
        ShaderBinding("aten.sigmoid.default", make_sigmoid_variant),
        ShaderBinding("aten.sqrt.default", make_sqrt_variant),
        ShaderBinding("aten.upsample_nearest2d.vec", make_upsample_nearest2d_variant),
        ...
        ShaderBinding("aten.to.dtype", make_cast_variant),
