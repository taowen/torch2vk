"""Generate common tensor scaffold declarations."""
...
LoweredOpContract: TypeAlias = tuple[str, tuple[str, ...], tuple[str, ...]]
...
def tensor_scaffold_fields_from_lowered_ops(
    *,
    ...
    """Infer tensor fields from lowered ops and their shader tensor contracts."""
    return _tensor_scaffold_fields_from_op_parts(
        op_parts=ops,
...
def _tensor_scaffold_fields_from_op_parts(
    *,
    op_parts: Sequence[LoweredOpContract],
    shader_variants: Mapping[str, ShaderVariant],
    parameter_sources: Mapping[str, str] | None,
    extra_fields: Sequence[TensorFieldPattern],
    external_fields: Sequence[str],
    role_overrides: Mapping[str, str] | None,
    dtype_overrides: Mapping[str, str] | None,
    lowering_registry: OpLoweringRegistry,
    include_unresolved_ops: bool,
) -> tuple[TensorFieldPattern, ...]:
    ...
    for target, inputs, outputs in op_parts:
