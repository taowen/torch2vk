...
TEXT_EMBED_LOOKUP_F32 = ShaderVariant(
    ...
    contract=ShaderContract(
        ...
        fields=(
            TensorFieldSpec("input_ids", IOKind.INPUT, "input", TensorContract(dtype="int64", shape=(1, 1))),
            TensorFieldSpec("embed_tokens_weight", IOKind.INPUT, "weight", TensorContract(dtype="bfloat16", shape=("V", "H"))),
            TensorFieldSpec("output", IOKind.OUTPUT, "output", TensorContract(dtype="float32", shape=(1, 1, "H"))),
        ),
