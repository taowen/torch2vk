...
TOKEN_SELECT_GREEDY_F32 = ShaderVariant(
    ...
    contract=ShaderContract(
        ...
        fields=(
            TensorFieldSpec("logits", IOKind.INPUT, "logits", TensorContract(dtype="float32", shape=(1, "T", "V"))),
            TensorFieldSpec("eos_token_ids", IOKind.INPUT, "eos_token_ids", TensorContract(dtype="int64", shape=("E",))),
            TensorFieldSpec("next_token", IOKind.OUTPUT, "next_token", TensorContract(dtype="int64", shape=(1,))),
