...
ATEN_WHERE_F32 = ShaderVariant(
    ...
    contract=ShaderContract(
        ...
        fields=(
            TensorFieldSpec("mask", IOKind.INPUT, "mask", TensorContract(dtype="bool", shape=("B", "T", 1))),
            TensorFieldSpec("x", IOKind.INPUT, "x", TensorContract(dtype="float32", shape=("B", "T", "H"))),
            TensorFieldSpec("y", IOKind.INPUT, "y", TensorContract(dtype="float32", shape=("B", "T", "H"))),
