...
def make_conv_transpose1d_q8_0_variant(
    ...
    return ShaderVariant(
        ...
        contract=ShaderContract(
            class_name=f"ExportConvTranspose1dQ8_0Weight{bias_suffix.title()}BiasProgram",
