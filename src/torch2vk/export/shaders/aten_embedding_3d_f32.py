...
ATEN_EMBEDDING_3D_F32 = ShaderVariant(
    ...
    contract=ShaderContract(
        ...
        fields=(
            ...
            TensorFieldSpec("indices", IOKind.INPUT, "indices", TensorContract(dtype="int64", shape=("B", "C", "T"))),
            TensorFieldSpec("output", IOKind.OUTPUT, "output", TensorContract(dtype="float32", shape=("B", "C", "T", "H"))),
        ),
