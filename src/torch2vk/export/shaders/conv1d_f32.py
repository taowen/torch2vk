...
def make_conv1d_variant(node: Node, activation_dtype: str = "float32") -> ShaderVariant | None:
    ...
    shader_name = f"conv1d_{weight_suffix}w_{bias_suffix}b_f32"

    return ShaderVariant(
        name=shader_name,
        family="export",
        contract=ShaderContract(
            class_name=f"ExportConv1d{weight_suffix.title()}Weight{bias_suffix.title()}BiasProgram",
            ...
            fields=(
                ...
                TensorFieldSpec(
                    ...
                    IOKind.INPUT,
                    "weight",
                    TensorContract(dtype=weight_dtype, shape=("Co", "Ci2", "Kh")),
                ),
                TensorFieldSpec(
