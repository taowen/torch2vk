...
def make_embedding_q8_0_variant(node: Node, activation_dtype: str = "float32") -> ShaderVariant | None:
    ...
    return ShaderVariant(
        ...
        source=_source(indices_dtype, activation_dtype),
    )


def _source(dtype: str, activation_dtype: str) -> str:
    ...
    return (
        ...
        .replace("{{STORE_EMBEDDING}}", activation_store("q8_0_value(uint(token_id), dim_idx)", activation_dtype))
    )
