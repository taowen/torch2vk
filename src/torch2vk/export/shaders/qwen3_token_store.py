"""Qwen3 generated-token store shader for replay decode."""
...
QWEN3_TOKEN_STORE = ShaderVariant(
    name="qwen3_token_store",
    family="qwen3.text",
    contract=ShaderContract(
        class_name="Qwen3TokenStoreProgram",
        shader_name="qwen3_token_store",
        fields=(
            TensorFieldSpec(
                name="next_token",
...
QWEN3_TOKEN_STORE_EOS = ShaderVariant(
    ...
    family=QWEN3_TOKEN_STORE.family,
    contract=ShaderContract(
        class_name="Qwen3TokenStoreEosProgram",
        shader_name="qwen3_token_store_eos",
        fields=QWEN3_TOKEN_STORE.contract.fields,
        push_constants=PushConstantSpec(
            size=12,
            fields=(
                PushConstantFieldSpec("G", PushConstantType.UINT32, 0, "G"),
        ...
        dispatch=QWEN3_TOKEN_STORE.contract.dispatch,
    ),
    execution_requirements=QWEN3_TOKEN_STORE.execution_requirements,
    source=QWEN3_TOKEN_STORE.source,
)
