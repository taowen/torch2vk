...
ATEN_SHIFTED_IDS_I64 = ShaderVariant(
    ...
    contract=ShaderContract(
        ...
        fields=(
            TensorFieldSpec("input_ids", IOKind.INPUT, "input_ids", TensorContract(dtype="int64", shape=("B", "C", "T"))),
            TensorFieldSpec("audio_mask", IOKind.INPUT, "audio_mask", TensorContract(dtype="bool", shape=("B", "T"))),
            TensorFieldSpec("codebook_layer_offsets", IOKind.INPUT, "codebook_layer_offsets", TensorContract(dtype="int64", shape=(1, "C", 1))),
            TensorFieldSpec("output", IOKind.OUTPUT, "output", TensorContract(dtype="int64", shape=("B", "C", "T"))),
        ),
