...
from torch2vk.export.torch_ops import TorchOpPattern
...
def torch_ops_from_exported_program(
    ...
    *,
    ...
    ``tensor_name_map`` maps FX node names, including placeholders, onto model adapter
    tensor fields. Unmapped nodes keep their FX name.
    """
